...
# static fields
.field private static final a:Lbg/c;
...
.method public b(Landroid/media/Image;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, v0, v1}, Lbg/c;->g(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public c(Lag/a;Z)Ljava/nio/ByteBuffer;
    .locals 17

    move/from16 v0, p2

    invoke-virtual/range {p1 .. p1}, Lag/a;->f()I
    ...
    invoke-virtual/range {p1 .. p1}, Lag/a;->d()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v1, v0}, Lbg/c;->f(Ljava/nio/ByteBuffer;Z)Ljava/nio/ByteBuffer;
    ...
    :cond_1
    invoke-virtual/range {p1 .. p1}, Lag/a;->i()[Landroid/media/Image$Plane;
    ...
    invoke-virtual/range {p1 .. p1}, Lag/a;->k()I

    move-result v1

    invoke-virtual/range {p1 .. p1}, Lag/a;->g()I

    move-result v2

    move-object/from16 v3, p0

    invoke-virtual {v3, v0, v1, v2}, Lbg/c;->e([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0}, Lbg/c;->a(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual/range {p1 .. p1}, Lag/a;->c()Landroid/graphics/Bitmap;
...
.method public e([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static/range {v5 .. v10}, Lbg/c;->h(Landroid/media/Image$Plane;II[BII)V
    ...
    invoke-static/range {v0 .. v5}, Lbg/c;->h(Landroid/media/Image$Plane;II[BII)V
