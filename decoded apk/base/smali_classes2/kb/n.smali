...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lkb/n;->b:Lcom/google/crypto/tink/internal/k;
    ...
    sput-object v1, Lkb/n;->c:Lcom/google/crypto/tink/internal/j;

    new-instance v1, Lkb/l;

    invoke-direct {v1}, Lkb/l;-><init>()V

    const-class v2, Lkb/g;
    ...
    sput-object v1, Lkb/n;->d:Lcom/google/crypto/tink/internal/c;
    ...
    sput-object v0, Lkb/n;->e:Lcom/google/crypto/tink/internal/b;

    return-void
.end method

.method public static synthetic a(Lcom/google/crypto/tink/internal/o;Ljb/y;)Lkb/g;
    .locals 0

    invoke-static {p0, p1}, Lkb/n;->b(Lcom/google/crypto/tink/internal/o;Ljb/y;)Lkb/g;
...
.method private static b(Lcom/google/crypto/tink/internal/o;Ljb/y;)Lkb/g;
    .locals 3
    ...
    invoke-static {v0, v1}, Lvb/i;->d0(Lcom/google/crypto/tink/shaded/protobuf/h;Lcom/google/crypto/tink/shaded/protobuf/p;)Lvb/i;

    move-result-object v0

    invoke-virtual {v0}, Lvb/i;->b0()I

    move-result v1

    if-nez v1, :cond_0

    invoke-static {}, Lkb/i;->a()Lkb/i$b;

    move-result-object v1

    invoke-virtual {v0}, Lvb/i;->Z()Lcom/google/crypto/tink/shaded/protobuf/h;
    ...
    invoke-virtual {v1, v2}, Lkb/i$b;->c(I)Lkb/i$b;

    move-result-object v1

    invoke-virtual {v0}, Lvb/i;->a0()Lvb/k;

    move-result-object v2

    invoke-virtual {v2}, Lvb/k;->Y()I

    move-result v2

    invoke-virtual {v1, v2}, Lkb/i$b;->b(I)Lkb/i$b;

    move-result-object v1

    const/16 v2, 0x10

    invoke-virtual {v1, v2}, Lkb/i$b;->d(I)Lkb/i$b;
    ...
    invoke-static {v2}, Lkb/n;->e(Lvb/i0;)Lkb/i$c;

    move-result-object v2

    invoke-virtual {v1, v2}, Lkb/i$b;->e(Lkb/i$c;)Lkb/i$b;

    move-result-object v1

    invoke-virtual {v1}, Lkb/i$b;->a()Lkb/i;

    move-result-object v1

    invoke-static {}, Lkb/g;->a()Lkb/g$b;

    move-result-object v2

    invoke-virtual {v2, v1}, Lkb/g$b;->e(Lkb/i;)Lkb/g$b;
    ...
    invoke-virtual {v1, p1}, Lkb/g$b;->d(Lxb/b;)Lkb/g$b;
    ...
    invoke-virtual {p1, p0}, Lkb/g$b;->c(Ljava/lang/Integer;)Lkb/g$b;

    move-result-object p0

    invoke-virtual {p0}, Lkb/g$b;->a()Lkb/g;
...
.method public static c()V
    ...
    invoke-static {v0}, Lkb/n;->d(Lcom/google/crypto/tink/internal/i;)V
...
.method private static e(Lvb/i0;)Lkb/i$c;
    .locals 3
    ...
    sget-object p0, Lkb/i$c;->d:Lkb/i$c;
    ...
    :cond_1
    sget-object p0, Lkb/i$c;->c:Lkb/i$c;

    return-object p0

    :cond_2
    sget-object p0, Lkb/i$c;->b:Lkb/i$c;
