...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lrb/f;->b:Lcom/google/crypto/tink/internal/k;
    ...
    sput-object v1, Lrb/f;->c:Lcom/google/crypto/tink/internal/j;
    ...
    sput-object v1, Lrb/f;->d:Lcom/google/crypto/tink/internal/c;
    ...
    sput-object v0, Lrb/f;->e:Lcom/google/crypto/tink/internal/b;

    return-void
.end method

.method public static synthetic a(Lcom/google/crypto/tink/internal/o;Ljb/y;)Lrb/a;
    .locals 0

    invoke-static {p0, p1}, Lrb/f;->b(Lcom/google/crypto/tink/internal/o;Ljb/y;)Lrb/a;
...
.method private static b(Lcom/google/crypto/tink/internal/o;Ljb/y;)Lrb/a;
    .locals 3
    ...
    invoke-static {v0, v1}, Lvb/a;->d0(Lcom/google/crypto/tink/shaded/protobuf/h;Lcom/google/crypto/tink/shaded/protobuf/p;)Lvb/a;

    move-result-object v0

    invoke-virtual {v0}, Lvb/a;->b0()I

    move-result v1

    if-nez v1, :cond_0

    invoke-static {}, Lrb/d;->a()Lrb/d$b;

    move-result-object v1

    invoke-virtual {v0}, Lvb/a;->Z()Lcom/google/crypto/tink/shaded/protobuf/h;
    ...
    invoke-virtual {v1, v2}, Lrb/d$b;->b(I)Lrb/d$b;

    move-result-object v1

    invoke-virtual {v0}, Lvb/a;->a0()Lvb/c;

    move-result-object v2

    invoke-virtual {v2}, Lvb/c;->Y()I

    move-result v2

    invoke-virtual {v1, v2}, Lrb/d$b;->c(I)Lrb/d$b;
    ...
    invoke-static {v2}, Lrb/f;->e(Lvb/i0;)Lrb/d$c;

    move-result-object v2

    invoke-virtual {v1, v2}, Lrb/d$b;->d(Lrb/d$c;)Lrb/d$b;

    move-result-object v1

    invoke-virtual {v1}, Lrb/d$b;->a()Lrb/d;
    ...
    invoke-virtual {v2, v1}, Lrb/a$b;->e(Lrb/d;)Lrb/a$b;
    ...
    invoke-virtual {v1, p1}, Lrb/a$b;->c(Lxb/b;)Lrb/a$b;
    ...
    invoke-virtual {p1, p0}, Lrb/a$b;->d(Ljava/lang/Integer;)Lrb/a$b;

    move-result-object p0

    invoke-virtual {p0}, Lrb/a$b;->a()Lrb/a;
...
.method public static c()V
    ...
    invoke-static {v0}, Lrb/f;->d(Lcom/google/crypto/tink/internal/i;)V
...
.method private static e(Lvb/i0;)Lrb/d$c;
    .locals 3

    sget-object v0, Lrb/f$a;->a:[I
    ...
    sget-object p0, Lrb/d$c;->e:Lrb/d$c;
    ...
    :cond_1
    sget-object p0, Lrb/d$c;->d:Lrb/d$c;

    return-object p0

    :cond_2
    sget-object p0, Lrb/d$c;->c:Lrb/d$c;

    return-object p0

    :cond_3
    sget-object p0, Lrb/d$c;->b:Lrb/d$c;
