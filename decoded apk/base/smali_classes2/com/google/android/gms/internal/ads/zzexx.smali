...
.method final synthetic zzc()Lcom/google/android/gms/internal/ads/zzexv;
    ...
    invoke-static {v6}, Lla/j;->c(Landroid/content/Context;)Z

    move-result v11

    invoke-static {v6}, Lla/j;->d(Landroid/content/Context;)Z
    ...
    :cond_3
    :try_start_0
    invoke-static {v3}, Lna/e;->a(Landroid/content/Context;)Lna/d;

    move-result-object v3

    iget-object v15, v7, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v3, v15, v6}, Lna/d;->f(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-virtual {v3, v6, v7}, Lna/d;->f(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v3}, Lcom/google/android/gms/ads/internal/util/j2;->a(Landroid/content/Context;)Z
    ...
    :try_start_2
    invoke-static {v7}, Lna/e;->a(Landroid/content/Context;)Lna/d;
    ...
    invoke-virtual {v8, v7, v6}, Lna/d;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
