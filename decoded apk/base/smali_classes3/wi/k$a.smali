...
.method static constructor <clinit>()V
    ...
    invoke-direct {v4, v9, v10, v6}, Lio/grpc/okhttp/internal/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lwi/k$a;->e:Lio/grpc/okhttp/internal/g;
    ...
    invoke-direct {v4, v9, v12, v6}, Lio/grpc/okhttp/internal/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lwi/k$a;->f:Lio/grpc/okhttp/internal/g;
    ...
    invoke-direct {v4, v13, v6, v12}, Lio/grpc/okhttp/internal/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lwi/k$a;->g:Lio/grpc/okhttp/internal/g;
    ...
    sput-object v4, Lwi/k$a;->h:Lio/grpc/okhttp/internal/g;
    ...
    sput-object v4, Lwi/k$a;->i:Lio/grpc/okhttp/internal/g;
    ...
    sput-object v4, Lwi/k$a;->j:Lio/grpc/okhttp/internal/g;
    ...
    :goto_4
    invoke-static {}, Lwi/k;->a()Ljava/util/logging/Logger;
    ...
    :goto_5
    sput-object v4, Lwi/k$a;->m:Ljava/lang/reflect/Method;

    sput-object v6, Lwi/k$a;->n:Ljava/lang/reflect/Method;

    sput-object v12, Lwi/k$a;->o:Ljava/lang/reflect/Method;

    sput-object v14, Lwi/k$a;->k:Ljava/lang/reflect/Method;

    sput-object v1, Lwi/k$a;->l:Ljava/lang/reflect/Method;
    ...
    :goto_8
    sput-object v1, Lwi/k$a;->p:Ljava/lang/reflect/Method;

    sput-object v9, Lwi/k$a;->q:Ljava/lang/reflect/Constructor;

    return-void
.end method

.method constructor <init>(Lio/grpc/okhttp/internal/h;)V
    .locals 0

    invoke-direct {p0, p1}, Lwi/k;-><init>(Lio/grpc/okhttp/internal/h;)V
...
.method protected c(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-static {p3}, Lwi/k;->b(Ljava/util/List;)[Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p2}, Lwi/k;->g(Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_2

    sget-object v4, Lwi/k$a;->k:Ljava/lang/reflect/Method;
    ...
    sget-object v4, Lwi/k$a;->l:Ljava/lang/reflect/Method;
    ...
    :cond_0
    sget-object v4, Lwi/k$a;->e:Lio/grpc/okhttp/internal/g;
    ...
    invoke-virtual {v4, p1, v5}, Lio/grpc/okhttp/internal/g;->e(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;

    :goto_0
    sget-object v4, Lwi/k$a;->p:Ljava/lang/reflect/Method;

    if-eqz v4, :cond_1

    sget-object v5, Lwi/k$a;->q:Ljava/lang/reflect/Constructor;
    ...
    :cond_1
    sget-object v4, Lwi/k$a;->f:Lio/grpc/okhttp/internal/g;
    ...
    :cond_2
    :goto_1
    sget-object p2, Lwi/k$a;->o:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sget-object p2, Lwi/k$a;->m:Ljava/lang/reflect/Method;
    ...
    sget-object p2, Lwi/k$a;->n:Ljava/lang/reflect/Method;
    ...
    iget-object p3, p0, Lwi/k;->a:Lio/grpc/okhttp/internal/h;

    invoke-virtual {p3}, Lio/grpc/okhttp/internal/h;->i()Lio/grpc/okhttp/internal/h$h;
    ...
    sget-object p3, Lwi/k$a;->h:Lio/grpc/okhttp/internal/g;
    ...
    sget-object p3, Lwi/k$a;->j:Lio/grpc/okhttp/internal/g;
...
.method public f(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    sget-object v0, Lwi/k$a;->o:Ljava/lang/reflect/Method;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lwi/k;->a:Lio/grpc/okhttp/internal/h;

    invoke-virtual {v0}, Lio/grpc/okhttp/internal/h;->i()Lio/grpc/okhttp/internal/h$h;

    move-result-object v0

    sget-object v2, Lio/grpc/okhttp/internal/h$h;->ALPN_AND_NPN:Lio/grpc/okhttp/internal/h$h;

    if-ne v0, v2, :cond_2

    :try_start_1
    sget-object v0, Lwi/k$a;->g:Lio/grpc/okhttp/internal/g;
    ...
    sget-object v3, Lio/grpc/okhttp/internal/l;->b:Ljava/nio/charset/Charset;
    ...
    sget-object v2, Lio/grpc/okhttp/internal/h$h;->NONE:Lio/grpc/okhttp/internal/h$h;

    if-eq v0, v2, :cond_3

    :try_start_2
    sget-object v0, Lwi/k$a;->i:Lio/grpc/okhttp/internal/g;

    new-array v1, v1, [Ljava/lang/Object;

    invoke-virtual {v0, p1, v1}, Lio/grpc/okhttp/internal/g;->f(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v1, Lio/grpc/okhttp/internal/l;->b:Ljava/nio/charset/Charset;
...
.method public h(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lwi/k$a;->f(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-super {p0, p1, p2, p3}, Lwi/k;->h(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
