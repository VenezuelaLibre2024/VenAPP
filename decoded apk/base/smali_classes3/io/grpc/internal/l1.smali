...
.method public constructor <init>(Lio/grpc/internal/l1$d;Lio/grpc/internal/p2;Lio/grpc/internal/h2;)V
    ...
    iput-object v1, p0, Lio/grpc/internal/l1;->d:Lvi/n;
...
.method static synthetic c(Lio/grpc/internal/l1;[BII)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/grpc/internal/l1;->n([BII)V

    return-void
.end method

.method static synthetic d(Lio/grpc/internal/l1;)Lio/grpc/internal/p2;
    .locals 0
...
.method private e(ZZ)V
    ...
    invoke-interface {v1, v0, p1, p2, v2}, Lio/grpc/internal/l1$d;->p(Lio/grpc/internal/o2;ZZI)V
...
.method private h()V
    ...
    invoke-interface {v0}, Lio/grpc/internal/o2;->release()V
...
.method private k(Lio/grpc/internal/l1$b;Z)V
    .locals 5
    ...
    invoke-interface {p2, v1, v3, v2}, Lio/grpc/internal/o2;->write([BII)V
    ...
    invoke-interface {v1, p2, v3, v3, v2}, Lio/grpc/internal/l1$d;->p(Lio/grpc/internal/o2;ZZI)V

    iput v4, p0, Lio/grpc/internal/l1;->k:I

    invoke-static {p1}, Lio/grpc/internal/l1$b;->b(Lio/grpc/internal/l1$b;)Ljava/util/List;
    ...
    invoke-interface {v1, v2, v3, v3, v3}, Lio/grpc/internal/l1$d;->p(Lio/grpc/internal/o2;ZZI)V
...
.method private l(Ljava/io/InputStream;I)I
    ...
    iget-object v0, p0, Lio/grpc/internal/l1;->d:Lvi/n;

    invoke-interface {v0, p2}, Lvi/n;->c(Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v0

    :try_start_0
    invoke-static {p1, v0}, Lio/grpc/internal/l1;->o(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    ...
    :cond_0
    sget-object p2, Lvi/g1;->o:Lvi/g1;
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, p2, v1}, Lio/grpc/internal/l1;->k(Lio/grpc/internal/l1$b;Z)V
...
.method private m(Ljava/io/InputStream;I)I
    ...
    :cond_0
    sget-object p1, Lvi/g1;->o:Lvi/g1;
    ...
    iget p2, p0, Lio/grpc/internal/l1;->b:I
    ...
    invoke-direct {p0, p2, v1, v0}, Lio/grpc/internal/l1;->n([BII)V

    iget-object p2, p0, Lio/grpc/internal/l1;->f:Lio/grpc/internal/l1$c;

    invoke-static {p1, p2}, Lio/grpc/internal/l1;->o(Ljava/io/InputStream;Ljava/io/OutputStream;)I
...
.method private n([BII)V
    ...
    invoke-interface {v0}, Lio/grpc/internal/o2;->a()I
    ...
    invoke-direct {p0, v0, v0}, Lio/grpc/internal/l1;->e(ZZ)V
    ...
    invoke-interface {v1, p1, p2, v0}, Lio/grpc/internal/o2;->write([BII)V
...
.method private static o(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    ...
    instance-of v0, p0, Lvi/w;

    if-eqz v0, :cond_0

    check-cast p0, Lvi/w;

    invoke-interface {p0, p1}, Lvi/w;->a(Ljava/io/OutputStream;)I
    ...
    :cond_0
    invoke-static {p0, p1}, Lfb/b;->b(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    invoke-static {v0, v1, p0, p1}, Leb/o;->j(ZLjava/lang/String;J)V
...
.method private p(Ljava/io/InputStream;I)I
    ...
    invoke-direct {p0, p1, p2}, Lio/grpc/internal/l1;->m(Ljava/io/InputStream;I)I
...
# virtual methods
.method public bridge synthetic a(Lvi/n;)Lio/grpc/internal/o0;
    .locals 0

    invoke-virtual {p0, p1}, Lio/grpc/internal/l1;->i(Lvi/n;)Lio/grpc/internal/l1;
...
.method public b(Ljava/io/InputStream;)V
    ...
    iget-object v1, p0, Lio/grpc/internal/l1;->d:Lvi/n;

    sget-object v4, Lvi/l$b;->a:Lvi/l;
    ...
    :goto_0
    :try_start_0
    invoke-direct {p0, p1}, Lio/grpc/internal/l1;->g(Ljava/io/InputStream;)I
    ...
    invoke-direct {p0, p1, v4}, Lio/grpc/internal/l1;->l(Ljava/io/InputStream;I)I
    ...
    :cond_1
    invoke-direct {p0, p1, v4}, Lio/grpc/internal/l1;->p(Ljava/io/InputStream;I)I
    ...
    sget-object v1, Lvi/g1;->t:Lvi/g1;

    invoke-virtual {v1, v0}, Lvi/g1;->r(Ljava/lang/String;)Lvi/g1;
...
.method public close()V
    ...
    invoke-interface {v1}, Lio/grpc/internal/o2;->k()I
...
.method public flush()V
    ...
    invoke-interface {v0}, Lio/grpc/internal/o2;->k()I
    ...
    invoke-direct {p0, v0, v1}, Lio/grpc/internal/l1;->e(ZZ)V

    :cond_0
    return-void
.end method

.method public i(Lvi/n;)Lio/grpc/internal/l1;
    .locals 1
    ...
    iput-object p1, p0, Lio/grpc/internal/l1;->d:Lvi/n;
