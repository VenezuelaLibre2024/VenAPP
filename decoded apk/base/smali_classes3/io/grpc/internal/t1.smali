...
.field private static final f:Leb/v;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/internal/t1;->f:Leb/v;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lio/grpc/internal/t1;->f:Leb/v;
    ...
    invoke-direct {p0, v0, v1, v2}, Lio/grpc/internal/t1;-><init>(Leb/v;Lio/grpc/internal/t1$c;Ljava/lang/String;)V

    return-void
.end method

.method constructor <init>(Leb/v;Lio/grpc/internal/t1$c;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/grpc/internal/t1;->a:Leb/v;
...
.method private c(Ljava/net/InetSocketAddress;)Lvi/c1;
    .locals 10
    ...
    iget-object v1, p0, Lio/grpc/internal/t1;->a:Leb/v;
    ...
    sget-object v2, Lio/grpc/internal/t1;->d:Ljava/util/logging/Logger;
    ...
    iget-object v2, p0, Lio/grpc/internal/t1;->b:Lio/grpc/internal/t1$c;

    invoke-static {v1}, Lio/grpc/internal/q0;->h(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    invoke-interface/range {v2 .. v8}, Lio/grpc/internal/t1$c;->a(Ljava/lang/String;Ljava/net/InetAddress;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/net/PasswordAuthentication;
    ...
    :cond_3
    invoke-static {}, Lvi/b0;->e()Lvi/b0$b;

    move-result-object v3

    invoke-virtual {v3, p1}, Lvi/b0$b;->d(Ljava/net/InetSocketAddress;)Lvi/b0$b;

    move-result-object p1

    invoke-virtual {p1, v1}, Lvi/b0$b;->c(Ljava/net/SocketAddress;)Lvi/b0$b;

    move-result-object p1

    if-nez v2, :cond_4

    invoke-virtual {p1}, Lvi/b0$b;->a()Lvi/b0;
    ...
    invoke-virtual {p1, v1}, Lvi/b0$b;->e(Ljava/lang/String;)Lvi/b0$b;
    ...
    :goto_0
    invoke-virtual {p1, v0}, Lvi/b0$b;->b(Ljava/lang/String;)Lvi/b0$b;
...
# virtual methods
.method public a(Ljava/net/SocketAddress;)Lvi/c1;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lvi/b0$b;->c(Ljava/net/SocketAddress;)Lvi/b0$b;

    move-result-object v0

    check-cast p1, Ljava/net/InetSocketAddress;

    invoke-virtual {v0, p1}, Lvi/b0$b;->d(Ljava/net/InetSocketAddress;)Lvi/b0$b;
    ...
    invoke-direct {p0, p1}, Lio/grpc/internal/t1;->c(Ljava/net/InetSocketAddress;)Lvi/c1;
