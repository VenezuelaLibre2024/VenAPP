...
.field private j:Lvi/g1;

.field private k:Lvi/p0$i;

.field private l:J


# direct methods
.method constructor <init>(Ljava/util/concurrent/Executor;Lvi/k1;)V
    .locals 2
    ...
    invoke-static {v0, v1}, Lvi/i0;->a(Ljava/lang/Class;Ljava/lang/String;)Lvi/i0;

    move-result-object v0

    iput-object v0, p0, Lio/grpc/internal/a0;->a:Lvi/i0;
    ...
    iput-object p2, p0, Lio/grpc/internal/a0;->d:Lvi/k1;

    return-void
.end method

.method static synthetic a(Lio/grpc/internal/a0;)Lio/grpc/internal/j1$a;
    .locals 0
...
.method static synthetic h(Lio/grpc/internal/a0;)Lvi/g1;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/a0;->j:Lvi/g1;
...
.method static synthetic n(Lio/grpc/internal/a0;)Lvi/k1;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/a0;->d:Lvi/k1;

    return-object p0
.end method

.method private o(Lvi/p0$f;[Lvi/k;)Lio/grpc/internal/a0$e;
    .locals 2
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lio/grpc/internal/a0$e;-><init>(Lio/grpc/internal/a0;Lvi/p0$f;[Lvi/k;Lio/grpc/internal/a0$a;)V
    ...
    iget-object p1, p0, Lio/grpc/internal/a0;->d:Lvi/k1;

    iget-object p2, p0, Lio/grpc/internal/a0;->e:Ljava/lang/Runnable;

    invoke-virtual {p1, p2}, Lvi/k1;->b(Ljava/lang/Runnable;)V
...
# virtual methods
.method public final b(Lvi/g1;)V
    .locals 6

    invoke-virtual {p0, p1}, Lio/grpc/internal/a0;->d(Lvi/g1;)V
    ...
    sget-object v4, Lio/grpc/internal/r$a;->REFUSED:Lio/grpc/internal/r$a;

    invoke-static {v1}, Lio/grpc/internal/a0$e;->x(Lio/grpc/internal/a0$e;)[Lvi/k;

    move-result-object v5

    invoke-direct {v3, p1, v4, v5}, Lio/grpc/internal/f0;-><init>(Lvi/g1;Lio/grpc/internal/r$a;[Lvi/k;)V
    ...
    invoke-virtual {p1, v2}, Lvi/k1;->execute(Ljava/lang/Runnable;)V
...
.method public final c(Lvi/x0;Lvi/w0;Lvi/c;[Lvi/k;)Lio/grpc/internal/q;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p3}, Lio/grpc/internal/s1;-><init>(Lvi/x0;Lvi/w0;Lvi/c;)V
    ...
    :try_start_1
    iget-object v3, p0, Lio/grpc/internal/a0;->j:Lvi/g1;

    if-eqz v3, :cond_0

    new-instance p1, Lio/grpc/internal/f0;

    iget-object p3, p0, Lio/grpc/internal/a0;->j:Lvi/g1;

    invoke-direct {p1, p3, p4}, Lio/grpc/internal/f0;-><init>(Lvi/g1;[Lvi/k;)V
    ...
    :goto_2
    iget-object p2, p0, Lio/grpc/internal/a0;->d:Lvi/k1;

    invoke-virtual {p2}, Lvi/k1;->a()V

    return-object p1

    :cond_0
    :try_start_2
    iget-object v3, p0, Lio/grpc/internal/a0;->k:Lvi/p0$i;

    if-nez v3, :cond_1

    invoke-direct {p0, v0, p4}, Lio/grpc/internal/a0;->o(Lvi/p0$f;[Lvi/k;)Lio/grpc/internal/a0$e;
    ...
    :try_start_3
    invoke-virtual {v3, v0}, Lvi/p0$i;->a(Lvi/p0$f;)Lvi/p0$e;

    move-result-object p1

    invoke-virtual {p3}, Lvi/c;->j()Z

    move-result p2

    invoke-static {p1, p2}, Lio/grpc/internal/q0;->j(Lvi/p0$e;Z)Lio/grpc/internal/s;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {v0}, Lvi/p0$f;->c()Lvi/x0;

    move-result-object p2

    invoke-virtual {v0}, Lvi/p0$f;->b()Lvi/w0;
    ...
    invoke-interface {p1, p2, p3, v0, p4}, Lio/grpc/internal/s;->c(Lvi/x0;Lvi/w0;Lvi/c;[Lvi/k;)Lio/grpc/internal/q;
...
.method public final d(Lvi/g1;)V
    .locals 3
    ...
    :try_start_0
    iget-object v1, p0, Lio/grpc/internal/a0;->j:Lvi/g1;
    ...
    :cond_0
    iput-object p1, p0, Lio/grpc/internal/a0;->j:Lvi/g1;

    iget-object v1, p0, Lio/grpc/internal/a0;->d:Lvi/k1;

    new-instance v2, Lio/grpc/internal/a0$d;

    invoke-direct {v2, p0, p1}, Lio/grpc/internal/a0$d;-><init>(Lio/grpc/internal/a0;Lvi/g1;)V

    invoke-virtual {v1, v2}, Lvi/k1;->b(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, p1}, Lvi/k1;->b(Ljava/lang/Runnable;)V
...
.method public e()Lvi/i0;
    ...
    iget-object v0, p0, Lio/grpc/internal/a0;->a:Lvi/i0;

    return-object v0
.end method

.method public final g(Lio/grpc/internal/j1$a;)Ljava/lang/Runnable;
    .locals 1
...
.method final r(Lvi/p0$i;)V
    ...
    :try_start_0
    iput-object p1, p0, Lio/grpc/internal/a0;->k:Lvi/p0$i;
    ...
    invoke-static {v2}, Lio/grpc/internal/a0$e;->y(Lio/grpc/internal/a0$e;)Lvi/p0$f;

    move-result-object v3

    invoke-virtual {p1, v3}, Lvi/p0$i;->a(Lvi/p0$f;)Lvi/p0$e;
    ...
    invoke-virtual {v4}, Lvi/p0$f;->a()Lvi/c;

    move-result-object v4

    invoke-virtual {v4}, Lvi/c;->j()Z

    move-result v5

    invoke-static {v3, v5}, Lio/grpc/internal/q0;->j(Lvi/p0$e;Z)Lio/grpc/internal/s;
    ...
    invoke-virtual {v4}, Lvi/c;->e()Ljava/util/concurrent/Executor;
    ...
    invoke-virtual {v1, v0}, Lvi/k1;->b(Ljava/lang/Runnable;)V
