...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lq3/h;->a(Ljava/nio/ByteBuffer;)Landroid/graphics/ImageDecoder$Source;
    ...
    invoke-static {p0, v0}, Lq3/d;->a(Landroid/graphics/ImageDecoder$Source;Landroid/graphics/ImageDecoder$OnHeaderDecodedListener;)Landroid/graphics/Bitmap;
...
.method private static synthetic lambda$decodeImage$0(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    invoke-static {p4}, Lp3/d;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;

    move-result-object p4

    invoke-static {p2, p4}, Lp3/e;->a(Landroid/graphics/ImageDecoder;Landroid/graphics/ColorSpace;)V

    const/4 p4, 0x1

    invoke-static {p2, p4}, Lp3/a;->a(Landroid/graphics/ImageDecoder;I)V

    invoke-static {p3}, Lp3/h;->a(Landroid/graphics/ImageDecoder$ImageInfo;)Landroid/util/Size;
