...
.method private static createImageReader(II)Landroid/media/ImageReader;
    ...
    invoke-static/range {v3 .. v8}, Lio/flutter/embedding/android/a;->a(IIIIJ)Landroid/media/ImageReader;
...
.method private updateCurrentBitmap()V
    ...
    invoke-static {v0}, Lio/flutter/embedding/android/b;->a(Landroid/media/Image;)Landroid/hardware/HardwareBuffer;
    ...
    invoke-static {v1}, Lp3/d;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;

    move-result-object v1

    invoke-static {v0, v1}, Lio/flutter/embedding/android/c;->a(Landroid/hardware/HardwareBuffer;Landroid/graphics/ColorSpace;)Landroid/graphics/Bitmap;

    move-result-object v1

    iput-object v1, p0, Lio/flutter/embedding/android/FlutterImageView;->currentBitmap:Landroid/graphics/Bitmap;

    invoke-static {v0}, Lio/flutter/embedding/android/d;->a(Landroid/hardware/HardwareBuffer;)V
