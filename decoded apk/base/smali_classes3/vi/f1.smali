...
.method static b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    invoke-static {p0, v1}, Lvi/f1;->a(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static e(Ljava/lang/Class;Ljava/lang/Iterable;Ljava/lang/ClassLoader;Lvi/f1$b;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p2}, Lvi/f1;->d(Ljava/lang/ClassLoader;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0, p1}, Lvi/f1;->b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    :cond_0
    invoke-static {p0, p2}, Lvi/f1;->c(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/lang/Iterable;
    ...
    invoke-interface {p3, p2}, Lvi/f1$b;->a(Ljava/lang/Object;)Z
    ...
    :cond_2
    new-instance p0, Lvi/f1$a;

    invoke-direct {p0, p3}, Lvi/f1$a;-><init>(Lvi/f1$b;)V
