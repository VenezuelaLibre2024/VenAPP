...
.method public a(Lgj/b;)Z
    ...
    invoke-virtual {p0, p1}, Lkj/d;->c(Lgj/b;)Z
...
.method public b(Lgj/b;)Z
    ...
    iget-object v0, p0, Lkj/d;->a:Ljava/util/List;
    ...
    iput-object v0, p0, Lkj/d;->a:Ljava/util/List;
...
.method d(Ljava/util/List;)V
    ...
    :try_start_0
    invoke-interface {v1}, Lgj/b;->dispose()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p1, v0}, Lhj/a;-><init>(Ljava/lang/Iterable;)V
...
.method public dispose()V
    ...
    iput-boolean v0, p0, Lkj/d;->b:Z

    iget-object v0, p0, Lkj/d;->a:Ljava/util/List;

    const/4 v1, 0x0

    iput-object v1, p0, Lkj/d;->a:Ljava/util/List;

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0, v0}, Lkj/d;->d(Ljava/util/List;)V
