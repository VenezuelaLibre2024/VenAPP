...
.method public static d(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILci/b;)V
    .locals 8

    new-instance v7, Lei/b;
    ...
    invoke-direct/range {v0 .. v6}, Lei/b;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILci/b;)V
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {v1, p0}, Lfi/f;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v1}, Lfi/f;->g()I

    move-result v0

    invoke-static {p0}, Lfi/a;->c(Ljava/io/Closeable;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
