...
.method static a(Landroidx/camera/core/impl/k;)Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
    ...
    invoke-static {p0, v0}, Landroidx/camera/camera2/internal/t1;->b(Landroidx/camera/core/impl/k;Ljava/util/List;)V
...
.method static b(Landroidx/camera/core/impl/k;Ljava/util/List;)V
    ...
    invoke-static {v0, p1}, Landroidx/camera/camera2/internal/t1;->b(Landroidx/camera/core/impl/k;Ljava/util/List;)V

    goto :goto_0

    :cond_0
    instance-of v0, p0, Landroidx/camera/camera2/internal/s1;

    if-eqz v0, :cond_1

    check-cast p0, Landroidx/camera/camera2/internal/s1;

    invoke-virtual {p0}, Landroidx/camera/camera2/internal/s1;->e()Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
    ...
    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/r1;-><init>(Landroidx/camera/core/impl/k;)V
