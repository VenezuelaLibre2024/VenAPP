...
# direct methods
.method public static a(Landroid/content/Context;Landroidx/camera/core/impl/e0;Lw/p;)V
    .locals 4
    ...
    :try_start_0
    invoke-virtual {p2}, Lw/p;->d()Ljava/lang/Integer;
    ...
    invoke-static {v0, p1, p0}, Lw/o0;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_2
    sget-object v2, Lw/p;->c:Lw/p;

    invoke-virtual {p1}, Landroidx/camera/core/impl/e0;->a()Ljava/util/LinkedHashSet;

    move-result-object v3

    invoke-virtual {v2, v3}, Lw/p;->e(Ljava/util/LinkedHashSet;)Landroidx/camera/core/impl/c0;
    ...
    :cond_4
    sget-object p0, Lw/p;->b:Lw/p;

    invoke-virtual {p1}, Landroidx/camera/core/impl/e0;->a()Ljava/util/LinkedHashSet;

    move-result-object p2

    invoke-virtual {p0, p2}, Lw/p;->e(Ljava/util/LinkedHashSet;)Landroidx/camera/core/impl/c0;
    :try_end_1
    ...
    new-instance p1, Landroidx/camera/core/impl/j0$a;

    const-string p2, "Expected camera missing from device."

    invoke-direct {p1, p2, p0}, Landroidx/camera/core/impl/j0$a;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
