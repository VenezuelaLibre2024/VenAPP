.class public Landroidx/camera/core/impl/utils/r;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/camera/core/impl/utils/r;->a:Landroid/graphics/RectF;
...
.method public static a(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
    ...
    sget-object v1, Landroidx/camera/core/impl/utils/r;->a:Landroid/graphics/RectF;
...
.method public static b(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    invoke-static {p0, p1, p2, v0}, Landroidx/camera/core/impl/utils/r;->c(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public static c(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/camera/core/impl/utils/r;->a(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static d(Landroid/graphics/Rect;I)Landroid/util/Size;
    ...
    invoke-static {p0}, Landroidx/camera/core/impl/utils/r;->i(Landroid/graphics/Rect;)Landroid/util/Size;

    move-result-object p0

    invoke-static {p0, p1}, Landroidx/camera/core/impl/utils/r;->k(Landroid/util/Size;I)Landroid/util/Size;
...
.method public static g(Landroid/util/Size;Landroid/util/Size;)Z
    ...
    invoke-static {p0, v0, p1, v0}, Landroidx/camera/core/impl/utils/r;->h(Landroid/util/Size;ZLandroid/util/Size;Z)Z
...
.method public static k(Landroid/util/Size;I)Landroid/util/Size;
    ...
    invoke-static {p1}, Landroidx/camera/core/impl/utils/r;->f(I)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {p0}, Landroidx/camera/core/impl/utils/r;->j(Landroid/util/Size;)Landroid/util/Size;
...
.method public static l(Landroid/util/Size;)Landroid/graphics/Rect;
    ...
    invoke-static {p0, v0, v0}, Landroidx/camera/core/impl/utils/r;->m(Landroid/util/Size;II)Landroid/graphics/Rect;
...
.method public static n(Landroid/util/Size;)Landroid/graphics/RectF;
    ...
    invoke-static {p0, v0, v0}, Landroidx/camera/core/impl/utils/r;->o(Landroid/util/Size;II)Landroid/graphics/RectF;
