...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {p1}, Landroidx/core/view/accessibility/q;->a()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p2}, Landroidx/core/view/accessibility/p;->S(Landroid/view/accessibility/AccessibilityNodeInfo;)Landroidx/core/view/accessibility/p;

    move-result-object v0

    invoke-static {p1}, Landroidx/core/view/x0;->J(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/p;->O(Z)V

    invoke-static {p1}, Landroidx/core/view/x0;->F(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/p;->M(Z)V

    invoke-static {p1}, Landroidx/core/view/x0;->m(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/p;->N(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/x0;->z(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/p;->Q(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p2, p1}, Landroidx/core/view/accessibility/p;->d(Ljava/lang/CharSequence;Landroid/view/View;)V
