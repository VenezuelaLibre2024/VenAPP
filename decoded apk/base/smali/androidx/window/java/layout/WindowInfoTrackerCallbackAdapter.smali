...
.method private final addListener(Ljava/util/concurrent/Executor;Landroidx/core/util/a;Lcl/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1}, Lzk/l0;->a(Lgk/f;)Lzk/k0;
    ...
    invoke-direct {v4, p3, p2, v5}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lcl/b;Landroidx/core/util/a;Lgk/Continuation;)V
...
.method private final removeListener(Landroidx/core/util/a;)V
    ...
    invoke-static {v1, v3, v2, v3}, Lzk/w1$a;->a(Lzk/w1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
...
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/core/util/a;)V
    ...
    invoke-interface {v0, p1}, Landroidx/window/layout/WindowInfoTracker;->windowLayoutInfo(Landroid/app/Activity;)Lcl/b;

    move-result-object p1

    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Landroidx/core/util/a;Lcl/b;)V
...
.method public windowLayoutInfo(Landroid/app/Activity;)Lcl/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
