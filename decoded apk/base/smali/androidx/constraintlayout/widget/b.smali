...
.method public static d(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Ljava/util/HashMap;)V
    ...
    sget v8, Landroidx/constraintlayout/widget/k;->z4:I
    ...
    :cond_0
    sget v8, Landroidx/constraintlayout/widget/k;->J4:I
    ...
    :cond_1
    sget v8, Landroidx/constraintlayout/widget/k;->A4:I
    ...
    sget-object v4, Landroidx/constraintlayout/widget/b$b;->BOOLEAN_TYPE:Landroidx/constraintlayout/widget/b$b;

    goto/16 :goto_5

    :cond_2
    sget v8, Landroidx/constraintlayout/widget/k;->C4:I

    if-ne v7, v8, :cond_4

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->COLOR_TYPE:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_4
    sget v8, Landroidx/constraintlayout/widget/k;->B4:I

    if-ne v7, v8, :cond_5

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->COLOR_DRAWABLE_TYPE:Landroidx/constraintlayout/widget/b$b;

    goto :goto_1

    :cond_5
    sget v8, Landroidx/constraintlayout/widget/k;->G4:I

    const/4 v10, 0x0

    if-ne v7, v8, :cond_6

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->DIMENSION_TYPE:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_6
    sget v8, Landroidx/constraintlayout/widget/k;->D4:I
    ...
    :cond_7
    sget v8, Landroidx/constraintlayout/widget/k;->E4:I

    if-ne v7, v8, :cond_8

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->FLOAT_TYPE:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_8
    sget v8, Landroidx/constraintlayout/widget/k;->F4:I

    const/4 v9, -0x1

    if-ne v7, v8, :cond_9

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->INT_TYPE:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_9
    sget v8, Landroidx/constraintlayout/widget/k;->I4:I

    if-ne v7, v8, :cond_a

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->STRING_TYPE:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_a
    sget v8, Landroidx/constraintlayout/widget/k;->H4:I

    if-ne v7, v8, :cond_b

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->REFERENCE_TYPE:Landroidx/constraintlayout/widget/b$b;
