...
.method protected m(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Landroidx/constraintlayout/widget/k;->B6:[I
    ...
    sget v3, Landroidx/constraintlayout/widget/k;->D6:I

    if-ne v2, v3, :cond_0

    iget-boolean v3, p0, Landroidx/constraintlayout/motion/widget/h;->u:Z
    ...
    :cond_0
    sget v3, Landroidx/constraintlayout/widget/k;->C6:I

    if-ne v2, v3, :cond_1

    iget-boolean v3, p0, Landroidx/constraintlayout/motion/widget/h;->v:Z

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Landroidx/constraintlayout/motion/widget/h;->v:Z
...
.method public setProgress(F)V
    ...
    iput-object v0, p0, Landroidx/constraintlayout/motion/widget/h;->x:[Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/constraintlayout/motion/widget/h;->x:[Landroid/view/View;
...
.method public u()Z
    ...
    iget-boolean v0, p0, Landroidx/constraintlayout/motion/widget/h;->v:Z
...
.method public v()Z
    ...
    iget-boolean v0, p0, Landroidx/constraintlayout/motion/widget/h;->u:Z
