...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lad/f;->a:Ljava/io/File;

    invoke-static {}, Lad/f;->v()Z
    ...
    invoke-static {v1}, Lad/f;->u(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lad/f;->q(Ljava/io/File;)Ljava/io/File;

    move-result-object p1

    iput-object p1, p0, Lad/f;->b:Ljava/io/File;
    ...
    invoke-static {v0}, Lad/f;->q(Ljava/io/File;)Ljava/io/File;

    move-result-object v0

    iput-object v0, p0, Lad/f;->c:Ljava/io/File;
    ...
    iput-object v0, p0, Lad/f;->d:Ljava/io/File;
    ...
    iput-object v0, p0, Lad/f;->e:Ljava/io/File;
    ...
    iput-object p1, p0, Lad/f;->f:Ljava/io/File;
...
.method private a(Ljava/io/File;)V
    ...
    invoke-static {p1}, Lad/f;->s(Ljava/io/File;)Z
...
.method private n(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object v1, p0, Lad/f;->c:Ljava/io/File;

    invoke-direct {v0, v1, p1}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-static {v0}, Lad/f;->r(Ljava/io/File;)Ljava/io/File;
...
.method private static declared-synchronized q(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-virtual {v1, v2}, Lsc/g;->d(Ljava/lang/String;)V
    :try_end_1
...
.method static s(Ljava/io/File;)Z
    ...
    invoke-static {v3}, Lad/f;->s(Ljava/io/File;)Z
...
.method public b()V
    ...
    iget-object v1, p0, Lad/f;->a:Ljava/io/File;

    const-string v2, ".com.google.firebase.crashlytics"

    invoke-direct {v0, v1, v2}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-direct {p0, v0}, Lad/f;->a(Ljava/io/File;)V
...
.method public c(Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Lad/f;->s(Ljava/io/File;)Z
...
.method public d()Ljava/util/List;
    ...
    iget-object v0, p0, Lad/f;->c:Ljava/io/File;

    invoke-virtual {v0}, Ljava/io/File;->list()[Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lad/f;->t([Ljava/lang/Object;)Ljava/util/List;
...
.method public e(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object v1, p0, Lad/f;->b:Ljava/io/File;
...
.method public f(Ljava/io/FilenameFilter;)Ljava/util/List;
    ...
    iget-object v0, p0, Lad/f;->b:Ljava/io/File;

    invoke-virtual {v0, p1}, Ljava/io/File;->listFiles(Ljava/io/FilenameFilter;)[Ljava/io/File;

    move-result-object p1

    invoke-static {p1}, Lad/f;->t([Ljava/lang/Object;)Ljava/util/List;
...
.method public g(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object v1, p0, Lad/f;->f:Ljava/io/File;
...
.method public h()Ljava/util/List;
    ...
    iget-object v0, p0, Lad/f;->f:Ljava/io/File;
...
.method public i(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0, p1}, Lad/f;->n(Ljava/lang/String;)Ljava/io/File;
...
.method public j(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object v1, p0, Lad/f;->e:Ljava/io/File;
...
.method public k()Ljava/util/List;
    ...
    iget-object v0, p0, Lad/f;->e:Ljava/io/File;
...
.method public l(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object v1, p0, Lad/f;->d:Ljava/io/File;
...
.method public m()Ljava/util/List;
    ...
    iget-object v0, p0, Lad/f;->d:Ljava/io/File;
