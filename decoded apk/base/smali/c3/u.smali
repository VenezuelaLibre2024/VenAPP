...
.method private d(Landroid/content/Context;)Z
    ...
    :cond_0
    invoke-static {p1}, Lc3/t;->a(Landroid/location/LocationManager;)Z
    ...
    :cond_1
    invoke-static {p1}, Lc3/u;->e(Landroid/content/Context;)Z
...
# virtual methods
.method a(ILandroid/content/Context;Lc3/u$a;Lc3/b;)V
    .locals 3
    ...
    invoke-direct {p0, p2}, Lc3/u;->c(Landroid/content/Context;)Z

    move-result p1

    invoke-interface {p3, p1}, Lc3/u$a;->onSuccess(I)V
    ...
    invoke-interface {p3, v2}, Lc3/u$a;->onSuccess(I)V
    ...
    :cond_4
    invoke-direct {p0, p1}, Lc3/u;->b(Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    :cond_6
    invoke-interface {p3, v1}, Lc3/u$a;->onSuccess(I)V
    ...
    :cond_a
    :goto_1
    invoke-direct {p0, p2}, Lc3/u;->d(Landroid/content/Context;)Z
