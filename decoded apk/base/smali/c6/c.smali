...
.method public constructor <init>(Li9/y;Li9/e;Lc6/f;)V
    ...
    iput-object v0, p0, Lc6/c;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lc6/c;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p1, p0, Lc6/c;->a:Li9/y;

    iput-object p2, p0, Lc6/c;->b:Li9/e;

    iput-object p3, p0, Lc6/c;->g:Lc6/f;
...
.method public a(Landroid/content/Context;)V
    ...
    iget-object p1, p0, Lc6/c;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    iget-object p1, p0, Lc6/c;->c:Lcom/facebook/ads/RewardedVideoAd;
    ...
    iget-object v0, p0, Lc6/c;->e:Li9/x;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Li9/x;->onAdFailedToShow(Lx8/b;)V
    ...
    :cond_1
    iget-object p1, p0, Lc6/c;->e:Li9/x;

    if-eqz p1, :cond_2

    invoke-interface {p1}, Li9/x;->onVideoStart()V
...
.method public c()V
    ...
    iget-object v0, p0, Lc6/c;->a:Li9/y;

    invoke-virtual {v0}, Li9/d;->b()Landroid/content/Context;

    move-result-object v0

    iget-object v1, p0, Lc6/c;->a:Li9/y;

    invoke-virtual {v1}, Li9/d;->c()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lc6/c;->b:Li9/e;
    ...
    :cond_0
    iget-object v2, p0, Lc6/c;->a:Li9/y;

    invoke-static {v2}, Lcom/google/ads/mediation/facebook/FacebookMediationAdapter;->setMixedAudience(Li9/d;)V

    iget-object v2, p0, Lc6/c;->g:Lc6/f;

    invoke-virtual {v2, v0, v1}, Lc6/f;->d(Landroid/content/Context;Ljava/lang/String;)Lcom/facebook/ads/RewardedVideoAd;

    move-result-object v0

    iput-object v0, p0, Lc6/c;->c:Lcom/facebook/ads/RewardedVideoAd;
    ...
    iget-object v0, p0, Lc6/c;->c:Lcom/facebook/ads/RewardedVideoAd;
    ...
    invoke-virtual {p0}, Lc6/c;->b()Lcom/facebook/ads/AdExperienceType;
...
.method public onAdLoaded(Lcom/facebook/ads/Ad;)V
    ...
    iget-object p1, p0, Lc6/c;->b:Li9/e;
    ...
    iput-object p1, p0, Lc6/c;->e:Li9/x;
...
.method public onError(Lcom/facebook/ads/Ad;Lcom/facebook/ads/AdError;)V
    ...
    iget-object p2, p0, Lc6/c;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p2, p0, Lc6/c;->e:Li9/x;

    if-eqz p2, :cond_1

    invoke-interface {p2, p1}, Li9/x;->onAdFailedToShow(Lx8/b;)V
    ...
    iget-object p2, p0, Lc6/c;->b:Li9/e;
...
.method public onRewardedVideoActivityDestroyed()V
    ...
    iget-object v0, p0, Lc6/c;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public onRewardedVideoCompleted()V
    ...
    invoke-interface {v0}, Li9/x;->onVideoComplete()V
    ...
    invoke-interface {v0, v1}, Li9/x;->onUserEarnedReward(Ln9/b;)V
