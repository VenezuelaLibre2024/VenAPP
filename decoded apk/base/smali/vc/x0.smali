...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lvc/z;->c(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lvc/x0;->a:Ljava/util/concurrent/ExecutorService;
...
.method public static synthetic a(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
    ...
    invoke-static {p0, p1}, Lvc/x0;->m(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
...
.method public static synthetic b(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
    ...
    invoke-static {p0, p1}, Lvc/x0;->l(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
...
.method public static synthetic c(Ljava/util/concurrent/CountDownLatch;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lvc/x0;->i(Ljava/util/concurrent/CountDownLatch;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
...
.method public static synthetic d(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lvc/x0;->j(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
...
.method public static synthetic e(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    invoke-static {p0, p1, p2}, Lvc/x0;->k(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public static f(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
    ...
    sget-object v1, Lvc/x0;->a:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lvc/s0;

    invoke-direct {v2, v0}, Lvc/s0;-><init>(Ljava/util/concurrent/CountDownLatch;)V
...
.method public static h(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v1, p1, p0, v0}, Lvc/u0;-><init>(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method private static synthetic k(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    invoke-direct {v0, p2}, Lvc/v0;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public static n(Lcom/google/android/gms/tasks/Task;Lcom/google/android/gms/tasks/Task;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v1, v0}, Lvc/w0;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public static o(Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/Task;Lcom/google/android/gms/tasks/Task;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v1, v0}, Lvc/t0;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
