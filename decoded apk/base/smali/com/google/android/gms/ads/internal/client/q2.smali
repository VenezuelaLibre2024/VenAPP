...
.method public final zzi()Lcom/google/android/gms/ads/internal/client/v2;
    ...
    instance-of v3, v2, Lcom/google/android/gms/ads/internal/client/v2;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lcom/google/android/gms/ads/internal/client/v2;

    goto :goto_0

    :cond_1
    new-instance v2, Lcom/google/android/gms/ads/internal/client/t2;

    invoke-direct {v2, v1}, Lcom/google/android/gms/ads/internal/client/t2;-><init>(Landroid/os/IBinder;)V
