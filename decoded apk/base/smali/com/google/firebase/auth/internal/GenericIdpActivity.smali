...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->c:Loc/e1;
...
.method private final d(Landroid/net/Uri$Builder;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    invoke-virtual/range {v5 .. v13}, Loc/p1;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v15}, Lzb/g;->p(Ljava/lang/String;)Lzb/g;
    ...
    invoke-virtual {v5}, Lzb/g;->s()Ljava/lang/String;

    move-result-object v5

    invoke-static {v6, v5}, Loc/r1;->c(Landroid/content/Context;Ljava/lang/String;)Loc/r1;

    move-result-object v5

    invoke-virtual {v5}, Loc/r1;->a()Ljava/lang/String;
    ...
    invoke-static {v1}, Loc/q;->a(Ljava/lang/String;)Lcom/google/android/gms/common/api/Status;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->g(Lcom/google/android/gms/common/api/Status;)V
...
.method static synthetic e(Landroid/net/Uri;Lcom/google/android/gms/tasks/Task;)Landroid/net/Uri;
    .locals 4
    ...
    invoke-virtual {p1}, Lec/d;->a()Ljava/lang/Exception;
    ...
    :cond_0
    invoke-virtual {p1}, Lec/d;->b()Ljava/lang/String;
...
.method private final g(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-static {v0, p1}, Loc/c1;->c(Landroid/content/Intent;Lcom/google/android/gms/common/api/Status;)V

    const-string v1, "com.google.firebase.auth.ACTION_RECEIVE_FIREBASE_AUTH_INTENT"

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    invoke-direct {p0, v0}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->h(Landroid/content/Intent;)Z
    ...
    invoke-static {v0, p1}, Loc/m0;->b(Landroid/content/Context;Lcom/google/android/gms/common/api/Status;)V

    goto :goto_0

    :cond_0
    sget-object p1, Lcom/google/firebase/auth/internal/GenericIdpActivity;->c:Loc/e1;

    invoke-virtual {p1, p0}, Loc/e1;->a(Landroid/content/Context;)V
...
.method private final h(Landroid/content/Intent;)Z
    ...
    invoke-virtual {v0, p1}, Lk1/a;->d(Landroid/content/Intent;)Z
...
.method private final i()V
    ...
    invoke-static {p0, v0}, Loc/m0;->b(Landroid/content/Context;Lcom/google/android/gms/common/api/Status;)V

    goto :goto_0

    :cond_0
    sget-object v0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->c:Loc/e1;

    invoke-virtual {v0, p0}, Loc/e1;->a(Landroid/content/Context;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->i()V
...
.method protected onResume()V
    ...
    invoke-static {v0}, Loc/c1;->b(Ljava/lang/String;)Lcom/google/android/gms/common/api/Status;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->g(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v3, p0, v6, v5}, Loc/p1;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Loc/o1;
    ...
    invoke-virtual {v3}, Loc/o1;->a()Ljava/lang/String;

    move-result-object v5

    invoke-static {v5}, Lzb/g;->p(Ljava/lang/String;)Lzb/g;
    ...
    invoke-static {v0, v5}, Loc/r1;->c(Landroid/content/Context;Ljava/lang/String;)Loc/r1;

    move-result-object v0

    invoke-virtual {v0, v4}, Loc/r1;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v3, v4}, Lcom/google/android/gms/internal/firebase-auth-api/zzagt;-><init>(Loc/o1;Ljava/lang/String;)V

    invoke-virtual {v3}, Loc/o1;->e()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3}, Loc/o1;->b()Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, Lea/e;->e(Lea/d;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->h(Landroid/content/Intent;)Z
    ...
    invoke-static {v1, v0, v3, v4}, Loc/m0;->c(Landroid/content/Context;Lcom/google/android/gms/internal/firebase-auth-api/zzagt;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {p0, v5}, Lla/a;->a(Landroid/content/Context;Ljava/lang/String;)[B

    move-result-object v0

    invoke-static {v0}, Lla/k;->b([B)Ljava/lang/String;
    ...
    invoke-static {v8}, Lcom/google/firebase/auth/FirebaseAuth;->getInstance(Lzb/g;)Lcom/google/firebase/auth/FirebaseAuth;

    move-result-object v0

    invoke-static {v8}, Lcom/google/android/gms/internal/firebase-auth-api/zzaed;->zza(Lzb/g;)Z
    ...
    invoke-direct/range {v4 .. v9}, Lcom/google/android/gms/internal/firebase-auth-api/zzaci;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;Lzb/g;Lcom/google/android/gms/internal/firebase-auth-api/zzack;)V

    invoke-virtual {v0}, Lcom/google/firebase/auth/FirebaseAuth;->z0()Ljava/util/concurrent/Executor;
    ...
    :cond_8
    invoke-virtual {v8}, Lzb/g;->r()Lzb/p;

    move-result-object v1

    invoke-virtual {v1}, Lzb/p;->b()Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v2, v5, v6}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->d(Landroid/net/Uri$Builder;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/auth/FirebaseAuth;->u0()Lee/b;

    move-result-object v0

    invoke-virtual {p0, v1, v5, v0}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->zza(Landroid/net/Uri;Ljava/lang/String;Lee/b;)V
...
.method public final zza(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->d(Landroid/net/Uri$Builder;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
...
.method public final zza(Landroid/net/Uri;Ljava/lang/String;Lee/b;)V
    .locals 1
    ...
    invoke-interface {p3, v0}, Ljc/b;->a(Z)Lcom/google/android/gms/tasks/Task;
    ...
    :goto_0
    new-instance p3, Loc/g0;

    invoke-direct {p3, p0, p2}, Loc/g0;-><init>(Lcom/google/firebase/auth/internal/GenericIdpActivity;Ljava/lang/String;)V
...
.method public final zza(Ljava/lang/String;Lcom/google/android/gms/common/api/Status;)V
    ...
    :cond_0
    invoke-direct {p0, p2}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->g(Lcom/google/android/gms/common/api/Status;)V
