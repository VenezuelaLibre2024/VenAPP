...
.field private static final d:Lga/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lr9/o;->a:[Ljava/lang/String;

    const-string v0, "androidPackageName"

    sput-object v0, Lr9/o;->b:Ljava/lang/String;
    ...
    sput-object v0, Lr9/o;->c:Landroid/content/ComponentName;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, v0, v1}, Lr9/o;->g(Landroid/content/Context;Ljava/lang/String;J)V
...
.method public static b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, v0}, Lr9/o;->c(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
...
.method public static c(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lr9/o;->o(Landroid/accounts/Account;)V

    invoke-static {p0, p1, p2, p3}, Lr9/o;->d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method public static d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p0, v0}, Lr9/o;->l(Landroid/content/Context;I)V
    ...
    :goto_0
    invoke-static {p0, p3}, Lr9/o;->n(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, Lr9/o;->p(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {v0, v1}, Lr9/o;->j(Lcom/google/android/gms/tasks/Task;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/os/Bundle;

    invoke-static {v0}, Lr9/o;->k(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0}, Lr9/o;->h(Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {v0, v1}, Lr9/o;->m(Lcom/google/android/gms/common/api/b;Ljava/lang/String;)V

    :cond_1
    new-instance v0, Lr9/l;

    invoke-direct {v0, p1, p2, p3}, Lr9/l;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V

    sget-object p1, Lr9/o;->c:Landroid/content/ComponentName;

    const-wide/16 p2, 0x0

    invoke-static {p0, p1, v0, p2, p3}, Lr9/o;->i(Landroid/content/Context;Landroid/content/ComponentName;Lr9/n;J)Ljava/lang/Object;
...
.method static synthetic e(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/IBinder;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p0}, Lr9/o;->h(Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method static bridge synthetic f(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lr9/o;->k(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static g(Landroid/content/Context;Ljava/lang/String;J)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/common/internal/s;->i(Ljava/lang/String;)V

    const p2, 0x802c80

    invoke-static {p0, p2}, Lr9/o;->l(Landroid/content/Context;I)V

    new-instance p2, Landroid/os/Bundle;

    invoke-direct {p2}, Landroid/os/Bundle;-><init>()V

    invoke-static {p0, p2}, Lr9/o;->n(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    :try_start_0
    invoke-static {p3, v0}, Lr9/o;->j(Lcom/google/android/gms/tasks/Task;Ljava/lang/String;)Ljava/lang/Object;
    :try_end_0
    .catch Lcom/google/android/gms/common/api/b; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p3, v0}, Lr9/o;->m(Lcom/google/android/gms/common/api/b;Ljava/lang/String;)V

    :cond_0
    new-instance p3, Lr9/m;

    invoke-direct {p3, p1, p2}, Lr9/m;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V

    sget-object p1, Lr9/o;->c:Landroid/content/ComponentName;

    const-wide/16 v0, 0x0

    invoke-static {p0, p1, p3, v0, v1}, Lr9/o;->i(Landroid/content/Context;Landroid/content/ComponentName;Lr9/n;J)Ljava/lang/Object;
...
.method private static h(Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-virtual {v2, v1, v3}, Lga/a;->h(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static i(Landroid/content/Context;Landroid/content/ComponentName;Lr9/n;J)Ljava/lang/Object;
    .locals 2
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/internal/i;->c(Landroid/content/Context;)Lcom/google/android/gms/common/internal/i;

    move-result-object p0

    :try_start_0
    invoke-virtual {p0, p1, v0, p4}, Lcom/google/android/gms/common/internal/i;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_1
    invoke-virtual {v0}, Lca/a;->a()Landroid/os/IBinder;

    move-result-object v1

    invoke-interface {p2, v1}, Lr9/n;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, v0, p4}, Lcom/google/android/gms/common/internal/i;->e(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method private static j(Lcom/google/android/gms/tasks/Task;Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget-object v0, Lr9/o;->d:Lga/a;

    new-array v1, v1, [Ljava/lang/Object;

    invoke-virtual {v0, p1, v1}, Lga/a;->h(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static k(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1, v0}, Lga/a;->h(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static l(Landroid/content/Context;I)V
    ...
    invoke-static {p0, p1}, Lca/k;->a(Landroid/content/Context;I)V
    :try_end_0
    .catch Lca/i; {:try_start_0 .. :try_end_0} :catch_2
    ...
    invoke-direct {p1, v0, p0}, Lr9/d;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, Lca/o;->a()Landroid/content/Intent;

    move-result-object p0

    invoke-direct {p1, v0, v1, p0}, Lr9/f;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method private static m(Lcom/google/android/gms/common/api/b;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0, v1}, Lga/a;->h(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static n(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    sget-object v0, Lr9/o;->b:Ljava/lang/String;
...
.method private static o(Landroid/accounts/Account;)V
    ...
    sget-object v0, Lr9/o;->a:[Ljava/lang/String;
...
.method private static p(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, p0, v1}, Lca/f;->h(Landroid/content/Context;I)I
