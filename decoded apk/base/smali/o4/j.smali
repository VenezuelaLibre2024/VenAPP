...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lo4/j;->c:Ljava/util/Set;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lo4/j;->d:Ljava/util/Map;
...
.method public static final d()Z
    ...
    :cond_0
    :try_start_0
    sget-object v2, Lo4/j;->a:Lo4/j;

    invoke-direct {v2}, Lo4/j;->g()V
    ...
    sget-object v2, Lo4/j;->b:Landroid/content/SharedPreferences;
    :try_end_0
    ...
    :cond_2
    invoke-static {v7}, Lkotlin/jvm/internal/n;->p(Ljava/lang/String;)V
...
.method public static final e(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-direct {v1}, Lo4/j;->g()V

    invoke-virtual {v1, p0}, Lo4/j;->a(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-virtual {v1, p0, p1}, Lo4/j;->c(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-direct {v1, p0}, Lo4/j;->f(Ljava/util/Map;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final f(Ljava/util/Map;)V
    ...
    invoke-static {v1, v0, v2}, Lq4/i;->f(Ljava/lang/String;Ljava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final g()V
    ...
    sput-object v0, Lo4/j;->b:Landroid/content/SharedPreferences;

    sget-object v1, Lo4/j;->c:Ljava/util/Set;
    ...
    sget-object v3, Lo4/j;->d:Ljava/util/Map;
...
.method public final a(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1}, Ldk/h0;->s(Ljava/util/Map;)Ljava/util/Map;
    ...
    sget-object v7, Lo4/j;->d:Ljava/util/Map;
    ...
    :cond_2
    sget-object v6, Lo4/j;->c:Ljava/util/Set;
    ...
    :cond_3
    :try_start_2
    sget-object v0, Lo4/j;->b:Landroid/content/SharedPreferences;
    ...
    sget-object v3, Lo4/j;->c:Ljava/util/Set;
...
.method public final b()V
    ...
    sget-object v3, Lo4/j;->b:Landroid/content/SharedPreferences;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v3}, Ldk/h0;->s(Ljava/util/Map;)Ljava/util/Map;
    ...
    sget-object v6, Lo4/j;->d:Ljava/util/Map;
    ...
    sget-object v5, Lo4/j;->c:Ljava/util/Set;
