...
public class d {
    ...
    public static y0 i(ServiceWorkerController serviceWorkerController) {
    ...
    public static void q(ServiceWorkerController serviceWorkerController, e2.h hVar) {
        serviceWorkerController.setServiceWorkerClient(new p0(hVar));
    }
}
