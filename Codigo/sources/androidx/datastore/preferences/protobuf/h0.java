...
abstract class h0 {
    ...
    private static final h0 f4132a;

    /* renamed from: b, reason: collision with root package name */
    private static final h0 f4133b;

    /* loaded from: classes.dex */
    private static final class b extends h0 {

        /* renamed from: c, reason: collision with root package name */
        private static final Class<?> f4134c = Collections.unmodifiableList(Collections.emptyList()).getClass();
        ...
        private static <L> List<L> g(Object obj, long j10, int i10) {
            ...
            if (!f10.isEmpty()) {
                if (f4134c.isAssignableFrom(f10.getClass())) {
        ...
        void c(Object obj, long j10) {
            ...
            if (list instanceof g0) {
                ...
                if (f4134c.isAssignableFrom(list.getClass())) {
                    return;
                }
