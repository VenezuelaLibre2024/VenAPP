...
public final class h2 {
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f3933a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f3933a) != null) {
            try {
