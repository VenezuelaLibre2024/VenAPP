...
public class d {
    ...
    /* renamed from: a */
    private static final Comparator<byte[]> f3815a = new Comparator() { // from class: androidx.core.provider.c
