...
import androidx.core.view.C1077o0;
import androidx.core.view.C1092r0;
import androidx.core.view.C1116x0;
import androidx.core.view.InterfaceC1082p0;
import androidx.core.view.InterfaceC1087q0;
import androidx.core.widget.C1139i;

/* renamed from: androidx.swiperefreshlayout.widget.c */
/* loaded from: classes.dex */
public class C1427c extends ViewGroup implements InterfaceC1087q0, InterfaceC1082p0 {
    ...
    private final C1077o0 mNestedScrollingChildHelper;
    private final C1092r0 mNestedScrollingParentHelper;
    ...
    class a implements Animation.AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            if (!c1427c.mRefreshing) {
                c1427c.reset();
                return;
            }
            c1427c.mProgress.setAlpha(C1427c.MAX_ALPHA);
            C1427c.this.mProgress.start();
            C1427c c1427c2 = C1427c.this;
            if (c1427c2.mNotify && (jVar = c1427c2.mListener) != null) {
                jVar.onRefresh();
            }
            C1427c c1427c3 = C1427c.this;
            c1427c3.mCurrentTargetOffsetTop = c1427c3.mCircleView.getTop();
        }
    ...
    public class b extends Animation {
        ...
        public void applyTransformation(float f10, Transformation transformation) {
            C1427c.this.setAnimationProgress(f10);
        }
    }
    ...
    public class c extends Animation {
        ...
        @Override // android.view.animation.Animation
        public void applyTransformation(float f10, Transformation transformation) {
            C1427c.this.setAnimationProgress(1.0f - f10);
        }
    }
    ...
    public class d extends Animation {
        ...
        @Override // android.view.animation.Animation
        public void applyTransformation(float f10, Transformation transformation) {
            C1427c.this.mProgress.setAlpha((int) (this.f6352a + ((this.f6353b - r0) * f10)));
        }
    }
    ...
    public class e implements Animation.AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            c1427c.startScaleDownAnimation(null);
        }
    ...
    class f extends Animation {
        ...
        public void applyTransformation(float f10, Transformation transformation) {
            C1427c c1427c = C1427c.this;
            int abs = !c1427c.mUsingCustomStart ? c1427c.mSpinnerOffsetEnd - Math.abs(c1427c.mOriginalOffsetTop) : c1427c.mSpinnerOffsetEnd;
            C1427c c1427c2 = C1427c.this;
            C1427c.this.setTargetOffsetTopAndBottom((c1427c2.mFrom + ((int) ((abs - r1) * f10))) - c1427c2.mCircleView.getTop());
            C1427c.this.mProgress.m8173e(1.0f - f10);
        }
    }
    ...
    public class h extends Animation {
        ...
        public void applyTransformation(float f10, Transformation transformation) {
            C1427c c1427c = C1427c.this;
            float f11 = c1427c.mStartingScale;
            c1427c.setAnimationProgress(f11 + ((-f11) * f10));
            C1427c.this.moveToStart(f10);
        }
    }
    ...
    /* loaded from: classes.dex */
    public interface i {
        boolean canChildScrollUp(C1427c c1427c, View view);
    }
    ...
    public static class k extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeByte(this.f6359a ? (byte) 1 : (byte) 0);
        }
    }
    ...
    public C1427c(Context context, AttributeSet attributeSet) {
        ...
        this.mNestedScrollingParentHelper = new C1092r0(this);
        this.mNestedScrollingChildHelper = new C1077o0(this);
    ...
    private void animateOffsetToCorrectPosition(int i10, Animation.AnimationListener animationListener) {
        ...
        if (animationListener != null) {
            this.mCircleView.m8164b(animationListener);
        }
    ...
    private void createProgressView() {
        this.mCircleView = new C1425a(getContext());
        C1426b c1426b = new C1426b(getContext());
        this.mProgress = c1426b;
        c1426b.m8178l(1);
    ...
    private void moveSpinner(float f10) {
        ...
        this.mProgress.m8176j(0.0f, Math.min(MAX_PROGRESS_ANGLE, max * MAX_PROGRESS_ANGLE));
        this.mProgress.m8173e(Math.min(1.0f, max));
        this.mProgress.m8175g((((max * 0.4f) - 0.25f) + (pow * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE);
    ...
    public boolean canChildScrollUp() {
        ...
        return view instanceof ListView ? C1139i.m5567a((ListView) view, -1) : view.canScrollVertically(-1);
    }

    @Override // android.view.View
    public boolean dispatchNestedFling(float f10, float f11, boolean z10) {
        return this.mNestedScrollingChildHelper.m5085a(f10, f11, z10);
    }

    @Override // android.view.View
    public boolean dispatchNestedPreFling(float f10, float f11) {
        return this.mNestedScrollingChildHelper.m5086b(f10, f11);
    }

    @Override // android.view.View
    public boolean dispatchNestedPreScroll(int i10, int i11, int[] iArr, int[] iArr2) {
        return this.mNestedScrollingChildHelper.m5087c(i10, i11, iArr, iArr2);
    }
    ...
    public void dispatchNestedScroll(int i10, int i11, int i12, int i13, int[] iArr, int i14, int[] iArr2) {
        if (i14 == 0) {
            this.mNestedScrollingChildHelper.m5089e(i10, i11, i12, i13, iArr, i14, iArr2);
        }
    }

    @Override // android.view.View
    public boolean dispatchNestedScroll(int i10, int i11, int i12, int i13, int[] iArr) {
        return this.mNestedScrollingChildHelper.m5090f(i10, i11, i12, i13, iArr);
    }

    public boolean dispatchNestedScroll(int i10, int i11, int i12, int i13, int[] iArr, int i14) {
        return i14 == 0 && this.mNestedScrollingChildHelper.m5091g(i10, i11, i12, i13, iArr, i14);
    }
    ...
    public int getNestedScrollAxes() {
        return this.mNestedScrollingParentHelper.m5128a();
    }
    ...
    public boolean hasNestedScrollingParent() {
        return this.mNestedScrollingChildHelper.m5092k();
    }
    ...
    public boolean isNestedScrollingEnabled() {
        return this.mNestedScrollingChildHelper.m5094m();
    }
    ...
    public void onNestedScrollAccepted(View view, View view2, int i10) {
        this.mNestedScrollingParentHelper.m5129b(view, view2, i10);
    ...
    public void onStopNestedScroll(View view) {
        this.mNestedScrollingParentHelper.m5131d(view);
    ...
    public void requestDisallowInterceptTouchEvent(boolean z10) {
        ViewParent parent;
        View view = this.mTarget;
        if (view == null || C1116x0.m5244I(view)) {
    ...
    public void setColorSchemeResources(int... iArr) {
        ...
        for (int i10 = 0; i10 < iArr.length; i10++) {
            iArr2[i10] = C0854a.getColor(context, iArr[i10]);
        }
    ...
    public void setNestedScrollingEnabled(boolean z10) {
        this.mNestedScrollingChildHelper.m5095n(z10);
    }
    ...
    public void setProgressBackgroundColorSchemeResource(int i10) {
        setProgressBackgroundColorSchemeColor(C0854a.getColor(getContext(), i10));
    }
    ...
    void setTargetOffsetTopAndBottom(int i10) {
        ...
        C1116x0.m5248M(this.mCircleView, i10);
        this.mCurrentTargetOffsetTop = this.mCircleView.getTop();
    }

    @Override // android.view.View
    public boolean startNestedScroll(int i10) {
        return this.mNestedScrollingChildHelper.m5096p(i10);
    }
    ...
    public void stopNestedScroll() {
        this.mNestedScrollingChildHelper.m5098r();
    }
