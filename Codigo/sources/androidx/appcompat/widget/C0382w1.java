...
public class C0382w1 extends C0319b1 {

    /* renamed from: c */
    private static boolean f1987c = false;

    /* renamed from: b */
    private final WeakReference<Context> f1988b;

    public C0382w1(Context context, Resources resources) {
        super(resources);
        this.f1988b = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m2038b() {
        return f1987c;
    }

    /* renamed from: c */
    public static void m2039c(boolean z10) {
        f1987c = z10;
    }

    /* renamed from: d */
    public static boolean m2040d() {
        m2038b();
        return false;
    }

    @Override // androidx.appcompat.widget.C0319b1, android.content.res.Resources
    ...
    public Drawable getDrawable(int i10) {
        Context context = this.f1988b.get();
        return context != null ? C0316a1.m1583g().m1597s(context, this, i10) : m1613a(i10);
    }
