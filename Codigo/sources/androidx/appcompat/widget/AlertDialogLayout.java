...
public class AlertDialogLayout extends t0 {
    ...
    private void h(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                t0.a aVar = (t0.a) childAt.getLayoutParams();
    ...
    private static int x(View view) {
        int v10 = androidx.core.view.x0.v(view);
        if (v10 > 0) {
            return v10;
        }
    ...
    private boolean y(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == g.f.P) {
                    view = childAt;
                } else if (id2 == g.f.f15348k) {
                    view2 = childAt;
                } else {
                    if ((id2 != g.f.f15350m && id2 != g.f.f15352o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.t0$a r15 = (androidx.appcompat.widget.t0.a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = androidx.core.view.x0.u(r17)
            int r2 = androidx.core.view.r.a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L95
            r3 = 5
