...
public class w1 extends b1 {
    ...
    private static boolean f1693c = false;

    /* renamed from: b, reason: collision with root package name */
    private final WeakReference<Context> f1694b;
    ...
    public Drawable getDrawable(int i10) {
        Context context = this.f1694b.get();
        return context != null ? a1.g().s(context, this, i10) : a(i10);
    }
