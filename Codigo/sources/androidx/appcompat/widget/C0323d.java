...
public class C0323d extends AutoCompleteTextView {
    ...
    /* renamed from: d */
    private static final int[] f1691d = {R.attr.popupBackground};

    /* renamed from: a */
    private final C0326e f1692a;

    /* renamed from: b */
    private final C0321c0 f1693b;

    /* renamed from: c */
    private final C0347l f1694c;

    public C0323d(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C7377a.f16712p);
    }

    public C0323d(Context context, AttributeSet attributeSet, int i10) {
        super(C0340i1.m1779b(context), attributeSet, i10);
        C0334g1.m1731a(this, getContext());
        C0349l1 m1845u = C0349l1.m1845u(getContext(), attributeSet, f1691d, i10, 0);
        if (m1845u.m1863r(0)) {
    ...
    protected void drawableStateChanged() {
        ...
        C0326e c0326e = this.f1692a;
        if (c0326e != null) {
            c0326e.m1696b();
        }
        C0321c0 c0321c0 = this.f1693b;
        if (c0321c0 != null) {
            c0321c0.m1642b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1693b.m1649j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1693b.m1650k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1694c.m1840d(C0353n.m1869a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z10) {
        this.f1694c.m1841e(z10);
    }

    @Override // android.widget.TextView
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f1694c.m1837a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f1693b.m1662w(colorStateList);
        this.f1693b.m1642b();
    }

    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f1693b.m1663x(mode);
        this.f1693b.m1642b();
    }
