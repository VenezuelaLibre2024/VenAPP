...
public final class j {
    ...
    private static final int[] f14170e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f, reason: collision with root package name */
    private static final j[] f14171f = b();
    ...
    public static j i(int i10) {
        ...
        return f14171f[i10 - 1];
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public kg.b a() {
        int e10 = e();
        kg.b bVar = new kg.b(e10);
        bVar.s(0, 0, 9, 9);
        int i10 = e10 - 8;
        bVar.s(i10, 0, 8, 9);
        bVar.s(0, i10, 9, 8);
        ...
        for (int i11 = 0; i11 < length; i11++) {
            int i12 = this.f14173b[i11] - 2;
            for (int i13 = 0; i13 < length; i13++) {
                if ((i11 != 0 || (i13 != 0 && i13 != length - 1)) && (i11 != length - 1 || i13 != 0)) {
                    bVar.s(this.f14173b[i13] - 2, i12, 5, 5);
                }
            }
        }
        int i14 = e10 - 17;
    ...
    public int e() {
        return (this.f14172a * 4) + 17;
    }

    public b f(f fVar) {
        return this.f14174c[fVar.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f14172a);
    }
}
