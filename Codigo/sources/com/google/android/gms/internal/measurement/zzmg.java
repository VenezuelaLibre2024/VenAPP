...
public final class zzmg {
    ...
    private static final class zza extends zzc {
        ...
        public final void zza(Object obj, long j10, boolean z10) {
            if (zzmg.zza) {
                zzmg.zza(obj, j10, z10);
            } else {
                zzmg.zzb(obj, j10, z10);
            }
        }
        ...
        public final boolean zzc(Object obj, long j10) {
            return zzmg.zza ? zzmg.zzf(obj, j10) : zzmg.zzg(obj, j10);
        }
    }
    ...
    static /* synthetic */ void zza(Throwable th2) {
        Logger.getLogger(zzmg.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: " + String.valueOf(th2));
    }
