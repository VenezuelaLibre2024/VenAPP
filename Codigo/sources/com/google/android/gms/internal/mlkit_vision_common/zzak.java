...
public final class zzak implements e {
    ...
    private final zzak zzk(d dVar, c cVar, Object obj, boolean z10) {
    ...
    private final zzak zzl(f fVar, c cVar, Object obj, boolean z10) {
    ...
    public final zzak zzd(c cVar, int i10, boolean z10) {
        if (z10 && i10 == 0) {
            return this;
        }
        zzai zzj = zzj(cVar);
    ...
    public final zzak zze(c cVar, long j10, boolean z10) {
        if (z10 && j10 == 0) {
            return this;
        }
        zzai zzj = zzj(cVar);
