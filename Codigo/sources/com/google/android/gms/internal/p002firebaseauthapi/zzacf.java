...
public final class zzacf {
    ...
    public static u zza(FirebaseAuth firebaseAuth, zzyk zzykVar, a0 a0Var) {
        zzy.zza(firebaseAuth);
        zzy.zza(zzykVar);
        Pair<String, String> pair = zza.get(17078);
        return new u((String) pair.first, (String) pair.second, j.z1(zzykVar, firebaseAuth, a0Var));
    }
    ...
    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.w1())) {
            return str;
        }
        return String.format(str + " [ %s ]", status.w1());
    }
    ...
    */
    public static zb.m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 552
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzacf.zza(com.google.android.gms.common.api.Status):zb.m");
    }

    public static m zza(Status status, h hVar, String str, String str2) {
        int v12 = status.v1();
        if (v12 == 17012 || v12 == 17007 || v12 == 17025) {
            return new x(zza(v12), zza(zzb(v12), status)).d(hVar).e(str).f(str2);
        }
        return zza(status);
    }
