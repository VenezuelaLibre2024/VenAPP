...
public interface zzalc {
    ...
    <T> void zza(T t10, zzalf<T> zzalfVar, zzaio zzaioVar);

    void zza(List<Boolean> list);

    @Deprecated
    <T> void zza(List<T> list, zzalf<T> zzalfVar, zzaio zzaioVar);

    <K, V> void zza(Map<K, V> map, zzake<K, V> zzakeVar, zzaio zzaioVar);

    float zzb();

    <T> void zzb(T t10, zzalf<T> zzalfVar, zzaio zzaioVar);

    void zzb(List<zzahp> list);

    <T> void zzb(List<T> list, zzalf<T> zzalfVar, zzaio zzaioVar);
