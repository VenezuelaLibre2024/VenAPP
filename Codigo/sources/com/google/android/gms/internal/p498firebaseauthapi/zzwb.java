...
public final class zzwb implements zzxi {
    ...
    @Override // com.google.android.gms.internal.p498firebaseauthapi.zzxi
    ...
    public final byte[] zzb(byte[] bArr) {
        ...
        if (length > C5101a.e.API_PRIORITY_OTHER - i10) {
            throw new GeneralSecurityException("plaintext length can not exceed " + (C5101a.e.API_PRIORITY_OTHER - this.zzd));
        }
