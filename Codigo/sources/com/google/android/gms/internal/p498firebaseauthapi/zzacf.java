...
import com.google.firebase.auth.C6127u;
import com.google.firebase.auth.C6139x;
import com.google.firebase.auth.FirebaseAuth;
import p272oc.C9860j;
...
public final class zzacf {
    ...
    public static C6127u zza(FirebaseAuth firebaseAuth, zzyk zzykVar, AbstractC6045a0 abstractC6045a0) {
        zzy.zza(firebaseAuth);
        zzy.zza(zzykVar);
        Pair<String, String> pair = zza.get(17078);
        return new C6127u((String) pair.first, (String) pair.second, C9860j.m29544z1(zzykVar, firebaseAuth, abstractC6045a0));
    }
    ...
    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.m12970w1())) {
            return str;
        }
        return String.format(str + " [ %s ]", status.m12970w1());
    }
    ...
    */
    public static p485zb.C12873m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 552
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p498firebaseauthapi.zzacf.zza(com.google.android.gms.common.api.Status):zb.m");
    }

    public static C12873m zza(Status status, AbstractC6072h abstractC6072h, String str, String str2) {
        int m12969v1 = status.m12969v1();
        if (m12969v1 == 17012 || m12969v1 == 17007 || m12969v1 == 17025) {
            return new C6139x(zza(m12969v1), zza(zzb(m12969v1), status)).m16622d(abstractC6072h).m16623e(str).m16624f(str2);
        }
        return zza(status);
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof C6111q) {
            return ((C6111q) exc).m16603a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C6111q) {
            return ((C6111q) exc).m16603a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C6111q) {
            return ((C6111q) exc).m16603a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
}
