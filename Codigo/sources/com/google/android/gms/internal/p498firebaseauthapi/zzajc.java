...
public abstract class zzajc<MessageType extends zzajc<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzahf<MessageType, BuilderType> {
    ...
    public static abstract class zza<MessageType extends zzajc<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzahe<MessageType, BuilderType> {
        ...
        @Override // com.google.android.gms.internal.p498firebaseauthapi.zzahe
        ...
        @Override // com.google.android.gms.internal.p498firebaseauthapi.zzakm
        ...
        @Override // com.google.android.gms.internal.p498firebaseauthapi.zzakp
    ...
    static final class zze implements zzaix<zze> {
        ...
        @Override // com.google.android.gms.internal.p498firebaseauthapi.zzaix
    ...
    @Override // com.google.android.gms.internal.p498firebaseauthapi.zzahf
    /* renamed from: a_ */
    final int mo13466a_() {
        return this.zzd & C5101a.e.API_PRIORITY_OTHER;
    }
    ...
    final int zza(zzalf zzalfVar) {
        if (!zzu()) {
            if (mo13466a_() != Integer.MAX_VALUE) {
                return mo13466a_();
            }
    ...
    final void zzb(int i10) {
        if (i10 >= 0) {
            this.zzd = (i10 & C5101a.e.API_PRIORITY_OTHER) | (this.zzd & Integer.MIN_VALUE);
        } else {
    ...
    public final void zzt() {
        this.zzd &= C5101a.e.API_PRIORITY_OTHER;
    }
