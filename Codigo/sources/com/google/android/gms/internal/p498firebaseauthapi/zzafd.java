                ...
                if (optJSONArray != null && optJSONArray.length() != 0) {
                    ...
                    while (i11 < optJSONArray.length()) {
                        ...
                        if (jSONObject2 == null) {
                            ...
                            i10 = i11;
                            zzafcVar = new zzafc(C9475t.m28179a(jSONObject2.optString("localId", null)), C9475t.m28179a(jSONObject2.optString(Constants.EMAIL, null)), jSONObject2.optBoolean("emailVerified", z10), C9475t.m28179a(jSONObject2.optString("displayName", null)), C9475t.m28179a(jSONObject2.optString("photoUrl", null)), zzafv.zza(jSONObject2.optJSONArray("providerUserInfo")), C9475t.m28179a(jSONObject2.optString("rawPassword", null)), C9475t.m28179a(jSONObject2.optString("phoneNumber", null)), jSONObject2.optLong("createdAt", 0L), jSONObject2.optLong("lastLoginAt", 0L), false, null, zzafr.zza(jSONObject2.optJSONArray("mfaInfo")), zzafq.zza(jSONObject2.optJSONArray("passkeyInfo")));
                        }
