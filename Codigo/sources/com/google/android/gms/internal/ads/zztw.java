...
public final class zztw implements zzup, zzuo {
    ...
    public zztw(zzup zzupVar, boolean z10, long j10, long j11) {
        this.zza = zzupVar;
        this.zzb = j11;
    }
    ...
    public final long zza(long j10, zzmj zzmjVar) {
        ...
        long max = Math.max(0L, Math.min(zzmjVar.zzf, j10));
        long j11 = zzmjVar.zzg;
        long j12 = this.zzb;
        long max2 = Math.max(0L, Math.min(j11, j12 == Long.MIN_VALUE ? Long.MAX_VALUE : j12 - j10));
        if (max != zzmjVar.zzf || max2 != zzmjVar.zzg) {
            zzmjVar = new zzmj(max, max2);
        }
        return this.zza.zza(j10, zzmjVar);
    }
    ...
    public final long zzd() {
        ...
        zzek.zzf(zzd2 >= 0);
        long j11 = this.zzb;
        zzek.zzf(j11 == Long.MIN_VALUE || zzd2 <= j11);
        return zzd2;
    }
