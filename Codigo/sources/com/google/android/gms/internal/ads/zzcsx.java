...
public final class zzcsx implements zzbrq {
    ...
    public final JSONObject zzb(zzcta zzctaVar) {
        ...
        if (zzaypVar == null) {
            ...
            boolean z10 = zzaypVar.zza;
            JSONObject jSONObject3 = new JSONObject();
            jSONObject3.put("afmaVersion", this.zzb.zzb()).put("activeViewJSON", this.zzb.zzd()).put(Constants.TIMESTAMP, zzctaVar.zzd).put("adFormat", this.zzb.zza()).put("hashCode", this.zzb.zzc()).put("isMraid", false).put("isStopped", false).put("isPaused", zzctaVar.zzb).put("isNative", this.zzb.zze()).put("isScreenOn", this.zzc.isInteractive()).put("appMuted", t.t().e()).put("appVolume", t.t().a()).put("deviceVolume", com.google.android.gms.ads.internal.util.d.b(this.zza.getApplicationContext()));
