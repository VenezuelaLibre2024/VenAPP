...
public final class zzgka {
    ...
    private static zzgjt zzf(zzgvz zzgvzVar) {
    ...
    private static zzgvz zzg(zzgjt zzgjtVar) {
        ...
        throw new GeneralSecurityException("Unable to serialize variant: ".concat(String.valueOf(zzgjtVar)));
    }
}
