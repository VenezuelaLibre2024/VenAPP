...
final class zzfvl {
    ...
    public zzfvl(Context context) {
        this.zza = zzfwh.zza(context) ? new zzfwe(context.getApplicationContext(), zzb, "OverlayDisplayService", zzc, zzfvg.zza, null) : null;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void zzf(zzfvs zzfvsVar, zzfvq zzfvqVar, int i10) {
        if (this.zza == null) {
            zzb.zza("error: %s", "Play Store not found.");
        } else {
            TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
            this.zza.zzs(new zzfvj(this, taskCompletionSource, zzfvsVar, i10, zzfvqVar, taskCompletionSource), taskCompletionSource);
        }
    }
}
