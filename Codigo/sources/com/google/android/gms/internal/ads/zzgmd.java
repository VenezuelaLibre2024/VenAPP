...
public final class zzgmd {
    ...
    private static zzgjg zzf(zzgvz zzgvzVar) {
    ...
    private static zzgvz zzg(zzgjg zzgjgVar) {
        ...
        throw new GeneralSecurityException("Unable to serialize variant: ".concat(String.valueOf(zzgjgVar)));
    }
}
