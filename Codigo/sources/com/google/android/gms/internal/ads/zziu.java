...
public final class zziu {
    ...
    public /* synthetic */ zziu(float f10, float f11, long j10, float f12, long j11, long j12, float f13, zzit zzitVar) {
        this.zza = j11;
        this.zzb = j12;
    }
    ...
    public final float zza(long j10, long j11) {
        ...
        if (this.zzc != -9223372036854775807L) {
            ...
            if (j13 == -9223372036854775807L) {
                ...
                this.zzm = max;
                zzf = zzf(this.zzn, Math.abs(j12 - max), 0.999f);
            }
            this.zzn = zzf;
            ...
            if (this.zzh > j14) {
                ...
                long[] jArr = {j14, this.zze, this.zzh - (((this.zzk - 1.0f) * zzq) + ((this.zzi - 1.0f) * zzq))};
            ...
            long j17 = j10 - j14;
            r2 = Math.abs(j17) >= this.zza ? Math.max(this.zzj, Math.min((((float) j17) * 1.0E-7f) + 1.0f, this.zzi)) : 1.0f;
            this.zzk = r2;
        }
        return r2;
    }
