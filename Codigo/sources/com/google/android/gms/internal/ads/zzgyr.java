...
public final class zzgyr extends zzgyt {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzgyr(InputStream inputStream, int i10, zzgyq zzgyqVar) {
        super(null);
    ...
    */
    ...
    public final zzgyl zzw() {
        ...
        if (zzj <= i10 - i11 && zzj > 0) {
            zzgyl zzv = zzgyl.zzv(this.zzf, i11, zzj);
            this.zzi += zzj;
            return zzv;
        }
        if (zzj == 0) {
    ...
    public final String zzx() {
        ...
        if (zzj > 0) {
            ...
            int i11 = this.zzi;
            if (zzj <= i10 - i11) {
                String str = new String(this.zzf, i11, zzj, zzhae.zzb);
                this.zzi += zzj;
                return str;
            }
        }
