...
public final class zzgiv {
    ...
    private static zzgio zzf(zzgvz zzgvzVar) {
    ...
    private static zzgtl zzg(zzgiq zzgiqVar) {
        zzgtk zzc2 = zzgtl.zzc();
        zzc2.zza(zzgiqVar.zzb());
        return (zzgtl) zzc2.zzal();
    }

    private static zzgvz zzh(zzgio zzgioVar) {
        ...
        throw new GeneralSecurityException("Unable to serialize variant: ".concat(String.valueOf(zzgioVar)));
    }
}
