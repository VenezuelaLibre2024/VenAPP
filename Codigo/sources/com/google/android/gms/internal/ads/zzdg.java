...
public class zzdg {
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((this.zzn ? 1 : 0) - 1048002209) * 31) + this.zzl) * 31) + this.zzm) * 31) + this.zzo.hashCode()) * 961) + this.zzq.hashCode()) * 961) + a.e.API_PRIORITY_OTHER) * 31) + a.e.API_PRIORITY_OTHER) * 31) + this.zzu.hashCode()) * 31) + 29791) * 31) + this.zzw.hashCode()) * 31) + this.zzx) * 887503681) + this.zzD.hashCode()) * 31) + this.zzE.hashCode();
    }
}
