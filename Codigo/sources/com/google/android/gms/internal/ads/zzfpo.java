...
public final class zzfpo {
    ...
    public static JSONObject zza(int i10, int i11, int i12, int i13) {
        ...
        try {
            ...
            zzfpp.zza("Error with creating viewStateObject", e10);
        }
        return jSONObject;
    }
    ...
    public static void zzb(JSONObject jSONObject, String str) {
        try {
            ...
            zzfpp.zza("Error with setting ad session id", e10);
        }
    }
    ...
    public static void zze(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            zzfpp.zza("JSONException during JSONObject.put for name [" + str + "]", e10);
        }
    }
