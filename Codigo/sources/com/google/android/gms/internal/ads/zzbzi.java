    ...
    */
    public zzbzi(android.content.Context r7) {
        ...
        L30:
            ...
            r6.zzt = r2
            boolean r2 = la.j.c(r7)
            r6.zzu = r2
            boolean r2 = la.j.d(r7)
            r6.zzv = r2
        ...
        L63:
            ...
            goto L61
        L68:
            na.d r3 = na.e.a(r7)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L61
        ...
        L8a:
            r6.zzx = r0
            na.d r0 = na.e.a(r7)     // Catch: java.lang.Exception -> Lb0
    ...
    private static ResolveInfo zzb(PackageManager packageManager, String str) {
        try {
            ...
            t.q().zzw(th2, "DeviceInfo.getResolveInfo");
            return null;
        }
    }
    ...
    private final void zzc(Context context) {
        ...
        if (audioManager != null) {
            try {
                ...
                t.q().zzw(th2, "DeviceInfo.gatherAudioInfo");
            }
        }
        this.zza = -2;
        this.zzb = false;
    ...
    private final void zzd(Context context) {
        ...
        Intent registerReceiver = (!((Boolean) a0.c().zza(zzbgc.zzkw)).booleanValue() || Build.VERSION.SDK_INT < 33) ? context.registerReceiver(null, intentFilter) : context.registerReceiver(null, intentFilter, 4);
    ...
    */
    private final void zze(android.content.Context r6) {
        ...
        L35:
            ...
            boolean r6 = com.google.android.gms.ads.internal.util.j2.b0(r6, r2)
            if (r6 == 0) goto L6f
