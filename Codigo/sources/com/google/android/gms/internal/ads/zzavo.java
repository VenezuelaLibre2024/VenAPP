...
public final class zzavo {
    ...
    public final String zza(byte[] bArr, byte[] bArr2) {
        ...
        try {
            ...
            throw new zzavn(this, e10);
        } catch (NoSuchAlgorithmException e11) {
            throw new zzavn(this, e11);
        } catch (BadPaddingException e12) {
            throw new zzavn(this, e12);
        } catch (IllegalBlockSizeException e13) {
            throw new zzavn(this, e13);
        } catch (NoSuchPaddingException e14) {
            throw new zzavn(this, e14);
        }
    }
    ...
    public final byte[] zzb(byte[] bArr, String str) {
        ...
        try {
            ...
            throw new zzavn(this, e15);
        } catch (NoSuchPaddingException e16) {
            throw new zzavn(this, e16);
        }
    }
}
