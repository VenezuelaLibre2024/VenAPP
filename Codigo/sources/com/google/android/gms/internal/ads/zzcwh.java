...
public class zzcwh implements zzemi {
    ...
    private final zzfea zze;
    private final zzdaq zzf;
    private final zzdfe zzg;
    private final zzdcn zzh;
    private final zzdij zzi;
    ...
    public zzcwh(zzcwg zzcwgVar) {
        ...
        zzdcn zzdcnVar;
        zzdij zzdijVar;
        zzfgyVar = zzcwgVar.zza;
        this.zza = zzfgyVar;
        zzfgmVar = zzcwgVar.zzb;
        this.zzb = zzfgmVar;
        zzdbwVar = zzcwgVar.zzc;
        this.zzc = zzdbwVar;
        zzdcjVar = zzcwgVar.zzd;
        this.zzd = zzdcjVar;
        zzfeaVar = zzcwgVar.zze;
        this.zze = zzfeaVar;
        zzdaqVar = zzcwgVar.zzf;
        this.zzf = zzdaqVar;
        zzdfeVar = zzcwgVar.zzg;
        this.zzg = zzdfeVar;
        zzdcnVar = zzcwgVar.zzh;
        this.zzh = zzdcnVar;
        zzdijVar = zzcwgVar.zzi;
        this.zzi = zzdijVar;
    }
