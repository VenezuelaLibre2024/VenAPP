...
final class zzfd extends zzcm implements RandomAccess, zzfw {
    ...
    private zzfd(long[] jArr, int i10, boolean z10) {
        super(z10);
        this.zzb = jArr;
        this.zzc = i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzel zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzfd(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
