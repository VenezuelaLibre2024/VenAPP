...
final class zzcq extends zzcm implements RandomAccess, zzfw {
    ...
    private zzcq(boolean[] zArr, int i10, boolean z10) {
        super(z10);
        this.zzb = zArr;
        this.zzc = i10;
    }
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzem.zza(this.zzb[i11]);
        }
        return i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzel zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzcq(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
