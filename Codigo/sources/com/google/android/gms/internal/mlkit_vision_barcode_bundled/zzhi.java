...
final class zzhi {
    ...
    public static void zzD(Object obj, long j10, byte b10) {
        zzhh zzhhVar = zzf;
        long j11 = (-4) & j10;
        int i10 = zzhhVar.zza.getInt(obj, j11);
        int i11 = ((~((int) j10)) & 3) << 3;
        zzhhVar.zza.putInt(obj, j11, ((255 & b10) << i11) | (i10 & (~(255 << i11))));
    }
    ...
    public static void zzE(Object obj, long j10, byte b10) {
        ...
        long j11 = (-4) & j10;
        int i10 = (((int) j10) & 3) << 3;
        zzhhVar.zza.putInt(obj, j11, ((255 & b10) << i10) | (zzhhVar.zza.getInt(obj, j11) & (~(255 << i10))));
    }
