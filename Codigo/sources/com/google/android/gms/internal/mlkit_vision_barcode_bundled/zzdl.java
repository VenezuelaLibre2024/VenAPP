...
final class zzdl extends zzcm implements RandomAccess, zzfw {
    ...
    private zzdl(double[] dArr, int i10, boolean z10) {
        super(z10);
        this.zzb = dArr;
        this.zzc = i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzel zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzdl(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
