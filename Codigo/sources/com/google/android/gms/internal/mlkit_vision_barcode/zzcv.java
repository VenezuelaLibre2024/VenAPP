...
public abstract class zzcv extends zzcq implements List, RandomAccess {
    ...
    public static zzcv zzg(Object[] objArr, int i10) {
        return i10 == 0 ? zzdn.zza : new zzdn(objArr, i10);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i10 = 0; i10 < size; i10++) {
                        if (zzay.zza(get(i10), list.get(i10))) {
                        }
                    }
                    return true;
                }
    ...
    public zzcv subList(int i10, int i11) {
        zzbc.zzd(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? zzdn.zza : new zzcu(this, i10, i12);
    }

    @Override // java.util.List
    /* renamed from: zzj, reason: merged with bridge method [inline-methods] */
    public final zzdy listIterator(int i10) {
        zzbc.zzb(i10, size(), "index");
        return isEmpty() ? zza : new zzct(this, i10);
    }
}
