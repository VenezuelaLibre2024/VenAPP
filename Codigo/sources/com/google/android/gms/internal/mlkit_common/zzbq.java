...
public final class zzbq implements e {
    ...
    public zzbq(OutputStream outputStream, Map map, Map map2, d dVar) {
    ...
    private static int zzh(c cVar) {
        zzbo zzboVar = (zzbo) cVar.c(zzbo.class);
        if (zzboVar != null) {
            return zzboVar.zza();
        }
    ...
    private static zzbo zzj(c cVar) {
        zzbo zzboVar = (zzbo) cVar.c(zzbo.class);
        if (zzboVar != null) {
            return zzboVar;
        }
    ...
    private final zzbq zzk(d dVar, c cVar, Object obj, boolean z10) {
    ...
    private final zzbq zzl(f fVar, c cVar, Object obj, boolean z10) {
    ...
    public final zzbq zzd(c cVar, int i10, boolean z10) {
        if (z10 && i10 == 0) {
            return this;
        }
        zzbo zzj = zzj(cVar);
    ...
    public final zzbq zze(c cVar, long j10, boolean z10) {
        if (z10 && j10 == 0) {
            return this;
        }
        zzbo zzj = zzj(cVar);
