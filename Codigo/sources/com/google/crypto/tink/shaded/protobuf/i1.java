...
public final class i1 {
    ...
    /* renamed from: a */
    private static final Class<?> f11417a = B();

    /* renamed from: b */
    private static final n1<?, ?> f11418b = C(false);

    /* renamed from: c */
    private static final n1<?, ?> f11419c = C(true);

    /* renamed from: d */
    private static final n1<?, ?> f11420d = new p1();

    public static <UT, UB> UB A(Object obj, int i10, List<Integer> list, a0.e eVar, UB ub2, n1<UT, UB> n1Var) {
        if (eVar == null) {
            return ub2;
        }
    ...
    public static void J(Class<?> cls) {
        Class<?> cls2;
        if (!y.class.isAssignableFrom(cls) && (cls2 = f11417a) != null && !cls2.isAssignableFrom(cls)) {
    ...
    public static int a(int i10, List<?> list, boolean z10) {
        ...
        return z10 ? k.T(i10) + k.C(size) : size * k.d(i10, true);
    }
    ...
    public static int d(int i10, List<Integer> list, boolean z10) {
        ...
        int e10 = e(list);
        int T = k.T(i10);
        return z10 ? T + k.C(e10) : e10 + (size * T);
    }
    ...
    public static int f(int i10, List<?> list, boolean z10) {
        ...
        return z10 ? k.T(i10) + k.C(size * 4) : size * k.m(i10, 0);
    }
    ...
    public static int h(int i10, List<?> list, boolean z10) {
        ...
        return z10 ? k.T(i10) + k.C(size * 8) : size * k.o(i10, 0L);
    }
    ...
    public static int k(int i10, List<Integer> list, boolean z10) {
        ...
        int l10 = l(list);
        int T = k.T(i10);
        return z10 ? T + k.C(l10) : l10 + (size * T);
    }
    ...
    public static int m(int i10, List<Long> list, boolean z10) {
        ...
        int n10 = n(list);
        return z10 ? k.T(i10) + k.C(n10) : n10 + (list.size() * k.T(i10));
    }
    ...
    public static int q(int i10, List<Integer> list, boolean z10) {
        ...
        int r10 = r(list);
        int T = k.T(i10);
        return z10 ? T + k.C(r10) : r10 + (size * T);
    }
    ...
    public static int s(int i10, List<Long> list, boolean z10) {
        ...
        int t10 = t(list);
        int T = k.T(i10);
        return z10 ? T + k.C(t10) : t10 + (size * T);
    }
    ...
    public static int u(int i10, List<?> list) {
        ...
        if (list instanceof g0) {
            ...
            while (i11 < size) {
                ...
                T += j10 instanceof h ? k.h((h) j10) : k.S((String) j10);
                i11++;
            }
        } else {
            while (i11 < size) {
    ...
    public static int v(int i10, List<Integer> list, boolean z10) {
        ...
        int w10 = w(list);
        int T = k.T(i10);
        return z10 ? T + k.C(w10) : w10 + (size * T);
    }
    ...
    public static int x(int i10, List<Long> list, boolean z10) {
        ...
        int y10 = y(list);
        int T = k.T(i10);
        return z10 ? T + k.C(y10) : y10 + (size * T);
    }
    ...
    public static <UT, UB> UB z(Object obj, int i10, List<Integer> list, a0.d<?> dVar, UB ub2, n1<UT, UB> n1Var) {
        if (dVar == null) {
            return ub2;
        }
        if (list instanceof RandomAccess) {
