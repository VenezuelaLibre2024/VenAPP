...
public class HeadlessInAppWebView implements Disposable {
    ...
    public void dispose() {
        ...
        if (inAppWebViewFlutterPlugin != null) {
            ...
            if (headlessInAppWebViewManager != null && headlessInAppWebViewManager.webViews.containsKey(this.f13545id)) {
                headlessInAppWebViewManager.webViews.put(this.f13545id, null);
            }
