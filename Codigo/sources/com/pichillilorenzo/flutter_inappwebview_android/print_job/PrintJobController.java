...
public class PrintJobController implements Disposable {
    ...
    public void dispose() {
        ...
        if (inAppWebViewFlutterPlugin != null && (printJobManager = inAppWebViewFlutterPlugin.printJobManager) != null && printJobManager.jobs.containsKey(this.f13548id)) {
            printJobManager.jobs.put(this.f13548id, null);
        }
        PrintJob printJob = this.job;
        if (printJob != null) {
            printJob.cancel();
