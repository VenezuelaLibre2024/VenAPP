...
public class InAppWebViewClientCompat extends WebViewClientCompat {
    ...
    */
    ...
    @Override // androidx.webkit.WebViewClientCompat
    public void onSafeBrowsingHit(final WebView webView, final WebResourceRequest webResourceRequest, final int i10, final f fVar) {
            ...
            public boolean nonNullSuccess(SafeBrowsingResponse safeBrowsingResponse) {
                ...
                if (action != null) {
                    ...
                    if (intValue != 0) {
                        ...
                        if (!t.a("SAFE_BROWSING_RESPONSE_PROCEED")) {
                            return true;
                        }
                        fVar.b(isReport);
                        return false;
                    }
                    if (t.a("SAFE_BROWSING_RESPONSE_BACK_TO_SAFETY")) {
                        fVar.a(isReport);
                        return false;
                    }
                }
