...
public abstract class PO {
     ...
     */
    public static PN A00(C1399Yn c1399Yn, JSONObject jSONObject, C07046c c07046c, JA ja2, C1154Oy c1154Oy, boolean z10) {
        boolean z11;
        String str;
        boolean z12 = z10;
        ...
        try {
            ...
            if (optJSONObject != null && optJSONObject.optString(A012) != null) {
                ...
                if (z11) {
                    optJSONObject.put(A012, c07046c.A0Q(optJSONObject.optString(A012)));
                }
            }
            ...
            if (optJSONArray != null) {
                for (int i10 = 0; i10 < optJSONArray.length(); i10++) {
                    ...
                    if (z11) {
                        optJSONArray.put(i10, c07046c.A0Q(optString2));
                    }
                }
            }
            ...
            if (optJSONArray2 != null) {
                for (int i11 = 0; i11 < optJSONArray2.length(); i11++) {
                    A03(arrayList, arrayList2, optJSONArray2.optJSONObject(i11), c07046c, z11);
                }
            } else {
                A03(arrayList, arrayList2, jSONObject, c07046c, z11);
            }
        } catch (JSONException unused) {
            c1154Oy.A04(C8A.A15, A01(0, 43, 79));
        }
    ...
    public static void A03(ArrayList<String> videoUrls, ArrayList<String> arrayList, JSONObject jSONObject, C07046c c07046c, boolean z10) throws JSONException {
        ...
        if (optJSONObject != null) {
            ...
            if (optJSONObject.optString(A012) != null) {
                ...
                if (z10) {
                    optJSONObject.put(A012, c07046c.A0Q(optString));
                }
            }
        }
        ...
        if (!TextUtils.isEmpty(jSONObject.optString(A013))) {
            ...
            arrayList.add(optString2);
            if (z10) {
                jSONObject.put(A013, c07046c.A0R(optString2));
            }
        }
    }
}
