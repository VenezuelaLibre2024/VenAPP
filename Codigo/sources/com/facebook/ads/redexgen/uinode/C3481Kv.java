...
public final class C3481Kv {
    ...
    private int A00(C4337Yn c4337Yn) {
        PackageInfo packageInfo;
        try {
            PackageManager packageManager = c4337Yn.getPackageManager();
    ...
    public static Intent A02(C4337Yn c4337Yn, Uri uri) {
        Intent A012 = A01(uri);
        A012.addCategory(A06(212, 33, 67));
        A012.addFlags(268435456);
        A012.putExtra(A06(288, 34, 25), c4337Yn.getPackageName());
        A012.putExtra(A06(494, 14, 75), false);
        if (C3348Ih.A1b(c4337Yn)) {
    ...
    public static Intent A03(C4337Yn c4337Yn, Uri uri) {
        Intent A012 = A01(uri);
        A012.setPackage(A06(322, 19, 20));
        A012.putExtra(A06(259, 8, 22), c4337Yn.getPackageName());
        A012.putExtra(A06(614, 7, 91), true);
        return A012;
    }

    private final EnumC22780g A04(C4337Yn c4337Yn, Uri uri, String str, Map<String, String> extraData) throws C3469Kh {
        boolean A05 = AbstractC3349Ii.A05(c4337Yn);
        boolean isInAppBrowserEnabled = A0E(uri);
        if (isInAppBrowserEnabled && A05) {
            A0B(c4337Yn, uri, str, extraData);
            return EnumC22780g.A07;
        }
        c4337Yn.A0E().A8f(A05);
        A09(c4337Yn, uri);
        return EnumC22780g.A06;
    }

    public static EnumC22780g A05(C3481Kv c3481Kv, C4337Yn c4337Yn, Uri uri, String str, Map<String, String> extraData) throws C3469Kh {
        ...
        if (!isGooglePlayWebLink && !z10) {
            return c3481Kv.A04(c4337Yn, uri, str, extraData);
        }
        try {
            c3481Kv.A0A(c4337Yn, uri, str);
            return EnumC22780g.A02;
        } catch (C3479Kt unused) {
            return c3481Kv.A04(c4337Yn, uri, str, extraData);
        }
    }
    ...
    private void A09(C4337Yn c4337Yn, Uri uri) throws C3469Kh {
        C3471Kj.A0C(c4337Yn, A02(c4337Yn, uri));
    }

    private final void A0A(C4337Yn c4337Yn, Uri uri, String str) throws C3479Kt, C3469Kh {
        if (A0G(c4337Yn)) {
            boolean z10 = (c4337Yn.A0F().A01() && C3348Ih.A1F(c4337Yn)) || (C3348Ih.A1c(c4337Yn) && A0H(c4337Yn));
            if (!z10) {
                boolean shouldTryToOpenSplitScreen = C3348Ih.A1y(c4337Yn);
                if (shouldTryToOpenSplitScreen) {
                    boolean shouldTryToOpenSplitScreen2 = C3471Kj.A0D(c4337Yn, A03(c4337Yn, uri));
                    if (shouldTryToOpenSplitScreen2) {
                        return;
                    }
                }
            }
            boolean shouldTryToOpenSplitScreen3 = A0K(c4337Yn, uri, str);
            if (shouldTryToOpenSplitScreen3) {
                return;
            }
            Intent A02 = A02(c4337Yn, uri);
            A02.setPackage(A06(322, 19, 20));
            if (Build.VERSION.SDK_INT >= 24 && z10) {
                A02.addFlags(268472320);
            }
            C3471Kj.A0C(c4337Yn, A02);
            return;
        }
        throw new C3479Kt();
    }

    private void A0B(C4337Yn c4337Yn, Uri uri, String str, Map<String, String> map) {
        AdActivityIntent A04 = C3471Kj.A04(c4337Yn);
        if (!ProcessUtils.isRemoteRenderingProcess()) {
            A04.addFlags(268435456);
        }
        A04.putExtra(A06(654, 8, 126), EnumC3438KB.A03);
        ...
        try {
            ...
            c4337Yn.A07().A9a(A06(168, 11, 15), AbstractC27248A.A0D, new C27258B(th2));
            Log.e(A06(149, 17, 66), A06(50, 90, 123), th2);
        }
    }

    public static void A0C(C3481Kv c3481Kv, C4337Yn c4337Yn, Uri uri, String str) {
        c3481Kv.A0L(c4337Yn, uri, str);
    }

    public static void A0D(C3481Kv c3481Kv, C4337Yn c4337Yn, Uri uri, String str) throws C3469Kh {
        A05(c3481Kv, c4337Yn, uri, str, null);
    }
    ...
    */
    public static boolean A0E(android.net.Uri r5) {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C3481Kv.A01
            r0 = 1
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L61:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3481Kv.A0E(android.net.Uri):boolean");
    }

    private boolean A0F(C4337Yn c4337Yn) {
        if (!C3348Ih.A14(c4337Yn)) {
            return false;
        }
        int A0D = C3348Ih.A0D(c4337Yn);
        if (A01[7].charAt(2) != 'a') {
            throw new RuntimeException();
        }
        A01[2] = "JMUKVK1n";
        int A002 = A00(c4337Yn);
        return A0D != -1 && A002 != -1 && A0D <= A002 && Build.VERSION.SDK_INT >= 28;
    }

    private boolean A0G(C4337Yn c4337Yn) {
        Intent playStoreIntent = new Intent(A06(186, 26, 50), AbstractC3484Ky.A00(A06(548, 34, 87)));
        Iterator<ResolveInfo> it = c4337Yn.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        while (it.hasNext()) {
    ...
    public static boolean A0H(C4337Yn c4337Yn) {
        ...
        if (onAndAboveNOS2) {
            ...
            if (strArr[6].length() == strArr[3].length()) {
                ...
                z11 = AbstractC3492L6.A0C(c4337Yn);
        ...
        c4337Yn.A0E().AA7(A0I, z10, supportsSplitScreenMultiWindow, appResizingSupported, z11);
        return z10;
    }

    public static boolean A0I(C4337Yn c4337Yn) {
        Activity A0D;
        PackageManager packageManager;
        ActivityInfo activityInfo;
        try {
            A0D = c4337Yn.A0D();
            packageManager = c4337Yn.getPackageManager();
        } catch (PackageManager.NameNotFoundException | IllegalAccessException | NoSuchFieldException e10) {
            c4337Yn.A0E().AA5(e10.getMessage());
        }
    ...
    private boolean A0J(C4337Yn c4337Yn, Uri uri, String str) throws C3469Kh {
        try {
            Activity A0D = c4337Yn.A0D();
            String uri2 = uri.toString();
            if (A0D != null && !TextUtils.isEmpty(uri2)) {
                Intent fbIntent = new Intent();
                if (C3348Ih.A15(c4337Yn)) {
                    String A06 = AbstractC4476b5.A06(str);
                ...
                if (!C3471Kj.A0D(c4337Yn, fbIntent)) {
            ...
            c4337Yn.A0E().A9e(e10.getMessage());
            return false;
        }
    }

    private boolean A0K(C4337Yn c4337Yn, Uri uri, String str) throws C3469Kh {
        return A0F(c4337Yn) && A0J(c4337Yn, uri, str);
    }

    private final boolean A0L(C4337Yn c4337Yn, Uri uri, String str) {
        return C3471Kj.A0H(c4337Yn, uri, str);
    }

    public static boolean A0M(C3481Kv c3481Kv, C4337Yn c4337Yn, Uri uri, String str) {
        try {
            A0D(c3481Kv, c4337Yn, uri, str);
            return true;
        } catch (C3469Kh e10) {
            Throwable cause = e10.getCause();
            Throwable th2 = e10;
            ...
            c4337Yn.A07().A9a(A06(168, 11, 15), AbstractC27248A.A05, new C27258B(th2));
            return false;
        }
    }
}
