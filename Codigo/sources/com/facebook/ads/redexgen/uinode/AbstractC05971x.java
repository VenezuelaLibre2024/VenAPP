...
public abstract class AbstractC05971x {
    ...
    public static AdSettings.IntegrationErrorMode A00(C1399Yn c1399Yn) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c1399Yn)) {
    ...
    public static boolean A03(C1399Yn c1399Yn) {
        return (c1399Yn.getApplicationInfo().flags & 2) != 0;
    }
}
