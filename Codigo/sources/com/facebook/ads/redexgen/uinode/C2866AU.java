...
public final class C2866AU {
    public static byte[] A02;
    public static final C2866AU A03;
    ...
    static {
        A03();
        A03 = new C2866AU(new int[]{2}, 2);
    }

    public C2866AU(int[] iArr, int i10) {
        if (iArr != null) {
    ...
    public static C2866AU A00(Context context) {
        return A01(AbstractC3483Kx.A00(context, null, new IntentFilter(A02(56, 36, 42))));
    }

    public static C2866AU A01(Intent intent) {
        if (intent == null || intent.getIntExtra(A02(92, 36, 65), 0) == 0) {
            return A03;
        }
        return new C2866AU(intent.getIntArrayExtra(A02(RecognitionOptions.ITF, 29, 28)), intent.getIntExtra(A02(157, 37, 29), 0));
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C2866AU)) {
            return false;
        }
        C2866AU c2866au = (C2866AU) obj;
        return Arrays.equals(this.A01, c2866au.A01) && this.A00 == c2866au.A00;
    }
