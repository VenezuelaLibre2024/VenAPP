...
public final class F8 {
     ...
     */
    public final synchronized int A09(C07829p c07829p, C1377Xr c1377Xr, boolean z10, boolean z11, Format format, F7 f72) {
        if (!A0I()) {
            if (z11) {
                c1377Xr.A02(4);
                return -4;
        ...
        if (z10 || this.A0G[A00] != format) {
            c07829p.A00 = this.A0G[A00];
            return -5;
        }
        if (c1377Xr.A0B()) {
            return -3;
        }
        c1377Xr.A00 = this.A0F[A00];
        c1377Xr.A02(this.A0B[A00]);
    ...
    */
    public final long A0C(int r6) {
        /*
            ...
            r0 = 1
        L10:
            com.facebook.ads.redexgen.uinode.AbstractC0955Ha.A03(r0)
            int r0 = r5.A02
            int r0 = r0 - r2
            r5.A02 = r0
            long r2 = r5.A06
