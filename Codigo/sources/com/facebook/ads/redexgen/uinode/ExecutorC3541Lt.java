...
public final class ExecutorC3541Lt implements Executor {
    ...
    static {
        A04();
        A08 = new ExecutorC3541Lt(A00(7, 7, 8), 0);
        A06 = new ExecutorC3541Lt(A00(0, 5, 91), 0);
        A07 = new ExecutorC3541Lt(A00(5, 2, 3), 0);
        A03 = 32;
        A0C = Executors.newSingleThreadExecutor();
        A0B = Executors.newFixedThreadPool(5);
        A0D = new AtomicBoolean();
        A0E = new AtomicBoolean();
        A0A = Executors.newCachedThreadPool(new ThreadFactoryC3539Lr());
        A09 = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    }

    public ExecutorC3541Lt(String str, int i10) {
        this.A02 = i10;
        int CPU_COUNT = Runtime.getRuntime().availableProcessors();
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(Math.max(2, Math.min(CPU_COUNT - 1, 4)), (CPU_COUNT * 2) + 1, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new ThreadFactoryC3540Ls(this, str));
    ...
    public static void A05(Context context) {
        A0D.set(C3348Ih.A2K(context));
        A0E.set(C3348Ih.A2J(context));
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (ExecutorC3541Lt.class) {
            int i10 = A03;
            if (reservedExecutorQueueSize == i10) {
                int reservedExecutorQueueSize2 = i10 * 2;
                A03 = reservedExecutorQueueSize2;
                C4336Ym A00 = AbstractC26927e.A00();
                if (A00 != null) {
                    A00.A07().A9a(A00(42, 7, 27), AbstractC27248A.A1d, new C27258B(A00(21, 21, 46), A00(14, 7, 25) + i10));
                }
            }
        }
