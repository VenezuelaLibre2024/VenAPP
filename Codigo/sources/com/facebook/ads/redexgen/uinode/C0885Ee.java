...
public final class C0885Ee extends AbstractC1412Za {
     ...
     */
    @Override // com.facebook.ads.redexgen.uinode.AbstractC06614k
                ...
                Runnable runnable = new Runnable() { // from class: com.facebook.ads.redexgen.X.4D
                    ...
                    public final void run() {
                        ...
                        while (it2.hasNext()) {
                            ...
                            C0885Ee.this.A0Y(c4m.A04, c4m.A00, c4m.A01, c4m.A02, c4m.A03);
                        }
                        arrayList.clear();
                        C0885Ee.this.A05.remove(arrayList);
                    }
                };
                if (z10) {
                ...
                Runnable runnable2 = new Runnable() { // from class: com.facebook.ads.redexgen.X.4E
                    ...
                    public final void run() {
                        ...
                        while (it2.hasNext()) {
                            ...
                            C0885Ee.this.A0W(change);
                        }
                        arrayList2.clear();
                        C0885Ee.this.A03.remove(arrayList2);
                    }
                };
                if (z10) {
                ...
                Runnable runnable3 = new Runnable() { // from class: com.facebook.ads.redexgen.X.4F
                    ...
                    public final void run() {
                        ...
                        while (it2.hasNext()) {
                            ...
                            C0885Ee.this.A0X(holder);
                        }
                        arrayList3.clear();
                        C0885Ee.this.A01.remove(arrayList3);
                    }
                };
                if (!z10 && !z11 && !z12) {
                    runnable3.run();
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 17 out of bounds for length 14
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    @Override // com.facebook.ads.redexgen.uinode.AbstractC1412Za
    ...
    private void A03(final AnonymousClass56 anonymousClass56) {
        ...
        animation.alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: com.facebook.ads.redexgen.X.4G
            ...
            public final void onAnimationEnd(Animator animator) {
                ...
                view.setAlpha(1.0f);
                C0885Ee.this.A0P(anonymousClass56);
                C0885Ee.this.A06.remove(anonymousClass56);
                C0885Ee.this.A0V();
            }
    ...
    public final void A0K(AnonymousClass56 anonymousClass56) {
        ...
        for (int j10 = this.A05.size() - 1; j10 >= 0; j10--) {
            ArrayList<C4M> arrayList2 = this.A05.get(j10);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x009a, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.C0885Ee.A0C[7].charAt(30) == 'w') goto L34;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x00ab, code lost:
        ...
        com.facebook.ads.redexgen.uinode.C0885Ee.A0C[7] = "80rjjAfjuSoUPBYOWBOUrC4mhnJBtDwK";
     */
    ...
    */
    public final boolean A0L() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C0885Ee.A0C
            r0 = 2
            r1 = r2[r0]
            r0 = 5
            r2 = r2[r0]
        ...
        L73:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C0885Ee.A0C
            r0 = 7
            r1 = r1[r0]
            r0 = 30
            char r1 = r1.charAt(r0)
        ...
        Lba:
            ...
            goto Lb9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0885Ee.A0L():boolean");
    }
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: com.facebook.ads.redexgen.X.4J
                ...
                public final void onAnimationEnd(Animator animator) {
                    ...
                    view.setTranslationX(0.0f);
                    view.setTranslationY(0.0f);
                    C0885Ee.this.A0Q(c4l.A05, true);
                    C0885Ee.this.A02.remove(c4l.A05);
                    C0885Ee.this.A0V();
                }
        ...
        if (view2 != null) {
            ...
            animate.translationX(0.0f).translationY(0.0f).setDuration(A05()).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: com.facebook.ads.redexgen.X.4K
                ...
                public final void onAnimationEnd(Animator animator) {
                    ...
                    view2.setTranslationX(0.0f);
                    view2.setTranslationY(0.0f);
                    C0885Ee.this.A0Q(c4l.A04, false);
                    C0885Ee.this.A02.remove(c4l.A04);
                    C0885Ee.this.A0V();
                }
    ...
    public final void A0X(final AnonymousClass56 anonymousClass56) {
        ...
        animation.setListener(new AnimatorListenerAdapter() { // from class: com.facebook.ads.redexgen.X.4H
            ...
            public final void onAnimationEnd(Animator animator) {
                animate.setListener(null);
                C0885Ee.this.A0N(anonymousClass56);
                C0885Ee.this.A00.remove(anonymousClass56);
                C0885Ee.this.A0V();
            }
    ...
    public final void A0Y(final AnonymousClass56 anonymousClass56, int i10, int i11, int i12, int i13) {
        ...
        animate.setDuration(A06()).setListener(new AnimatorListenerAdapter() { // from class: com.facebook.ads.redexgen.X.4I
            ...
            public final void onAnimationEnd(Animator animator) {
                animate.setListener(null);
                C0885Ee.this.A0O(anonymousClass56);
                C0885Ee.this.A04.remove(anonymousClass56);
                C0885Ee.this.A0V();
            }
