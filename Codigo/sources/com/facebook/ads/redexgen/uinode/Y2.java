...
public final class Y2 implements A0, DZ, InterfaceC0802Aj, InterfaceC0984Id, F4, InterfaceC0944Go {
    ...
    public A5 A00;
    public final InterfaceC0958Hd A03;
     ...
     */
    private final AL A04(int i10, C0895Eo c0895Eo) {
        AbstractC0955Ha.A01(this.A00);
        long A5T = this.A03.A5T();
        AH A6f = this.A00.A6f();
        return new AL(A5T, A6f, i10, c0895Eo, i10 == this.A00.A6g() ? (c0895Eo == null || !c0895Eo.A01()) ? this.A00.A6Y() : (this.A00.A6a() == c0895Eo.A00 && this.A00.A6b() == c0895Eo.A01) ? this.A00.A6d() : 0L : (i10 >= A6f.A01() || (c0895Eo != null && c0895Eo.A01())) ? 0L : A6f.A0B(i10, this.A01).A00(), this.A00.A6d(), this.A00.A6C() - this.A00.A6Y());
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 9 out of bounds for length 9
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0802Aj
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 9 out of bounds for length 8
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0944Go
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 8 out of bounds for length 8
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0984Id
    ...
    public Y2(A5 a52, InterfaceC0958Hd interfaceC0958Hd) {
        this.A00 = a52;
        this.A03 = (InterfaceC0958Hd) AbstractC0955Ha.A01(interfaceC0958Hd);
    }
    ...
    private AL A05(AK ak2) {
        if (ak2 == null) {
            Object A01 = AbstractC0955Ha.A01(this.A00);
            String[] strArr = A06;
            if (strArr[5].charAt(24) != strArr[3].charAt(24)) {
                throw new RuntimeException();
            }
    ...
    public final void ABM(int i10, C0895Eo c0895Eo, F3 f32) {
        A04(i10, c0895Eo);
        Iterator<AM> it = this.A04.iterator();
    ...
    @Override // com.facebook.ads.redexgen.uinode.F4
    public final void ABy(int i10, C0895Eo c0895Eo, F2 f22, F3 f32) {
        A04(i10, c0895Eo);
        Iterator<AM> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.uinode.F4
    public final void AC0(int i10, C0895Eo c0895Eo, F2 f22, F3 f32) {
        A04(i10, c0895Eo);
        Iterator<AM> it = this.A04.iterator();
        while (true) {
            boolean hasNext = it.hasNext();
    ...
    @Override // com.facebook.ads.redexgen.uinode.F4
    public final void AC3(int i10, C0895Eo c0895Eo, F2 f22, F3 f32, IOException iOException, boolean z10) {
        A04(i10, c0895Eo);
        Iterator<AM> it = this.A04.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.uinode.F4
    public final void AC5(int i10, C0895Eo c0895Eo, F2 f22, F3 f32) {
        A04(i10, c0895Eo);
        Iterator<AM> it = this.A04.iterator();
        while (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.uinode.F4
    public final void ACG(int i10, C0895Eo c0895Eo) {
        this.A02.A0B(i10, c0895Eo);
        A04(i10, c0895Eo);
        Iterator<AM> it = this.A04.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.uinode.F4
    public final void ACH(int i10, C0895Eo c0895Eo) {
        this.A02.A0C(i10, c0895Eo);
        A04(i10, c0895Eo);
        Iterator<AM> it = this.A04.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.uinode.A0
    public final void ACd(C07709c c07709c) {
        A02();
        Iterator<AM> it = this.A04.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.uinode.F4
    public final void ACp(int i10, C0895Eo c0895Eo) {
        this.A02.A0D(i10, c0895Eo);
        A04(i10, c0895Eo);
        Iterator<AM> it = this.A04.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.uinode.A0
    public final void ADM(TrackGroupArray trackGroupArray, C0937Gh c0937Gh) {
        A02();
        Iterator<AM> it = this.A04.iterator();
        if (it.hasNext()) {
            it.next();
