...
public final class C07498g {
    ...
    public static synchronized LA A00(C07277f c07277f) {
        LA la2;
        synchronized (C07498g.class) {
            if (A01 == null) {
                A01 = LB.A00(c07277f);
            }
            la2 = A01;
    ...
    public static void A06(C07277f c07277f, String str, Map<String, String> params) {
        String str2;
        if (A0A(c07277f)) {
            str2 = C1031Kc.A03(str);
        } else {
            str2 = A00;
        }
        if (str2 != null) {
    ...
    public static void A07(final C07277f c07277f, boolean z10) {
        if (!A05.compareAndSet(0, 1)) {
            return;
        }
        A00(c07277f);
        try {
            final SharedPreferences A002 = KE.A00(c07277f);
            final C8K c8k = new C8K(c07277f);
                ...
                */
                public final java.lang.Boolean call() throws java.lang.Exception {
                    /*
                        ...
                        if (r0 == 0) goto L3e
                    L17:
                        com.facebook.ads.redexgen.X.7f r0 = com.facebook.ads.redexgen.uinode.C07277f.this
                        boolean r0 = com.facebook.ads.redexgen.uinode.C0988Ih.A2G(r0)
                        if (r0 == 0) goto L3e
                        ...
                        if (r0 == 0) goto L3e
                        com.facebook.ads.redexgen.X.7f r1 = com.facebook.ads.redexgen.uinode.C07277f.this
                        java.lang.String r0 = r1.getPackageName()
                        java.lang.String r6 = com.facebook.ads.redexgen.uinode.LG.A01(r1, r0)
                    L3e:
                        r5 = 1
                        java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.CallableC07488f.A05
                        r0 = 7
                        r0 = r1[r0]
                        int r1 = r0.length()
                        r0 = 20
                        ...
                        throw r0
                    L52:
                        java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.CallableC07488f.A05
                        ...
                        com.facebook.ads.redexgen.X.7f r1 = com.facebook.ads.redexgen.uinode.C07277f.this
                        java.lang.String r0 = r1.getPackageName()
                        java.lang.String r0 = com.facebook.ads.redexgen.uinode.C1031Kc.A02(r1, r0)
                        com.facebook.ads.redexgen.uinode.C07498g.A00 = r0
                    L6c:
                        android.content.SharedPreferences r0 = r3
                        android.content.SharedPreferences$Editor r2 = r0.edit()
                        java.lang.String r1 = r4
                        java.lang.String r0 = com.facebook.ads.redexgen.uinode.C07498g.A00
                        android.content.SharedPreferences$Editor r0 = r2.putString(r1, r0)
                        r0.apply()
                        java.util.concurrent.atomic.AtomicInteger r1 = com.facebook.ads.redexgen.uinode.C07498g.A04()
                        r0 = 2
                        r1.set(r0)
                    ...
                    L8a:
                        com.facebook.ads.redexgen.X.7f r0 = com.facebook.ads.redexgen.uinode.C07277f.this
                        boolean r0 = com.facebook.ads.redexgen.uinode.C0988Ih.A1I(r0)
                        if (r0 == 0) goto Le7
                        com.facebook.ads.redexgen.X.7f r1 = com.facebook.ads.redexgen.uinode.C07277f.this
                        java.lang.String r0 = r1.getPackageName()
                        java.lang.String r4 = com.facebook.ads.redexgen.uinode.C1031Kc.A02(r1, r0)
                        r2 = 1
                        r1 = 5
                        r0 = 33
                        java.lang.String r0 = A01(r2, r1, r0)
                        ...
                        r4.A9b(r0, r3, r7)
                    Le7:
                        com.facebook.ads.redexgen.uinode.C07498g.A00 = r6
                        goto L6c
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.CallableC07488f.call():java.lang.Boolean");
                }
            });
    ...
    public static void A08(C07277f c07277f, boolean z10, String str) {
        if (A0A(c07277f)) {
            A09(c07277f, z10, str);
        } else {
            A07(c07277f, z10);
    ...
    public static void A09(C07277f c07277f, boolean z10, final String str) {
        if (str == null) {
            str = c07277f.getPackageName();
        }
        if (A0B(str)) {
            return;
        }
        A00(c07277f);
        final C1031Kc c1031Kc = new C1031Kc(c07277f, str);
        try {
            c1031Kc.A06();
    ...
    public static boolean A0A(C07277f c07277f) {
        return ProcessUtils.isRemoteRenderingProcess() || C0988Ih.A2L(c07277f);
    }
