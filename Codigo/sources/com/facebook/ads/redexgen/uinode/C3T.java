...
public abstract class C3T {
    ...
    static {
        if (Build.VERSION.SDK_INT >= 26) {
            A00 = new C05520d() { // from class: com.facebook.ads.redexgen.X.0U
            };
            return;
        }
    ...
    public static C06363k A05(View view, C06363k c06363k) {
        return A00.A08(view, c06363k);
    }

    public static C06363k A06(View view, C06363k c06363k) {
        return A00.A09(view, c06363k);
    }
