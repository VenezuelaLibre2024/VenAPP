...
public final class C27748z {
    ...
    public C27748z(int i10, int i11) {
        if (i10 < -1) {
    ...
    public final int A04(C27748z c27748z) {
        int i10 = this.A00;
        int i11 = c27748z.A00;
        if (i10 != i11) {
            return i10 - i11;
        }
        return this.A01 - c27748z.A01;
    }

    public final C27748z A05(int i10) {
        int i11 = this.A01;
        if (i10 + i11 >= 0) {
            return new C27748z(this.A00, i11 + i10);
        }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C27748z)) {
            return false;
        }
        C27748z c27748z = (C27748z) obj;
        int i10 = c27748z.A00;
        int i11 = this.A00;
        if (A03[4].charAt(2) != 'U') {
        ...
        return i10 == i11 && c27748z.A01 == this.A01;
    }
