...
public final class EJ implements Y6 {
    ...
    public final AF A0F;
    public final AG A0G;
    public final AbstractC0939Gj A0H;
    public final C0940Gk A0I;
    public final ArrayDeque<C07749g> A0J;
    ...
    public EJ(Y5[] y5Arr, AbstractC0939Gj abstractC0939Gj, InterfaceC07849r interfaceC07849r, InterfaceC0958Hd interfaceC0958Hd) {
        ...
        AbstractC0955Ha.A04(y5Arr.length > 0);
        this.A0L = (Y5[]) AbstractC0955Ha.A01(y5Arr);
        this.A0H = (AbstractC0939Gj) AbstractC0955Ha.A01(abstractC0939Gj);
        this.A0A = false;
        this.A03 = 0;
        this.A0B = false;
        this.A0K = new CopyOnWriteArraySet<>();
        C0940Gk c0940Gk = new C0940Gk(new AB[y5Arr.length], new InterfaceC0936Gg[y5Arr.length], null);
        this.A0I = c0940Gk;
        this.A0G = new AG();
        this.A0F = new AF();
        this.A07 = C07909x.A04;
        ...
        this.A0C = handler;
        this.A06 = new C07899w(AH.A01, 0L, TrackGroupArray.A04, c0940Gk);
        this.A0J = new ArrayDeque<>();
        EI ei2 = new EI(y5Arr, abstractC0939Gj, c0940Gk, interfaceC07849r, this.A0A, this.A03, this.A0B, handler, this, interfaceC0958Hd);
        this.A0E = ei2;
    ...
    private C07899w A01(boolean z10, boolean z11, int i10) {
        C0940Gk c0940Gk;
        if (z10) {
            this.A01 = 0;
            this.A00 = 0;
        ...
        if (z11) {
            ...
            c0940Gk = this.A06.A06;
        }
        return new C07899w(ah2, obj, c0895Eo, j10, j11, i10, false, trackGroupArray, c0940Gk);
    }

    private void A04(C07899w c07899w, int i10, boolean z10, int i11) {
        int i12;
        C07899w c07899w2 = c07899w;
        int i13 = this.A02 - i10;
        this.A02 = i13;
        if (i13 == 0) {
            if (c07899w2.A02 == -9223372036854775807L) {
                c07899w2 = c07899w2.A04(c07899w2.A04, 0L, c07899w2.A01);
            }
            if ((!this.A06.A03.A0E() || this.A08) && c07899w2.A03.A0E()) {
                this.A00 = 0;
                this.A01 = 0;
                this.A04 = 0L;
            }
            ...
            this.A08 = false;
            this.A09 = false;
            A05(c07899w2, z10, i11, i12, z11, false);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    private void A05(final C07899w c07899w, final boolean z10, final int i10, final int i11, final boolean z11, final boolean z12) {
        boolean isRunningRecursiveListenerNotification = !this.A0J.isEmpty();
        ArrayDeque<C07749g> arrayDeque = this.A0J;
        final C07899w c07899w2 = this.A06;
        final CopyOnWriteArraySet<A0> copyOnWriteArraySet = this.A0K;
        final AbstractC0939Gj abstractC0939Gj = this.A0H;
        final boolean z13 = this.A0A;
        arrayDeque.addLast(new Object(c07899w, c07899w2, copyOnWriteArraySet, abstractC0939Gj, z10, i10, i11, z11, z13, z12) { // from class: com.facebook.ads.redexgen.X.9g
            ...
            public final C07899w A02;
            public final AbstractC0939Gj A03;
...

            {
                ...
                this.A03 = abstractC0939Gj;
                this.A08 = z10;
                this.A00 = i10;
                this.A01 = i11;
                this.A09 = z11;
                this.A06 = z13;
                this.A07 = z12 || c07899w2.A00 != c07899w.A00;
                this.A0A = (c07899w2.A03 == c07899w.A03 && c07899w2.A07 == c07899w.A07) ? false : true;
                this.A05 = c07899w2.A08 != c07899w.A08;
                this.A0B = c07899w2.A06 != c07899w.A06;
            }
    ...
    public final void A09(int i10, long j10) {
        ...
        if (strArr[7].charAt(11) == strArr[2].charAt(11)) {
            ...
            this.A0E.A0y(ah2, i10, C9W.A00(j10));
    ...
    public final void A0A(Message message) {
        switch (message.what) {
            case 0:
                A04((C07899w) message.obj, message.arg1, message.arg2 != -1, message.arg2);
                return;
            case 1:
                C07909x c07909x = (C07909x) message.obj;
                C07909x playbackParameters = this.A07;
                if (!playbackParameters.equals(c07909x)) {
                    this.A07 = c07909x;
                    Iterator<A0> it = this.A0K.iterator();
                    while (it.hasNext()) {
                        it.next().ACb(c07909x);
                ...
                return;
            case 2:
                C07709c c07709c = (C07709c) message.obj;
                this.A05 = c07709c;
                String[] strArr = A0N;
    ...
    public final long A6q() {
        ...
        if (A0B()) {
            C0895Eo c0895Eo = this.A06.A04;
            ah2.A09(c0895Eo.A02, this.A0F);
            return C9W.A01(this.A0F.A0A(c0895Eo.A00, c0895Eo.A01));
        }
    ...
    @Override // com.facebook.ads.redexgen.uinode.Y6
    public final void AE5(InterfaceC0897Eq interfaceC0897Eq, boolean z10, boolean z11) {
        this.A05 = null;
        C07899w A01 = A01(z10, z11, 2);
        this.A08 = true;
        this.A02++;
        this.A0E.A0z(interfaceC0897Eq, z10, z11);
    ...
    public final void AEV() {
        ...
        Log.i(A02(2, 13, 88), append.append(A02).append(IF.A04).append(A02).append(C07809m.A00()).append(A02(46, 1, 60)).toString());
        this.A0E.A0x();
