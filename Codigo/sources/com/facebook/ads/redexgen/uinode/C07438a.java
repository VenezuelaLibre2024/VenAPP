...
public final class C07438a {
    ...
    static {
        A06();
        A02 = C07438a.class.getSimpleName();
    ...
    public static long A01(C07277f c07277f, String str) {
        try {
            PackageManager packageManager = c07277f.getPackageManager();
            ...
            if (A03.compareAndSet(false, true)) {
                c07277f.A07().A9a(A02(144, 7, 117), C8A.A1E, new C8B(e10));
            }
            return -1L;
        }
    }
    ...
    public static String A05(C07277f c07277f, String str) {
        JSONObject jSONObject = new JSONObject();
        A07(c07277f, jSONObject, A02(174, 6, 127), String.valueOf(A08()));
        A07(c07277f, jSONObject, A02(97, 8, 52), String.valueOf(A01(c07277f, str)));
        A07(c07277f, jSONObject, A02(180, 15, 73), String.valueOf(A00()));
        A07(c07277f, jSONObject, A02(105, 18, 113), String.valueOf(AbstractC1032Ke.A01(c07277f)));
        A07(c07277f, jSONObject, A02(161, 13, 111), String.valueOf(A09(c07277f)));
        A07(c07277f, jSONObject, A02(133, 11, 61), A04(c07277f));
        A07(c07277f, jSONObject, A02(123, 10, 96), A03(c07277f));
        return jSONObject.toString();
    }

    public static void A07(C07277f c07277f, JSONObject jSONObject, String str, String str2) {
        try {
