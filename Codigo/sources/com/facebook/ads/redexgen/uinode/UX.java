...
public class UX implements NS {
    ...
    public UX(ViewOnClickListenerC0827Bi viewOnClickListenerC0827Bi) {
    ...
    public final void ACV(String str) {
        ...
        ViewOnClickListenerC0827Bi.A02(this.A00);
    }

    @Override // com.facebook.ads.redexgen.uinode.NS
    public final void ACn(int i10) {
        if (((UT) this.A00).A05) {
            ViewOnClickListenerC0827Bi viewOnClickListenerC0827Bi = this.A00;
            if (A02[6].length() == 8) {
            ...
            viewOnClickListenerC0827Bi.A0C.setProgress(i10);
        }
    }
