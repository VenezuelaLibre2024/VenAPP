...
public final class C1000Iv implements AudienceNetworkExportedActivityApi {
    ...
    public C1000Iv(Activity activity) {
        this.A00 = activity;
    }
    ...
    private boolean A03(C0999Iu c0999Iu) {
        String callingPackage = this.A00.getCallingPackage();
        if (callingPackage != null) {
            String callingPackage2 = c0999Iu.A03;
            if (callingPackage.equals(callingPackage2)) {
                return true;
            }
        }
        A02(12);
        if (c0999Iu.A00 instanceof C1464aT) {
            ((C1464aT) c0999Iu.A00).A0F().A0E().AEj();
        }
        if (c0999Iu.A00 instanceof C1461aQ) {
            ((C1461aQ) c0999Iu.A00).A0H().A0E().AEj();
            return false;
        }
        return false;
    }
    ...
    public final void onCreate(Bundle bundle) {
        C1399Yn A05 = C06785c.A05(this.A00, UUID.randomUUID().toString());
        ...
        C0999Iu A04 = VW.A00().A04(adId);
        AnonymousClass23 anonymousClass23 = A04 != null ? A04.A00 : null;
        if (A02[6].length() == 29) {
            A02[6] = "3hvfYctBGPg0BeMvR8jiqRXkEjCpv";
            if (A04 != null && (anonymousClass23 instanceof C1461aQ)) {
                if (!A03(A04)) {
                    return;
                }
                C1461aQ c1461aQ = (C1461aQ) anonymousClass23;
                c1461aQ.A0G().A02().A0I(this.A00);
                c1461aQ.A0M(this.A00.getIntent().getIntExtra(A00(0, 26, 86), -1), 0L);
            } else {
                if (A04 != null) {
                    boolean z10 = anonymousClass23 instanceof C1464aT;
                    if (A02[1].charAt(21) == 'i') {
                        ...
                        if (z10) {
                            ...
                            C1464aT c1464aT = (C1464aT) anonymousClass23;
                            c1464aT.A0E().A05().A0I(this.A00);
                            c1464aT.A0J();
                        }
                    }
                }
