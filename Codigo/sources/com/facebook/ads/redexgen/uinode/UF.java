...
public class UF implements L8 {
    ...
    public /* synthetic */ UF(UD ud2, UK uk2) {
        this(ud2);
    }
    ...
    public final void ACm(float f10) {
        ...
        boolean z13;
        AbstractC1502b5 abstractC1502b55;
        this.A00.A0O((int) f10);
        z10 = this.A00.A0V;
        if (!z10) {
            c05761c = this.A00.A0G;
            this.A00.A0W.setProgress(100.0f * (1.0f - (f10 / c05761c.A07())));
            return;
        }
        z11 = this.A00.A0B;
        if (z11) {
            abstractC1502b54 = this.A00.A0F;
            A03 = 1.0f - (f10 / abstractC1502b54.A0x().A0D().A02());
            z13 = this.A00.A0E;
            if (z13 || A03 < 1.0f) {
                this.A00.A0E = false;
                abstractC1502b55 = this.A00.A0F;
                String A022 = abstractC1502b55.A11().A02();
                String[] strArr = A02;
            ...
            A03 = 1.0f - (f10 / abstractC1502b5.A0x().A0D().A03());
        }
        this.A00.A0W.setProgress(100.0f * A03);
        abstractC1502b52 = this.A00.A0F;
        float A023 = abstractC1502b52.A0x().A0D().A02() - f10;
        abstractC1502b53 = this.A00.A0F;
        float percentageOfReward = abstractC1502b53.A0x().A0D().A03();
