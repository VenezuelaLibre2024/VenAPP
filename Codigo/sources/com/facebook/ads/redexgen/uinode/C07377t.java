...
public final class C07377t {
    ...
    public C07377t(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
        options.remove(null);
        this.A00 = num;
        this.A01 = num2;
    ...
    public C07377t(String[] strArr, Integer num, Integer num2) {
    ...
    public static C07377t A00(String str) {
        if (str == null) {
            return null;
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        ...
        return new C07377t(linkedHashSet, num, num2, str);
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C07377t)) {
            return false;
        }
        C07377t c07377t = (C07377t) obj;
        ...
        A06[0] = "YHhc40Na8nm";
        Integer num2 = c07377t.A00;
        if (num != num2 && (num == null || !num.equals(num2))) {
            return false;
        }
        Integer num3 = this.A01;
        Integer num4 = c07377t.A01;
        return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c07377t.A03);
    }
