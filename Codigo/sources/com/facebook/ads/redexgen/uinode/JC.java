...
public abstract class JC {
    ...
    public static void A05(C1399Yn c1399Yn, String str, long j10) {
        J2 adEventManager = c1399Yn.A09();
        JA ja2 = new JA(str, adEventManager);
        HashMap hashMap = new HashMap();
        hashMap.put(A00(24, 15, 47), C1057Lf.A06(j10));
        hashMap.put(A00(12, 12, 118), C1057Lf.A04(j10));
        ja2.A04(J9.A0D, hashMap);
    }

    public static void A06(C1399Yn c1399Yn, JSONObject jSONObject, long j10, String str) {
        ...
        if (TextUtils.isEmpty(str) && optJSONArray != null) {
            A07(c1399Yn, optJSONObject, A02(c1399Yn, optJSONArray), j10, null);
        } else {
            ...
            A07(c1399Yn, optJSONObject, map.get(str), j10, str);
        }
    }

    public static void A07(C1399Yn c1399Yn, JSONObject jSONObject, List<String> list, long j10, String str) {
        String A002 = A00(0, 2, 62);
        if (jSONObject.has(A002)) {
            String clientToken = jSONObject.optString(A002);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c1399Yn, clientToken, j10);
        }
    }
