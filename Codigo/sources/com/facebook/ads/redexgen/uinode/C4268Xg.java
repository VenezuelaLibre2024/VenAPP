...
public final class C4268Xg extends AbstractC2964C6 {
    ...
    public C4268Xg(InterfaceC2962C4 interfaceC2962C4) {
    ...
    public final void A0B(C3306Hz c3306Hz, long j10) throws C28319v {
        if (this.A00 == 2) {
            ...
            super.A00.AFR(c3306Hz, A042);
            super.A00.AFS(j10, 1, A042, 0, null);
            return;
        }
        int A0E = c3306Hz.A0E();
        if (A04[2].length() != 16) {
        ...
        A04[7] = "";
        if (A0E == 0 && !this.A01) {
            byte[] bArr = new byte[c3306Hz.A04()];
            c3306Hz.A0c(bArr, 0, bArr.length);
            Pair<Integer, Integer> audioParams = AbstractC3285He.A03(bArr);
        ...
        int A043 = c3306Hz.A04();
        super.A00.AFR(c3306Hz, A043);
        super.A00.AFS(j10, 1, A043, 0, null);
    }
    ...
    */
    public final boolean A0C(com.facebook.ads.redexgen.uinode.C3306Hz r18) throws com.facebook.ads.redexgen.uinode.C4264Xc {
        /*
            Method dump skipped, instructions count: 239
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4268Xg.A0C(com.facebook.ads.redexgen.X.Hz):boolean");
    }
}
