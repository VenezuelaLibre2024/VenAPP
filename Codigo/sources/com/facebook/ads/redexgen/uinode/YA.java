...
public final class YA<T> implements AnonymousClass97<T> {
    ...
    public YA(AnonymousClass94 anonymousClass94, C9C c9c) throws IOException {
        ...
        C07668y c07668y = new C07668y(new File(anonymousClass94.A05(), A00(509, 6, 70)));
        this.A04 = c07668y;
        this.A00 = c07668y.A03();
    ...
    private void A02(int i10, int i11) throws IOException {
        C07678z c07678z = new C07678z(i10, i11);
        this.A00 = c07678z;
        this.A04.A04(c07678z);
    }
            ...
            if (A06(yb2)) {
                ...
                if (this.A00.A04(yb2.A00().A02) == 0) {
                    try {
                        ...
                        throw new C9G(A00(361, 30, 93), e10);
                    }
                }
    ...
    */
            ...
            try {
                ...
                while (true) {
                    ...
                    if (A0A.A01().A03() == AnonymousClass90.A04) {
                        ...
                        this.A01 = new C07678z(storageOffset5 + 1, 0);
                    } else {
                ...
                if (!arrayList.isEmpty()) {
                    C07678z c07678z = yb2.A01().A02;
                    int storageOffset6 = yb2.A01().A01;
                    this.A01 = c07678z.A05(storageOffset6);
                }
            } catch (IOException e10) {
                throw new C9G(A00(306, 29, 79), e10);
            }
        } else {
    ...
    public final synchronized int A7n() throws C9G {
        ...
        if (!this.A03) {
            try {
                ...
                throw new C9G(A00(335, 26, 122), e10);
            }
        } else {
            throw new C9G(A00(427, 39, 68));
        }
    ...
    public final synchronized void AGb(byte[] bArr) throws C9G {
        if (!this.A03) {
            try {
                ...
                throw new C9G(A00(257, 25, 61), e10);
            }
        } else {
            throw new C9G(A00(427, 39, 68));
        }
    ...
    public final synchronized void clear() throws C9G {
        try {
            ...
            throw new C9G(A00(282, 24, 16), e10);
        }
    }
