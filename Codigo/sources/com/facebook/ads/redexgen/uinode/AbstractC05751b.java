...
public abstract class AbstractC05751b {
    ...
    public static C05801g A01(JSONObject jSONObject) {
        return new C05791f().A06(A0A(jSONObject)).A07(A0B(jSONObject)).A05(A05(jSONObject)).A04(A04(jSONObject)).A08();
    }
