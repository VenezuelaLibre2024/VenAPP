...
public final class C1546bn implements AnonymousClass00 {
    ...
    private File A02(AnonymousClass06 anonymousClass06, String str, String str2, int i10, AnonymousClass09 anonymousClass09) {
        ...
        try {
            ...
            C1542bj c1542bj2 = new C1542bj(file, new GG(C0988Ih.A0N(this.A05)));
            if (c1542bj2.A09()) {
                if (this.A08) {
                    String str4 = A03(49, 22, 106) + c1542bj2.A00.getName();
                }
            ...
            if (this.A08) {
                String str5 = A03(71, 26, 117) + c1542bj2.A00.getName();
            }
            ...
            while (true) {
                ...
                try {
                    A05(this.A05, c1542bj2, str3, i10, i11, currentTimeMillis);
                    break;
                } catch (C0H e11) {
                    e = e11;
                    if (i11 == this.A00 - 1) {
                        A06(c1542bj);
                        if (e instanceof C1543bk) {
                            throw ((C1543bk) e);
                        }
                        if (e instanceof C1540bh) {
                            throw ((C1540bh) e);
                        }
                    }
                    i11++;
            ...
            this.A04.AEP(AEP2, 2113, e12.toString(), null, null, anonymousClass063);
            if (!this.A08) {
                return null;
            }
            Log.e(A0B, A03, e12);
            ...
            this.A04.AEP(AEP, 2119, e13.toString(), null, null, anonymousClass062);
            if (!this.A08) {
                return null;
            }
            Log.e(A0B, A03, e13);
    ...
    static {
        A04();
        A0B = C1546bn.class.getSimpleName();
    }

    public C1546bn(C07277f c07277f, AnonymousClass08 anonymousClass08, C0L c0l) {
        this.A05 = c07277f;
    ...
    public static C1544bl A00(Context context, String str) throws C0H {
        try {
            ...
            while (true) {
                ...
                if (read != -1) {
                    ...
                    return new C1544bl(byteArrayOutputStream.toByteArray());
                }
            }
    ...
    */
    private void A05(android.content.Context r24, com.facebook.ads.redexgen.uinode.C1542bj r25, java.lang.String r26, int r27, int r28, long r29) throws com.facebook.ads.redexgen.uinode.C0H {
        /*
            Method dump skipped, instructions count: 578
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1546bn.A05(android.content.Context, com.facebook.ads.redexgen.X.bj, java.lang.String, int, int, long):void");
    }

    private void A06(C1542bj c1542bj) {
        try {
            File A04 = c1542bj.A04();
            if (A04.exists()) {
                c1542bj.A06();
    ...
    private boolean A07(C1542bj c1542bj) {
        try {
            c1542bj.A05();
            return true;
        } catch (C1540bh e10) {
    ...
    public final AnonymousClass02<Bitmap> AFH(AnonymousClass06 anonymousClass06, boolean z10) {
        return A08(anonymousClass06, new AnonymousClass09(new C1549bq(anonymousClass06.A01, anonymousClass06.A00, this.A02.A04(), this.A02.A03(), z10)));
    }
    ...
    public final File AFI(AnonymousClass06 anonymousClass06) {
        AnonymousClass09 anonymousClass09 = new AnonymousClass09(new C1548bp());
    ...
    public final String AFJ(AnonymousClass06 anonymousClass06) {
        return (String) A08(anonymousClass06, new AnonymousClass09(new C1547bo())).A00();
    }
    ...
    public final String AFK(AnonymousClass06 anonymousClass06) {
        AnonymousClass09 anonymousClass09 = new AnonymousClass09(new C1547bo());
        anonymousClass09.A01(true);
        anonymousClass09.A02(false);
