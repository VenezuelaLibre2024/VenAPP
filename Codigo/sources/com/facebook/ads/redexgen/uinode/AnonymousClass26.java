...
public final class AnonymousClass26 {
    ...
    public AnonymousClass26(C1399Yn c1399Yn, InterstitialAd interstitialAd, String str) {
        this(c1399Yn, interstitialAd, str, new C1470aZ());
    }

    public AnonymousClass26(C1399Yn c1399Yn, InterstitialAd interstitialAd, String str, C8Z c8z) {
        this.A0A = c1399Yn;
        this.A0B = str;
    ...
    public final void A0D(InterstitialAd interstitialAd) {
        if (interstitialAd == null && !C0988Ih.A0p(this.A0A)) {
            return;
        }
        this.A01 = interstitialAd;
    }
