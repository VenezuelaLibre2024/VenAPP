...
public class C3824QS {
    ...
    public int A00;
    public int A01;
    public InterfaceC3811QF A02;
    public String A03;
    public boolean A04;
    public final C4424aF A05;
    public final C4337Yn A06;
    public final InterfaceC3369J2 A07;
    public final InterfaceC3810QE A08;
    public final InterfaceC3816QK A09;
    public final C3817QL A0A;
     ...
     */
    public C3824QS(C4337Yn c4337Yn, InterfaceC3369J2 interfaceC3369J2, InterfaceC3810QE interfaceC3810QE, List<AbstractC23842P> list, String str, boolean z10, Bundle bundle, Map<String, String> map, InterfaceC3816QK interfaceC3816QK) {
        this.A0B = new Object();
        this.A01 = 0;
        this.A00 = 0;
        this.A03 = null;
        ...
        this.A08 = interfaceC3810QE;
        this.A0C = str;
        this.A0D = map;
        this.A04 = z10;
        this.A09 = interfaceC3816QK;
        list.add(new C3826QU(this, 0.5d, -1.0d, 2.0d, true));
        list.add(new C3825QT(this, 1.0E-7d, -1.0d, 0.001d, false));
        if (bundle != null) {
            this.A05 = new C4424aF(list, bundle.getBundle(A0F(6, 16, 29)), interfaceC3816QK);
            this.A01 = bundle.getInt(A0F(57, 18, 2));
            this.A00 = bundle.getInt(A0F(39, 18, 44));
        } else {
            this.A05 = new C4424aF(list, interfaceC3816QK);
        }
        this.A0A = new C3817QL(new Handler(), this);
    }
    ...
    public C3824QS(C4337Yn c4337Yn, InterfaceC3369J2 interfaceC3369J2, InterfaceC3810QE interfaceC3810QE, List<AbstractC23842P> list, String str, boolean z10, Bundle bundle, InterfaceC3816QK interfaceC3816QK) {
        this(c4337Yn, interfaceC3369J2, interfaceC3810QE, list, str, z10, bundle, null, interfaceC3816QK);
    }

    public C3824QS(C4337Yn c4337Yn, InterfaceC3369J2 interfaceC3369J2, InterfaceC3810QE interfaceC3810QE, List<AbstractC23842P> list, String str, boolean z10, InterfaceC3816QK interfaceC3816QK) {
        this(c4337Yn, interfaceC3369J2, interfaceC3810QE, list, str, z10, null, interfaceC3816QK);
    }

    private final float A0E() {
        return AbstractC3533Ll.A00(this.A06) * this.A08.getVolume();
    }

    private Map<String, String> A0H(int i10) {
        HashMap<String, String> hashMap = new HashMap<>();
        AbstractC3533Ll.A03(hashMap, this.A08.getVideoStartReason() == EnumC3818QM.A02, !this.A08.A95());
        A0T(hashMap);
        A0S(hashMap);
        A0V(hashMap, i10);
        A0U(hashMap);
    ...
    public Map<String, String> A0I(EnumC3812QG enumC3812QG) {
        return A0J(enumC3812QG, this.A08.getCurrentPositionInMillis());
    }

    private Map<String, String> A0J(EnumC3812QG enumC3812QG, int i10) {
        Map<String, String> A0H = A0H(i10);
        A0H.put(A0F(0, 6, 122), String.valueOf(enumC3812QG.A00));
        return A0H;
    }

    private void A0L() {
        A0Q(this.A0C, A0I(EnumC3812QG.A04));
    }

    private void A0M() {
        A0Q(this.A0C, A0I(EnumC3812QG.A0A));
    }
    ...
    private final void A0O(int i10, boolean z10, boolean z11) {
        ...
        if (i10 > i11) {
            ...
            if (z11 || i10 - this.A00 >= 5000) {
                A0Q(this.A0C, A0J(EnumC3812QG.A09, i10));
                if (A0F[5].length() == 0) {
    ...
    public void A0Q(String str, Map<String, String> data) {
        ...
        InterfaceC3811QF interfaceC3811QF = this.A02;
        if (interfaceC3811QF != null) {
            interfaceC3811QF.AC8();
        }
    }
    ...
    public final void A0Y() {
        A0Q(this.A0C, A0I(EnumC3812QG.A07));
    }

    public final void A0Z() {
        A0Q(this.A0C, A0I(EnumC3812QG.A08));
    }
    ...
    public final void A0d(int i10) {
        this.A05.A04();
        A0Q(this.A0C, A0I(EnumC3812QG.A05));
    ...
    public final void A0h(InterfaceC3811QF interfaceC3811QF) {
        this.A02 = interfaceC3811QF;
    }
}
