...
public final class C1360Xa implements CA {
    ...
    private double A00(InterfaceC0838Bt interfaceC0838Bt, int i10) throws IOException, InterruptedException {
        long A02 = A02(interfaceC0838Bt, i10);
        if (i10 == 4) {
    ...
    private long A01(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        interfaceC0838Bt.AFM();
        while (true) {
            interfaceC0838Bt.ADv(this.A06, 0, 4);
            int A00 = CH.A00(this.A06[0]);
            if (A00 != -1 && A00 <= 4) {
                int A01 = (int) CH.A01(this.A06, A00, false);
                if (this.A03.A96(A01)) {
                    interfaceC0838Bt.AGP(A00);
                    return A01;
                }
            }
    ...
    private long A02(InterfaceC0838Bt interfaceC0838Bt, int i10) throws IOException, InterruptedException {
        interfaceC0838Bt.readFully(this.A06, 0, i10);
        long j10 = 0;
    ...
    private String A04(InterfaceC0838Bt interfaceC0838Bt, int i10) throws IOException, InterruptedException {
        if (i10 == 0) {
            return A03(0, 0, 103);
        }
        byte[] bArr = new byte[i10];
        interfaceC0838Bt.readFully(bArr, 0, i10);
    ...
    @Override // com.facebook.ads.redexgen.uinode.CA
    public final boolean AEJ(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        long j10;
        int i10;
        ...
        while (true) {
            ...
            if (this.A01 == 0) {
                long A05 = this.A04.A05(interfaceC0838Bt, true, false, 4);
                if (A05 == -2) {
                    A05 = A01(interfaceC0838Bt);
                }
                if (A05 == -1) {
                    return false;
                }
            ...
            if (this.A01 == 1) {
                this.A02 = this.A04.A05(interfaceC0838Bt, false, true, 8);
                this.A01 = 2;
            }
            ...
            switch (A6s) {
                ...
                case 2:
                    long j11 = this.A02;
                    if (j11 <= 8) {
                        this.A03.A8t(this.A00, A02(interfaceC0838Bt, (int) j11));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C07889v(A03(41, 22, 116) + this.A02);
                case 3:
                    long j12 = this.A02;
                    if (j12 <= 2147483647L) {
                        this.A03.AGc(this.A00, A04(interfaceC0838Bt, (int) j12));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C07889v(A03(63, 21, 6) + this.A02);
                case 4:
                    this.A03.A42(this.A00, (int) this.A02, interfaceC0838Bt);
                    if (A08[7].charAt(2) != 'S') {
                ...
                case 5:
                    long j13 = this.A02;
                    if (j13 == 4 || j13 == 8) {
                        this.A03.A5j(this.A00, A00(interfaceC0838Bt, (int) j13));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C07889v(A03(21, 20, 43) + this.A02);
                default:
                    throw new C07889v(A03(0, 21, 11) + A6s);
            }
        }
    }
