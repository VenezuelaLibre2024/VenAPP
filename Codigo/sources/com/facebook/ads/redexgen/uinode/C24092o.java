...
public final class C24092o {
    public static C24092o A05;
    public static byte[] A06;
    public static final Object A07;
    public final Context A00;
    public final Handler A01;
    public final HashMap<BroadcastReceiver, ArrayList<C24082n>> A04 = new HashMap<>();
    public final HashMap<String, ArrayList<C24082n>> A03 = new HashMap<>();
    public final ArrayList<C24072m> A02 = new ArrayList<>();
    ...
    public C24092o(Context context) {
        this.A00 = context;
    ...
    public static C24092o A00(Context context) {
        C24092o c24092o;
        synchronized (A07) {
            if (A05 == null) {
                A05 = new C24092o(context.getApplicationContext());
            }
            c24092o = A05;
        }
        return c24092o;
    ...
    */
    public void A02() {
        ...
        L0:
            ...
            goto L44
        Ld:
            com.facebook.ads.redexgen.X.2m[] r7 = new com.facebook.ads.redexgen.uinode.C24072m[r0]     // Catch: java.lang.Throwable -> L45
            java.util.ArrayList<com.facebook.ads.redexgen.X.2m> r0 = r8.A02     // Catch: java.lang.Throwable -> L45
        ...
        L27:
            ...
            com.facebook.ads.redexgen.X.2n r1 = (com.facebook.ads.redexgen.uinode.C24082n) r1
            boolean r0 = r1.A01
            if (r0 != 0) goto L3e
        ...
        L45:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24092o.A02():void");
    }

    public final void A05(BroadcastReceiver broadcastReceiver) {
        synchronized (this.A04) {
            ArrayList<C24082n> remove = this.A04.remove(broadcastReceiver);
            if (remove == null) {
                return;
            }
            for (int size = remove.size() - 1; size >= 0; size--) {
                C24082n c24082n = remove.get(size);
                c24082n.A01 = true;
                for (int j10 = 0; j10 < c24082n.A03.countActions(); j10++) {
                    String action = c24082n.A03.getAction(j10);
                    ArrayList<C24082n> arrayList = this.A03.get(action);
                    if (arrayList != null) {
                        int i10 = arrayList.size();
                        for (int i11 = i10 - 1; i11 >= 0; i11--) {
                            C24082n c24082n2 = arrayList.get(i11);
                            if (c24082n2.A02 == broadcastReceiver) {
                                c24082n2.A01 = true;
    ...
    public final void A06(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.A04) {
            C24082n c24082n = new C24082n(intentFilter, broadcastReceiver);
            ArrayList<C24082n> arrayList = this.A04.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList<>(1);
                this.A04.put(broadcastReceiver, arrayList);
            }
            arrayList.add(c24082n);
            for (int i10 = 0; i10 < intentFilter.countActions(); i10++) {
                String action = intentFilter.getAction(i10);
                ArrayList<C24082n> arrayList2 = this.A03.get(action);
                if (arrayList2 == null) {
                    arrayList2 = new ArrayList<>(1);
                    this.A03.put(action, arrayList2);
                }
                arrayList2.add(c24082n);
            }
        }
    }
    ...
    public final boolean A07(Intent intent) {
        ...
        synchronized (this.A04) {
            ...
            if (debug) {
                ...
                String type = A01(RecognitionOptions.ITF, 15, 14);
            ...
            HashMap<String, ArrayList<C24082n>> hashMap = this.A03;
            String type4 = intent.getAction();
            ArrayList<C24082n> arrayList = hashMap.get(type4);
            if (arrayList != null) {
                if (debug) {
                ...
                for (int i10 = 0; i10 < arrayList.size(); i10++) {
                    C24082n c24082n = arrayList.get(i10);
                    if (debug) {
                        StringBuilder sb4 = new StringBuilder();
                        String type6 = A01(104, 24, 48);
                        sb4.append(type6).append(c24082n.A03).toString();
                    }
                    if (!c24082n.A00) {
                        int match = c24082n.A03.match(action, resolveTypeIfNeeded, action2, data, categories, A01(83, 21, 127));
                        if (match >= 0) {
                            if (debug) {
                ...
                if (arrayList2 != null) {
                    for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                        ((C24082n) arrayList2.get(i11)).A00 = false;
                    }
                    this.A02.add(new C24072m(intent, arrayList2));
