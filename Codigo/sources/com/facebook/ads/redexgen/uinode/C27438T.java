...
public final class C27438T {
     ...
     */
    public C27438T(Map<String, String> map) {
        char c10;
        this.A01 = -1;
        this.A00 = -1;
        this.A0B = A0G;
        ...
        this.A06 = ModuleDescriptor.MODULE_VERSION;
        this.A07 = 200;
        this.A02 = 3600;
        this.A0D = false;
    ...
    static {
        A02();
        A0H = C27438T.class.getSimpleName();
        A0G = AdPlacementType.UNKNOWN;
    }

    public static C27438T A00(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
