...
public enum EnumC3372J5 {
    ...
    A0N(A01(635, 25, 113)),
    A0O(A01(660, 20, 107)),
    A0F(A01(RecognitionOptions.UPC_A, 37, 57)),
    A0E(A01(500, 12, 14)),
    A0Q(A01(694, 5, 109)),
    A0J(A01(576, 16, 59)),
    A0K(A01(592, 9, 70)),
    ...
    EnumC3372J5(String str) {
        this.A00 = str;
    }

    public static EnumC3372J5 A00(String str) {
        for (EnumC3372J5 enumC3372J5 : values()) {
            if (enumC3372J5.A00.equalsIgnoreCase(str)) {
                return enumC3372J5;
            }
        }
        String[] strArr = A02;
