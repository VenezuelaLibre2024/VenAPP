...
public final class FT extends AbstractC1502b5 {
    ...
    public static FT A02(JSONObject jSONObject, C1399Yn c1399Yn) {
        FT ft = new FT(AbstractC1502b5.A08(jSONObject, c1399Yn, new C1498b1()));
        ft.A16(jSONObject);
        ft.A0b(A03(0, 6, 46));
        return ft;
    }
