...
public abstract class OM {
    ...
    public static OL A00(OP op, Bundle bundle, boolean z10) {
        ...
        AbstractC05560h A003 = C05570i.A00(op.A05(), op.A06(), A01(0, 0, 67), AbstractC1050Ky.A00(op.A04().A0x().A0F().A05()), new HashMap(), op.A04().A0y());
        boolean z11 = !TextUtils.isEmpty(A0x.A0D().A08());
        if (C0988Ih.A1W(op.A05())) {
            op.A05().A0A().AGv(op.A02(), op.A04().A12(), z11);
        }
        boolean A03 = A03(op, z11);
        if ((A0N && (A003 instanceof C0911Fe)) || A03) {
            c1262Tc = new TT(op, A03);
        } else if (z11) {
            c1262Tc = new BI(op);
        } else if (!z11 && C0988Ih.A2A(op.A05())) {
            c1262Tc = new BJ(op, A06);
        } else if (!A06) {
            c1262Tc = new C1262Tc(op, OI.A04(A002));
        } else {
            int A004 = op.A00();
            if (A01[2].length() != 3) {
            ...
            A01[6] = "JelR9";
            c1262Tc = new C1265Tf(op, A004 == 2);
        }
        if (z10) {
            c1262Tc.A10(A0x, op.A04().A12(), A002, bundle);
        }
        return c1262Tc;
    }
    ...
    public static boolean A03(OP op, boolean z10) {
        ...
        Uri A002 = AbstractC1050Ky.A00(op.A04().A0x().A0F().A05());
