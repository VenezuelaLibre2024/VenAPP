...
public abstract class PE {
     ...
     */
    public static WebResourceResponse A00(C1399Yn c1399Yn, WebResourceRequest webResourceRequest, Uri uri, String str, HashMap<String, String> hashMap) throws IOException {
        String A02 = A02(85, 5, 49);
        C1320Vj A0F = R0.A05(c1399Yn.A01()).A0F(c1399Yn);
        C07046c.A0H(c1399Yn, uri.toString());
        try {
            PF pf2 = new PF(c1399Yn.A01(), uri, A0F);
            int available = pf2.available();
            if (available <= 0) {
                A05(c1399Yn, 1, new Pair[]{new Pair(A02(61, 9, 77), String.valueOf(available))});
                return null;
            }
            ...
            try {
                ...
                A05(c1399Yn, 3, new Pair[]{new Pair(A02, e10.toString())});
                return null;
            }
        } catch (IOException e11) {
            A05(c1399Yn, 2, new Pair[]{new Pair(A02, e11.toString())});
            return null;
        }
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 8 out of bounds for length 8
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static void A05(C1399Yn c1399Yn, int i10, Pair<String, String>[] pairArr) {
        ...
        c1399Yn.A0E().A5N(jSONObject.toString());
    }
