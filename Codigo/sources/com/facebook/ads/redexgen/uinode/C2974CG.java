...
public final class C2974CG {
    ...
    public int A00;
    public final C3306Hz A01 = new C3306Hz(8);
    ...
    */
    private long A00(com.facebook.ads.redexgen.uinode.InterfaceC2951Bt r6) throws java.io.IOException, java.lang.InterruptedException {
        /*
            r5 = this;
        ...
        L3f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C2974CG.A00(com.facebook.ads.redexgen.X.Bt):long");
    }

    public final boolean A01(InterfaceC2951Bt interfaceC2951Bt) throws IOException, InterruptedException {
        ...
        int i10 = (int) j10;
        interfaceC2951Bt.ADv(this.A01.A00, 0, 4);
        ...
        while (true) {
            if (tag != 440786851) {
                ...
                interfaceC2951Bt.ADv(this.A01.A00, 0, 1);
                tag = ((tag << 8) & (-256)) | (this.A01.A00[0] & 255);
            } else {
                long A00 = A00(interfaceC2951Bt);
                long j11 = this.A00;
                if (A00 == Long.MIN_VALUE || (A7I != -1 && j11 + A00 >= A7I)) {
                    return false;
                }
                while (true) {
                    int i11 = this.A00;
                    if (i11 >= j11 + A00) {
                        return ((long) i11) == j11 + A00;
                    }
                    long A002 = A00(interfaceC2951Bt);
                    ...
                    long A003 = A00(interfaceC2951Bt);
                    if (A003 < 0) {
                        break;
                    }
                    if (A02[5].charAt(8) != 'M') {
