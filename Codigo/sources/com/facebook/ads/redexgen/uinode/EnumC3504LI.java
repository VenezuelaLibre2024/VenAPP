...
public enum EnumC3504LI {
    ...
    EnumC3504LI(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    public static EnumC3504LI A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC3504LI enumC3504LI : values()) {
            if (enumC3504LI.A01 == nativeComponentTag) {
                return enumC3504LI;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC3504LI internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC3504LI enumC3504LI) {
        if (view != null && enumC3504LI != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC3504LI);
        }
    }
