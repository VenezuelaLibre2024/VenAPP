...
public class C4398Zn extends AbstractC254351 {
    ...
    private final int A03(View view, int i10) {
        ...
        return A0N(A08.A0o(view) - c25314p.topMargin, A08.A0j(view) + c25314p.bottomMargin, A08.A0g(), A08.A0X() - A08.A0d(), i10);
    }
    ...
    public int A0O(View view, int i10) {
        ...
        C25314p c25314p = (C25314p) view.getLayoutParams();
        return A0N(A08.A0k(view) - c25314p.leftMargin, A08.A0n(view) + c25314p.rightMargin, A08.A0e(), A08.A0h() - A08.A0f(), i10);
    }

    public C4398Zn(Context context) {
    ...
    private final void A07(C25414z c25414z) {
        PointF A0P = A0P(A07());
        ...
        int time = (int) (A0L(ModuleDescriptor.MODULE_VERSION) * 1.2f);
        c25414z.A04((int) (this.A00 * 1.2f), (int) (this.A01 * 1.2f), time, this.A05);
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC254351
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC254351
    public final void A0H(int i10, int i11, C254553 c254553, C25414z c25414z) {
        if (A06() == 0) {
            A09();
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC254351
    public void A0I(View view, C254553 c254553, C25414z c25414z) {
        ...
        if (time > 0) {
            int distance = -A0O;
            int dy2 = -A03;
            c25414z.A04(distance, dy2, time, this.A04);
        }
    }
    ...
    public PointF A0P(int i10) {
        Object A08 = A08();
        if (A08 instanceof InterfaceC254250) {
            return ((InterfaceC254250) A08).A4O(i10);
        }
        Log.w(A04(0, 20, 70), A04(20, 93, 111) + InterfaceC254250.class.getCanonicalName());
        return null;
    }
}
