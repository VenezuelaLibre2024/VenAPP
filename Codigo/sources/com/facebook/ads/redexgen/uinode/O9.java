...
public final class O9 extends LinearLayout {
    ...
    public O9(C1399Yn c1399Yn, C1P c1p, boolean z10, int i10, int i11, int i12) {
        super(c1399Yn);
        setOrientation(1);
        TextView textView = new TextView(c1399Yn);
        this.A02 = textView;
        AbstractC1066Lo.A0X(textView, true, i10);
        textView.setEllipsize(TextUtils.TruncateAt.END);
        int i13 = A08;
        textView.setLineSpacing(i13, 1.0f);
        TextView textView2 = new TextView(c1399Yn);
        this.A01 = textView2;
        TextView textView3 = new TextView(c1399Yn);
        this.A00 = textView3;
        AbstractC1066Lo.A0X(textView3, false, i11);
        textView3.setEllipsize(TextUtils.TruncateAt.END);
        textView3.setLineSpacing(i13, 1.0f);
        boolean A0y = C0988Ih.A0y(c1399Yn);
        this.A03 = A0y;
        int i14 = A0y ? -2 : -1;
    ...
    */
    public O9(com.facebook.ads.redexgen.uinode.C1399Yn r8, com.facebook.ads.redexgen.uinode.C1P r9, boolean r10, boolean r11, boolean r12) {
        /*
            r7 = this;
            if (r11 == 0) goto L19
            r4 = 18
    ...
    public void setCTAClickListener(ViewOnClickListenerC1271Tl viewOnClickListenerC1271Tl) {
        OH A03 = OI.A03(viewOnClickListenerC1271Tl, A00(0, 9, 57));
