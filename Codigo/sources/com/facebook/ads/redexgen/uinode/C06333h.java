...
public class C06333h extends ViewGroup {
    ...
    public static final C06323g A0w;
        ...
        while (true) {
            if (i14 >= childCount) {
                ...
                for (int i15 = 0; i15 < childCount2; i15++) {
                    ...
                    if (childAt.getVisibility() != 8 && ((c06263a = (C06263a) childAt.getLayoutParams()) == null || !c06263a.A05)) {
                        float f10 = paddingLeft;
                        String[] strArr = A0t;
                        if (strArr[4].length() == strArr[5].length()) {
                            A0t[1] = "11cm9STM7FlxGR3";
                            childAt.measure(View.MeasureSpec.makeMeasureSpec((int) (f10 * c06263a.A00), 1073741824), this.A0A);
                        }
                    }
                }
                return;
            ...
            if (childAt2.getVisibility() != 8) {
                C06263a c06263a2 = (C06263a) childAt2.getLayoutParams();
                if (A0t[1].length() == 12) {
                    break;
                }
                String[] strArr2 = A0t;
                strArr2[4] = "";
                strArr2[5] = "";
                if (c06263a2 != null && c06263a2.A05) {
                    int i16 = c06263a2.A04 & 7;
                    int i17 = c06263a2.A04 & 112;
                    ...
                    if (c06263a2.width != -2) {
                        i18 = 1073741824;
                        i12 = c06263a2.width != -1 ? c06263a2.width : paddingLeft;
                    } else {
                        i12 = paddingLeft;
                    }
                    if (c06263a2.height != -2) {
                        i19 = 1073741824;
                        if (c06263a2.height != -1) {
                            i13 = c06263a2.height;
                            if (A0t[1].length() != 12) {
    ...
    static {
        ...
        A0w = new Comparator<View>() { // from class: com.facebook.ads.redexgen.X.3g
            ...
            public final int compare(View view, View view2) {
                C06263a c06263a = (C06263a) view.getLayoutParams();
                C06263a c06263a2 = (C06263a) view2.getLayoutParams();
                if (c06263a.A05 != c06263a2.A05) {
                    return c06263a.A05 ? 1 : -1;
                }
                return c06263a.A02 - c06263a2.A02;
            }
        };
    }

    public C06333h(Context context) {
        super(context);
    ...
    */
    private final com.facebook.ads.redexgen.uinode.C3Z A04(int r4) {
        ...
        L19:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.A04(int):com.facebook.ads.redexgen.X.3Z");
    }
    ...
    */
    private final com.facebook.ads.redexgen.uinode.C3Z A07(android.view.View r5) {
        ...
        L1f:
            r3 = 0
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C06333h.A0t
            r0 = 4
            r1 = r2[r0]
            r0 = 5
            r0 = r2[r0]
        ...
        L38:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.A07(android.view.View):com.facebook.ads.redexgen.X.3Z");
    }
    ...
    */
    private void A0A() {
        ...
        L1:
            ...
            com.facebook.ads.redexgen.X.3a r0 = (com.facebook.ads.redexgen.uinode.C06263a) r0
            boolean r0 = r0.A05
            if (r0 != 0) goto L1a
            r2.removeViewAt(r1)
            int r1 = r1 + (-1)
        ...
        L1d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.A0A():void");
    }
    ...
    private final void A0D() {
        ...
        C3T.A0B(this, new C1435Zz(this));
        if (C3T.A00(this) == 0) {
            C3T.A09(this, 1);
        }
        C3T.A0C(this, new C1436a0(this));
    }

    private void A0E(int i10) {
        List<InterfaceC06283c> list = this.A0d;
        if (list != null) {
            int i11 = list.size();
        ...
        if (startPos == this.A0G) {
            ...
            if (A0t[2].length() != 14) {
                ...
                for (int i18 = 0; i18 < N2; i18++) {
                    ...
                    C06263a c06263a = (C06263a) childAt.getLayoutParams();
                    c06263a.A01 = i18;
                    if (!c06263a.A05 && c06263a.A00 == 0.0f) {
                        C3Z A07 = A07(childAt);
                        String[] strArr7 = A0t;
    ...
    private final void A0I(int childLeft, float f10, int i10) {
        ...
        if (0 != 0) {
            ...
            for (int i12 = 0; i12 < childCount2; i12++) {
                ...
                if (!((C06263a) childAt2.getLayoutParams()).A05) {
                    childAt2.getLeft();
                    getClientWidth();
    ...
    */
    private final void A0O(int r7, boolean r8, boolean r9, int r10) {
        ...
        L91:
            ...
            goto L90
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.A0O(int, boolean, boolean, int):void");
    }
    ...
    */
    private void A0Q(com.facebook.ads.redexgen.uinode.C3Z r13, int r14, com.facebook.ads.redexgen.uinode.C3Z r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.A0Q(com.facebook.ads.redexgen.X.3Z, int, com.facebook.ads.redexgen.X.3Z):void");
    }
    ...
    */
    public final void A0e() {
        ...
        L7d:
            ...
            java.util.Comparator<com.facebook.ads.redexgen.X.3Z> r0 = com.facebook.ads.redexgen.uinode.C06333h.A0x
        ...
        L8b:
            ...
            com.facebook.ads.redexgen.X.3a r1 = (com.facebook.ads.redexgen.uinode.C06263a) r1
            boolean r0 = r1.A05
            if (r0 != 0) goto L9e
            r0 = 0
            r1.A00 = r0
        ...
        La1:
            r11.A0N(r6, r4, r5)
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C06333h.A0t
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 14
        ...
        Lbc:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.A0e():void");
    }
    ...
    */
    public final void addFocusables(java.util.ArrayList<android.view.View> r7, int r8, int r9) {
        ...
        L57:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.addFocusables(java.util.ArrayList, int, int):void");
    }
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        C06263a c06263a = (C06263a) layoutParams;
        c06263a.A05 |= A0c(view);
        if (this.A0h) {
            if (c06263a == null || !c06263a.A05) {
                c06263a.A03 = true;
                if (A0t[2].length() == 14) {
                    throw new RuntimeException();
                }
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C06263a) && super.checkLayoutParams(layoutParams);
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.draw(android.graphics.Canvas):void");
    }
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new C06263a(getContext(), attributeSet);
    }
    ...
    public final int getChildDrawingOrder(int i10, int i11) {
        ...
        int index = ((C06263a) this.A0b.get(result).getLayoutParams()).A01;
        return index;
    }
            ...
            if (count2 == str2.length()) {
                ...
                if (i15 < paddingLeft) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        C06263a c06263a = (C06263a) childAt.getLayoutParams();
                        if (c06263a.A05) {
                            int count3 = c06263a.A04 & 7;
                            int childTop = c06263a.A04 & 112;
                            switch (count3) {
                                case 1:
                    ...
                    while (i19 < paddingLeft) {
                        ...
                        if (childAt2.getVisibility() != i16) {
                            C06263a c06263a2 = (C06263a) childAt2.getLayoutParams();
                            if (!c06263a2.A05 && (A07 = A07(childAt2)) != null) {
                                int childWidth = scrollX + ((int) (paddingRight2 * A07.A00));
                                if (c06263a2.A03) {
                                    c06263a2.A03 = false;
                                    int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (paddingRight2 * c06263a2.A00), 1073741824);
    ...
    */
    public void setAdapter(com.facebook.ads.redexgen.uinode.C3E r7) {
        ...
        L9c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06333h.setAdapter(com.facebook.ads.redexgen.X.3E):void");
    }
    ...
    @Deprecated
    public void setOnPageChangeListener(InterfaceC06283c interfaceC06283c) {
        this.A0Y = interfaceC06283c;
    }
    ...
    public void setPageMarginDrawable(int i10) {
        setPageMarginDrawable(AbstractC06102k.A00(getContext(), i10));
    }
