...
public final class RunnableC3291Hk implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public RunnableC3291Hk(Handler handler) {
        this.A04 = handler;
    }
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new C3289Hi(AbstractC3322IF.A0P(A04(0, 67, 61), Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static EGLSurface A03(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i10) {
        ...
        if (i10 == 1) {
            ...
            if (eglCreatePbufferSurface == null) {
                throw new C3289Hi(A04(90, 30, 107));
            }
        }
        if (!EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eGLContext)) {
            throw new C3289Hi(A04(160, 21, 80));
        }
    ...
    public static void A06(int[] iArr) {
        ...
        if (glGetError == 0) {
            ...
            throw new C3289Hi(A04(181, 29, 20) + Integer.toHexString(glGetError));
        }
    }

    public final SurfaceTexture A07() {
        return (SurfaceTexture) AbstractC3281Ha.A01(this.A00);
    }
