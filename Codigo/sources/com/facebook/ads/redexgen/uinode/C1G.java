...
public final class C1G implements Serializable {
    ...
    public static C1G A00(JSONObject jSONObject) {
        ...
        C1I A0I = new C1I().A0J(jSONObject.optString(A01(496, 9, 21))).A0H(jSONObject.optLong(A01(472, 24, 61), -1L)).A0D(optInt).A0C(jSONObject.optInt(A01(274, 18, 10), a.e.API_PRIORITY_OTHER)).A0I(C05761c.A01(jSONObject));
