...
public final class C1519bM implements InterfaceC05630p, InterfaceC05811h {
    ...
    private int A00() {
        ...
        EnumC1116Nm A02 = A02();
        if (A02 == EnumC1116Nm.A06) {
            return -1;
        }
        if (A02 == EnumC1116Nm.A04) {
            switch (rotation) {
                case 2:
                case 3:
                    return 8;
    ...
    private void A06(Intent intent) {
        ...
        c05821i.A0I(intent, rewardData, Q7.A03(rewardData, this.A0A, this.A06));
    }

    private final void A07(C1399Yn c1399Yn, AnonymousClass10 anonymousClass10, C05951v c05951v, EnumSet<CacheFlag> enumSet, String str) {
        C05821i c05821i = new C05821i(c1399Yn, c05951v, this, str);
        C1F A0D = c05821i.A0D();
        if (C0988Ih.A0q(c1399Yn)) {
            boolean z10 = A0D instanceof AbstractC1502b5;
            String[] strArr = A0C;
            if (strArr[3].charAt(11) == strArr[7].charAt(11)) {
                A0C[2] = "TkuXboGIr4gI6uBXxoSPLVsF8oObr4N9";
                if (z10 && AbstractC05600l.A06(this.A05, AbstractC05600l.A01(c1399Yn, c05951v.A03(), ((AbstractC1502b5) A0D).A12()), c1399Yn.A09())) {
                    this.A05.A0E().A4K();
        ...
        this.A04 = c05821i;
        A08(c05821i.A0E());
        c05821i.A0J(c1399Yn, enumSet);
    }

    private void A08(KB kb2) {
        if (kb2.equals(KB.A04)) {
            this.A05.A0E().AGG(EnumC05530e.A04);
            return;
        }
        if (kb2.equals(KB.A0A)) {
            this.A05.A0E().AGG(EnumC05530e.A03);
            return;
        }
        if (kb2.equals(KB.A0B)) {
            this.A05.A0E().AGG(EnumC05530e.A0A);
            return;
        }
        if (kb2.equals(KB.A0D)) {
            this.A05.A0E().AGG(EnumC05530e.A0C);
            return;
        }
        if (kb2.equals(KB.A0C)) {
            this.A05.A0E().AGG(EnumC05530e.A0B);
            return;
        }
        ...
        if (this.A04.A0K()) {
            this.A05.A0E().AGG(EnumC05530e.A07);
        } else if ((A09() instanceof AbstractC1502b5) && this.A04.A0L((AbstractC1502b5) A09())) {
            this.A05.A0E().AGG(EnumC05530e.A09);
        } else {
            this.A05.A0E().AGG(EnumC05530e.A08);
        }
    }
    ...
    public final void A0A(C1399Yn c1399Yn, AnonymousClass10 anonymousClass10, C05951v c05951v, EnumSet<CacheFlag> enumSet, String str, String str2, RewardData rewardData) {
        this.A05 = c1399Yn;
        this.A02 = anonymousClass10;
        String A02 = c05951v.A02();
        this.A08 = A02;
        this.A06 = A02 != null ? A02.split(A03(107, 1, 19))[0] : A03(0, 0, 5);
        this.A00 = c05951v.A00();
        this.A07 = str2;
        this.A01 = rewardData;
        A07(c1399Yn, anonymousClass10, c05951v, enumSet, str);
    }
    ...
    public final boolean A0B() {
        ...
        AdActivityIntent A04 = C1037Kj.A04(this.A05);
