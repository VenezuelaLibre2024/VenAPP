...
public final class C05761c implements Serializable {
    ...
    public static final EnumC05771d A0F;
    public static final EnumC1116Nm A0G;
    public static final long serialVersionUID = -5352540123250859603L;
    public String A00;
    public final int A01;
    public final int A02;
    public final EnumC05771d A03;
    public final EnumC1116Nm A04;
    ...
    public C05761c(String str, String str2, int i10, String str3, String str4, EnumC1116Nm enumC1116Nm, int i11, boolean z10, boolean z11, EnumC05771d enumC05771d, boolean z12, String str5) {
        if (z12) {
            String uuid = UUID.randomUUID().toString();
            this.A08 = uuid;
            Uri uri = AbstractC1050Ky.A00(str).buildUpon().appendQueryParameter(A03(132, 11, 111), uuid).appendQueryParameter(A03(58, 12, 69), str5).build();
        ...
        this.A09 = str3;
        this.A05 = str4;
        this.A04 = enumC1116Nm;
        this.A02 = i11;
        this.A0B = z10;
        this.A0A = z11;
        this.A03 = enumC05771d;
        this.A0C = z12;
    }
    ...
    public static C05761c A01(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A03(198, 13, 62));
        if (optJSONObject == null) {
            return null;
        }
        return new C05761c(optJSONObject.optString(A03(282, 3, 72)), optJSONObject.optString(A03(143, 19, 61)), A00(jSONObject), A05(optJSONObject), A04(optJSONObject), A02(optJSONObject), optJSONObject.optInt(A03(285, 32, 0), 5000), optJSONObject.optBoolean(A03(103, 17, 87), true), optJSONObject.optBoolean(A03(88, 15, 37)), EnumC05771d.A00(optJSONObject.optString(A03(211, 17, 50), A0F.name())), optJSONObject.optBoolean(A03(162, 25, 111)), jSONObject.optString(A03(70, 2, 71)));
    }

    public static EnumC1116Nm A02(JSONObject jSONObject) {
        int orientation = jSONObject.optInt(A03(187, 11, 74), A0G.A03());
        return EnumC1116Nm.A00(orientation);
    }
    ...
    public final EnumC05771d A09() {
        return this.A03;
    }

    public final EnumC1116Nm A0A() {
        return this.A04;
    }
