...
public final class C1410Yy implements AnonymousClass66 {
    ...
    public final InterfaceC1217Rj A01;
    ...
    public C1410Yy(InterfaceC0964Hj interfaceC0964Hj) {
        InterfaceC1217Rj A4i = interfaceC0964Hj.A4i(EnumC1218Rk.A0B);
        this.A01 = A4i;
        A4i.A3R(new C1411Yz(this));
        A03();
    }
    ...
    public static Set<AnonymousClass69> A01(JSONObject jSONObject) {
        ...
        for (int i10 = 0; i10 < optJSONArray.length(); i10++) {
            ...
            if (optJSONObject == null || (A00 = C1409Yx.A00(optJSONObject)) == null) {
                return null;
            }
            hashSet.add(A00);
            if (A04[1].length() == 21) {
