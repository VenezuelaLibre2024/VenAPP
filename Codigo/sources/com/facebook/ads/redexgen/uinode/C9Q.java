...
public final class C9Q extends AbstractC1252Ss {
    ...
    public final AbstractC1174Ps A0E;
    public final AbstractC1143On A0F;
    public final O7 A0G;
    public final NX A0H;
    public final NQ A0I;
    public final C1048Kw A0J;
    public final KP A0K;
    ...
    public C9Q(C1399Yn c1399Yn, InterfaceC1087Mj interfaceC1087Mj, J2 j22, AbstractC1502b5 abstractC1502b5, C07046c c07046c, MC mc2) {
        super(c1399Yn, interfaceC1087Mj, j22, abstractC1502b5, c07046c, mc2);
        this.A09 = new C1241Sh(this);
        ...
        this.A0G = o72;
        AbstractC1143On abstractC1143On = new AbstractC1143On() { // from class: com.facebook.ads.redexgen.X.9U
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.uinode.AbstractC07618s
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        NQ nq = new NQ() { // from class: com.facebook.ads.redexgen.X.9T
            ...
            public final void A03(AnonymousClass93 anonymousClass93) {
                ...
                ol2 = C9Q.this.A00;
                ol2.A0C(anonymousClass93);
            }
        };
        this.A0I = nq;
        AbstractC1176Pu abstractC1176Pu = new AbstractC1176Pu() { // from class: com.facebook.ads.redexgen.X.9S
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.uinode.AbstractC07618s
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A03 = z10;
        AbstractC1066Lo.A0M(this, super.A01.A0w().A01().A07(true));
        if (C0988Ih.A1q(super.A03)) {
    ...
    private void A04() {
        this.A0B.postDelayed(new C1240Sg(this), C0988Ih.A0K(super.A03));
    }

    private void A05() {
        this.A0B.postDelayed(new C1239Sf(this), C0988Ih.A0L(super.A03));
    }
    ...
    public void A0E(AnonymousClass93 anonymousClass93) {
        if (this.A0B.getState() == RB.A02 && C0988Ih.A1D(super.A03)) {
            this.A0B.postDelayed(new C1242Si(this, anonymousClass93), 5000L);
        }
    }
    ...
    public void A0F(AnonymousClass93 anonymousClass93) {
        ...
        if (this.A03) {
            ...
            if (!ViewOnClickListenerC1271Tl.A08(super.A01)) {
                if (i10 > 0) {
