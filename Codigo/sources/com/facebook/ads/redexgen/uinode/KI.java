...
public final class KI implements InterfaceC1191Qj {
    public int A00;
    ...
    private ValueAnimator A00(int i10, int i11, View view) {
        ...
        ofInt.addUpdateListener(new C1194Qm(this, view));
        return ofInt;
    }
    ...
    public void A07(boolean z10) {
        if (z10) {
            ...
            this.A01 = A00;
            A00.addListener(new C1193Ql(this));
            this.A01.start();
            return;
        }
    ...
    public void A08(boolean z10) {
        ...
        if (z10) {
            ...
            this.A01 = A00;
            A00.addListener(new C1192Qk(this));
            this.A01.start();
            return;
        }
        ViewGroup.LayoutParams layoutParams = this.A05.getLayoutParams();
