...
public abstract class AbstractC0990Ik {
    ...
    public static int A00(Context context) {
        return C0988Ih.A0R(context).A2T(A03(0, 26, 62), ModuleDescriptor.MODULE_VERSION);
    }

    public static int A01(Context context) {
        return C0988Ih.A0R(context).A2T(A03(95, 25, 79), 30000);
    }

    public static long A02(Context context) {
        return C0988Ih.A0R(context).A2U(A03(41, 29, 34), 86400000L);
    }
    ...
    public static void A06(Context context) {
        C0988Ih.A0R(context).A2W(A03(26, 15, 15));
    }
    ...
    public static boolean A08(Context context) {
        return C0988Ih.A0R(context).A2Z(A03(120, 19, 2), true);
    }

    public static boolean A09(Context context) {
        return C0988Ih.A0R(context).A2Z(A03(139, 18, 41), true);
    }
    ...
    public static boolean A0B(Context context) {
        return C0988Ih.A0R(context).A2Z(A03(157, 22, 59), false);
    }

    public static boolean A0C(Context context) {
        return A0E(context) && C0988Ih.A0R(context).A2Z(A03(70, 25, 115), false);
    }
    ...
    public static boolean A0E(Context context) {
        return Build.VERSION.SDK_INT >= 21 && C0988Ih.A0R(context).A2Z(A03(26, 15, 15), false) && A0D(context) && !A0F(context, A02(context));
    }

    public static boolean A0F(Context context, long j10) {
        long lastUpdateTime = System.currentTimeMillis();
        long currentTime = C0988Ih.A0Q(context);
