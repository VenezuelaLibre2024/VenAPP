...
public final class SH extends FrameLayout implements QB {
    ...
    public SH(C1399Yn c1399Yn, NativeAd nativeAd, JR jr, JS js, O3 o32, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1399Yn);
        ArrayList<View> arrayList = new ArrayList<>();
        this.A07 = arrayList;
        this.A05 = nativeAd;
        this.A04 = mediaView;
        QC qc2 = new QC(c1399Yn, nativeAd, jr, o32, adOptionsView);
        this.A06 = qc2;
        int i10 = A0C;
    ...
    */
    ...
    private void A02(int i10) {
        AbstractC1066Lo.A0N(this.A04, i10 > A0B ? 0 : 8);
        AbstractC1066Lo.A0N(this.A03, i10 > A0A ? 0 : 8);
        AbstractC1066Lo.A0N(this.A00, i10 <= A09 ? 8 : 0);
    }

    public static void A03(int i10, int i11, TextView... textViewArr) {
        for (TextView textView : textViewArr) {
            if (textView != null && textView.getVisibility() == 0) {
                int A04 = AbstractC1066Lo.A04(textView, i11);
