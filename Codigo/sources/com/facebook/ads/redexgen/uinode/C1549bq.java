...
public final class C1549bq implements AnonymousClass03<Bitmap> {
    ...
    public final String A02 = C1549bq.class.getSimpleName();
    ...
    public C1549bq(int i10, int i11, boolean z10, boolean z11, boolean z12) {
        this.A01 = i10;
        this.A00 = i11;
        this.A05 = z10;
        this.A03 = z11;
    ...
    public final AnonymousClass02<Bitmap> A3M(File file, C0L c0l) {
        ...
        try {
            ...
            c0l.A9U(new C1543bk(A01(4, 14, 77)));
            return A00(null);
        } catch (Throwable t10) {
            file.delete();
            c0l.A9U(t10);
    ...
    @Override // com.facebook.ads.redexgen.uinode.AnonymousClass03
    public final void A4U(File file, C0L c0l) throws C1543bk {
        if (this.A03) {
            try {
                ...
                c0l.A9f(th2);
                Throwable t10 = new C1543bk(A01(18, 33, 49), th2);
                throw t10;
            }
        }
    }
