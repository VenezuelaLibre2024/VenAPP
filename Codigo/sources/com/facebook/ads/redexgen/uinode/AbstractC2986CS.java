...
public abstract class AbstractC2986CS {
    public static C2985CR A00(int i10, long[] jArr, int[] iArr, long j10) {
        int chunkSamplesRemaining = 8192 / i10;
        int i11 = 0;
        for (int i12 : iArr) {
            i11 += AbstractC3322IF.A04(i12, chunkSamplesRemaining);
        }
        ...
        return new C2985CR(jArr2, iArr2, originalSampleIndex, timestamps, flags, j10 * i13);
    }
}
