...
public class C4T {
    ...
    private final View A01(View view) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            C06664p c06664p = (C06664p) view3.getLayoutParams();
            if (view3 != view && !c06664p.A02()) {
                int A00 = c06664p.A00();
                int size2 = this.A01;
                int i12 = A00 - size2;
                int size3 = this.A03;
    ...
    private final void A02(View view) {
        ...
        if (closest == null) {
            ...
            this.A01 = ((C06664p) closest.getLayoutParams()).A00();
        }
    }

    public final View A03(C06724w c06724w) {
        if (this.A08 != null) {
            return A00();
        }
        View A0G = c06724w.A0G(this.A01);
        this.A01 += this.A03;
        return A0G;
    }
