...
public class C4455ak implements InterfaceC229710 {
    ...
    public final /* synthetic */ C3149FQ A00;
    ...
    public C4455ak(C3149FQ c3149fq, Runnable runnable) {
        this.A00 = c3149fq;
        this.A01 = runnable;
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC229710
    public final void ABl(C4493bM c4493bM, String str, boolean z10) {
        this.A00.A06.A0C();
        boolean z11 = !TextUtils.isEmpty(str);
        if (z10 && z11) {
            try {
                Intent intent = new Intent(A00(85, 26, 108));
                intent.setData(AbstractC3484Ky.A00(str));
                C3471Kj.A0C(this.A00.A0B, intent);
            } catch (C3469Kh e10) {
                ...
                this.A00.A0B.A07().A9a(A00(74, 11, 41), AbstractC27248A.A04, new C27258B(th2));
            }
        }
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC229710
    public final void ABm(C4493bM c4493bM) {
        this.A00.A06.A04();
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC229710
    public final void ABn(C4493bM c4493bM) {
        this.A00.A06.A05();
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC229710
    public final void ABo(C4493bM c4493bM) {
        if (c4493bM != this.A00.A00) {
            return;
        }
        if (c4493bM == null) {
            this.A00.A0B.A07().A9a(A00(111, 3, 45), AbstractC27248A.A0X, new C27258B(A00(8, 37, 108)));
            ABp(c4493bM, AdError.internalError(AdError.INTERNAL_ERROR_2004));
            return;
        }
        this.A00.A0F().removeCallbacks(this.A01);
        this.A00.A01 = c4493bM;
        this.A00.A0I();
        this.A00.A06.A0F(c4493bM);
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC229710
    public final void ABp(C4493bM c4493bM, AdError adError) {
        if (c4493bM != this.A00.A00) {
            return;
        }
        this.A00.A0F().removeCallbacks(this.A01);
        this.A00.A0N(c4493bM);
        this.A00.A0B.A0E().A4t(adError.getErrorCode(), adError.getErrorMessage());
        this.A00.A06.A0G(new C3403Jb(adError.getErrorCode(), adError.getErrorMessage()));
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC229710
    public final void ABq(C4493bM c4493bM) {
        AbstractC3416Jp.A05(A00(114, 31, 70), A00(45, 29, 54), A00(0, 8, 121));
        this.A00.A06.A0D();
        this.A00.A0L();
    }
