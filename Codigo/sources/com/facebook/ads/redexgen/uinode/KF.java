...
public final class KF implements InterfaceC1191Qj {
    ...
    public EnumC1190Qi A01 = EnumC1190Qi.A05;
    ...
    private void A04(boolean z10) {
        this.A01 = EnumC1190Qi.A04;
        if (this.A04) {
            AbstractC1066Lo.A0L(this.A03);
        }
        String[] strArr = A05;
        ...
        if (!z10) {
            ...
            this.A01 = EnumC1190Qi.A03;
        } else {
            this.A00 = this.A03.animate().alpha(1.0f).setDuration(this.A02).setListener(new C1195Qn(this));
        }
    }

    private void A05(boolean z10) {
        this.A01 = EnumC1190Qi.A06;
        if (z10) {
            this.A00 = this.A03.animate().alpha(0.0f).setDuration(this.A02).setListener(new C1196Qo(this));
            return;
        }
        View view = this.A03;
