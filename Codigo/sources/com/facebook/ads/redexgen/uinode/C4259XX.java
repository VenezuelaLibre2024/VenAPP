...
public final class C4259XX implements InterfaceC2950Bs {
    ...
    public static final InterfaceC2953Bv A0r;
    ...
    public boolean A0a;
    public int[] A0b;
    public final SparseArray<C2972CE> A0c;
    public final InterfaceC2968CA A0d;
    public final C2975CH A0e;
    public final C3306Hz A0f;
    public final C3306Hz A0g;
    public final C3306Hz A0h;
    public final C3306Hz A0i;
    public final C3306Hz A0j;
    public final C3306Hz A0k;
    public final C3306Hz A0l;
    public final C3306Hz A0m;
    public final C3306Hz A0n;
    ...
    */
    private void A08(com.facebook.ads.redexgen.uinode.InterfaceC2951Bt r11, com.facebook.ads.redexgen.uinode.C2972CE r12, int r13) throws java.io.IOException, java.lang.InterruptedException {
        /*
            Method dump skipped, instructions count: 698
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4259XX.A08(com.facebook.ads.redexgen.X.Bt, com.facebook.ads.redexgen.X.CE, int):void");
    }
    ...
    static {
        ...
        A0t = AbstractC3322IF.A0i(A03(539, 90, 83));
    ...
    public C4259XX(int i10) {
        this(new C4262Xa(), i10);
    }

    public C4259XX(InterfaceC2968CA interfaceC2968CA, int i10) {
        this.A0K = -1L;
        ...
        this.A0d = interfaceC2968CA;
        interfaceC2968CA.A8p(new C4260XY(this, null));
        this.A0o = (i10 & 1) == 0;
        this.A0e = new C2975CH();
        this.A0c = new SparseArray<>();
        this.A0k = new C3306Hz(4);
        this.A0n = new C3306Hz(ByteBuffer.allocate(4).putInt(-1).array());
        this.A0l = new C3306Hz(4);
        this.A0i = new C3306Hz(AbstractC3302Hv.A03);
        this.A0h = new C3306Hz(4);
        this.A0j = new C3306Hz();
        this.A0m = new C3306Hz();
        this.A0f = new C3306Hz(8);
        this.A0g = new C3306Hz();
    }

    private int A00(InterfaceC2951Bt interfaceC2951Bt, InterfaceC2962C4 interfaceC2962C4, int i10) throws IOException, InterruptedException {
        int bytesRead;
        int strippedBytesLeft = this.A0j.A04();
        if (strippedBytesLeft > 0) {
            bytesRead = Math.min(i10, strippedBytesLeft);
            interfaceC2962C4.AFR(this.A0j, bytesRead);
        } else {
            bytesRead = interfaceC2962C4.AFQ(interfaceC2951Bt, i10, false);
        }
        this.A07 += bytesRead;
        this.A08 += bytesRead;
        return bytesRead;
    ...
    private long A01(long j10) throws C28319v {
        long j11 = this.A0M;
        if (j11 != -9223372036854775807L) {
            return AbstractC3322IF.A0F(j10, j11, 1000L);
        }
        throw new C28319v(A03(189, 54, 68));
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private com.facebook.ads.redexgen.uinode.InterfaceC2959C1 A02() {
        /*
            r11 = this;
            long r3 = r11.A0K
            r1 = -1
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4259XX.A02():com.facebook.ads.redexgen.X.C1");
    }
    ...
    private void A07(InterfaceC2951Bt interfaceC2951Bt, int i10) throws IOException, InterruptedException {
        if (this.A0k.A07() >= i10) {
            return;
        }
        if (this.A0k.A05() < i10) {
            C3306Hz c3306Hz = this.A0k;
            c3306Hz.A0b(Arrays.copyOf(c3306Hz.A00, Math.max(this.A0k.A00.length * 2, i10)), this.A0k.A07());
        }
        ...
        interfaceC2951Bt.readFully(bArr, A07, i10 - this.A0k.A07());
        this.A0k.A0X(i10);
    }

    private void A09(InterfaceC2951Bt interfaceC2951Bt, byte[] bArr, int i10) throws IOException, InterruptedException {
        ...
        interfaceC2951Bt.readFully(bArr2, sizeWithPrefix3, i10);
        this.A0m.A0W(length);
    }

    private void A0A(InterfaceC2951Bt interfaceC2951Bt, byte[] bArr, int i10, int i11) throws IOException, InterruptedException {
        int min = Math.min(i11, this.A0j.A04());
        int pendingStrippedBytes = i11 - min;
        interfaceC2951Bt.readFully(bArr, i10 + min, pendingStrippedBytes);
        if (min > 0) {
    ...
    private void A0B(C2972CE c2972ce, long j10) {
        if (c2972ce.A0X != null) {
            C2973CF c2973cf = c2972ce.A0X;
            if (A0q[6].length() != 27) {
                throw new RuntimeException();
            }
            A0q[6] = "nKrIVrdQs7NkqXN01cL0onp1lFd";
            c2973cf.A03(c2972ce, j10);
        } else {
            if (A03(843, 11, 89).equals(c2972ce.A0Y)) {
                A0C(c2972ce, A03(33, 19, 7), 19, 1000L, A0x);
            } else if (A03(833, 10, 57).equals(c2972ce.A0Y)) {
                A0C(c2972ce, A03(14, 19, 109), 21, 10000L, A0v);
            }
            c2972ce.A0W.AFS(j10, this.A01, this.A08, 0, c2972ce.A0V);
        }
        this.A0V = true;
        A05();
    }

    private void A0C(C2972CE c2972ce, String str, int i10, long j10, byte[] bArr) {
        A0D(this.A0m.A00, this.A0C, str, i10, j10, bArr);
        InterfaceC2962C4 interfaceC2962C4 = c2972ce.A0W;
        C3306Hz c3306Hz = this.A0m;
        interfaceC2962C4.AFR(c3306Hz, c3306Hz.A07());
    ...
    public static void A0D(byte[] bArr, long j10, String str, int i10, long j11, byte[] bArr2) {
        ...
        if (j10 == -9223372036854775807L) {
            ...
            timeCodeData = AbstractC3322IF.A0i(String.format(Locale.US, str, Integer.valueOf(i11), Integer.valueOf(i12), Integer.valueOf(lastValue), Integer.valueOf(seconds)));
        }
        System.arraycopy(timeCodeData, 0, bArr, i10, bArr2.length);
    }

    private boolean A0E(C2957Bz c2957Bz, long j10) {
        if (this.A0Y) {
            this.A0J = j10;
            c2957Bz.A00 = this.A0F;
            this.A0Y = false;
            return true;
        }
    ...
    public final void A0I(int i10) throws C28319v {
        switch (i10) {
            case 160:
                if (this.A04 != 2) {
                    return;
            ...
            case 174:
                if (A0F(this.A0O.A0Y)) {
                    C2972CE c2972ce = this.A0O;
                    c2972ce.A09(this.A0N, c2972ce.A0N);
            ...
            case 19899:
                ...
                throw new C28319v(A03(667, 50, 26));
            case 25152:
                if (!this.A0O.A0c) {
                    return;
                }
                if (this.A0O.A0V != null) {
                    this.A0O.A0U = new DrmInitData(new DrmInitData.SchemeData(AbstractC28079W.A04, A03(RecognitionOptions.UPC_E, 10, 63), this.A0O.A0V.A03));
                    return;
                }
                throw new C28319v(A03(449, 55, 115));
            case 28032:
                if (!this.A0O.A0c || this.A0O.A0f == null) {
                    return;
                } else {
                    throw new C28319v(A03(243, 53, 10));
                }
            case 357149030:
            ...
            case 374648427:
                ...
                throw new C28319v(A03(756, 26, 64));
            case 475249515:
                if (this.A0a) {
                    return;
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:103:0x0322, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.C4259XX.A0q[7].charAt(2) == 'J') goto L109;
     */
    /* JADX WARN: Code restructure failed: missing block: B:104:0x0324, code lost:
    
        r10 = com.facebook.ads.redexgen.uinode.C4259XX.A0q;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:114:0x0372, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C28319v(A03(396, 37, 107));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:121:0x0382, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C28319v(A03(782, 33, 29));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:128:0x03a3, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C28319v(A03(877, 25, 30) + r11);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x0273, code lost:
        ...
        r19.A0b[r11] = r2;
        r2 = com.facebook.ads.redexgen.uinode.C4259XX.A0q;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:78:0x0291, code lost:
        ...
        com.facebook.ads.redexgen.uinode.C4259XX.A0q[6] = "AJCSp0dPwFu9XZoKvCoy3nlmL9O";
        r12 = r12 + 1;
        A07(r22, r12);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:91:0x02f3, code lost:
        ...
        com.facebook.ads.redexgen.uinode.C4259XX.A0q[7] = "JvemuAcSz5vc2l4QyutSma8u3cOiXxC4";
        r10 = 1;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0K(int r20, int r21, com.facebook.ads.redexgen.uinode.InterfaceC2951Bt r22) throws java.io.IOException, java.lang.InterruptedException {
        /*
            Method dump skipped, instructions count: 978
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4259XX.A0K(int, int, com.facebook.ads.redexgen.X.Bt):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0L(int r11, long r12) throws com.facebook.ads.redexgen.uinode.C28319v {
        /*
            Method dump skipped, instructions count: 988
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4259XX.A0L(int, long):void");
    }

    public final void A0M(int i10, long j10, long j11) throws C28319v {
        switch (i10) {
            case 160:
                this.A0W = false;
                return;
            case 174:
                this.A0O = new C2972CE(null);
                return;
            case 187:
                this.A0Z = false;
                return;
            ...
            case 408125543:
                ...
                throw new C28319v(A03(717, 39, 113));
            case 475249515:
                this.A0Q = new C3296Hp();
                this.A0P = new C3296Hp();
                return;
            case 524531317:
                if (this.A0a) {
                    return;
                ...
                if (this.A0o && this.A0F != -1) {
                    ...
                    this.A0N.AFi(new C4271Xj(this.A0H));
                    this.A0a = true;
                    return;
                }
        }
    ...
    public final void A0N(int i10, String str) throws C28319v {
        switch (i10) {
            case 134:
                this.A0O.A0Y = str;
                return;
            case 17026:
                if (A03(1034, 4, 113).equals(str) || A03(1016, 8, 122).equals(str)) {
                    ...
                    throw new C28319v(A03(369, 8, 117) + str + A03(0, 14, 21));
                }
            case 2274716:
                C2972CE.A02(this.A0O, str);
                return;
            default:
                return;
        }
    ...
    public final int AEH(InterfaceC2951Bt interfaceC2951Bt, C2957Bz c2957Bz) throws IOException, InterruptedException {
        ...
        boolean z10 = true;
        while (z10 && !this.A0V) {
            z10 = this.A0d.AEJ(interfaceC2951Bt);
            if (z10 && A0E(c2957Bz, interfaceC2951Bt.A7i())) {
                return 1;
            }
        }
        if (z10) {
        ...
        int i10 = 0;
        while (true) {
            SparseArray<C2972CE> sparseArray = this.A0c;
            String[] strArr = A0q;
            String str = strArr[0];
    ...
    */
    public final void AFh(long r3, long r5) {
        ...
        L18:
            ...
            com.facebook.ads.redexgen.X.CE r0 = (com.facebook.ads.redexgen.uinode.C2972CE) r0
            r0.A08()
            int r1 = r1 + 1
            goto L18
        L2e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4259XX.AFh(long, long):void");
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC2950Bs
    public final boolean AGR(InterfaceC2951Bt interfaceC2951Bt) throws IOException, InterruptedException {
        return new C2974CG().A01(interfaceC2951Bt);
    }
}
