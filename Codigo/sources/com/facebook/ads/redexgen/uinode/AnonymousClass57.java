...
public abstract class AnonymousClass57 {
    ...
    public static int A00(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC06654o abstractC06654o, boolean z10) {
        if (abstractC06654o.A0W() == 0 || anonymousClass53.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z10) {
            return Math.abs(abstractC06654o.A0p(view) - abstractC06654o.A0p(view2)) + 1;
        }
    ...
    public static int A01(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC06654o abstractC06654o, boolean z10) {
        if (abstractC06654o.A0W() == 0 || anonymousClass53.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z10) {
        ...
        int A0p = abstractC06654o.A0p(view);
        int laidOutArea = abstractC06654o.A0p(view2);
        float abs = A0C / (Math.abs(A0p - laidOutArea) + 1);
        int laidOutArea2 = anonymousClass53.A03();
        return (int) (abs * laidOutArea2);
    }

    public static int A02(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC06654o abstractC06654o, boolean z10, boolean z11) {
        int laidOutArea;
        if (abstractC06654o.A0W() != 0) {
            ...
            if (A03 != 0 && view != null && view2 != null) {
                int maxPosition = Math.min(abstractC06654o.A0p(view), abstractC06654o.A0p(view2));
                int A0p = abstractC06654o.A0p(view);
                int minPosition = abstractC06654o.A0p(view2);
                ...
                int itemsBefore2 = abstractC06654o.A0p(view);
                int minPosition4 = abstractC06654o.A0p(view2);
