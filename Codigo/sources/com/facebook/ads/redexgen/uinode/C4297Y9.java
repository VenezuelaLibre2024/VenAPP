...
public final class C4297Y9 implements InterfaceC28279r {
    ...
    public final C4169W2 A07;
    public final C3310I3 A08;
    ...
    public C4297Y9() {
        this(new C4169W2(true, 65536));
    }

    @Deprecated
    public C4297Y9(C4169W2 c4169w2) {
        this(c4169w2, 15000, 50000, 2500, 5000, -1, true);
    }

    @Deprecated
    public C4297Y9(C4169W2 c4169w2, int i10, int i11, int i12, int i13, int i14, boolean z10) {
        this(c4169w2, i10, i11, i12, i13, i14, z10, null);
    }

    @Deprecated
    public C4297Y9(C4169W2 c4169w2, int i10, int i11, int i12, int i13, int i14, boolean z10, C3310I3 c3310i3) {
    ...
    */
    private final int A00(com.facebook.ads.redexgen.uinode.InterfaceC4293Y5[] r4, com.facebook.ads.redexgen.uinode.C3226Gh r5) {
        /*
            r3 = this;
            r2 = 0
            r1 = 0
        L2:
            ...
            r0 = r4[r1]
            int r0 = r0.A8C()
            int r0 = com.facebook.ads.redexgen.uinode.AbstractC3322IF.A01(r0)
            int r2 = r2 + r0
        L16:
            int r1 = r1 + 1
            goto L2
        L19:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4297Y9.A00(com.facebook.ads.redexgen.X.Y5[], com.facebook.ads.redexgen.X.Gh):int");
    }

    public static void A03(int i10, int i11, String str, String str2) {
        AbstractC3281Ha.A05(i10 >= i11, str + A01(0, 21, 44) + str2);
    }

    private void A04(boolean z10) {
        this.A00 = 0;
        C3310I3 c3310i3 = this.A08;
        if (c3310i3 != null && this.A01) {
            c3310i3.A03(0);
        }
        this.A01 = false;
        if (z10) {
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC28279r
    public final C4169W2 A60() {
        return this.A07;
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC28279r
    public final void ADN(InterfaceC4293Y5[] interfaceC4293Y5Arr, TrackGroupArray trackGroupArray, C3226Gh c3226Gh) {
        int i10 = this.A02;
        if (i10 == -1) {
            i10 = A00(interfaceC4293Y5Arr, c3226Gh);
        }
        this.A00 = i10;
        this.A07.A04(i10);
    }
    ...
    public final boolean AGI(long j10, float f10) {
        ...
        long j11 = this.A06;
        if (f10 > 1.0f) {
            j11 = Math.min(AbstractC3322IF.A0C(j11, f10), this.A05);
        }
        if (j10 < j11) {
            if (!this.A09 && z11) {
                z10 = false;
        ...
        if (c3310i3 != null && (targetBufferSizeReached = this.A01) != z12) {
    ...
    public final boolean AGL(long j10, float f10, boolean z10) {
        long A0D = AbstractC3322IF.A0D(j10, f10);
