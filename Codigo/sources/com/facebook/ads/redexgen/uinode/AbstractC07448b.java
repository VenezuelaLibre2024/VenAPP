...
public abstract class AbstractC07448b {
    ...
    public static String A01(C1398Ym c1398Ym) {
        return KE.A00(c1398Ym).getString(A00(0, 17, 36), null);
    }

    public static String A02(C1398Ym c1398Ym) {
        return KE.A00(c1398Ym).getString(A00(17, 22, 99), null);
    }

    public static void A04(C1398Ym c1398Ym) {
        KE.A00(c1398Ym).edit().remove(A00(17, 22, 99)).apply();
    }

    public static void A05(C1398Ym c1398Ym, String str, String str2) {
        KE.A00(c1398Ym).edit().putString(A00(17, 22, 99), str).putString(A00(0, 17, 36), str2).apply();
    }
}
