...
public final class C1358Wy implements InterfaceC0863Cy {
    ...
    public C1358Wy(String str) {
        this.A0J = str;
        C0980Hz c0980Hz = new C0980Hz(RecognitionOptions.UPC_E);
        this.A0I = c0980Hz;
        this.A0H = new C0979Hy(c0980Hz.A00);
    }

    private int A00(C0979Hy c0979Hy) throws C07889v {
        int A01 = c0979Hy.A01();
        Pair<Integer, Integer> config = AbstractC0959He.A02(c0979Hy, true);
        int bitsLeft = ((Integer) config.first).intValue();
        this.A05 = bitsLeft;
        int bitsLeft2 = ((Integer) config.second).intValue();
        this.A02 = bitsLeft2;
        int bitsLeft3 = c0979Hy.A01();
        return A01 - bitsLeft3;
    }

    private int A01(C0979Hy c0979Hy) throws C07889v {
        int tmp;
        int i10 = 0;
    ...
    public static long A02(C0979Hy c0979Hy) {
        int bytesForValue = c0979Hy.A04(2);
        return c0979Hy.A04((bytesForValue + 1) * 8);
    }
    ...
    private void A06(C0979Hy c0979Hy) throws C07889v {
        boolean useSameStreamMux = c0979Hy.A0F();
        if (!useSameStreamMux) {
            this.A0G = true;
            A08(c0979Hy);
        } else {
    ...
    private void A07(C0979Hy c0979Hy) {
        int A04 = c0979Hy.A04(3);
        this.A03 = A04;
        switch (A04) {
            case 0:
                c0979Hy.A08(8);
    ...
    private void A08(C0979Hy c0979Hy) throws C07889v {
        boolean otherDataLenEsc;
        int A04 = c0979Hy.A04(1);
        int A042 = A04 == 1 ? c0979Hy.A04(1) : 0;
        this.A00 = A042;
        if (A042 == 0) {
            if (A04 == 1) {
                A02(c0979Hy);
            ...
            if (c0979Hy.A0F()) {
                this.A04 = c0979Hy.A04(6);
                int A043 = c0979Hy.A04(4);
                ...
                if (A043 == 0 && A044 == 0) {
                    if (A04 == 0) {
                        ...
                        c0979Hy.A08(((int) A02(c0979Hy)) - A00(c0979Hy));
                    }
                    A07(c0979Hy);
                    ...
                    if (A0F) {
                        if (A04 == 1) {
                            this.A09 = A02(c0979Hy);
                        }
                        do {
                            otherDataLenEsc = c0979Hy.A0F();
                            this.A09 = (this.A09 << 8) + c0979Hy.A04(8);
    ...
    private void A09(C0979Hy c0979Hy, int i10) {
        int A03 = c0979Hy.A03();
        ...
        if (bitPosition == 0) {
            ...
            c0979Hy.A0D(this.A0I.A00, 0, bitPosition3);
            C0980Hz c0980Hz = this.A0I;
            String[] strArr = A0L;
            String str = strArr[6];
    ...
    public final void A4R(C0980Hz c0980Hz) throws C07889v {
        while (true) {
            int A04 = c0980Hz.A04();
            if (A0L[1].charAt(8) != 'b') {
                throw new RuntimeException();
            ...
            if (A04 > 0) {
                switch (this.A08) {
                    ...
                    case 2:
                        ...
                        int A0E3 = ((bytesToRead & (-225)) << 8) | c0980Hz.A0E();
                        this.A06 = A0E3;
                        ...
                        break;
                    case 3:
                        int min = Math.min(c0980Hz.A04(), this.A06 - this.A01);
                        byte[] bArr = this.A0H.A00;
                        int bytesToRead2 = this.A01;
                        c0980Hz.A0c(bArr, bytesToRead2, min);
    ...
    public final void A4p(InterfaceC0839Bu interfaceC0839Bu, DC dc2) {
        dc2.A05();
        this.A0D = interfaceC0839Bu.AGi(dc2.A03(), 1);
        this.A0E = dc2.A04();
    }
