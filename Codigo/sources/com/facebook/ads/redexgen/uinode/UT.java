...
public class UT extends RelativeLayout implements MD {
    ...
    public UT(C5V c5v, C1399Yn c1399Yn, J2 j22, MC mc2) {
        super(c1399Yn);
        U1 u12;
        UW uw = new UW(this);
        this.A06 = uw;
        ...
        NS A0E = A0E();
        this.A0D = A0E;
        if (AbstractC0989Ii.A02(c1399Yn) || c1399Yn.A0D() == null) {
            u12 = new U1(c1399Yn, A0E);
        } else {
            u12 = new U1(c1399Yn, c1399Yn.A0D(), A0E);
        }
        this.A0E = u12;
        NJ nj2 = new NJ(c1399Yn, u12);
        this.A0B = nj2;
        ...
        this.A0C = new NK(c1399Yn, null, R.attr.progressBarStyleHorizontal);
        A0F();
        c5v.A0N(uw);
    }
