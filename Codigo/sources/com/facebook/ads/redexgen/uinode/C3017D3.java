...
public final class C3017D3 {
    ...
    public boolean A0A;
    public boolean A0B;
    public final InterfaceC2962C4 A0C;

    public C3017D3(InterfaceC2962C4 interfaceC2962C4) {
        this.A0C = interfaceC2962C4;
    }
    ...
    public final void A04(byte[] bArr, int i10, int i11) {
        if (this.A07) {
            ...
            if (i13 < i11) {
                ...
                this.A06 = (headerOffset & RecognitionOptions.ITF) != 0;
                String[] strArr3 = A0D;
