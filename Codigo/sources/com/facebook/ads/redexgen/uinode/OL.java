...
public abstract class OL extends RelativeLayout {
    ...
    public OL(OP op, boolean z10) {
        ...
        this.A00 = A00;
        this.A01 = z10;
        ViewOnClickListenerC1271Tl viewOnClickListenerC1271Tl = new ViewOnClickListenerC1271Tl(op.A05(), op.A04(), this.A00, op.A06(), op.A09(), op.A0B(), op.A07());
        this.A04 = viewOnClickListenerC1271Tl;
        viewOnClickListenerC1271Tl.setRoundedCornersEnabled(A00());
        viewOnClickListenerC1271Tl.setViewShowsOverMedia(A0D());
        AbstractC1066Lo.A0G(AdError.NO_FILL_ERROR_CODE, viewOnClickListenerC1271Tl);
        O9 o92 = new O9(A05, this.A00, this.A01, A01(), A02());
        this.A05 = o92;
        AbstractC1066Lo.A0K(o92);
    }
    ...
    public C1399Yn getAdContextWrapper() {
        return this.A02;
    }
    ...
    public ViewOnClickListenerC1271Tl getCtaButton() {
        return this.A04;
    }
