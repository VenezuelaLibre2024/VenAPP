...
public final class X6 implements InterfaceC0863Cy {
    ...
    public X6(boolean z10, String str) {
        this.A0D = new C0979Hy(new byte[7]);
        this.A0E = new C0980Hz(Arrays.copyOf(A0J, 10));
        A03();
        this.A0G = z10;
        this.A0F = str;
    }

    private void A01() throws C07889v {
        this.A0D.A07(0);
        if (!this.A0C) {
            ...
            byte[] audioSpecificConfig = AbstractC0959He.A07(A04, channelConfig, audioObjectType);
            Pair<Integer, Integer> A03 = AbstractC0959He.A03(audioSpecificConfig);
    ...
    private void A08(C0980Hz c0980Hz) {
    ...
    private void A09(C0980Hz c0980Hz) {
        int min = Math.min(c0980Hz.A04(), this.A02 - this.A00);
    ...
    private boolean A0A(C0980Hz c0980Hz, byte[] bArr, int i10) {
        ...
        while (c0980Hz.A04() > 0) {
            switch (this.A03) {
                case 0:
                    ...
                    break;
                case 1:
                    if (!A0A(c0980Hz, this.A0E.A00, 10)) {
                        break;
                    } else {
                        A02();
                        break;
                ...
                case 2:
                    if (!A0A(c0980Hz, this.A0D.A00, this.A0B ? 7 : 5)) {
                        break;
                    } else {
                        A01();
                        break;
    ...
    public final void A4p(InterfaceC0839Bu interfaceC0839Bu, DC dc2) {
        dc2.A05();
        this.A0A = dc2.A04();
        this.A09 = interfaceC0839Bu.AGi(dc2.A03(), 1);
        if (this.A0G) {
            dc2.A05();
