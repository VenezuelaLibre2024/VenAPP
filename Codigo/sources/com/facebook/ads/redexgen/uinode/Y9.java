...
public final class Y9 implements InterfaceC07849r {
    ...
    */
    private final int A00(com.facebook.ads.redexgen.uinode.Y5[] r4, com.facebook.ads.redexgen.uinode.C0937Gh r5) {
        /*
            r3 = this;
            r2 = 0
            r1 = 0
    ...
    public static void A03(int i10, int i11, String str, String str2) {
        AbstractC0955Ha.A05(i10 >= i11, str + A01(0, 21, 44) + str2);
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC07849r
    public final W2 A60() {
        return this.A07;
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC07849r
    public final void ADN(Y5[] y5Arr, TrackGroupArray trackGroupArray, C0937Gh c0937Gh) {
        int i10 = this.A02;
        if (i10 == -1) {
            i10 = A00(y5Arr, c0937Gh);
        }
        this.A00 = i10;
        this.A07.A04(i10);
    }
    ...
    public final boolean AGI(long j10, float f10) {
        ...
        long j11 = this.A06;
        if (f10 > 1.0f) {
            j11 = Math.min(IF.A0C(j11, f10), this.A05);
        }
        if (j10 < j11) {
            if (!this.A09 && z11) {
                z10 = false;
