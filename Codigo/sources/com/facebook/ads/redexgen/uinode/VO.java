...
public class VO extends KT {
    ...
    public final /* synthetic */ C07277f A00;
    ...
    public final void A06() {
        ...
        try {
            ...
            if (all.size() > 1) {
                C07277f c07277f = this.A00;
                JD.A06(c07277f, C1210Rc.A00(c07277f), all);
            }
            sharedPreferences.edit().clear().apply();
            sharedPreferences.edit().putString(A00(45, 19, 10), this.A00.A08().A02()).putString(A00(64, 21, 50), C1057Lf.A02(this.A00.A08().A01())).apply();
        } catch (JSONException e10) {
            this.A00.A07().A9a(A00(31, 14, 7), 3502, new C8B(e10));
            sharedPreferences.edit().clear().apply();
        }
