...
public final class C4223Wx implements InterfaceC3012Cy {
    ...
    public C4223Wx(String str) {
        this.A02 = 0;
        C3306Hz c3306Hz = new C3306Hz(4);
        this.A0A = c3306Hz;
        c3306Hz.A00[0] = -1;
        this.A09 = new C2956By();
        this.A0B = str;
    }
    ...
    */
    private void A00(com.facebook.ads.redexgen.uinode.C3306Hz r9) {
        /*
            r8 = this;
            byte[] r6 = r9.A00
            int r5 = r9.A06()
        ...
        L42:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4223Wx.A00(com.facebook.ads.redexgen.X.Hz):void");
    }

    private void A01(C3306Hz c3306Hz) {
        int min = Math.min(c3306Hz.A04(), this.A01 - this.A00);
        this.A05.AFR(c3306Hz, min);
        ...
        InterfaceC2962C4 interfaceC2962C4 = this.A05;
        if (A0C[2].charAt(7) == 'H') {
        ...
        interfaceC2962C4.AFS(this.A04, 1, i10, 0, null);
        this.A04 += this.A03;
        this.A00 = 0;
        this.A02 = 0;
    }

    private void A02(C3306Hz c3306Hz) {
        int min = Math.min(c3306Hz.A04(), 4 - this.A00);
        c3306Hz.A0c(this.A0A.A00, this.A00, min);
        ...
        this.A0A.A0Y(0);
        if (C2956By.A04(this.A0A.A08(), this.A09)) {
            this.A01 = this.A09.A02;
            if (!this.A07) {
                this.A03 = (this.A09.A04 * 1000000) / this.A09.A03;
                this.A05.A5n(Format.A07(this.A06, this.A09.A06, null, -1, RecognitionOptions.AZTEC, this.A09.A01, this.A09.A03, null, null, 0, this.A0B));
                this.A07 = true;
            }
            this.A0A.A0Y(0);
    ...
    public final void A4p(InterfaceC2952Bu interfaceC2952Bu, C3025DC c3025dc) {
        c3025dc.A05();
        this.A06 = c3025dc.A04();
        this.A05 = interfaceC2952Bu.AGi(c3025dc.A03(), 1);
    }
