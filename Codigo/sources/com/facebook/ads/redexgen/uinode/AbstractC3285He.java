...
public abstract class AbstractC3285He {
    ...
    public static int A00(C3305Hy c3305Hy) {
        int A042 = c3305Hy.A04(5);
        if (A042 == 31) {
            int audioObjectType = c3305Hy.A04(6);
            return audioObjectType + 32;
        }
        return A042;
    }

    public static int A01(C3305Hy c3305Hy) {
        int A042 = c3305Hy.A04(4);
        if (A042 == 15) {
            int frequencyIndex = c3305Hy.A04(24);
            return frequencyIndex;
        }
        AbstractC3281Ha.A03(A042 < 13);
        int frequencyIndex2 = A04[A042];
        return frequencyIndex2;
    }

    public static Pair<Integer, Integer> A02(C3305Hy c3305Hy, boolean z10) throws C28319v {
        int A002 = A00(c3305Hy);
        int A012 = A01(c3305Hy);
        int channelConfiguration = c3305Hy.A04(4);
        if (A002 == 5 || A002 == 29) {
            A012 = A01(c3305Hy);
            String[] strArr = A01;
            String str = strArr[0];
            ...
            A002 = A00(c3305Hy);
            if (A002 == 22) {
                channelConfiguration = c3305Hy.A04(4);
            }
        }
        if (z10) {
            switch (A002) {
                ...
                case 22:
                case 23:
                    A06(c3305Hy, A002, channelConfiguration);
                    switch (A002) {
                        case 17:
                        case 19:
                        case 20:
                        ...
                        case 22:
                        case 23:
                            int epConfig = c3305Hy.A04(2);
                            if (epConfig == 2 || epConfig == 3) {
                                throw new C28319v(A04(31, 22, 104) + epConfig);
                            }
                            break;
                    }
                case 5:
                ...
                case 18:
                default:
                    throw new C28319v(A04(0, 31, 107) + A002);
            }
        }
        int channelCount = A03[channelConfiguration];
        AbstractC3281Ha.A03(channelCount != -1);
        return Pair.create(Integer.valueOf(A012), Integer.valueOf(channelCount));
    }

    public static Pair<Integer, Integer> A03(byte[] bArr) throws C28319v {
        return A02(new C3305Hy(bArr), false);
    }

    public static void A06(C3305Hy c3305Hy, int i10, int i11) {
        c3305Hy.A08(1);
        if (c3305Hy.A0F()) {
            c3305Hy.A08(14);
        }
