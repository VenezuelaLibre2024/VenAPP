...
public abstract class AbstractC2862AQ {
     ...
     */
    public static Format A07(C3306Hz c3306Hz, String str, String str2, DrmInitData drmInitData) {
        int i10 = A05[(c3306Hz.A0E() & 192) >> 6];
        int A0E = c3306Hz.A0E();
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static Format A08(C3306Hz c3306Hz, String str, String str2, DrmInitData drmInitData) {
        c3306Hz.A0Z(2);
        int i10 = A05[(c3306Hz.A0E() & 192) >> 6];
        int A0E = c3306Hz.A0E();
        ...
        if (((c3306Hz.A0E() & 30) >> 1) > 0 && (c3306Hz.A0E() & 2) != 0) {
            i11 += 2;
        }
        String A0A = A0A(9, 10, 48);
        if (c3306Hz.A04() > 0 && (c3306Hz.A0E() & 1) != 0) {
            A0A = A0A(19, 14, 124);
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:123:0x028c, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.AbstractC2862AQ.A01[6].charAt(31) == 'Q') goto L166;
     */
    /* JADX WARN: Code restructure failed: missing block: B:124:0x028e, code lost:
    
        r6 = com.facebook.ads.redexgen.uinode.AbstractC2862AQ.A01;
    ...
    */
    public static com.facebook.ads.redexgen.uinode.C2861AP A09(com.facebook.ads.redexgen.uinode.C3305Hy r18) {
        /*
            Method dump skipped, instructions count: 900
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.AbstractC2862AQ.A09(com.facebook.ads.redexgen.X.Hy):com.facebook.ads.redexgen.X.AP");
    }
