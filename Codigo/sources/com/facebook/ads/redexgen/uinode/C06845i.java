...
public final class C06845i implements NativeAdApi {
    ...
    public C06845i(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        V2.A0L(nativeAdBaseApi).A1Y(EnumC1009Jg.A05);
    }

    public C06845i(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C1399Yn A11 = A00().A11();
            C1399Yn downloadContext = C06785c.A03(imageView.getContext());
