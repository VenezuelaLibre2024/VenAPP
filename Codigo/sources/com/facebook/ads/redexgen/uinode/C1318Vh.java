...
public final class C1318Vh implements HU {
    ...
    public static final C1318Vh A04;
    public int A00;
    ...
    static {
        A03();
        A04 = new C1318Vh(Collections.emptyMap());
    }

    public C1318Vh(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static C1318Vh A00(DataInputStream dataInputStream) throws IOException {
    ...
    */
    public static void A04(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1318Vh.A04(java.util.HashMap, java.util.List):void");
    }
    ...
    public final C1318Vh A08(HW hw) {
        Map<String, byte[]> A022 = A02(this.A01, hw);
        if (A06(A022)) {
            return this;
        }
        return new C1318Vh(A022);
    }
