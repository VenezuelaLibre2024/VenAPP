...
public abstract class AbstractC0987Ig {
    ...
    public static long A00(Context context) {
        return C0988Ih.A0R(context).A2U(A02(29, 25, 4), -1L);
    }

    public static long A01(Context context) {
        return C0988Ih.A0R(context).A2U(A02(131, 31, 5), -1L);
    }

    public static boolean A04(Context context) {
        return C0988Ih.A0R(context).A2Z(A02(54, 39, 15), true);
    }

    public static boolean A05(Context context) {
        return C0988Ih.A0R(context).A2Z(A02(0, 29, 11), false);
    }

    public static boolean A06(Context context) {
        return C0988Ih.A0R(context).A2Z(A02(93, 16, 92), false);
    }

    public static boolean A07(Context context) {
        return C0988Ih.A0R(context).A2Z(A02(109, 22, 1), false);
    }
}
