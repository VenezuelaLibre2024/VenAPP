...
public final class C1265Tf extends OL implements OE {
    ...
    public C1265Tf(OP op, boolean z10) {
        super(op, true);
        ...
        AbstractC1066Lo.A0R(relativeLayout, getAdContextWrapper());
        ...
        if (op.A0C() && !z10) {
            ...
            c1170Po.A02(A042, A042);
            AbstractC1066Lo.A0G(1007, c1170Po);
            LinearLayout.LayoutParams layoutParams6 = new LinearLayout.LayoutParams(-1, -2);
            layoutParams6.setMargins(0, OL.A07, 0, 0);
            linearLayout.addView(c1170Po, layoutParams6);
            if (C0988Ih.A0z(op.A05())) {
                c1170Po.setOnClickListener(getCtaButton());
            }
        }
        ...
        View A02 = op.A02();
        if (A02 != null && (A09.A00 || C0988Ih.A16(getAdContextWrapper()))) {
            if (z10) {
            ...
            if (A09.A00) {
                ...
                A02.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.OJ
                    ...
                    public final void onClick(View view) {
                        C1265Tf.this.A13(view);
                    }
                });
            } else {
                AbstractC1115Nl.A00(A02, C0988Ih.A17(getAdContextWrapper()), new OK(this));
            }
        } else if (A02 != null) {
