...
public final class C3328IN {
    ...
    public C3328IN(List<byte[]> initializationData, int i10) {
        this.A01 = initializationData;
        this.A00 = i10;
    }

    public static C3328IN A00(C3306Hz c3306Hz) throws C28319v {
        try {
            c3306Hz.A0Z(21);
            int A0E = c3306Hz.A0E() & 3;
            int i10 = c3306Hz.A0E();
            int j10 = 0;
            int A06 = c3306Hz.A06();
            for (int i11 = 0; i11 < i10; i11++) {
                c3306Hz.A0Z(1);
                int csdStartPosition = c3306Hz.A0I();
                for (int csdLength = 0; csdLength < csdStartPosition; csdLength++) {
                    int numberOfArrays = c3306Hz.A0I();
                    int lengthSizeMinusOne = numberOfArrays + 4;
                    j10 += lengthSizeMinusOne;
                    c3306Hz.A0Z(numberOfArrays);
                }
            }
            c3306Hz.A0Y(A06);
            ...
            if (numberOfArrays2 != lengthSizeMinusOne2) {
                ...
                for (int lengthSizeMinusOne3 = 0; lengthSizeMinusOne3 < i10; lengthSizeMinusOne3++) {
                    ...
                    for (int j11 = 0; j11 < A0I; j11++) {
                        int numberOfNalUnits = c3306Hz.A0I();
                        byte[] bArr = AbstractC3302Hv.A03;
                        int csdLength2 = AbstractC3302Hv.A03.length;
                        System.arraycopy(bArr, 0, buffer, csdStartPosition2, csdLength2);
                        int numberOfArrays3 = AbstractC3302Hv.A03.length;
                        int csdStartPosition3 = csdStartPosition2 + numberOfArrays3;
                        byte[] bArr2 = c3306Hz.A00;
                        int numberOfArrays4 = c3306Hz.A06();
                        ...
                        c3306Hz.A0Z(numberOfNalUnits);
                    }
                }
                int numberOfArrays5 = A0E + 1;
                return new C3328IN(j10 == 0 ? null : Collections.singletonList(buffer), numberOfArrays5);
            }
            throw new RuntimeException();
        } catch (ArrayIndexOutOfBoundsException e10) {
            throw new C28319v(A01(0, 25, 65), e10);
        }
    }
}
