...
public final class ZH extends C06765a implements MediaViewApi, Repairable, InterfaceC07237b {
    ...
    private void A0A(View view, V2 v22) {
        ...
        C1179Px A01 = AbstractC1178Pw.A01(this.A07, A1C);
    ...
    private void A0B(ImageView imageView) {
        if (!this.A0D) {
            ...
            if (imageView2 != null) {
                AbstractC1066Lo.A0J(imageView2);
            }
            imageView.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(imageView, layoutParams);
            imageView.setId(AbstractC1066Lo.A00());
            this.A02 = imageView;
            return;
        }
    ...
    private final void A0C(C1399Yn c1399Yn, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1399Yn, attributeSet, i10, i11));
        A0H(new C1109Nf(c1399Yn, attributeSet, i10, i11));
        this.A08 = new C3C(c1399Yn, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1399Yn, attributeSet, i10, i11));
        A07();
    }

    private final void A0D(C1399Yn c1399Yn, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1399Yn, attributeSet, i10));
        A0H(new C1109Nf(c1399Yn, attributeSet, i10));
        this.A08 = new C3C(c1399Yn, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1399Yn, attributeSet, i10));
        A07();
    }

    private final void A0E(C1399Yn c1399Yn, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1399Yn, attributeSet));
        A0H(new C1109Nf(c1399Yn, attributeSet));
        this.A08 = new C3C(c1399Yn, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1399Yn, attributeSet));
        A07();
    }

    private final void A0F(C1399Yn c1399Yn, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1399Yn));
        A0H(new C1109Nf(c1399Yn));
        this.A08 = new C3C(c1399Yn);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1399Yn));
        A07();
    }

    private void A0G(V2 v22, boolean z10, JP jp) {
        AsyncTaskC1276Tq A04 = new AsyncTaskC1276Tq(this.A02, this.A07).A04();
        if (z10) {
    ...
    private void A0H(C1109Nf c1109Nf) {
        if (!this.A0D) {
            C1109Nf c1109Nf2 = this.A09;
            if (c1109Nf2 != null) {
                this.A03.removeView(c1109Nf2);
            }
            c1109Nf.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c1109Nf, layoutParams);
            this.A09 = c1109Nf;
            return;
        }
    ...
    private boolean A0I(NativeAd nativeAd) {
        List<NativeAd> carousel = ((C06845i) nativeAd.getNativeAdApi()).A03();
        if (carousel == null) {
            return false;
        }
    ...
    public boolean A0J(NativeAd nativeAd) {
        return Build.VERSION.SDK_INT >= 14 && !TextUtils.isEmpty(((C06845i) nativeAd.getNativeAdApi()).A02());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:73:0x03b6, code lost:
        ...
        ((com.facebook.ads.redexgen.uinode.C0882Eb) r1).setAdapter(null);
     */
    ...
    */
    ...
    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C1399Yn A11 = ((V2) nativeAdBaseApi).A11();
        C1399Yn adObjectContext = this.A07;
        ...
        ((C06835h) this.A05.getMediaViewVideoRendererApi()).A03();
        View view = this.A01;
        if (view != null) {
        ...
        if (adIcon != null) {
            ...
            if (nativeAdBaseApi.isAdLoaded()) {
                C1399Yn adObjectContext2 = this.A07;
    ...
    public final void bringChildToFront(View view) {
        if (view == this.A01 || view == this.A05 || view == this.A09 || view == this.A02) {
            ...
            C1179Px c1179Px = this.A0B;
            if (c1179Px != null) {
                this.A06.bringChildToFront(c1179Px);
            }
        }
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        if (context instanceof C1399Yn) {
            this.A07 = (C1399Yn) context;
        } else {
            this.A07 = C06785c.A03(context);
        }
        this.A07.A0L(this);
    ...
    @Override // com.facebook.ads.redexgen.uinode.C06765a, com.facebook.ads.internal.api.AdComponentViewApi
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C06835h) this.A05.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C06835h) this.A05.getMediaViewVideoRendererApi()).A07(new ZI(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            ((C06835h) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A07.A09());
            ...
            mediaViewVideoRenderer.setId(AbstractC1066Lo.A00());
            return;
        }
