...
public final class C1048Kw extends ImageView implements QN {
    ...
    public C1048Kw(C1399Yn c1399Yn, JA ja2) {
        super(c1399Yn);
        ...
        A05();
        setOnClickListener(new ViewOnClickListenerC1183Qb(this));
    }

    private void A04() {
        setImageBitmap(AbstractC1075Lx.A01(EnumC1074Lw.SOUND_OFF));
    }

    private void A05() {
        setImageBitmap(AbstractC1075Lx.A01(EnumC1074Lw.SOUND_ON));
    }
