...
public final class XU implements InterfaceC0837Bs {
    ...
    public static final InterfaceC0840Bv A0G;
    ...
    public long A02;
    public long A03;
    public InterfaceC0839Bu A04;
    public C4 A05;
    public XV A06;
    public Metadata A07;
    public final int A08;
    public final long A09;
    public final C0841Bw A0A;
    public final Bx A0B;
    public final By A0C;
    public final C0980Hz A0D;
    ...
    public XU(int i10, long j10) {
        this.A08 = i10;
        this.A09 = j10;
        this.A0D = new C0980Hz(10);
        this.A0C = new By();
        this.A0A = new C0841Bw();
        this.A02 = -9223372036854775807L;
        this.A0B = new Bx();
    }

    private int A00(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        if (this.A00 == 0) {
            interfaceC0838Bt.AFM();
            if (!interfaceC0838Bt.ADw(this.A0D.A00, 0, 4, true)) {
                return -1;
            }
            this.A0D.A0Y(0);
        ...
        int AFQ = this.A05.AFQ(interfaceC0838Bt, this.A00, true);
        if (AFQ == -1) {
            return -1;
        }
    ...
    */
    public static int A01(com.facebook.ads.redexgen.uinode.C0980Hz r4, int r5) {
        /*
            int r1 = r4.A07()
            int r0 = r5 + 4
            if (r1 < r0) goto L3e
    ...
    private EE A02(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        interfaceC0838Bt.ADv(this.A0D.A00, 0, 4);
        this.A0D.A0Y(0);
        By.A04(this.A0D.A08(), this.A0C);
        return new EE(interfaceC0838Bt.A7I(), interfaceC0838Bt.A7i(), this.A0C);
    }

    private XV A03(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        C0980Hz c0980Hz = new C0980Hz(this.A0C.A02);
        interfaceC0838Bt.ADv(c0980Hz.A00, 0, this.A0C.A02);
        int i10 = 21;
        if ((this.A0C.A05 & 1) != 0) {
        ...
        int xingBase = A01(c0980Hz, i10);
        if (xingBase == A0J || xingBase == A0H) {
            E4 A01 = E4.A01(interfaceC0838Bt.A7I(), interfaceC0838Bt.A7i(), this.A0C, c0980Hz);
            if (A01 != null && !this.A0A.A03()) {
                interfaceC0838Bt.AFM();
                interfaceC0838Bt.A3W(i10 + 141);
                C0980Hz frame = this.A0D;
                interfaceC0838Bt.ADv(frame.A00, 0, 3);
                C0980Hz frame2 = this.A0D;
                frame2.A0Y(0);
                C0841Bw c0841Bw = this.A0A;
                C0980Hz frame3 = this.A0D;
                c0841Bw.A04(frame3.A0G());
            }
            interfaceC0838Bt.AGP(this.A0C.A02);
            if (A01 != null && !A01.A9I() && xingBase == A0H) {
                return A02(interfaceC0838Bt);
            }
            return A01;
        }
        if (xingBase == A0I) {
            EC A00 = EC.A00(interfaceC0838Bt.A7I(), interfaceC0838Bt.A7i(), this.A0C, c0980Hz);
            interfaceC0838Bt.AGP(this.A0C.A02);
            return A00;
        }
        interfaceC0838Bt.AFM();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A07(com.facebook.ads.redexgen.uinode.InterfaceC0838Bt r14, boolean r15) throws java.io.IOException, java.lang.InterruptedException {
        /*
    ...
    public final void A8o(InterfaceC0839Bu interfaceC0839Bu) {
        this.A04 = interfaceC0839Bu;
        this.A05 = interfaceC0839Bu.AGi(0, 1);
        this.A04.A5Y();
    }
    ...
    public final int AEH(InterfaceC0838Bt interfaceC0838Bt, C0842Bz c0842Bz) throws IOException, InterruptedException {
        if (this.A01 == 0) {
            try {
                A07(interfaceC0838Bt, false);
            } catch (EOFException unused) {
                return -1;
            }
        }
        if (this.A06 == null) {
            XV A03 = A03(interfaceC0838Bt);
            this.A06 = A03;
            if (A03 == null || (!A03.A9I() && (this.A08 & 1) != 0)) {
                this.A06 = A02(interfaceC0838Bt);
            }
    ...
    public final boolean AGR(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        return A07(interfaceC0838Bt, true);
    }
}
