...
public final class C4474b3 extends AbstractC23121F implements Serializable {
    ...
    public int A02;
    public int A03;
    public final List<AbstractC4476b5> A0A;
    ...
    public C4474b3(List<AbstractC4476b5> list) {
        this.A0A = list;
    }

    public static C4474b3 A02(JSONObject jSONObject, C4337Yn c4337Yn) throws JSONException {
        return A03(jSONObject, c4337Yn, false);
    }

    public static C4474b3 A03(JSONObject jSONObject, C4337Yn c4337Yn, boolean z10) throws JSONException {
        JSONArray jSONArray = jSONObject.getJSONArray(A04(0, 3, 35));
        ArrayList arrayList = new ArrayList(jSONArray.length());
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            if (z10) {
                arrayList.add(C3153FU.A02(jSONArray.getJSONObject(i10), c4337Yn));
            } else {
                arrayList.add(C3151FS.A02(jSONArray.getJSONObject(i10), c4337Yn));
            }
        }
        C4474b3 c4474b3 = new C4474b3(arrayList);
        JSONObject chainingParams = jSONObject.getJSONObject(A04(3, 12, 43));
        c4474b3.A04 = chainingParams.toString();
        c4474b3.A01 = chainingParams.optInt(A04(15, 17, 120), arrayList.size());
        c4474b3.A03 = chainingParams.optInt(A04(32, 24, 126), 0);
        c4474b3.A02 = chainingParams.optInt(A04(100, 24, 109), 0);
        c4474b3.A00 = chainingParams.optInt(A04(56, 19, 124), 2);
        c4474b3.A0d(chainingParams);
        c4474b3.A07 = chainingParams.optBoolean(A04(174, 16, 45), false);
        c4474b3.A06 = chainingParams.optBoolean(A04(146, 28, 8), false);
        c4474b3.A05 = chainingParams.optBoolean(A04(124, 22, 9), false);
        JSONArray optJSONArray = chainingParams.optJSONArray(A04(75, 25, 10));
        if (optJSONArray != null) {
            for (int i11 = 0; i11 < optJSONArray.length(); i11++) {
                c4474b3.A09.add(Integer.valueOf(optJSONArray.optInt(i11, 0)));
            }
        }
        return c4474b3;
    }
    ...
    public final AbstractC4476b5 A0u() {
        if (!this.A0A.isEmpty()) {
            AbstractC4476b5 abstractC4476b5 = this.A0A.get(0);
            ...
            return abstractC4476b5;
        }
        return null;
    }

    public final AbstractC4476b5 A0v(int i10) {
    ...
    public final String A0y() {
        AbstractC4476b5 firstAdDataBundle = A0u();
