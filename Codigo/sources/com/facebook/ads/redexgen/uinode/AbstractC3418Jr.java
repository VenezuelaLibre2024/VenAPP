...
public abstract class AbstractC3418Jr implements InterfaceC3893RZ {
    ...
    public final InterfaceC3894Ra A00;
    ...
    public AbstractC3418Jr(InterfaceC3894Ra interfaceC3894Ra) {
        this.A00 = interfaceC3894Ra;
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC3893RZ
    public final boolean ABU(C3891RX c3891rx) {
        InterfaceC3877RJ A00 = c3891rx.A00();
        if (this.A00.A98()) {
            Log.e(AbstractC3418Jr.class.getSimpleName(), A00(14, 27, 78), c3891rx);
        }
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC3893RZ
    public final void AE6(HttpURLConnection httpURLConnection, EnumC3889RV enumC3889RV, String str) throws IOException {
        httpURLConnection.setRequestMethod(enumC3889RV.A02());
        httpURLConnection.setDoOutput(enumC3889RV.A04());
        httpURLConnection.setDoInput(enumC3889RV.A03());
        if (str != null) {
