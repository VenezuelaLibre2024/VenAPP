...
public final class C1541bi implements C0K {
    ...
    static {
        A04();
        A07 = C1541bi.class.getSimpleName();
    }

    public C1541bi(String str) {
        this(str, C0I.A01(str));
    }

    public C1541bi(String str, int i10) {
        this(str);
        this.A00 = i10;
    }

    public C1541bi(String str, String str2) {
    ...
    private HttpURLConnection A02(int i10, int i11) throws IOException, C1543bk {
        ...
        do {
            ...
            if (i12 > 5) {
                ...
                throw new C1543bk(url2);
            }
        } while (code != 0);
        return httpURLConnection;
    }

    private void A03() throws C1543bk {
        String[] strArr;
        ...
        try {
            try {
                httpURLConnection = A02(0, ModuleDescriptor.MODULE_VERSION);
                ...
                Log.e(A07, A01(129, 25, 77) + this.A03, e10);
                C0I.A05(inputStream);
    ...
    private final void A05(int i10, int i11) throws C1543bk {
        try {
            ...
            throw new C1543bk(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i10, e10);
        }
    }
    ...
    public final void ADm(int i10) throws C1543bk {
        A05(i10, this.A00);
    }

    @Override // com.facebook.ads.redexgen.uinode.C0K
    public final void close() throws C1543bk {
        HttpURLConnection httpURLConnection = this.A02;
        if (httpURLConnection != null) {
            try {
                httpURLConnection.disconnect();
            } catch (NullPointerException e10) {
                throw new C1543bk(A01(92, 37, 93), e10);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.uinode.C0K
    public final synchronized int length() throws C1543bk {
    ...
    @Override // com.facebook.ads.redexgen.uinode.C0K
    public final int read(byte[] bArr) throws C1543bk {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new GF(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e10);
            } catch (IOException e11) {
                throw new C1543bk(A01 + this.A03, e11);
            }
        }
        throw new C1543bk(A01 + this.A03 + A01(51, 23, 21));
    }
