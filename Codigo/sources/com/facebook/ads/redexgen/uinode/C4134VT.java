...
public final class C4134VT implements InterfaceC3368J1 {
    ...
    public final InterfaceC3367J0 A07;
    public final InterfaceC3878RK A08;
    public volatile boolean A0C;
    public final Runnable A0A = new C4136VV(this);
    public final Runnable A09 = new C4135VU(this);
    ...
    static {
        A07();
        A0F = InterfaceC3368J1.class.getSimpleName();
    }

    public C4134VT(C4336Ym c4336Ym, InterfaceC3367J0 interfaceC3367J0) {
        this.A07 = interfaceC3367J0;
        this.A06 = c4336Ym;
        this.A04 = (ConnectivityManager) c4336Ym.getSystemService(A03(293, 12, 10));
        this.A08 = C3896Rc.A01(c4336Ym);
        this.A03 = AbstractC3350Ij.A0K(c4336Ym);
        this.A02 = AbstractC3350Ij.A0J(c4336Ym);
    }

    public static /* synthetic */ int A00(C4134VT c4134vt) {
        int i10 = c4134vt.A00 + 1;
        c4134vt.A00 = i10;
        return i10;
    }
    ...
    private void A06() {
        if (this.A00 >= AbstractC3350Ij.A09(this.A06)) {
            A05();
            A5B();
        } else {
            if (this.A00 == 1) {
                this.A01 = AbstractC3350Ij.A0I(this.A06);
            } else {
                this.A01 *= 2;
            }
            A5C();
    ...
    public final void A0B() {
        try {
            ...
            c3892ry.put(A03(315, 7, 92), A4a.toString());
            InterfaceC3877RJ ADz = this.A08.ADz(this.A06.A04().A73(), c3892ry.A08());
            ...
            if (!TextUtils.isEmpty(A69) && ADz != null) {
                if (ADz.A83() != 200) {
                    ...
                    if (A0E[4].length() != 29) {
                        ...
                        if (A83 == 413 && C3348Ih.A22(this.A06)) {
                            this.A07.ACo();
                            A05();
                            return;
                        } else {
            ...
            if (C3348Ih.A1t(this.A06) && A4a.has(A03)) {
                this.A07.ABI(A4a.getJSONArray(A03));
            }
            A06();
        } catch (Exception e10) {
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC3368J1
