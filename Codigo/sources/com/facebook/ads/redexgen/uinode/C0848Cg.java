...
public final class C0848Cg {
    ...
    public final void A02(int i10) {
        C0980Hz c0980Hz = this.A09;
        if (c0980Hz == null || c0980Hz.A07() < i10) {
            this.A09 = new C0980Hz(i10);
        }
        this.A01 = i10;
        this.A0A = true;
        this.A0B = true;
    ...
    public final void A04(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        interfaceC0838Bt.readFully(this.A09.A00, 0, this.A01);
        this.A09.A0Y(0);
        this.A0B = false;
    }

    public final void A05(C0980Hz c0980Hz) {
        c0980Hz.A0c(this.A09.A00, 0, this.A01);
        this.A09.A0Y(0);
        this.A0B = false;
    }
}
