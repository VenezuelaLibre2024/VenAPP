...
public final class C4414a5<K, V> extends C242231<K, V> implements Map<K, V> {
    public AbstractC24192y<K, V> A00;
    ...
    private AbstractC24192y<K, V> A00() {
        if (this.A00 == null) {
            this.A00 = new C4415a6(this);
        }
        return this.A00;
    }
