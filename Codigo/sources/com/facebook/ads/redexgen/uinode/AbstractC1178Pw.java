...
public abstract class AbstractC1178Pw {
    ...
    public static BitmapDrawable A00(C1399Yn c1399Yn, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c1399Yn, overlayBm))) {
                ...
                if (resources != null) {
                    ...
                    if (displayMetrics != null) {
                        ...
                        A04(c1399Yn, A02(0, 23, 116));
                    }
                } else {
                    A04(c1399Yn, A02(23, 18, 112));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th2) {
            c1399Yn.A07().A9a(A02(59, 3, 42), C8A.A1u, new C8B(th2));
            return null;
        }
    }

    public static C1179Px A01(C1399Yn c1399Yn, String str) {
        BitmapDrawable A002;
        try {
            if (TextUtils.isEmpty(str) || (A002 = A00(c1399Yn, str)) == null) {
                return null;
            }
            C1179Px overlayView = new C1179Px(c1399Yn);
    ...
    public static void A04(C1399Yn c1399Yn, String str) {
        c1399Yn.A07().A9a(A02(59, 3, 42), C8A.A1u, new C8B(str));
    }
    ...
    */
    public static boolean A05(com.facebook.ads.redexgen.uinode.C1399Yn r5, android.graphics.Bitmap r6) {
        /*
            r3 = 0
        L1:
            int r4 = r6.getWidth()
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.AbstractC1178Pw.A02
            r0 = 2
            r1 = r1[r0]
            r0 = 4
            ...
            if (r1 == r0) goto L4d
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.AbstractC1178Pw.A02
        ...
        L4d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.AbstractC1178Pw.A05(com.facebook.ads.redexgen.X.Yn, android.graphics.Bitmap):boolean");
    }
}
