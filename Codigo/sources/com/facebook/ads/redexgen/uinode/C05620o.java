...
import com.facebook.ads.redexgen.uinode.C05620o;
...
public final class C05620o {
    ...
    public C05620o(J2 j22, final Activity activity, int i10) {
        this.A05 = j22;
    ...
    public static C05620o A00(J2 j22, Activity activity) {
        return A01(j22, activity, Build.VERSION.SDK_INT);
    }

    public static C05620o A01(J2 j22, Activity activity, int i10) {
        if (activity != null && i10 >= 14) {
            return new C05620o(j22, activity, i10);
        }
        return null;
    }

    private void A04(String str, long j10, long j11, EnumC05550g enumC05550g) {
        HashMap hashMap = new HashMap();
        hashMap.put(A02(9, 10, 8), Long.toString(j10));
        hashMap.put(A02(0, 9, 34), Long.toString(j11));
        if (enumC05550g != null) {
            hashMap.put(A02(19, 7, 9), enumC05550g.name());
        }
    ...
    public final void A06(EnumC05550g enumC05550g) {
        this.A02 = enumC05550g;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC05550g enumC05550g = EnumC05550g.A04;
        if (A07[2].charAt(6) == '9') {
