...
public class C242231<K, V> {
    ...
    public int[] A01 = AbstractC24122r.A00;
    public Object[] A02 = AbstractC24122r.A02;
    public int A00 = 0;
    ...
    public final V A0A(int i10) {
        ...
        if (i12 <= 1) {
            ...
            this.A01 = AbstractC24122r.A00;
            this.A02 = AbstractC24122r.A02;
            i11 = 0;
        } else {
            i11 = i12 - 1;
            int[] iArr = this.A01;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C242231) {
            C242231 c242231 = (C242231) obj;
            if (size() != c242231.size()) {
                return false;
            }
            for (int i10 = 0; i10 < this.A00; i10++) {
                try {
                    K A09 = A09(i10);
                    V A0B = A0B(i10);
                    Object obj2 = c242231.get(A09);
                    if (A0B == null) {
                        if (obj2 == null && c242231.containsKey(A09)) {
                        }
                        return false;
                    }
                    if (!A0B.equals(obj2)) {
    ...
    public static int A02(int[] iArr, int i10, int i11) {
        try {
            return AbstractC24122r.A02(iArr, i10, i11);
    ...
    public final void clear() {
        if (this.A00 > 0) {
            ...
            Object[] objArr = this.A02;
            int i10 = this.A00;
            int[] ohashes = AbstractC24122r.A00;
            this.A01 = ohashes;
            this.A02 = AbstractC24122r.A02;
            this.A00 = 0;
            A06(iArr, objArr, i10);
