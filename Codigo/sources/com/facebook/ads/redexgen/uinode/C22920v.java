...
public final class C22920v {
     ...
     */
    public final synchronized void A0A(String str) throws JSONException, C27258B {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    private final synchronized C23261T A00(String str, JSONObject jSONObject) throws JSONException, C27258B {
        C23261T frequencyCappingData;
        if (str.equals(jSONObject.optString(A01(29, 12, 116), null))) {
            frequencyCappingData = new C23261T(str);
            A03(frequencyCappingData, jSONObject);
        } else {
            C27258B c27258b = new C27258B(new IllegalArgumentException());
    ...
    private void A03(C23261T c23261t, JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(A01)) {
            c23261t.A06((JSONArray) jSONObject.get(A01));
        }
        String A012 = A01(81, 20, 86);
        if (jSONObject.has(A012)) {
            int cappingTimeSecs = jSONObject.optInt(A012);
            c23261t.A04(cappingTimeSecs);
        }
        c23261t.A05(optInt, optInt2, optLong, maxCappedArrayLength);
    }
    ...
    public final synchronized void A08(String str) throws JSONException {
        if (str != null) {
            if (!str.trim().isEmpty()) {
                ...
                for (int i10 = 0; i10 < jSONArray.length() && i10 < C23261T.A00(); i10++) {
    ...
    public final synchronized void A0B(JSONObject jSONObject) throws JSONException {
        ...
        if (this.A00.has(optString) && (this.A00.get(optString) instanceof C23261T)) {
            frequencyCappingData = (C23261T) this.A00.get(optString);
        } else {
            frequencyCappingData = new C23261T(optString);
        }
        A03(frequencyCappingData, jSONObject);
