...
public final class C4383ZX extends C25785a implements AdOptionsViewApi {
    ...
    static {
        A02();
        A04 = (int) (AbstractC3499LD.A02 * 23.0f);
        A05 = (int) (AbstractC3499LD.A02 * 4.0f);
    }

    public C4383ZX(final Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i10, AdOptionsView adOptionsView) {
        int i11;
        ...
        ImageView A00 = A00(EnumC3544Lw.DEFAULT_INFO_ICON);
        this.A01 = A00;
        ImageView A002 = A00(EnumC3544Lw.AD_CHOICES_ICON);
        this.A00 = A002;
        ...
        final C4107V2 A0L = C4107V2.A0L(nativeAdBase.getInternalNativeAd());
        ...
        if (A0y != null && A0y.A0R() && !A0y.A0P()) {
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.5N
                ...
                public final void onClick(View view) {
                    ...
                    try {
                        A0L.A1I();
                        if (Build.VERSION.SDK_INT >= 16 && C3348Ih.A23(context)) {
                            linearLayout.performAccessibilityAction(RecognitionOptions.ITF, null);
                        }
                    } catch (Throwable th2) {
                        if (A04[5].charAt(5) == 'z') {
            ...
            EnumC3504LI.A04(adOptionsView, EnumC3504LI.A0B);
        }
    }

    public C4383ZX(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        this(context, nativeAdBase, nativeAdLayout, AdOptionsView.Orientation.HORIZONTAL, 23, adOptionsView);
    }

    private ImageView A00(EnumC3544Lw enumC3544Lw) {
    ...
    public final void A03(EnumC3544Lw enumC3544Lw) {
    ...
    public final void setIconSizeDp(int i10) {
        int iconSize = Math.max(A04, (int) (AbstractC3499LD.A02 * i10));
    ...
    public final void setSingleIcon(boolean z10) {
        AbstractC3536Lo.A0N(this.A01, z10 ? 8 : 0);
    }
}
