...
public final class UA implements MD {
    ...
    public final J2 A05;
    public final MC A06;
    public final InterfaceC1082Me A07;
    public final SA A08;
    public final AbstractC1176Pu A09;
    public final AbstractC1174Ps A0A;
    public final AbstractC1143On A0B;
    public final O7 A0C;
    ...
    public UA(C1399Yn c1399Yn, InterfaceC1082Me interfaceC1082Me, J2 j22, MC mc2) {
        BU bu = new BU(this);
        this.A0C = bu;
        BT bt = new BT(this);
        this.A0B = bt;
        ...
        this.A04 = c1399Yn;
        this.A05 = j22;
        this.A07 = interfaceC1082Me;
        SA sa2 = new SA(c1399Yn);
        this.A08 = sa2;
        sa2.A0c(new AnonymousClass86(c1399Yn));
        ...
        MK closeButton = new MK(c1399Yn);
        closeButton.setOnClickListener(new ViewOnClickListenerC1080Mc(this));
    ...
    public final void A9Q(Intent intent, Bundle bundle, C5V c5v) {
        ...
        if (stringExtra != null && !stringExtra.isEmpty()) {
            C1169Pn c1169Pn = new C1169Pn(this.A04, stringExtra);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
            int i10 = (int) (16.0f * LD.A02);
            layoutParams.setMargins(i10, i10, i10, i10);
            layoutParams.addRule(10);
            layoutParams.addRule(9);
            c1169Pn.setOnClickListener(new ViewOnClickListenerC1081Md(this));
            this.A06.A3U(c1169Pn, layoutParams);
        }
    ...
    public final void ACW(boolean z10) {
        this.A06.A44(A02(37, 21, 27), new C1166Pk());
        this.A08.A0W();
    }
    ...
    public final void onDestroy() {
        this.A06.A44(A02(37, 21, 27), new C1095Mr(this.A00, this.A08.getCurrentPositionInMillis()));
