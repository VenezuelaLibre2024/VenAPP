...
public enum EnumC3397JU {
    ...
    public static VideoAutoplayBehavior A00(EnumC3397JU enumC3397JU) {
        if (enumC3397JU == null) {
            return VideoAutoplayBehavior.DEFAULT;
        }
        switch (C3396JT.A00[enumC3397JU.ordinal()]) {
            case 1:
                return VideoAutoplayBehavior.DEFAULT;
            case 2:
    ...
    public static EnumC3397JU[] valuesCustom() {
        EnumC3397JU[] valuesCustom = values();
        if (A01[1].charAt(9) == 'M') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
        strArr[6] = "qrA";
        strArr[3] = "mB";
        return (EnumC3397JU[]) valuesCustom.clone();
    }
}
