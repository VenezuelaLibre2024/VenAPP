...
public final class C4036Ts extends AbstractC3644NY {
    ...
    public final WeakReference<InterfaceC3647Nb> A0A;
    ...
    static {
        A06();
        A0H = C4036Ts.class.getSimpleName();
    }

    public C4036Ts(C4337Yn c4337Yn, WeakReference<InterfaceC3647Nb> weakReference, int i10, String str) {
        this(c4337Yn, weakReference, i10, false);
        if (C3348Ih.A1W(c4337Yn)) {
            c4337Yn.A01().A0A().AGw(this, str == null ? A04(0, 0, 74) : str, false, true);
            this.A06 = true;
        }
    }

    public C4036Ts(C4337Yn c4337Yn, WeakReference<InterfaceC3647Nb> weakReference, int i10, boolean z10) {
        super(c4337Yn);
        ...
        this.A01 = new C3528Lg();
        this.A05 = true;
        this.A06 = false;
        this.A09 = c4337Yn;
        this.A04 = z10;
        this.A0A = weakReference;
        this.A02 = new C4040Tw(this);
        this.A03 = new C3872RE(this, i10, new WeakReference(this.A02), c4337Yn);
        setWebChromeClient(A0D());
        setWebViewClient(A0E());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        if (Build.VERSION.SDK_INT > 16) {
            addJavascriptInterface(new C3646Na(this, weakReference.get(), this.A03, atomicBoolean, atomicBoolean2, c4337Yn), A04(0, 9, 97));
        }
    }
    ...
    public final WebViewClient A0E() {
        return new C3649Nd(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }

    public final void A0F() {
        this.A09.A0E().AGy();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C4038Tu(this.A03));
    }
