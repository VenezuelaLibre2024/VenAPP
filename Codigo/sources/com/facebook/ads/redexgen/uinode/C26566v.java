...
public class C26566v<E> extends AbstractC26556u<E>.IteratorImpl implements ListIterator<E> {
    public static byte[] A01;
    public final /* synthetic */ AbstractC26556u<E> A00;
    ...
    public C26566v(AbstractC26556u abstractC26556u, int i10) {
        super(abstractC26556u);
        this.A00 = abstractC26556u;
        AbstractC26556u.A02.A04(i10, abstractC26556u.size());
        A05(i10);
    }
    ...
    public final E previous() {
        if (hasPrevious()) {
            AbstractC26556u<E> abstractC26556u = this.A00;
            A05(getA00() - 1);
            return abstractC26556u.get(getA00());
        }
