...
public final class C6T {
    ...
    public C1398Ym A00;
    public String A01;
    public final LP A02 = new LP(300000000000L, new C1406Yu(this));
    ...
    public static InterfaceC07518i A00(C1398Ym c1398Ym) {
        if (C0988Ih.A10(c1398Ym)) {
            return C07528j.A01(A01(0, 6, 104), A01(18, 12, 67), A01(6, 12, 63));
        }
        YK A00 = C07528j.A00();
        String[] strArr = A04;
    ...
    public void A02() {
        ...
        String A042 = C07548l.A00().A01(c1398Ym, true).A04(A00(c1398Ym));
        synchronized (this) {
            this.A01 = A042;
        }
    }
    ...
    public final synchronized String A06(C1398Ym c1398Ym) {
        this.A00 = c1398Ym;
        c1398Ym.A07().AAL();
        if (this.A00.A06().AGJ() || ((A05.get() && C0988Ih.A1Y(this.A00)) || this.A01 == null)) {
            A02();
            this.A02.A04().A03();
            A05.set(false);
        }
