...
public final class FS extends AbstractC1502b5 implements Serializable {
    ...
    public static FS A02(JSONObject jSONObject, C1399Yn c1399Yn) {
        FS fs = new FS(AbstractC1502b5.A08(jSONObject, c1399Yn, new C1497b0()));
        fs.A16(jSONObject);
        fs.A0b(A03(0, 14, 8));
        return fs;
    }
