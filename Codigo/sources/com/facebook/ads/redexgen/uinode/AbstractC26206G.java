...
public abstract class AbstractC26206G {
    ...
    public static C26196F A00(ContentResolver contentResolver) {
        String A012 = A01(72, 14, 36);
        String A013 = A01(3, 9, 127);
        String A014 = A01(0, 3, 122);
        Cursor c10 = null;
        try {
            c10 = contentResolver.query(AbstractC3484Ky.A00(A01(12, 60, 38)), new String[]{A014, A013, A012}, null, null, null);
            if (c10 == null || !c10.moveToFirst()) {
                return new C26196F(null, null, false);
            }
            String string = c10.getString(c10.getColumnIndex(A014));
            String attributionId = c10.getString(c10.getColumnIndex(A013));
            C26196F c26196f = new C26196F(string, attributionId, Boolean.valueOf(c10.getString(c10.getColumnIndex(A012))).booleanValue());
            if (c10 != null) {
                c10.close();
            }
            return c26196f;
