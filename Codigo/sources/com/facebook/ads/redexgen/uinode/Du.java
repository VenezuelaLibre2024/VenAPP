...
public final class Du {
     ...
     */
    public static Du A02(C0980Hz c0980Hz) {
        ...
        if (!z10) {
            ...
            r14 = z12 ? c0980Hz.A0M() : -9223372036854775807L;
            if (!z12) {
                int A0E2 = c0980Hz.A0E();
                arrayList = new ArrayList(A0E2);
                for (int i13 = 0; i13 < A0E2; i13++) {
                    arrayList.add(new C0878Dt(c0980Hz.A0E(), c0980Hz.A0M(), null));
                }
                String[] strArr = A0B;
            ...
            if (z14) {
                long A0E3 = c0980Hz.A0E();
                z13 = (128 & A0E3) != 0;
                j10 = (1000 * (((1 & A0E3) << 32) | c0980Hz.A0M())) / 90;
            }
            i10 = c0980Hz.A0I();
            i11 = c0980Hz.A0E();
            i12 = c0980Hz.A0E();
        }
        return new Du(A0M, z10, z11, z12, arrayList, r14, z13, j10, i10, i11, i12);
    }

    public Du(long j10, boolean z10, boolean z11, boolean z12, List<C0878Dt> list, long j11, boolean z13, long j12, int i10, int i11, int i12) {
        this.A04 = j10;
        this.A0A = z10;
        this.A08 = z11;
        this.A09 = z12;
    ...
    public static /* synthetic */ Du A03(C0980Hz c0980Hz) {
        return A02(c0980Hz);
    }
