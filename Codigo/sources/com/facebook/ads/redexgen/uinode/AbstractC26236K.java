...
public abstract class AbstractC26236K {
     ...
     */
    public static C26166C A02(C26937f c26937f) {
        Object A002;
        Method A022;
        Object A003;
        Method A023 = AbstractC26246L.A02(A00, A04(257, 29, 114), Context.class);
        if (A023 == null || (A002 = AbstractC26246L.A00(null, A023, c26937f)) == null || ((Integer) A002).intValue() != 0 || (A022 = AbstractC26246L.A02(A04(65, 57, 11), A04(232, 20, 55), Context.class)) == null || (A003 = AbstractC26246L.A00(null, A022, c26937f)) == null) {
            return null;
        }
        Method A012 = AbstractC26246L.A01(A003.getClass(), A04(252, 5, 38), new Class[0]);
        Method A013 = AbstractC26246L.A01(A003.getClass(), A04(286, 24, 120), new Class[0]);
        if (A012 == null || A013 == null) {
            return null;
        }
        String str = (String) AbstractC26246L.A00(A003, A012, new Object[0]);
        Boolean bool = (Boolean) AbstractC26246L.A00(A003, A013, new Object[0]);
        if (str != null) {
            return new C26166C(str, bool != null && bool.booleanValue(), EnumC26156B.A07);
        }
        return null;
    }
    ...
    static {
        A05();
        A03 = C26166C.class.getSimpleName();
        A00 = A04(173, 52, 75);
    }
    ...
    */
    public static com.facebook.ads.redexgen.uinode.C26166C A00(com.facebook.ads.redexgen.uinode.C26937f r5) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.AbstractC26236K.A02
            r0 = 0
            r1 = r1[r0]
            r0 = 25
            ...
            throw r0
        L2d:
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.AbstractC26236K.A02
        ...
        L4b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.AbstractC26236K.A00(com.facebook.ads.redexgen.X.7f):com.facebook.ads.redexgen.X.6C");
    }

    public static C26166C A01(C26937f c26937f) {
        InterfaceC26977j adId = c26937f.A04().A7p();
        if (adId != null) {
            return new C26166C(adId.getId(), adId.A97(), EnumC26156B.A03);
        }
        return null;
    }

    /* JADX WARN: Type inference failed for: r0v9, types: [com.facebook.ads.internal.attribution.GmsAttributionProvider$GoogleAdInfo] */
    public static C26166C A03(C26937f c26937f) {
        ServiceConnectionC26226J serviceConnectionC26226J = new ServiceConnectionC26226J();
        Intent intent = new Intent(A04(122, 51, 52));
        intent.setPackage(A04(43, 22, 2));
        if (c26937f.bindService(intent, serviceConnectionC26226J, 1)) {
            try {
                final IBinder A022 = serviceConnectionC26226J.A02();
                ...
                return new C26166C(r02.A02(), r02.A03(), EnumC26156B.A08);
            } catch (Throwable th2) {
                try {
                    c26937f.A07().A9a(A04(225, 7, 30), AbstractC27248A.A1Q, new C27258B(th2));
                } finally {
                    c26937f.unbindService(serviceConnectionC26226J);
                }
            }
        }
        return null;
