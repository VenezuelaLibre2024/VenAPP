...
public final class C1A extends BroadcastReceiver {
    ...
    public C1A(C0819Ba c0819Ba, Context context) {
        this.A01 = c0819Ba;
        this.A00 = context;
    }
    ...
    public final void A02() {
        ...
        C06142o.A00(this.A00).A06(this, intentFilter);
    }

    public final void A03() {
        try {
            C06142o.A00(this.A00).A05(this);
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (str3.equals(action5)) {
            ...
            if (serializableExtra instanceof C1095Mr) {
                if (this.A01.getListener() != null) {
                ...
                if (this.A02) {
                    ...
                    this.A01.A0Y(((C1095Mr) serializableExtra).A01());
                }
                this.A01.setVisibility(0);
                this.A01.A0b(QM.A04, 1);
                return;
            }
            if (serializableExtra instanceof C1166Pk) {
                if (this.A01.getListener() == null) {
                    return;
                }
