...
public final class GI {
    ...
    public final C0980Hz A00 = new C0980Hz();
    ...
    public static char A00(C0980Hz c0980Hz, int i10) {
        return (char) c0980Hz.A00[i10];
    }

    public static String A02(C0980Hz c0980Hz) {
        int limit = c0980Hz.A06();
        int A07 = c0980Hz.A07();
        char c10 = 0;
        while (limit < A07 && c10 == 0) {
            int i10 = limit + 1;
            int position = c0980Hz.A00[limit];
            int limit2 = (char) position;
            c10 = limit2 == 41 ? (char) 1 : (char) 0;
            limit = i10;
        }
        int position2 = c0980Hz.A06();
        return c0980Hz.A0S((limit - 1) - position2).trim();
    }

    public static String A03(C0980Hz c0980Hz, StringBuilder sb2) {
        sb2.setLength(0);
        int A06 = c0980Hz.A06();
        int A07 = c0980Hz.A07();
        boolean z10 = false;
        while (A06 < A07 && !z10) {
            int position = c0980Hz.A00[A06];
        ...
        int position2 = c0980Hz.A06();
        c0980Hz.A0Z(A06 - position2);
        return sb2.toString();
    }

    public static String A04(C0980Hz c0980Hz, StringBuilder sb2) {
        A0A(c0980Hz);
        if (c0980Hz.A04() == 0) {
            return null;
        }
        String A032 = A03(c0980Hz, sb2);
        String A01 = A01(0, 0, 115);
        if (!A01.equals(A032)) {
            return A032;
        }
        String identifier = A01 + ((char) c0980Hz.A0E());
        return identifier;
    }

    public static String A05(C0980Hz c0980Hz, StringBuilder sb2) {
        StringBuilder sb3 = new StringBuilder();
        boolean z10 = false;
        while (!z10) {
            int A06 = c0980Hz.A06();
            String token = A04(c0980Hz, sb2);
            if (token == null) {
                return null;
            }
    ...
    public static String A06(C0980Hz c0980Hz, StringBuilder sb2) {
        A0A(c0980Hz);
        if (c0980Hz.A04() < 5) {
            return null;
        }
        String A0S = c0980Hz.A0S(5);
    ...
    private void A08(GM gm2, String str) {
        ...
        if (indexOf2 != -1) {
            gm2.A0J(str4.substring(0, indexOf2));
            gm2.A0I(str4.substring(indexOf2 + 1));
        } else {
            gm2.A0J(str4);
        }
        if (classDivision.length > 1) {
            gm2.A0L((String[]) Arrays.copyOfRange(classDivision, 1, classDivision.length));
        }
    }

    public static void A09(C0980Hz c0980Hz) {
        String line;
        do {
            line = c0980Hz.A0P();
    ...
    public static void A0A(C0980Hz c0980Hz) {
        boolean skipping = true;
        while (c0980Hz.A04() > 0 && skipping) {
            boolean skipping2 = A0D(c0980Hz);
            if (!skipping2) {
                boolean skipping3 = A0C(c0980Hz);
                if (!skipping3) {
                    skipping = false;
                }
            }
    ...
    public static void A0B(C0980Hz c0980Hz, GM gm2, StringBuilder sb2) {
        A0A(c0980Hz);
        String A032 = A03(c0980Hz, sb2);
        String A01 = A01(0, 0, 115);
        if (A01.equals(A032)) {
        ...
        String property = A04(c0980Hz, sb2);
        if (!A012.equals(property)) {
            return;
        }
        A0A(c0980Hz);
        String token = A05(c0980Hz, sb2);
        if (token == null || A01.equals(token)) {
            return;
        }
        int A06 = c0980Hz.A06();
        String A042 = A04(c0980Hz, sb2);
        String[] strArr = A03;
        String str = strArr[4];
        ...
        if (position != str2.charAt(25)) {
            ...
            if (property6.equals(A032)) {
                gm2.A0C(AbstractC0960Hf.A02(token));
                return;
            }
            String property7 = A01(30, 16, 24);
            if (property7.equals(A032)) {
                gm2.A0B(AbstractC0960Hf.A02(token));
                return;
            }
    ...
    public static boolean A0C(C0980Hz c0980Hz) {
        int position = c0980Hz.A06();
        int limit = c0980Hz.A07();
        ...
        if (bArr[i10] == 42) {
            ...
            c0980Hz.A0Z(limit - c0980Hz.A06());
            return true;
        }
        return false;
    }

    public static boolean A0D(C0980Hz c0980Hz) {
        switch (A00(c0980Hz, c0980Hz.A06())) {
            case '\t':
            case '\n':
            case '\f':
            case '\r':
    ...
    public final GM A0E(C0980Hz c0980Hz) {
        this.A01.setLength(0);
        int A06 = c0980Hz.A06();
        A09(c0980Hz);
        C0980Hz c0980Hz2 = this.A00;
        byte[] bArr = c0980Hz.A00;
        int initialInputPosition = c0980Hz.A06();
        c0980Hz2.A0b(bArr, initialInputPosition);
        this.A00.A0Y(A06);
