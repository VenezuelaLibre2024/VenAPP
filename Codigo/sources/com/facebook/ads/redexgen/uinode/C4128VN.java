...
public class C4128VN implements InterfaceC3879RL {
    ...
    public C4128VN(C26937f c26937f) {
        this.A00 = c26937f;
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC3879RL
    public final void AB9(InterfaceC3877RJ interfaceC3877RJ) {
        if (this.A00.A04().A8z() && interfaceC3877RJ != null) {
            String str = A00(24, 31, 72) + interfaceC3877RJ.A69();
        }
    }
    ...
    public final void ABS(Exception exc) {
        if (this.A00.A04().A8z()) {
            Log.e(C3380JD.A00(), A00(0, 24, 60), exc);
        }
    }
}
