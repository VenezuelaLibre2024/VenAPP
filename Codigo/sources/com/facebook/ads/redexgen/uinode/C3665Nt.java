...
public final class C3665Nt extends View {
    ...
    static {
        A01();
        A0B = (int) (AbstractC3499LD.A02 * 5.0f);
    }

    public C3665Nt(C4337Yn c4337Yn) {
        super(c4337Yn);
    ...
    public final void A02(int i10, int i11, int i12) {
        ...
        this.A06.setColorFilter(new PorterDuffColorFilter(AbstractC24102p.A01(i11, i12), PorterDuff.Mode.SRC_ATOP));
    }
    ...
    public void setImage(EnumC3544Lw enumC3544Lw) {
        this.A02 = enumC3544Lw == null ? null : AbstractC3545Lx.A01(enumC3544Lw);
        invalidate();
    }
