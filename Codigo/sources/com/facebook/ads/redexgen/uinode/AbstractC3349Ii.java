...
public abstract class AbstractC3349Ii {
    ...
    public static boolean A02(Context context) {
        return C3348Ih.A0R(context).A2Z(A00(0, 47, 108), true);
    }

    public static boolean A03(Context context) {
        return C3348Ih.A0R(context).A2Z(A00(47, 47, 115), false);
    }

    public static boolean A04(Context context) {
        return C3348Ih.A0R(context).A2Z(A00(139, 46, 114), false);
    }

    public static boolean A05(Context context) {
        return Build.VERSION.SDK_INT >= 19 && C3348Ih.A0R(context).A2Z(A00(185, 15, 91), false);
    }

    public static boolean A06(Context context) {
        return C3348Ih.A0R(context).A2Z(A00(94, 45, 96), false);
    }
}
