...
public final class C26015x implements RewardedVideoAdApi, Repairable {
    ...
    public C26015x(Context context, String str, InterfaceC2219Ad interfaceC2219Ad) {
        this.A00 = interfaceC2219Ad;
        String uuid = UUID.randomUUID().toString();
        C4337Yn A07 = C25805c.A07(context, uuid);
        this.A03 = A07;
        InterfaceC22640S A0E = A07.A0E();
        String adId = AdPlacementType.REWARDED_VIDEO.toString();
        A0E.A2s(adId, str);
        C23742F c23742f = new C23742F(A07, str, interfaceC2219Ad, new C4444aZ());
        this.A01 = c23742f;
        A07.A0L(this);
        this.A02 = new C3139FE(c23742f, uuid);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi, com.facebook.ads.FullScreenAd
    /* renamed from: A02, reason: merged with bridge method [inline-methods] */
    public final C26025y buildLoadAdConfig() {
        return new C26025y(this);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi, com.facebook.ads.FullScreenAd
    /* renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final C26035z buildShowAdConfig() {
        return new C26035z();
    }
    ...
    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi, com.facebook.ads.InterfaceC2219Ad
    public final void destroy() {
        AbstractC3416Jp.A05(A00(136, 7, 66), A00(48, 27, 119), A00(16, 8, 74));
        A04();
    }
    ...
    public final void loadAd() {
        AbstractC3416Jp.A05(A00(143, 6, 60), A00(75, 32, 89), A00(24, 8, 17));
        A07(null, null, true);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final void loadAd(RewardedVideoAd.RewardedVideoLoadAdConfig rewardedVideoLoadAdConfig) {
        ((C26025y) rewardedVideoLoadAdConfig).A00();
    }

    @Override // com.facebook.ads.internal.context.Repairable
    public final void repair(Throwable th2) {
        if (this.A01.A04 != null) {
            this.A01.A04.onError(this.A00, new AdError(AdError.INTERNAL_ERROR_CODE, A00(32, 16, 5) + AbstractC3518LW.A03(this.A01.A0B, th2)));
        }
    }
    ...
    public final boolean show() {
        AbstractC3416Jp.A05(A00(149, 4, 94), A00(107, 29, 107), A00(0, 8, 62));
        return A08(new C26035z().withAppOrientation(-1).build());
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final boolean show(RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        AbstractC3416Jp.A05(A00(149, 4, 94), A00(107, 29, 107), A00(8, 8, 108));
