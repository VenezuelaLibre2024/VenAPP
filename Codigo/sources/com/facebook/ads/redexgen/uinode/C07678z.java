...
public final class C07678z {
    ...
    public C07678z(int i10, int i11) {
        if (i10 < -1) {
    ...
    public final int A04(C07678z c07678z) {
        int i10 = this.A00;
        int i11 = c07678z.A00;
        if (i10 != i11) {
            return i10 - i11;
        }
        return this.A01 - c07678z.A01;
    }

    public final C07678z A05(int i10) {
        int i11 = this.A01;
        if (i10 + i11 >= 0) {
            return new C07678z(this.A00, i11 + i10);
        }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C07678z)) {
            return false;
        }
        C07678z c07678z = (C07678z) obj;
        int i10 = c07678z.A00;
        int i11 = this.A00;
        if (A03[4].charAt(2) != 'U') {
        ...
        return i10 == i11 && c07678z.A01 == this.A01;
    }
