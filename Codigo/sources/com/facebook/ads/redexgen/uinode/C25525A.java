...
public final class C25525A extends AbstractC2948Bq {
    ...
    public int A02;
    public int A03;
    public List<C3172Fn> A05;
    public List<C3172Fn> A06;
    public boolean A07;
    public final int A08;
    public final int A09;
    public final C3306Hz A0A = new C3306Hz();
    public final ArrayList<C3179Fu> A0B = new ArrayList<>();
    public C3179Fu A04 = new C3179Fu(0, 4);
    ...
    public C25525A(String str, int i10) {
    ...
    private List<C3172Fn> A05() {
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < this.A0B.size(); i10++) {
            C3172Fn A05 = this.A0B.get(i10).A05();
            if (A05 != null) {
                arrayList.add(A05);
            }
        }
    ...
    private void A0A(byte b10, byte b11) {
        ...
        if (i10 != row3) {
            ...
            if (row4 != 1 && !this.A04.A0F()) {
                int i11 = this.A02;
                int row5 = this.A03;
                C3179Fu c3179Fu = new C3179Fu(i11, row5);
                this.A04 = c3179Fu;
                this.A0B.add(c3179Fu);
            }
            this.A04.A0C(i10);
        }
        ...
        int row7 = b11 >> 1;
        int i12 = row7 & 7;
        C3179Fu c3179Fu2 = this.A04;
        int row8 = cursorOrStyle != 0 ? 8 : i12;
        c3179Fu2.A0E(row8, isCursor);
        if (cursorOrStyle != 0) {
            C3179Fu c3179Fu3 = this.A04;
            int row9 = A0F[i12];
            c3179Fu3.A0B(row9);
        }
    }
    ...
    */
    private boolean A0E(byte r6, byte r7) {
        /*
            ...
            r0 = 0
            r5.A07 = r0
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C25525A.A0D
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            if (r1 == r0) goto L30
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C25525A.A0D
        ...
        L81:
            ...
            goto L7d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C25525A.A0E(byte, byte):boolean");
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC2948Bq
    /* renamed from: A0L */
    public final /* bridge */ /* synthetic */ C2963C5 A54() throws C3174Fp {
        return super.A54();
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC2948Bq
    /* renamed from: A0M */
    public final /* bridge */ /* synthetic */ AbstractC2949Br A55() throws C3174Fp {
        return super.A55();
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC2948Bq
    public final C4185WI A0N() {
        List<C3172Fn> list = this.A05;
        this.A06 = list;
        return new C4185WI(list);
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC2948Bq
    /* renamed from: A0O */
    public final /* bridge */ /* synthetic */ void AEG(C2963C5 c2963c5) throws C3174Fp {
        super.AEG(c2963c5);
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC2948Bq
    public final void A0P(C2963C5 c2963c5) {
        int i10;
        this.A0A.A0b(c2963c5.A01.array(), c2963c5.A01.limit());
        boolean z10 = false;
        boolean z11 = false;
        while (true) {
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC2948Bq, com.facebook.ads.redexgen.uinode.InterfaceC2909BB
    public final void AEV() {
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC2948Bq, com.facebook.ads.redexgen.uinode.InterfaceC4188WL
