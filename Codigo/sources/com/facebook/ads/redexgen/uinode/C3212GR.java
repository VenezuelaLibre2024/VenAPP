...
public final class C3212GR {
     ...
     */
    public static void A0C(String str, String str2, C3209GO c3209go, List<C3207GM> list) {
                ...
                case '<':
                    if (i10 + 1 < str2.length()) {
                        ...
                        if (A042 != null && A0E(A042)) {
                            if (!z10) {
                                if (!z11) {
                                    arrayDeque.push(C3210GP.A01(substring, spannableStringBuilder.length()));
                                    break;
                                } else {
                                    break;
                                }
                                ...
                                while (!arrayDeque.isEmpty()) {
                                    C3210GP c3210gp = (C3210GP) arrayDeque.pop();
                                    A0B(str, c3210gp, spannableStringBuilder, list, arrayList);
                                    if (c3210gp.A01.equals(A042)) {
                                        break;
                                    }
                                }
                                break;
        ...
        while (!arrayDeque.isEmpty()) {
            A0B(str, (C3210GP) arrayDeque.pop(), spannableStringBuilder, list, arrayList);
        }
        A0B(str, C3210GP.A00(), spannableStringBuilder, list, arrayList);
        c3209go.A0C(spannableStringBuilder);
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 20 out of bounds for length 15
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public final boolean A0G(C3306Hz c3306Hz, C3209GO c3209go, List<C3207GM> list) {
        ...
        if (matcher.matches()) {
            return A0F(null, matcher, c3306Hz, c3209go, this.A00, list);
        }
        String A0P2 = c3306Hz.A0P();
        if (A0P2 == null) {
            return false;
        }
        Matcher matcher2 = pattern.matcher(A0P2);
        if (matcher2.matches()) {
            return A0F(A0P.trim(), matcher2, c3306Hz, c3209go, this.A00, list);
        }
        return false;
    }
    ...
    */
    public static int A00(java.lang.String r7) {
        ...
        L4a:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C3212GR.A02
            r0 = 6
            r1 = r1[r0]
            r0 = 12
            ...
            r0 = 85
            if (r1 == r0) goto Lb9
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C3212GR.A02
        ...
        Lb9:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3212GR.A00(java.lang.String):int");
    }
    ...
    public static String A04(String str) {
        ...
        if (!trim.isEmpty()) {
            return AbstractC3322IF.A0m(trim, A03(156, 5, 44))[0];
        }
        if (A02[4].length() == 19) {
            throw new RuntimeException();
        }
    ...
    public static void A06(SpannableStringBuilder spannableStringBuilder, C3207GM c3207gm, int i10, int i11) {
        if (c3207gm == null) {
            return;
        }
        if (c3207gm.A08() != -1) {
            spannableStringBuilder.setSpan(new StyleSpan(c3207gm.A08()), i10, i11, 33);
        }
        if (c3207gm.A0O()) {
        ...
        if (c3207gm.A0N()) {
            spannableStringBuilder.setSpan(new ForegroundColorSpan(c3207gm.A06()), i10, i11, 33);
        }
        if (c3207gm.A0M()) {
            spannableStringBuilder.setSpan(new BackgroundColorSpan(c3207gm.A05()), i10, i11, 33);
        }
        String A0H = c3207gm.A0H();
        if (A02[6].charAt(12) != 'U') {
            A02[6] = "tzfwj6Yb5L7snAfsv0bj9UNvpNFUfxvv";
            if (A0H != null) {
                spannableStringBuilder.setSpan(new TypefaceSpan(c3207gm.A0H()), i10, i11, 33);
            }
            if (c3207gm.A0A() != null) {
                spannableStringBuilder.setSpan(new AlignmentSpan.Standard(c3207gm.A0A()), i10, i11, 33);
            }
            switch (c3207gm.A07()) {
                case 1:
                    spannableStringBuilder.setSpan(new AbsoluteSizeSpan((int) c3207gm.A04(), true), i10, i11, 33);
                    return;
                case 2:
                    spannableStringBuilder.setSpan(new RelativeSizeSpan(c3207gm.A04()), i10, i11, 33);
                    return;
                case 3:
                    spannableStringBuilder.setSpan(new RelativeSizeSpan(c3207gm.A04() / 100.0f), i10, i11, 33);
                    return;
                default:
                    return;
            }
    ...
    public static void A08(String str, C3209GO c3209go) {
    ...
    public static void A09(String str, C3209GO c3209go) throws NumberFormatException {
        int indexOf = str.indexOf(44);
        if (indexOf != -1) {
            c3209go.A06(A00(str.substring(indexOf + 1)));
            str = str.substring(0, indexOf);
        } else {
            c3209go.A06(Integer.MIN_VALUE);
        }
        if (str.endsWith(A03(2, 1, 47))) {
            c3209go.A03(AbstractC3213GS.A00(str)).A07(0);
            return;
        }
        ...
        c3209go.A03(commaIndex).A07(1);
    }

    public static void A0A(String str, C3209GO c3209go) throws NumberFormatException {
        int indexOf = str.indexOf(44);
        if (indexOf != -1) {
            int commaIndex = indexOf + 1;
            c3209go.A08(A00(str.substring(commaIndex)));
            str = str.substring(0, indexOf);
        } else {
            c3209go.A08(Integer.MIN_VALUE);
        }
        c3209go.A04(AbstractC3213GS.A00(str));
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public static void A0B(String str, C3210GP c3210gp, SpannableStringBuilder spannableStringBuilder, List<C3207GM> list, List<C3211GQ> list2) {
        char c10;
        int i10 = c3210gp.A00;
        int i11 = spannableStringBuilder.length();
        String str2 = c3210gp.A01;
    ...
    public static void A0D(List<C3207GM> list, String str, C3210GP c3210gp, List<C3211GQ> list2) {
        int size = list.size();
        for (int i10 = 0; i10 < size; i10++) {
            C3207GM c3207gm = list.get(i10);
            String str2 = c3210gp.A01;
            String[] strArr = c3210gp.A03;
            String str3 = c3210gp.A02;
            ...
            int styleCount = c3207gm.A09(str, str2, strArr, str3);
            if (styleCount > 0) {
                list2.add(new C3211GQ(styleCount, c3207gm));
            }
        }
    ...
    public static boolean A0F(String str, Matcher matcher, C3306Hz c3306Hz, C3209GO c3209go, StringBuilder sb2, List<C3207GM> list) {
        try {
            c3209go.A0A(AbstractC3213GS.A01(matcher.group(1))).A09(AbstractC3213GS.A01(matcher.group(2)));
            A08(matcher.group(3), c3209go);
            sb2.setLength(0);
            while (true) {
                String A0P = c3306Hz.A0P();
                if (!TextUtils.isEmpty(A0P)) {
                    ...
                    A0C(str, sb2.toString(), c3209go, list);
                    return true;
                }
            }
        } catch (NumberFormatException unused) {
