...
public class C1424Zn extends AnonymousClass51 {
    ...
    private final int A03(View view, int i10) {
        ...
        return A0N(A08.A0o(view) - c06664p.topMargin, A08.A0j(view) + c06664p.bottomMargin, A08.A0g(), A08.A0X() - A08.A0d(), i10);
    }
    ...
    public int A0O(View view, int i10) {
        ...
        C06664p c06664p = (C06664p) view.getLayoutParams();
        return A0N(A08.A0k(view) - c06664p.leftMargin, A08.A0n(view) + c06664p.rightMargin, A08.A0e(), A08.A0h() - A08.A0f(), i10);
    }

    public C1424Zn(Context context) {
    ...
    private final void A07(C06754z c06754z) {
        PointF A0P = A0P(A07());
        ...
        c06754z.A04((int) (this.A00 * 1.2f), (int) (this.A01 * 1.2f), time, this.A05);
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AnonymousClass51
    public final void A0H(int i10, int i11, AnonymousClass53 anonymousClass53, C06754z c06754z) {
        if (A06() == 0) {
            A09();
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AnonymousClass51
    public void A0I(View view, AnonymousClass53 anonymousClass53, C06754z c06754z) {
        ...
        if (time > 0) {
            int distance = -A0O;
            int dy2 = -A03;
            c06754z.A04(distance, dy2, time, this.A04);
        }
    }
