...
public class SA extends RelativeLayout implements RC, QE {
    ...
    public static final C1175Pt A0G;
    public static final O8 A0H;
    public static final C1117Nn A0I;
    public static final C1083Mf A0J;
    public static final C1078Ma A0K;
    public static final MW A0L;
    public static final MU A0M;
    public static final C1072Lu A0N;
    public int A00;
    public JA A01;
    public QJ A02;
    public boolean A03;
    ...
    public final C07608r<AbstractC07618s, C07598q> A0B;
    ...
    public SA(C1399Yn c1399Yn) {
        super(c1399Yn);
        this.A0C = new ArrayList();
        this.A07 = new Handler();
        this.A08 = new Handler();
        this.A0B = new C07608r<>();
        this.A05 = true;
        this.A00 = 200;
        this.A09 = new QD(this);
        this.A0A = c1399Yn;
        if (A0S(c1399Yn)) {
            this.A0D = new TextureViewSurfaceTextureListenerC1024Jv(c1399Yn);
        } else {
            this.A0D = new TextureViewSurfaceTextureListenerC1023Ju(c1399Yn);
        }
        A0G();
    }

    public SA(C1399Yn c1399Yn, AttributeSet attributeSet) {
        ...
        this.A0A = c1399Yn;
        if (A0S(c1399Yn)) {
            this.A0D = new TextureViewSurfaceTextureListenerC1024Jv(c1399Yn, attributeSet);
        } else {
            this.A0D = new TextureViewSurfaceTextureListenerC1023Ju(c1399Yn, attributeSet);
        }
        A0G();
    }

    public SA(C1399Yn c1399Yn, AttributeSet attributeSet, int i10) {
        ...
        this.A0A = c1399Yn;
        if (A0S(c1399Yn)) {
            this.A0D = new TextureViewSurfaceTextureListenerC1024Jv(c1399Yn, attributeSet, i10);
        } else {
            this.A0D = new TextureViewSurfaceTextureListenerC1023Ju(c1399Yn, attributeSet, i10);
        }
        A0G();
    }

    public static /* synthetic */ C1117Nn A0C() {
        C1117Nn c1117Nn = A0I;
        if (A0F[0].length() != 31) {
            throw new RuntimeException();
        }
    ...
    private void A0R(QQ qq) {
        if (qq instanceof C7R) {
            ...
            AbstractC1066Lo.A0J(qq);
        }
    }

    private boolean A0S(C1399Yn c1399Yn) {
        return C0988Ih.A2S(c1399Yn, C1204Qw.A03());
    }
    ...
    public final void ABa(final long j10, final long j11, final long j12, final float f10) {
        if (!C0988Ih.A1X(this.A0A)) {
            return;
        }
        this.A0B.A02(new QA(j10, j11, j12, f10) { // from class: com.facebook.ads.redexgen.X.9F
        });
    }
    ...
    public C07608r<AbstractC07618s, C07598q> getEventBus() {
        return this.A0B;
    }
    ...
    public void setVideoURI(String str) {
        ...
        setVideoURI(str != null ? AbstractC1050Ky.A00(str) : null);
    }
    ...
    public void setVolume(float f10) {
        ...
        C07608r<AbstractC07618s, C07598q> eventBus = getEventBus();
        if (A0F[2].length() == 19) {
            throw new RuntimeException();
        }
