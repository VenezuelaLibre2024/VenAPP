...
public class C4400Zp implements InterfaceC25284m {
    ...
    public final void A04(C3100Eb c3100Eb, boolean z10) {
        this.A00 = 0;
        int[] iArr = this.A03;
        if (iArr != null) {
            Arrays.fill(iArr, -1);
        }
        AbstractC25304o abstractC25304o = c3100Eb.A06;
        if (c3100Eb.A04 != null && abstractC25304o != null && abstractC25304o.A1U()) {
            if (z10) {
                boolean A0B = c3100Eb.A00.A0B();
                String[] strArr = A05;
                if (strArr[0].charAt(30) != strArr[5].charAt(30)) {
                    A05[7] = "b5aEeD0";
                    if (!A0B) {
                        abstractC25304o.A1r(c3100Eb.A04.A0E(), this);
                    }
                }
                throw new RuntimeException();
            }
            if (!c3100Eb.A1p()) {
                abstractC25304o.A1q(this.A01, this.A02, c3100Eb.A0s, this);
            }
            int i10 = this.A00;
            int i11 = abstractC25304o.A00;
            String[] strArr2 = A05;
            if (strArr2[3].length() != strArr2[6].length()) {
                A05[7] = "TjVTm35";
                if (i10 > i11) {
                    abstractC25304o.A00 = this.A00;
                    abstractC25304o.A08 = z10;
                    c3100Eb.A0r.A0O();
                    return;
                }
                return;
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC25284m
