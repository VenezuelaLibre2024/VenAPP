...
public abstract class AbstractC07367s {
    ...
    public abstract C07327m[] A0A();

    static {
        A04();
    }

    public AbstractC07367s(C07337o c07337o) {
        this.A00 = c07337o;
    }
    ...
    public static String A02(String str, C07327m[] c07327mArr) {
        StringBuilder sb2 = new StringBuilder(A01(56, 7, 106));
        for (int i10 = 0; i10 < c07327mArr.length - 1; i10++) {
            sb2.append(c07327mArr[i10].A01);
        ...
        sb2.append(c07327mArr[c07327mArr.length - 1].A01);
        sb2.append(A01(6, 6, 79));
        sb2.append(str);
        return sb2.toString();
    }

    public static String A03(String str, C07327m[] c07327mArr, C07327m c07327m) {
        return A02(str, c07327mArr) + A01(12, 7, 121) + c07327m.A01 + A01(2, 4, 32);
    }
