...
public final class C27127y {
    ...
    public C27127y(String str, Map<String, String> mStaticEnvironmentData) {
        this(str, mStaticEnvironmentData, false);
    }

    public C27127y(String str, Map<String, String> map, boolean z10) {
        this.A01 = str;
        this.A02 = map;
