...
public final class C1051Kz {
    ...
    public static int A00(C1399Yn c1399Yn, int i10) {
        return KE.A00(c1399Yn).getInt(A01(0, 21, 2), i10);
    }

    public static String A02(C1399Yn c1399Yn, String str) {
        int A002 = A00(c1399Yn, -1);
        if (A002 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C1399Yn c1399Yn, String str, String str2) {
        if (c1399Yn == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c1399Yn, str);
    ...
    public final RewardedVideoAd A07(C1399Yn c1399Yn, String str, String str2) {
        if (c1399Yn == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c1399Yn, str);
    ...
    public final void A08(C1399Yn c1399Yn, boolean z10) {
        int i10 = 0;
        String A01 = A01(0, 21, 2);
        if (!z10) {
            int lastNonChainedAds = KE.A00(c1399Yn).getInt(A01, 0);
            i10 = lastNonChainedAds + 1;
        }
        KE.A00(c1399Yn).edit().putInt(A01, i10).apply();
    }

    public final boolean A09(C1399Yn c1399Yn, String str, int i10) {
        if (i10 <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c1399Yn, i10 - 1);
