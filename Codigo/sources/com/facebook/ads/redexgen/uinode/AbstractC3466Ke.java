...
public abstract class AbstractC3466Ke {
     ...
     */
    public static EnumC3465Kd A00() throws ClassNotFoundException, NoSuchMethodException, NoSuchFieldException, InvocationTargetException, IllegalAccessException {
        ...
        for (Object obj : map.values()) {
            ...
            if (activity.isTaskRoot() && activity.getIntent().getCategories().contains(A03(34, 32, 84))) {
                return EnumC3465Kd.A06;
            }
        }
        return EnumC3465Kd.A09;
    }
    ...
    public static EnumC3465Kd A01(Context context) {
        try {
            ...
            return EnumC3465Kd.A04;
        }
    }

    public static EnumC3465Kd A02(Context context) {
        if (context == null) {
            return EnumC3465Kd.A0C;
        }
        ActivityManager mgr = (ActivityManager) context.getSystemService(A03(0, 8, 87));
        if (mgr == null) {
            return EnumC3465Kd.A07;
        }
        List<ActivityManager.AppTask> tasks = mgr.getAppTasks();
        if (tasks.isEmpty()) {
            return EnumC3465Kd.A0A;
        }
        ...
        while (it.hasNext()) {
            ...
            if (taskInfo != null && taskInfo.baseIntent != null) {
                ...
                if (categories != null && taskInfo.baseIntent.getCategories().contains(A03(34, 32, 84))) {
                    return EnumC3465Kd.A05;
                }
            }
        }
        return EnumC3465Kd.A08;
    }
}
