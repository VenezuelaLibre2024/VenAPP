...
public final class C0852Ck {
    ...
    public final C0980Hz A0A = new C0980Hz(255);
    ...
    public final boolean A03(InterfaceC0838Bt interfaceC0838Bt, boolean z10) throws IOException, InterruptedException {
        this.A0A.A0V();
        A02();
        boolean hasEnoughBytes = interfaceC0838Bt.A7I() == -1 || interfaceC0838Bt.A7I() - interfaceC0838Bt.A7d() >= 27;
        if (hasEnoughBytes) {
            boolean hasEnoughBytes2 = interfaceC0838Bt.ADw(this.A0A.A00, 0, 27, true);
            if (hasEnoughBytes2) {
                if (this.A0A.A0M() != A0C) {
                    if (z10) {
                        return false;
                    }
                    throw new C07889v(A00(4, 46, 60));
                }
                ...
                if (A0E != 0) {
                    ...
                    throw new C07889v(A00(50, 31, 66));
                }
                ...
                this.A01 = A0E2 + 27;
                this.A0A.A0V();
                interfaceC0838Bt.ADv(this.A0A.A00, 0, this.A02);
