...
public final class C25384w {
    ...
    public int A00;
    public C25374v A01;
    public ArrayList<AbstractC254856> A02;
    public int A03;
    public AbstractC254654 A04;
    public final ArrayList<AbstractC254856> A05;
    public final ArrayList<AbstractC254856> A06;
    public final List<AbstractC254856> A07;
    public final /* synthetic */ C3100Eb A08;
    ...
    public C25384w(C3100Eb c3100Eb) {
        this.A08 = c3100Eb;
        ArrayList<AbstractC254856> arrayList = new ArrayList<>();
        this.A05 = arrayList;
        this.A02 = null;
    ...
    private final AbstractC254856 A01(int i10) {
        int size;
        int A04;
        ArrayList<AbstractC254856> arrayList = this.A02;
        if (arrayList == null || (size = arrayList.size()) == 0) {
            return null;
        }
        for (int i11 = 0; i11 < size; i11++) {
            AbstractC254856 abstractC254856 = this.A02.get(i11);
            if (!abstractC254856.A0g()) {
                int i12 = abstractC254856.A0I();
                if (i12 == i10) {
                    abstractC254856.A0T(32);
        ...
        if (this.A08.A04.A0A() && (A04 = this.A08.A00.A04(i10)) > 0) {
            ...
            if (A04 < offsetPosition) {
                ...
                for (int i13 = 0; i13 < size; i13++) {
                    AbstractC254856 abstractC2548562 = this.A02.get(i13);
                    if (!abstractC2548562.A0g() && abstractC2548562.A0K() == A042) {
                        abstractC2548562.A0T(32);
                        return abstractC2548562;
                    }
                }
            }
        }
    ...
    private final AbstractC254856 A02(int i10, boolean z10) {
        View A08;
        int size = this.A05.size();
        for (int i11 = 0; i11 < size; i11++) {
            AbstractC254856 abstractC254856 = this.A05.get(i11);
            if (!abstractC254856.A0g()) {
                int scrapCount = abstractC254856.A0I();
                if (scrapCount == i10 && !abstractC254856.A0Z() && (this.A08.A0s.A09 || !abstractC254856.A0a())) {
                    abstractC254856.A0T(32);
                    return abstractC254856;
                }
            }
        ...
        if (!z10 && (A08 = this.A08.A01.A08(i10)) != null) {
            AbstractC254856 A0F = C3100Eb.A0F(A08);
        ...
        for (int i12 = 0; i12 < size2; i12++) {
            AbstractC254856 abstractC2548562 = this.A06.get(i12);
            if (!abstractC2548562.A0Z()) {
                int scrapCount2 = abstractC2548562.A0I();
                if (scrapCount2 == i10) {
                    if (!z10) {
                        this.A06.remove(i12);
                    }
    ...
    */
    private final com.facebook.ads.redexgen.uinode.AbstractC254856 A03(long r8, int r10, boolean r11) {
        /*
            Method dump skipped, instructions count: 313
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C25384w.A03(long, int, boolean):com.facebook.ads.redexgen.X.56");
    }
    ...
    private void A09(AbstractC254856 abstractC254856) {
        if (this.A08.A1o()) {
            View view = abstractC254856.A0H;
            if (AbstractC24493T.A00(view) == 0) {
                AbstractC24493T.A09(view, 1);
            }
            if (!AbstractC24493T.A0F(view)) {
                abstractC254856.A0T(16384);
                AbstractC24493T.A0B(view, this.A08.A09.A0A());
            }
        }
    }

    private void A0A(AbstractC254856 abstractC254856) {
        if (abstractC254856.A0H instanceof ViewGroup) {
            A08((ViewGroup) abstractC254856.A0H, false);
        }
    }

    private final void A0B(AbstractC254856 abstractC254856) {
        if (0 != 0) {
            throw new NullPointerException(A04(617, 14, 27));
        }
        if (this.A08.A0s != null) {
            this.A08.A0t.A0B(abstractC254856);
        }
    }

    private final boolean A0C(AbstractC254856 abstractC254856) {
        if (abstractC254856.A0a()) {
            return this.A08.A0s.A07();
        }
        if (abstractC254856.A03 >= 0 && abstractC254856.A03 < this.A08.A04.A0E()) {
            if (!this.A08.A0s.A07()) {
                int A03 = this.A08.A04.A03(abstractC254856.A03);
                int type = abstractC254856.A0H();
                if (A03 != type) {
                    return false;
                }
            }
            return !this.A08.A04.A0A() || abstractC254856.A0K() == this.A08.A04.A04(abstractC254856.A03);
        }
        throw new IndexOutOfBoundsException(A04(211, 60, 112) + abstractC254856 + this.A08.A1H());
    }

    private boolean A0D(AbstractC254856 abstractC254856, int i10, int i11, long startBindNs) {
        abstractC254856.A08 = this.A08;
        int A0H = abstractC254856.A0H();
        long nanoTime = this.A08.getNanoTime();
        if (startBindNs != Long.MAX_VALUE) {
            C25374v c25374v = this.A01;
            String[] strArr = A0A;
            String str = strArr[5];
            ...
            if (!c25374v.A0A(A0H, nanoTime, startBindNs)) {
                return false;
            }
        }
        this.A08.A04.A09(abstractC254856, i10);
        this.A01.A05(abstractC254856.A0H(), this.A08.getNanoTime() - nanoTime);
        A09(abstractC254856);
        if (this.A08.A0s.A07()) {
            abstractC254856.A04 = i11;
            return true;
        }
        return true;
    }
    ...
    public final C25374v A0H() {
        if (this.A01 == null) {
            this.A01 = new C25374v();
        }
        return this.A01;
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.facebook.ads.redexgen.uinode.AbstractC254856 A0I(int r21, boolean r22, long r23) {
        /*
            Method dump skipped, instructions count: 761
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C25384w.A0I(int, boolean, long):com.facebook.ads.redexgen.X.56");
    }

    public final List<AbstractC254856> A0J() {
        return this.A07;
    }
    ...
    public final void A0M() {
        int size = this.A06.size();
        for (int i10 = 0; i10 < size; i10++) {
            C25314p c25314p = (C25314p) this.A06.get(i10).A0H.getLayoutParams();
            if (c25314p != null) {
                c25314p.A01 = true;
            }
        }
    ...
    public final void A0N() {
        if (this.A08.A04 != null && this.A08.A04.A0A()) {
            int size = this.A06.size();
            for (int i10 = 0; i10 < size; i10++) {
                AbstractC254856 abstractC254856 = this.A06.get(i10);
                ...
                if (abstractC254856 != null) {
                    abstractC254856.A0T(6);
                    abstractC254856.A0W(null);
                }
            }
            return;
        }
    ...
    public final void A0U(AbstractC25184c abstractC25184c, AbstractC25184c abstractC25184c2, boolean z10) {
        A0P();
        A0H().A08(abstractC25184c, abstractC25184c2, z10);
    }

    public final void A0V(C25374v c25374v) {
        C25374v c25374v2 = this.A01;
        if (c25374v2 != null) {
            c25374v2.A04();
        }
        this.A01 = c25374v;
        if (c25374v != null) {
            c25374v.A07(this.A08.getAdapter());
        }
    }

    public final void A0W(AbstractC254654 abstractC254654) {
        this.A04 = abstractC254654;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00dd, code lost:
        ...
        r0 = com.facebook.ads.redexgen.uinode.C3100Eb.A1E;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0X(com.facebook.ads.redexgen.uinode.AbstractC254856 r10) {
        /*
            Method dump skipped, instructions count: 394
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C25384w.A0X(com.facebook.ads.redexgen.X.56):void");
    }

    public final void A0Y(AbstractC254856 abstractC254856) {
        boolean z10;
        z10 = abstractC254856.A0G;
        if (z10) {
            this.A02.remove(abstractC254856);
        } else {
            this.A05.remove(abstractC254856);
        }
        abstractC254856.A0F = null;
        abstractC254856.A0G = false;
        abstractC254856.A0O();
    }

    public final void A0Z(AbstractC254856 abstractC254856, boolean z10) {
        C3100Eb.A0s(abstractC254856);
        if (abstractC254856.A0i(16384)) {
            abstractC254856.A0U(0, 16384);
            AbstractC24493T.A0B(abstractC254856.A0H, null);
        }
        if (z10) {
            A0B(abstractC254856);
        }
        abstractC254856.A08 = null;
        A0H().A09(abstractC254856);
    }
}
