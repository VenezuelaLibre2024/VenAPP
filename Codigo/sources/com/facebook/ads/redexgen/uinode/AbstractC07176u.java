...
public abstract class AbstractC07176u<E> extends H0<E> implements List<E> {
    ...
    public static final C1559c1 A02;
    ...
    public int indexOf(E element) {
        ...
        while (it.hasNext()) {
            if (C1553bu.A0A(it.next(), element)) {
                return i10;
            }
            i10++;
        }
    ...
    public int lastIndexOf(E element) {
        AbstractC07176u<E> abstractC07176u = this;
        ListIterator<E> listIterator = abstractC07176u.listIterator(abstractC07176u.size());
        while (listIterator.hasPrevious()) {
            if (C1553bu.A0A(listIterator.previous(), element)) {
    ...
    public Iterator<E> iterator() {
        return new C0953Gx(this);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator() {
        return new C07186v(this, 0);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int index) {
        return new C07186v(this, index);
    }
