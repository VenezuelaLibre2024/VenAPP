...
public class C4076UX implements InterfaceC3638NS {
    ...
    public C4076UX(ViewOnClickListenerC2940Bi viewOnClickListenerC2940Bi) {
    ...
    public final void ACT(String str) {
        ...
        ((C4072UT) this.A00).A05 = false;
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC3638NS
    public final void ACV(String str) {
        int i10;
        ((C4072UT) this.A00).A05 = true;
        this.A00.A0B.setUrl(str);
        i10 = this.A00.A00;
        if (i10 > 1) {
            this.A00.A0H(A00(0, 34, 94));
        }
        ViewOnClickListenerC2940Bi.A02(this.A00);
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC3638NS
    public final void ACn(int i10) {
        if (((C4072UT) this.A00).A05) {
            ViewOnClickListenerC2940Bi viewOnClickListenerC2940Bi = this.A00;
            if (A02[6].length() == 8) {
            ...
            viewOnClickListenerC2940Bi.A0C.setProgress(i10);
        }
    }
