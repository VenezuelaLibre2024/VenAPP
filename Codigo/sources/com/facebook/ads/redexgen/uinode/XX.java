...
public final class XX implements InterfaceC0837Bs {
    ...
    public static final InterfaceC0840Bv A0r;
    ...
    public final CA A0d;
    public final CH A0e;
    public final C0980Hz A0f;
    public final C0980Hz A0g;
    public final C0980Hz A0h;
    public final C0980Hz A0i;
    public final C0980Hz A0j;
    public final C0980Hz A0k;
    public final C0980Hz A0l;
    public final C0980Hz A0m;
    public final C0980Hz A0n;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:80:0x0280, code lost:
        ...
        com.facebook.ads.redexgen.uinode.AbstractC0955Ha.A04(r0);
    ...
    */
    private void A08(com.facebook.ads.redexgen.uinode.InterfaceC0838Bt r11, com.facebook.ads.redexgen.uinode.CE r12, int r13) throws java.io.IOException, java.lang.InterruptedException {
        /*
    ...
    public XX(CA ca2, int i10) {
        ...
        this.A0k = new C0980Hz(4);
        this.A0n = new C0980Hz(ByteBuffer.allocate(4).putInt(-1).array());
        this.A0l = new C0980Hz(4);
        this.A0i = new C0980Hz(AbstractC0976Hv.A03);
        this.A0h = new C0980Hz(4);
        this.A0j = new C0980Hz();
        this.A0m = new C0980Hz();
        this.A0f = new C0980Hz(8);
        this.A0g = new C0980Hz();
    }

    private int A00(InterfaceC0838Bt interfaceC0838Bt, C4 c42, int i10) throws IOException, InterruptedException {
        int bytesRead;
        ...
        if (strippedBytesLeft > 0) {
            ...
            bytesRead = c42.AFQ(interfaceC0838Bt, i10, false);
        }
        this.A07 += bytesRead;
        this.A08 += bytesRead;
        return bytesRead;
    ...
    private long A01(long j10) throws C07889v {
        long j11 = this.A0M;
        if (j11 != -9223372036854775807L) {
            return IF.A0F(j10, j11, 1000L);
        }
        throw new C07889v(A03(189, 54, 68));
    }
    ...
    */
    ...
    private void A07(InterfaceC0838Bt interfaceC0838Bt, int i10) throws IOException, InterruptedException {
        if (this.A0k.A07() >= i10) {
            return;
        }
        if (this.A0k.A05() < i10) {
            C0980Hz c0980Hz = this.A0k;
            c0980Hz.A0b(Arrays.copyOf(c0980Hz.A00, Math.max(this.A0k.A00.length * 2, i10)), this.A0k.A07());
        }
        ...
        interfaceC0838Bt.readFully(bArr, A07, i10 - this.A0k.A07());
        this.A0k.A0X(i10);
    }

    private void A09(InterfaceC0838Bt interfaceC0838Bt, byte[] bArr, int i10) throws IOException, InterruptedException {
        ...
        interfaceC0838Bt.readFully(bArr2, sizeWithPrefix3, i10);
        this.A0m.A0W(length);
    }

    private void A0A(InterfaceC0838Bt interfaceC0838Bt, byte[] bArr, int i10, int i11) throws IOException, InterruptedException {
        int min = Math.min(i11, this.A0j.A04());
        int pendingStrippedBytes = i11 - min;
        interfaceC0838Bt.readFully(bArr, i10 + min, pendingStrippedBytes);
        if (min > 0) {
    ...
    private void A0B(CE ce2, long j10) {
        if (ce2.A0X != null) {
            CF cf2 = ce2.A0X;
            if (A0q[6].length() != 27) {
                throw new RuntimeException();
            ...
            ce2.A0W.AFS(j10, this.A01, this.A08, 0, ce2.A0V);
        }
        this.A0V = true;
        A05();
    }

    private void A0C(CE ce2, String str, int i10, long j10, byte[] bArr) {
        A0D(this.A0m.A00, this.A0C, str, i10, j10, bArr);
        C4 c42 = ce2.A0W;
        C0980Hz c0980Hz = this.A0m;
        c42.AFR(c0980Hz, c0980Hz.A07());
    ...
    private boolean A0E(C0842Bz c0842Bz, long j10) {
        if (this.A0Y) {
            this.A0J = j10;
            c0842Bz.A00 = this.A0F;
            this.A0Y = false;
            return true;
        }
    ...
    public final void A0I(int i10) throws C07889v {
        switch (i10) {
            case 160:
                if (this.A04 != 2) {
                    return;
            ...
            case 19899:
                ...
                throw new C07889v(A03(667, 50, 26));
            case 25152:
                if (!this.A0O.A0c) {
                    return;
                }
                if (this.A0O.A0V != null) {
                    this.A0O.A0U = new DrmInitData(new DrmInitData.SchemeData(C9W.A04, A03(RecognitionOptions.UPC_E, 10, 63), this.A0O.A0V.A03));
                    return;
                }
                throw new C07889v(A03(449, 55, 115));
            case 28032:
                if (!this.A0O.A0c || this.A0O.A0f == null) {
                    return;
                } else {
                    throw new C07889v(A03(243, 53, 10));
                }
            case 357149030:
            ...
            case 374648427:
                ...
                throw new C07889v(A03(756, 26, 64));
            case 475249515:
                if (this.A0a) {
                    return;
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:101:0x030f, code lost:
        ...
        if (r2 < (-2147483648L)) goto L282;
     */
    /* JADX WARN: Code restructure failed: missing block: B:103:0x0322, code lost:
    
        if (com.facebook.ads.redexgen.uinode.XX.A0q[7].charAt(2) == 'J') goto L263;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:114:0x0372, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C07889v(A03(396, 37, 107));
     */
    /* JADX WARN: Code restructure failed: missing block: B:115:0x0346, code lost:
    
        if (r2 > 2147483647L) goto L280;
     */
    /* JADX WARN: Code restructure failed: missing block: B:121:0x0382, code lost:
    
        throw new com.facebook.ads.redexgen.uinode.C07889v(A03(782, 33, 29));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:128:0x03a3, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C07889v(A03(877, 25, 30) + r11);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:58:0x0210, code lost:
        ...
        if (r10[1].charAt(15) == r10[5].charAt(15)) goto L220;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:0x0289, code lost:
        ...
        if (r2[1].charAt(15) == r2[5].charAt(15)) goto L238;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:79:0x02a5, code lost:
        ...
        if (r19.A0k.A00[r12 - 1] == 0) goto L283;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:83:0x02b8, code lost:
        ...
        if ((r19.A0k.A00[r12 - 1] & r10) == 0) goto L247;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:85:0x02f1, code lost:
        ...
        if (r10[0].charAt(31) == r10[2].charAt(31)) goto L288;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0K(int r20, int r21, com.facebook.ads.redexgen.uinode.InterfaceC0838Bt r22) throws java.io.IOException, java.lang.InterruptedException {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0L(int r11, long r12) throws com.facebook.ads.redexgen.uinode.C07889v {
        /*
    ...
    public final void A0M(int i10, long j10, long j11) throws C07889v {
        switch (i10) {
            case 160:
                this.A0W = false;
                return;
            ...
            case 408125543:
                ...
                throw new C07889v(A03(717, 39, 113));
            case 475249515:
                this.A0Q = new C0970Hp();
                this.A0P = new C0970Hp();
                return;
            case 524531317:
                if (this.A0a) {
                    return;
                ...
                if (this.A0o && this.A0F != -1) {
                    ...
                    this.A0N.AFi(new C1369Xj(this.A0H));
                    this.A0a = true;
                    return;
                }
        }
    ...
    public final void A0N(int i10, String str) throws C07889v {
        switch (i10) {
            case 134:
                this.A0O.A0Y = str;
                return;
            case 17026:
                if (A03(1034, 4, 113).equals(str) || A03(1016, 8, 122).equals(str)) {
                    ...
                    throw new C07889v(A03(369, 8, 117) + str + A03(0, 14, 21));
                }
            case 2274716:
                this.A0O.A0g = str;
                return;
    ...
    public final int AEH(InterfaceC0838Bt interfaceC0838Bt, C0842Bz c0842Bz) throws IOException, InterruptedException {
        ...
        boolean z10 = true;
        while (z10 && !this.A0V) {
            z10 = this.A0d.AEJ(interfaceC0838Bt);
            if (z10 && A0E(c0842Bz, interfaceC0838Bt.A7i())) {
                return 1;
            }
        }
        if (z10) {
    ...
    */
    ...
    public final boolean AGR(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        return new CG().A01(interfaceC0838Bt);
    }
}
