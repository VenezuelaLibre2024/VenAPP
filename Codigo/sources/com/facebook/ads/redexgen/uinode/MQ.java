...
public final class MQ extends RelativeLayout {
    ...
    public MQ(C1399Yn c1399Yn, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1399Yn);
        TextView textView = new TextView(c1399Yn);
        this.A05 = textView;
        Button button = new Button(c1399Yn);
        this.A02 = button;
        Button button2 = new Button(c1399Yn);
        this.A01 = button2;
        ImageView imageView = new ImageView(c1399Yn);
        this.A03 = imageView;
        this.A04 = new LinearLayout(c1399Yn);
        ...
        if (textView2 != null) {
            ...
            AbstractC1066Lo.A0X(this.A00, false, 18);
        }
        imageView.setImageBitmap(bitmap);
        imageView.setColorFilter(i10);
        button.setText(str3);
        AbstractC1066Lo.A0X(button, true, 18);
        button.setAllCaps(true);
        button.setTextColor(i11);
        int i12 = A06;
        button.setPadding(i12, i12, i12, i12);
        button2.setText(str4);
        AbstractC1066Lo.A0X(button2, true, 18);
        button2.setAllCaps(true);
        button2.setTextColor(i10);
        button2.setPadding(i12, i12, i12, i12);
        int A01 = AbstractC06152p.A01(i11, 20);
        int i13 = A07;
        AbstractC1066Lo.A0O(button, i10, i13);
        AbstractC1066Lo.A0O(button2, A01, i13);
        A00();
        setGravity(17);
    }
