...
public final class W5 implements InterfaceC0950Gu {
    ...
    public final long ADl(C0954Gy c0954Gy) throws C0943Gn {
        try {
            Uri uri = c0954Gy.A04;
            this.A01 = uri;
            ...
            this.A02 = open;
            if (open.skip(c0954Gy.A03) < c0954Gy.A03) {
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0950Gu
    public final void close() throws C0943Gn {
        this.A01 = null;
        try {
            try {
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0950Gu
    public final int read(byte[] bArr, int i10, int i11) throws C0943Gn {
        if (i11 == 0) {
            return 0;
        }
        long j10 = this.A00;
        ...
        if (read == -1) {
            ...
            throw new C0943Gn(new EOFException());
        }
        long j11 = this.A00;
        if (j11 != -1) {
            long j12 = read;
