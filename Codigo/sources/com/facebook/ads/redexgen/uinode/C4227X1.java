...
public final class C4227X1 implements InterfaceC3012Cy {
    ...
    public String A04;
    public boolean A05;
    public final C3021D7 A09;
    public final boolean A0B;
    public final boolean A0C;
    public final boolean[] A0D = new boolean[3];
    public final C3018D4 A08 = new C3018D4(7, RecognitionOptions.ITF);
    public final C3018D4 A06 = new C3018D4(8, RecognitionOptions.ITF);
    public final C3018D4 A07 = new C3018D4(6, RecognitionOptions.ITF);
    ...
    public C4227X1(C3021D7 c3021d7, boolean z10, boolean z11) {
        this.A09 = c3021d7;
        this.A0B = z10;
        this.A0C = z11;
    }
        ...
        if (!this.A05 || this.A03.A07()) {
            ...
            if (!this.A05) {
                if (this.A08.A03() && this.A06.A03()) {
                    ...
                    C3301Hu spsData = AbstractC3302Hv.A06(this.A08.A01, 3, this.A08.A00);
                    C3300Ht A05 = AbstractC3302Hv.A05(this.A06.A01, 3, this.A06.A00);
                ...
                this.A03.A05(AbstractC3302Hv.A06(this.A08.A01, 3, this.A08.A00));
                this.A08.A00();
            } else if (this.A06.A03()) {
                this.A03.A04(AbstractC3302Hv.A05(this.A06.A01, 3, this.A06.A00));
                this.A06.A00();
            }
        }
        if (this.A07.A04(i11)) {
            ...
            int unescapedLength = AbstractC3302Hv.A02(c3018d4.A01, this.A07.A00);
    ...
    public final void A4R(C3306Hz c3306Hz) {
        ...
        int offset3 = c3306Hz.A04();
        interfaceC2962C4.AFR(c3306Hz, offset3);
        while (true) {
            int A04 = AbstractC3302Hv.A04(bArr, A06, A07, this.A0D);
            if (A04 == A07) {
                A04(bArr, A06, A07);
                return;
            }
            int lengthToNalUnit = AbstractC3302Hv.A01(bArr, A04);
            int i10 = A04 - A06;
            String[] strArr = A0F;
    ...
    public final void A4p(InterfaceC2952Bu interfaceC2952Bu, C3025DC c3025dc) {
        ...
        this.A02 = AGi;
        this.A03 = new C3016D2(AGi, this.A0B, this.A0C);
        this.A09.A03(interfaceC2952Bu, c3025dc);
    }
