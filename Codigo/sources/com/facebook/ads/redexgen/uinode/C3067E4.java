...
public final class C3067E4 implements InterfaceC4257XV {
     ...
     */
    public static C3067E4 A01(long j10, long j11, C2956By c2956By, C3306Hz c3306Hz) {
        int A0H;
        int i10 = c2956By.A04;
        int i11 = c2956By.A03;
        int A08 = c3306Hz.A08();
        if ((A08 & 1) != 1 || (A0H = c3306Hz.A0H()) == 0) {
            return null;
        }
        long A0F = AbstractC3322IF.A0F(A0H, i10 * 1000000, i11);
        if ((A08 & 6) != 6) {
            return new C3067E4(j11, c2956By.A02, A0F);
        }
        long A0H2 = c3306Hz.A0H();
        long[] jArr = new long[100];
        for (int i12 = 0; i12 < 100; i12++) {
            jArr[i12] = c3306Hz.A0E();
        }
        if (j10 != -1 && j10 != j11 + A0H2) {
            Log.w(A02(27, 10, 25), A02(2, 25, 119) + j10 + A02(0, 2, 77) + (j11 + A0H2));
        }
        return new C3067E4(j11, c2956By.A02, A0F, A0H2, jArr);
    }
    ...
    public final long A88(long j10) {
        ...
        int A0B = AbstractC3322IF.A0B(this.A04, (long) d10, true, true);
        long A00 = A00(A0B);
        long j12 = this.A04[A0B];
        long A002 = A00(A0B + 1);
        return Math.round((A002 - A00) * (j12 == (A0B == 99 ? 256L : this.A04[A0B + 1]) ? 0.0d : (d10 - j12) / (r9 - j12))) + A00;
    }
    ...
    public C3067E4(long j10, int i10, long j11) {
        this(j10, i10, j11, -1L, null);
    }

    public C3067E4(long j10, int i10, long j11, long j12, long[] jArr) {
        this.A02 = j10;
        this.A00 = i10;
        this.A03 = j11;
        this.A01 = j12;
    ...
    public final C2958C0 A7t(long j10) {
        ...
        if (!A9I()) {
            return new C2958C0(new C2960C2(0L, this.A02 + this.A00));
        }
        long A0E = AbstractC3322IF.A0E(j10, 0L, this.A03);
        ...
        return new C2958C0(new C2960C2(A0E, this.A02 + AbstractC3322IF.A0E(round, positionOffset, this.A01 - 1)));
    }
