...
public final class VT implements J1 {
    ...
    public VT(C1398Ym c1398Ym, J0 j02) {
        this.A07 = j02;
        this.A06 = c1398Ym;
        this.A04 = (ConnectivityManager) c1398Ym.getSystemService(A03(293, 12, 10));
        this.A08 = C1210Rc.A01(c1398Ym);
        this.A03 = Ij.A0K(c1398Ym);
        this.A02 = Ij.A0J(c1398Ym);
    }
    ...
    public final void A0B() {
        try {
            ...
            if (!TextUtils.isEmpty(A69) && ADz != null) {
                if (ADz.A83() != 200) {
                    ...
                    if (A0E[4].length() != 29) {
                        ...
                        if (A83 == 413 && C0988Ih.A22(this.A06)) {
                            this.A07.ACo();
                            A05();
                            return;
                        } else {
            ...
            if (C0988Ih.A1t(this.A06) && A4a.has(A03)) {
                this.A07.ABI(A4a.getJSONArray(A03));
            }
            A06();
        } catch (Exception e10) {
