...
public final class JZ {
    ...
    public JZ(C07277f c07277f, JX jx) {
        int nativeViewabilityHistorySamplingRate = Ij.A0D(c07277f);
        if (nativeViewabilityHistorySamplingRate < 1) {
            this.A0F = false;
        } else {
            this.A0F = c07277f.A08().A00() < 1.0d / ((double) nativeViewabilityHistorySamplingRate);
        }
        this.A0B = jx;
    }
    ...
    public final void A0C(C07277f c07277f, String str) {
        if (!this.A0F) {
            return;
        }
        A03(new JY(A01(), 103, A00(), null));
        ExecutorC1071Lt.A06.execute(new JW(this, str, c07277f));
    }
}
