...
public final class C2956By {
     ...
     */
    public static boolean A04(int i10, C2956By c2956By) {
        int i11;
        int i12;
        int i13;
        int i14;
        ...
        c2956By.A03(i11, A0F[3 - i12], i17, i18, ((i10 >> 6) & 3) == 3 ? 1 : 2, i15 * AdError.NETWORK_ERROR_CODE, i16);
        return true;
    }
    ...
    static {
        ...
        A09 = new int[]{32, 64, 96, RecognitionOptions.ITF, 160, 192, 224, RecognitionOptions.QR_CODE, 288, 320, 352, 384, 416, 448};
        A0D = new int[]{32, 48, 56, 64, 80, 96, 112, RecognitionOptions.ITF, 144, 160, 176, 192, 224, RecognitionOptions.QR_CODE};
        A0A = new int[]{32, 48, 56, 64, 80, 96, 112, RecognitionOptions.ITF, 160, 192, 224, RecognitionOptions.QR_CODE, 320, 384};
        A0B = new int[]{32, 40, 48, 56, 64, 80, 96, 112, RecognitionOptions.ITF, 160, 192, 224, RecognitionOptions.QR_CODE, 320};
        A0C = new int[]{8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, RecognitionOptions.ITF, 144, 160};
    }
