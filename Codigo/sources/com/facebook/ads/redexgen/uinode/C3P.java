...
public abstract class C3P extends C0882Eb implements View.OnTouchListener {
    ...
    public C3P(C1399Yn c1399Yn, AttributeSet attributeSet) {
    ...
    public C3P(C1399Yn c1399Yn, AttributeSet attributeSet, int i10) {
    ...
    public void setLayoutManager(AbstractC06654o abstractC06654o) {
        if (abstractC06654o instanceof C1425Zo) {
            super.setLayoutManager(abstractC06654o);
            this.A01 = (C1425Zo) abstractC06654o;
            return;
        }
        throw new IllegalArgumentException(A09(0, 50, 58));
    }

    public void setSnapDelegate(InterfaceC1168Pm interfaceC1168Pm) {
        this.A02 = interfaceC1168Pm;
    }
}
