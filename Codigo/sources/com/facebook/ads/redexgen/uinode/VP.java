...
public final class VP implements J0 {
    ...
    public VP(C1398Ym c1398Ym, YH yh2) {
        this.A00 = c1398Ym;
        this.A01 = yh2;
    }

    public static JSONArray A01(C1398Ym c1398Ym, JSONArray jSONArray, JSONArray jSONArray2) {
        int i10 = 0;
        if (jSONArray != null) {
        ...
        return A02(c1398Ym, jSONArray, jSONArray2, i10);
    }

    public static JSONArray A02(C1398Ym c1398Ym, JSONArray jSONArray, JSONArray jSONArray2, int i10) {
        if (jSONArray == null) {
            return jSONArray2;
        }
        if (jSONArray2 == null) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                if (A00(393, 26, 8).equals(string)) {
                    C0988Ih.A0R(this.A00).A2X(jSONObject.getString(A00(419, 14, 47)));
                    this.A00.A03().AAL();
                } else {
