...
public enum EnumC1116Nm {
    ...
    public static EnumC1116Nm A00(int i10) {
        for (EnumC1116Nm enumC1116Nm : valuesCustom()) {
            if (enumC1116Nm.A00 == i10) {
                return enumC1116Nm;
            }
        }
        return A05;
    ...
    public static EnumC1116Nm[] valuesCustom() {
        Object clone = values().clone();
        if (A02[4].length() == 18) {
            throw new RuntimeException();
        }
        A02[4] = "9YF3oPenjmVnddjujEMQmJq4m";
        return (EnumC1116Nm[]) clone;
    }
}
