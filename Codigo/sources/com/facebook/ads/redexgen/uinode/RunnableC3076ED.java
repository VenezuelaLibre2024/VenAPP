...
public final class RunnableC3076ED implements Runnable {
    ...
    public final C3079EG A05;
    public volatile int A06;
    public volatile InterfaceC3083EK A07;
    ...
    public RunnableC3076ED(int i10, C3079EG c3079eg, DownloadAction downloadAction, int i11) {
        this.A02 = i10;
        this.A05 = c3079eg;
    ...
    public /* synthetic */ RunnableC3076ED(int i10, C3079EG c3079eg, DownloadAction downloadAction, int i11, RunnableC3068E5 runnableC3068E5) {
        this(i10, c3079eg, downloadAction, i11);
    }
    ...
    public void A08() {
        ...
        if (!A0F(0, 5)) {
            ...
            handler.post(new RunnableC3073EA(this));
        }
    }
    ...
    public final C3078EF A0K() {
        return new C3078EF(this.A02, this.A04, A01(), A00(), A05(), this.A01, null);
    }
    ...
    public final void run() {
        ...
        try {
            C3079EG.A0J(A07(59, 15, 50), this);
            Throwable finalError = null;
            try {
                DownloadAction downloadAction = this.A04;
                c3084el = this.A05.A0A;
                this.A07 = downloadAction.A07(c3084el);
                if (this.A04.A03) {
                    this.A07.remove();
                } else {
                    int i10 = 0;
                    ...
                    while (!Thread.interrupted()) {
                        try {
                            ...
                            if (A6p != j10) {
                                C3079EG.A0J(A07(22, 37, 27) + A6p, this);
                                j10 = A6p;
                                i10 = 0;
                            }
                            ...
                            C3079EG.A0J(A07(0, 22, 33) + i10, this);
            ...
            handler = this.A05.A07;
            handler.post(new RunnableC3074EB(this, finalError));
        } catch (Throwable th3) {
