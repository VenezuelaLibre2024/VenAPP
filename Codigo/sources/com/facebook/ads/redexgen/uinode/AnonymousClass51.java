...
public abstract class AnonymousClass51 {
    ...
    public View A01;
    public AbstractC06654o A02;
    public C0882Eb A03;
    public boolean A04;
    public boolean A05;
    public int A00 = -1;
    public final C06754z A06 = new C06754z(0, 0);
    ...
    public abstract void A0H(int i10, int i11, AnonymousClass53 anonymousClass53, C06754z c06754z);

    public abstract void A0I(View view, AnonymousClass53 anonymousClass53, C06754z c06754z);
    ...
    public void A04(int i10, int i11) {
        ...
        if (!this.A05 || this.A00 == -1 || c0882Eb == null) {
            A09();
        }
        this.A04 = false;
        View view = this.A01;
        if (view != null) {
            ...
            strArr2[0] = "WYaFIbeKL";
            if (A00 == i12) {
                A0I(this.A01, c0882Eb.A0s, this.A06);
                C06754z c06754z = this.A06;
                if (A08[5].length() != 9) {
                    String[] strArr3 = A08;
                    strArr3[6] = "M";
                    strArr3[2] = "Q";
        ...
        if (this.A05) {
            A0H(i10, i11, c0882Eb.A0s, this.A06);
            boolean hadJumpTarget = this.A06.A06();
            this.A06.A05(c0882Eb);
            if (hadJumpTarget) {
                if (this.A05) {
                    this.A04 = true;
                    c0882Eb.A08.A07();
    ...
    public final AbstractC06654o A08() {
        return this.A02;
    }
    ...
    public final void A0D(C0882Eb c0882Eb, AbstractC06654o abstractC06654o) {
        this.A03 = c0882Eb;
        this.A02 = abstractC06654o;
        if (this.A00 != -1) {
            c0882Eb.A0s.A0F = this.A00;
            this.A05 = true;
            this.A04 = true;
            this.A01 = A01(A07());
            this.A03.A08.A07();
