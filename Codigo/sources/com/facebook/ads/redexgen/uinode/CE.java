...
public final class CE {
     ...
     */
    public static Pair<String, List<byte[]>> A00(C0980Hz c0980Hz) throws C07889v {
        try {
            c0980Hz.A0Z(16);
            ...
            for (int A06 = c0980Hz.A06() + 20; A06 < bArr.length - 4; A06++) {
            ...
            throw new C07889v(A01(238, 45, 91));
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw new C07889v(A01(137, 33, 14));
        }
    }
    ...
    public static List<byte[]> A03(byte[] bArr) throws C07889v {
    ...
    public static boolean A05(C0980Hz c0980Hz) throws C07889v {
        UUID uuid;
        UUID uuid2;
        try {
            int A0C = c0980Hz.A0C();
            ...
            throw new C07889v(A01(170, 34, 16));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x067b, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.AbstractC0973Hs.A0B(r15) == false) goto L420;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:54:0x07b2, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C07889v(A01(398, 21, 104));
     */
    ...
    */
    public final void A09(com.facebook.ads.redexgen.uinode.InterfaceC0839Bu r30, int r31) throws com.facebook.ads.redexgen.uinode.C07889v {
        /*
