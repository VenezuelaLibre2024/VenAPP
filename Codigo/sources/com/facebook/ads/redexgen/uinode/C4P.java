...
public final class C4P implements Runnable {
    ...
    public long A00;
    public long A01;
    public ArrayList<C0882Eb> A02 = new ArrayList<>();
    ...
    private AnonymousClass56 A00(C0882Eb c0882Eb, int i10, long j10) {
        if (A08(c0882Eb, i10)) {
            return null;
        }
        C06724w c06724w = c0882Eb.A0r;
        try {
            c0882Eb.A1K();
            AnonymousClass56 A0I = c06724w.A0I(i10, false, j10);
            if (A0I != null) {
                if (A0I.A0Y() && !A0I.A0Z()) {
                    c06724w.A0T(A0I.A0H);
                } else {
                    c06724w.A0Z(A0I, false);
                }
            }
            return A0I;
        } finally {
    ...
    */
    private void A02() {
        ...
        L8:
            ...
            com.facebook.ads.redexgen.X.Eb r1 = (com.facebook.ads.redexgen.uinode.C0882Eb) r1
        ...
        L51:
            ...
            com.facebook.ads.redexgen.X.Eb r9 = (com.facebook.ads.redexgen.uinode.C0882Eb) r9
    ...
    */
    ...
    private void A07(C0882Eb c0882Eb, long j10) {
        if (c0882Eb == null) {
            return;
        }
        if (c0882Eb.A0C) {
        ...
        C1426Zp c1426Zp = c0882Eb.A02;
        c1426Zp.A04(c0882Eb, true);
        if (c1426Zp.A00 != 0) {
            try {
                AbstractC06162q.A01(A01(0, 18, 7));
                c0882Eb.A0s.A05(c0882Eb.A04);
                int i10 = 0;
                while (true) {
                    int i11 = c1426Zp.A00 * 2;
                    ...
                    strArr[7] = "TD";
                    if (i10 < i11) {
                        A00(c0882Eb, c1426Zp.A03[i10], j10);
                        i10 += 2;
                    } else {
                        return;
                    }
    ...
    public static boolean A08(C0882Eb c0882Eb, int i10) {
        int A062 = c0882Eb.A01.A06();
        for (int i11 = 0; i11 < A062; i11++) {
            AnonymousClass56 A0F = C0882Eb.A0F(c0882Eb.A01.A0A(i11));
    ...
    public final void A09(C0882Eb c0882Eb) {
        this.A02.add(c0882Eb);
    }

    public final void A0A(C0882Eb c0882Eb) {
        this.A02.remove(c0882Eb);
    }

    public final void A0B(C0882Eb c0882Eb, int i10, int i11) {
        if (c0882Eb.isAttachedToWindow() && this.A01 == 0) {
            this.A01 = c0882Eb.getNanoTime();
            c0882Eb.post(this);
        }
        c0882Eb.A02.A03(i10, i11);
    }

    @Override // java.lang.Runnable
    public final void run() {
        try {
            AbstractC06162q.A01(A01(18, 11, 2));
            if (this.A02.isEmpty()) {
                return;
            }
            ...
            for (int i10 = 0; i10 < size; i10++) {
                C0882Eb c0882Eb = this.A02.get(i10);
                if (c0882Eb.getWindowVisibility() == 0) {
                    j10 = Math.max(c0882Eb.getDrawingTime(), j10);
                }
            }
            if (j10 == 0) {
                this.A01 = 0L;
