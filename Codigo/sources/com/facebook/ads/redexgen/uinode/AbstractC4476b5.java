...
public abstract class AbstractC4476b5 extends AbstractC23121F implements Serializable {
    ...
    public AbstractC4476b5(List<C23131G> list) {
        this.A0D = list;
    }
    ...
    public static List<C23131G> A08(JSONObject jSONObject, C4337Yn c4337Yn, InterfaceC23251S interfaceC23251S) {
        JSONArray optJSONArray = jSONObject.optJSONArray(A05(101, 8, 125));
        if (optJSONArray != null && optJSONArray.length() > 0) {
            return AbstractC23211O.A01(optJSONArray, jSONObject, c4337Yn, interfaceC23251S);
        }
        List<AdInfo> adInfoList = new ArrayList<>();
        C23131G A00 = C23131G.A00(jSONObject);
        interfaceC23251S.A3N(A00, jSONObject);
        adInfoList.add(A00);
        return adInfoList;
    }
    ...
    private void A0C(C23091C c23091c) {
        this.A05 = c23091c;
    }

    private final void A0D(C23271U c23271u) {
        this.A06 = c23271u;
    }

    private void A0E(C23301X c23301x) {
        this.A07 = c23301x;
    }

    private final void A0F(C23331a c23331a) {
        this.A08 = c23331a;
    }

    private void A0G(C23391g c23391g) {
        this.A09 = c23391g;
    }
    ...
    public final C23091C A0w() {
        return this.A05;
    }

    public final C23131G A0x() {
        return this.A0D.get(0);
    }

    public final C23271U A0y() {
        return this.A06;
    }

    public final C23301X A0z() {
        return this.A07;
    }

    public final C23331a A10() {
        return this.A08;
    }

    public final C23391g A11() {
        return this.A09;
    }
    ...
    */
    public final void A15(com.facebook.ads.redexgen.uinode.InterfaceC3560MC r8) {
        /*
            r7 = this;
        ...
        L10:
            ...
            r8.A43(r0)
        L1d:
            com.facebook.ads.redexgen.X.QP r0 = com.facebook.ads.redexgen.uinode.EnumC3821QP.A08
        ...
        L39:
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.AbstractC4476b5.A0H
            r0 = 2
            r1 = r2[r0]
            r0 = 1
            r2 = r2[r0]
        ...
        L6b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.AbstractC4476b5.A15(com.facebook.ads.redexgen.X.MC):void");
    }

    public final void A16(JSONObject jSONObject) {
        String A05;
        JSONObject layoutObject;
        A0D(C23271U.A00(jSONObject.optJSONObject(A05(225, 16, 120))));
        A0F = jSONObject.optJSONObject(A05(89, 12, 95));
        C23321Z A06 = new C23321Z().A06(jSONObject.optString(A05(319, 5, 56)));
        ...
        A0F(A06.A05(A05).A04(jSONObject.optString(A05(0, 19, 117))).A07(AbstractC23341b.A03(jSONObject)).A08());
        ...
        A0C(new C23091C(C23221P.A01(layoutObject), C23221P.A01(optJSONObject != null ? optJSONObject.optJSONObject(A05(253, 9, 30)) : null)));
        A0G(AbstractC23341b.A01(jSONObject));
        A0E(AbstractC23341b.A00(jSONObject));
