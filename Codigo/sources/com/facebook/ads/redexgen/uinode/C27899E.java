...
public final class C27899E implements Closeable {
    ...
    public boolean A00;
    public final C277994 A01;
    public final Deque<C27889D> A02;
    ...
    public final synchronized int A09() throws IOException {
        ...
        i10 = 0;
        Iterator<C27889D> it = this.A02.iterator();
        while (it.hasNext()) {
            i10 += it.next().A01();
        }
        return i10;
    ...
    public C27899E(C277994 c277994, InterfaceC27879C interfaceC27879C) throws IOException {
        LinkedList linkedList = new LinkedList();
        this.A02 = linkedList;
        this.A00 = false;
        this.A01 = c277994;
        A05(c277994, interfaceC27879C);
        if (linkedList.isEmpty()) {
            A00();
        }
    }

    private C27889D A00() throws IOException {
        int i10 = -1;
        if (!this.A02.isEmpty()) {
            i10 = this.A02.getLast().A00();
        }
        int i11 = i10 + 1;
        this.A02.add(new C27889D(i11, new C27859A(new File(this.A01.A05(), A01(i11)))));
    ...
    private void A04(int i10, File file) throws IOException {
        C27859A c27859a = new C27859A(file);
        c27859a.A05();
        this.A02.addFirst(new C27889D(i10, c27859a));
    }

    private void A05(C277994 c277994, InterfaceC27879C interfaceC27879C) throws IOException {
        File[] listFiles = c277994.A05().listFiles();
        if (listFiles != null) {
            ...
            for (File file : listFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC27879C.AFF(String.format(Locale.US, A02(260, 39, 79), file.getCanonicalPath()));
                }
            }
            if (!hashMap.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (fileNumber2 < fileNumberToLoad) {
                        interfaceC27879C.AFF(String.format(Locale.US, A02(166, 61, 2), Integer.valueOf(fileNumber2), Integer.valueOf(fileNumberToLoad)));
                ...
                while (fileNumber >= fileNumberToLoad) {
                    ...
                    try {
                        ...
                        interfaceC27879C.AFG(String.format(Locale.US, A02(104, 62, 43), file2.getCanonicalPath(), Integer.valueOf(fileNumber)), e10);
            ...
            for (File file3 : hashSet) {
                if (!file3.delete()) {
                    interfaceC27879C.AFF(String.format(Locale.US, A02(40, 26, 29), file3.getCanonicalPath()));
                }
            }
            return;
        }
        throw new IOException(String.format(Locale.US, A02(66, 38, 93), c277994.A05().getCanonicalPath()));
    }
    ...
    public final synchronized C277792 A0A(int i10, int i11, byte[] bArr, int i12, int[] iArr, int i13) throws IOException {
        if (!this.A00) {
            for (C27889D file : this.A02) {
                if (file.A00() == i10) {
                    return new C277792(i10, file.A02(i11, bArr, i12, iArr, i13));
                }
            }
            return new C277792(-1, new C277691(EnumC277590.A04, -1, -1, 0));
        }
        throw new IOException(A02(227, 33, 62));
    }
    ...
    public final synchronized boolean A0D() throws IOException {
        if (!this.A00) {
            ...
            C27889D first = this.A02.getFirst();
