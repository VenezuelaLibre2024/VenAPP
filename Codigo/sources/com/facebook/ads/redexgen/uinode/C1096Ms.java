...
public final class C1096Ms extends LinearLayout {
    public boolean A00;
    ...
    public C1096Ms(C1399Yn c1399Yn) {
        super(c1399Yn);
        this.A00 = false;
        setOrientation(0);
        int i10 = A04;
    ...
    private void A00() {
        ...
        AbstractC1066Lo.A0X(this.A02, false, 14);
        if (this.A00) {
            textColor = -1;
        } else {
            textColor = -10459280;
    ...
    public void setData(String str, EnumC1074Lw enumC1074Lw) {
