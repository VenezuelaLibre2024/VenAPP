...
public final class C3029DG {
    ...
    public C3029DG(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11, boolean z12) {
        this.A02 = (String) AbstractC3281Ha.A01(str);
        this.A01 = str2;
    ...
    public static int A00(String str, String str2, int i10) {
        int i11;
        if (i10 > 1 || (AbstractC3322IF.A02 >= 26 && i10 > 0)) {
            return i10;
        }
    ...
    public static C3029DG A01(String str) {
        return new C3029DG(str, null, null, true, false, false);
    }

    public static C3029DG A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11) {
        return new C3029DG(str, str2, codecCapabilities, false, z10, z11);
    }

    private void A05(String str) {
        StringBuilder append = new StringBuilder().append(A03(38, 16, 126)).append(str);
        String A03 = A03(80, 3, 100);
        append.append(A03).append(this.A02).append(A03(4, 2, 120)).append(this.A01).append(A03).append(AbstractC3322IF.A04).append(A03(79, 1, 119)).toString();
    }
    ...
    public static boolean A07(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC3322IF.A02 >= 19 && A08(codecCapabilities);
    }
    ...
    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC3322IF.A02 >= 21 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC3322IF.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public final Point A0E(int i10, int i11) {
        ...
        int heightAlignment2 = AbstractC3322IF.A04(i10, widthAlignment);
        return new Point(heightAlignment2 * widthAlignment, AbstractC3322IF.A04(i11, heightAlignment) * heightAlignment);
    }
    ...
    public final boolean A0I(String str) {
        ...
        String A05 = AbstractC3299Hs.A05(str);
        if (A08[4].charAt(25) != 'Z') {
            String[] strArr = A08;
            ...
            if (codecMimeType.charAt(14) != 'p') {
                ...
                Pair<Integer, Integer> A02 = C3036DR.A02(str);
                if (A02 == null) {
                    return true;
                }
