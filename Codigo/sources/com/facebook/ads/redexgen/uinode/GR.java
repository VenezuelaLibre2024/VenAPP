...
public final class GR {
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 20 out of bounds for length 15
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public final boolean A0G(C0980Hz c0980Hz, GO go, List<GM> list) {
        String A0P = c0980Hz.A0P();
        if (A0P == null) {
            return false;
        }
        Pattern pattern = A03;
        ...
        if (matcher.matches()) {
            return A0F(null, matcher, c0980Hz, go, this.A00, list);
        }
        String A0P2 = c0980Hz.A0P();
        if (A0P2 == null) {
            return false;
        }
        Matcher matcher2 = pattern.matcher(A0P2);
        if (matcher2.matches()) {
            return A0F(A0P.trim(), matcher2, c0980Hz, go, this.A00, list);
        }
        return false;
    }
    ...
    */
    ...
    public static void A06(SpannableStringBuilder spannableStringBuilder, GM gm2, int i10, int i11) {
        if (gm2 == null) {
            return;
        }
        if (gm2.A08() != -1) {
            spannableStringBuilder.setSpan(new StyleSpan(gm2.A08()), i10, i11, 33);
        }
        if (gm2.A0O()) {
        ...
        if (gm2.A0N()) {
            spannableStringBuilder.setSpan(new ForegroundColorSpan(gm2.A06()), i10, i11, 33);
        }
        if (gm2.A0M()) {
            spannableStringBuilder.setSpan(new BackgroundColorSpan(gm2.A05()), i10, i11, 33);
        }
        String A0H = gm2.A0H();
        if (A02[6].charAt(12) != 'U') {
            A02[6] = "tzfwj6Yb5L7snAfsv0bj9UNvpNFUfxvv";
            if (A0H != null) {
                spannableStringBuilder.setSpan(new TypefaceSpan(gm2.A0H()), i10, i11, 33);
            }
            if (gm2.A0A() != null) {
                spannableStringBuilder.setSpan(new AlignmentSpan.Standard(gm2.A0A()), i10, i11, 33);
            }
            switch (gm2.A07()) {
                case 1:
                    spannableStringBuilder.setSpan(new AbsoluteSizeSpan((int) gm2.A04(), true), i10, i11, 33);
                    return;
                case 2:
                    spannableStringBuilder.setSpan(new RelativeSizeSpan(gm2.A04()), i10, i11, 33);
                    return;
                case 3:
                    spannableStringBuilder.setSpan(new RelativeSizeSpan(gm2.A04() / 100.0f), i10, i11, 33);
                    return;
                default:
                    return;
            }
    ...
    public static void A0D(List<GM> list, String str, GP gp, List<GQ> list2) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            int styleCount = gm2.A09(str, str2, strArr, str3);
            if (styleCount > 0) {
                list2.add(new GQ(styleCount, gm2));
            }
        }
    ...
    public static boolean A0F(String str, Matcher matcher, C0980Hz c0980Hz, GO go, StringBuilder sb2, List<GM> list) {
        try {
