...
public final class C1366Xg extends C6 {
    ...
    public final void A0B(C0980Hz c0980Hz, long j10) throws C07889v {
        if (this.A00 == 2) {
            int A042 = c0980Hz.A04();
            super.A00.AFR(c0980Hz, A042);
        ...
        A04[7] = "";
        if (A0E == 0 && !this.A01) {
            byte[] bArr = new byte[c0980Hz.A04()];
            c0980Hz.A0c(bArr, 0, bArr.length);
            Pair<Integer, Integer> audioParams = AbstractC0959He.A03(bArr);
        ...
        int A043 = c0980Hz.A04();
        super.A00.AFR(c0980Hz, A043);
    ...
    */
    public final boolean A0C(com.facebook.ads.redexgen.uinode.C0980Hz r18) throws com.facebook.ads.redexgen.uinode.C1362Xc {
        /*
            Method dump skipped, instructions count: 239
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1366Xg.A0C(com.facebook.ads.redexgen.X.Hz):boolean");
    }
}
