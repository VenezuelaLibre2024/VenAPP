...
public final class ViewpointViewNode implements DspViewableNode {
    ...
    public static final C1567cK A03;
    public static final WeakHashMap<View, ViewpointViewNode> A04;
    public final WeakReference<View> A00;

    public /* synthetic */ ViewpointViewNode(View view, AbstractC1554bv abstractC1554bv) {
        this(view);
    }
    ...
    public final boolean A8N(Rect rect, Rect rect2, Rect rect3) {
        C1553bu.A07(rect, A01(13, 20, 31));
        C1553bu.A07(rect2, A01(0, 13, 38));
        C1553bu.A07(rect3, A01(33, 12, 114));
        View view = this.A00.get();
        if (view == null) {
            return false;
        }
        boolean A00 = AbstractC1566cJ.A00(view, rect, rect2, rect3);
    ...
    public final boolean equals(Object other) {
        ...
        if (other != null) {
            boolean A0A = C1553bu.A0A(other.getClass(), getClass());
            if (A02[0].length() == 17) {
                throw new RuntimeException();
            }
