...
public final class C0804Al extends Exception {
    ...
    */
    public C0804Al(int r5, int r6, int r7, int r8) {
        /*
            r4 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0804Al.<init>(int, int, int, int):void");
    }
}
