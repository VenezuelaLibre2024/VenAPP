...
public final class C06142o {
    public static C06142o A05;
    public static byte[] A06;
    public static final Object A07;
    public final Context A00;
    public final Handler A01;
    public final HashMap<BroadcastReceiver, ArrayList<C06132n>> A04 = new HashMap<>();
    public final HashMap<String, ArrayList<C06132n>> A03 = new HashMap<>();
    public final ArrayList<C06122m> A02 = new ArrayList<>();
    ...
    public C06142o(Context context) {
        this.A00 = context;
    ...
    public static C06142o A00(Context context) {
        C06142o c06142o;
        synchronized (A07) {
            if (A05 == null) {
                A05 = new C06142o(context.getApplicationContext());
            }
            c06142o = A05;
        }
        return c06142o;
    ...
    */
    public void A02() {
        ...
        L0:
            ...
            goto L44
        Ld:
            com.facebook.ads.redexgen.X.2m[] r7 = new com.facebook.ads.redexgen.uinode.C06122m[r0]     // Catch: java.lang.Throwable -> L45
            java.util.ArrayList<com.facebook.ads.redexgen.X.2m> r0 = r8.A02     // Catch: java.lang.Throwable -> L45
        ...
        L27:
            ...
            com.facebook.ads.redexgen.X.2n r1 = (com.facebook.ads.redexgen.uinode.C06132n) r1
            boolean r0 = r1.A01
            if (r0 != 0) goto L3e
        ...
        L45:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06142o.A02():void");
    }

    public final void A05(BroadcastReceiver broadcastReceiver) {
        synchronized (this.A04) {
            ArrayList<C06132n> remove = this.A04.remove(broadcastReceiver);
            if (remove == null) {
                return;
            }
            for (int size = remove.size() - 1; size >= 0; size--) {
                C06132n c06132n = remove.get(size);
                c06132n.A01 = true;
                for (int j10 = 0; j10 < c06132n.A03.countActions(); j10++) {
                    String action = c06132n.A03.getAction(j10);
                    ArrayList<C06132n> arrayList = this.A03.get(action);
                    if (arrayList != null) {
                        int i10 = arrayList.size();
                        for (int i11 = i10 - 1; i11 >= 0; i11--) {
                            C06132n c06132n2 = arrayList.get(i11);
                            if (c06132n2.A02 == broadcastReceiver) {
                                c06132n2.A01 = true;
    ...
    public final void A06(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.A04) {
            C06132n c06132n = new C06132n(intentFilter, broadcastReceiver);
            ArrayList<C06132n> arrayList = this.A04.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList<>(1);
                this.A04.put(broadcastReceiver, arrayList);
            }
            arrayList.add(c06132n);
            for (int i10 = 0; i10 < intentFilter.countActions(); i10++) {
                String action = intentFilter.getAction(i10);
                ArrayList<C06132n> arrayList2 = this.A03.get(action);
                if (arrayList2 == null) {
                    arrayList2 = new ArrayList<>(1);
                    this.A03.put(action, arrayList2);
                }
                arrayList2.add(c06132n);
            }
        }
    }
    ...
    public final boolean A07(Intent intent) {
        ...
        synchronized (this.A04) {
            ...
            HashMap<String, ArrayList<C06132n>> hashMap = this.A03;
            String type4 = intent.getAction();
            ArrayList<C06132n> arrayList = hashMap.get(type4);
            if (arrayList != null) {
                if (debug) {
                ...
                for (int i10 = 0; i10 < arrayList.size(); i10++) {
                    C06132n c06132n = arrayList.get(i10);
                    if (debug) {
                        StringBuilder sb4 = new StringBuilder();
                        String type6 = A01(104, 24, 48);
                        sb4.append(type6).append(c06132n.A03).toString();
                    }
                    if (!c06132n.A00) {
                        int match = c06132n.A03.match(action, resolveTypeIfNeeded, action2, data, categories, A01(83, 21, 127));
                        if (match >= 0) {
                            if (debug) {
                ...
                if (arrayList2 != null) {
                    for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                        ((C06132n) arrayList2.get(i11)).A00 = false;
                    }
                    this.A02.add(new C06122m(intent, arrayList2));
