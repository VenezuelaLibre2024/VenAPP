...
public final class C1574cR {
    ...
    public final SU A05;
    public final InterfaceC1584cc A06;
    public final C1576cT A07;
    public final HB A08;
    public final Runnable A09;
    public final List<Rect> A0A;
    public final List<DspViewableNode> A0B;

    public C1574cR(InterfaceC1584cc interfaceC1584cc, SU su, HB hb2, C1576cT c1576cT, Handler handler) {
        this(interfaceC1584cc, su, hb2, c1576cT, handler, 100);
    }

    public C1574cR(InterfaceC1584cc interfaceC1584cc, SU su, HB hb2, C1576cT c1576cT, Handler handler, int i10) {
        this.A03 = new Rect();
        this.A02 = new Rect();
        this.A0B = new ArrayList();
        this.A0A = new ArrayList();
        this.A01 = false;
        this.A06 = interfaceC1584cc;
        this.A05 = su;
        this.A08 = hb2;
        this.A07 = c1576cT;
        this.A04 = handler;
        this.A09 = new RunnableC1575cS(this, i10, new Exception());
    }
        ...
        if (this.A0B.isEmpty()) {
            ...
            loop0: while (true) {
                if (it.hasNext()) {
                    ...
                    C1582ca A00 = this.A07.A00(next);
                    Iterator<Rect> it2 = this.A0A.iterator();
                    while (it2.hasNext()) {
                        if (next.A8N(this.A03, this.A02, it2.next()) && A00 != C1582ca.A08) {
                            HB hb2 = this.A08;
                    ...
                    this.A08.A5Z();
                    InterfaceC1578cV interfaceC1578cV = this.A00;
                    if (interfaceC1578cV != null) {
                        interfaceC1578cV.AD2();
                    }
                    this.A0B.clear();
                    String[] strArr = A0C;
    ...
    public final void A0A(InterfaceC1578cV interfaceC1578cV) {
        this.A00 = interfaceC1578cV;
    }
}
