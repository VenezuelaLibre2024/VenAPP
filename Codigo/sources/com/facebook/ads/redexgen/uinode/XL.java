...
public final class XL implements InterfaceC0837Bs, C1 {
    ...
    public static final InterfaceC0840Bv A0L;
    ...
    public XL(int i10) {
        this.A0E = i10;
        this.A0F = new C0980Hz(16);
        this.A0I = new ArrayDeque<>();
        this.A0H = new C0980Hz(AbstractC0976Hv.A03);
        this.A0G = new C0980Hz(4);
        this.A06 = -1;
    }
    ...
    private int A01(InterfaceC0838Bt interfaceC0838Bt, C0842Bz c0842Bz) throws IOException, InterruptedException {
        int i10;
        ...
        if (sampleSize != 0) {
            ...
            while (this.A04 < i12) {
                int i14 = this.A05;
                if (i14 == 0) {
                    interfaceC0838Bt.readFully(this.A0G.A00, i13, nalUnitLengthFieldLength);
                    this.A0G.A0Y(0);
                    ...
                    int AFQ = trackOutput.AFQ(interfaceC0838Bt, i14, false);
                    this.A04 += AFQ;
                    this.A05 -= AFQ;
                }
            }
            ...
            while (true) {
                ...
                int AFQ2 = trackOutput.AFQ(interfaceC0838Bt, i12 - i15, false);
                this.A04 += AFQ2;
                this.A05 -= AFQ2;
            }
            i10 = 0;
    ...
    public static int A02(C0849Ch c0849Ch, long j10) {
        int A00 = c0849Ch.A00(j10);
        if (A00 == -1) {
            return c0849Ch.A01(j10);
        }
        return A00;
    }

    public static long A03(C0849Ch c0849Ch, long j10, long j11) {
        int A02 = A02(c0849Ch, j10);
        if (A02 == -1) {
            return j11;
        }
        long min = Math.min(c0849Ch.A06[A02], j11);
    ...
    private ArrayList<C0849Ch> A05(XT xt, C0841Bw c0841Bw, boolean z10) throws C07889v {
        C0846Ce A0C;
        ArrayList<C0849Ch> arrayList = new ArrayList<>();
        for (int i10 = 0; i10 < xt.A01.size(); i10++) {
            XT xt2 = xt.A01.get(i10);
            int i11 = ((CJ) xt2).A00;
            if (i11 == CJ.A1M && (A0C = CO.A0C(xt2, xt.A07(CJ.A0o), -9223372036854775807L, null, z10, this.A0B)) != null) {
                C0849Ch A0E = CO.A0E(A0C, xt2.A06(CJ.A0e).A06(CJ.A0i).A06(CJ.A17), c0841Bw);
                if (A0E.A01 != 0) {
                    arrayList.add(A0E);
                }
            }
    ...
    */
    private void A08(long r6) throws com.facebook.ads.redexgen.uinode.C07889v {
        /*
            r5 = this;
        L0:
    ...
    private void A0A(XT xt) throws C07889v {
        ArrayList<C0849Ch> A05;
        int trackCount = -1;
        long j10 = -9223372036854775807L;
        ArrayList arrayList = new ArrayList();
        Metadata metadata = null;
        C0841Bw c0841Bw = new C0841Bw();
        XS A07 = xt.A07(CJ.A1Q);
        if (A07 != null && (metadata = CO.A0F(A07, this.A0B)) != null) {
            c0841Bw.A05(metadata);
        }
        try {
            A05 = A05(xt, c0841Bw, (this.A0E & 1) != 0);
        } catch (XP unused) {
            c0841Bw = new C0841Bw();
            A05 = A05(xt, c0841Bw, true);
        }
        int size = A05.size();
        for (int i10 = 0; i10 < size; i10++) {
            C0849Ch c0849Ch = A05.get(i10);
            C0846Ce c0846Ce = c0849Ch.A03;
            CY cy = new CY(c0846Ce, c0849Ch, this.A09.AGi(i10, c0846Ce.A03));
            Format A0F = c0846Ce.A07.A0F(c0849Ch.A00 + 30);
            if (c0846Ce.A03 == 1) {
                if (c0841Bw.A03()) {
                    A0F = A0F.A0G(c0841Bw.A00, c0841Bw.A01);
                }
                if (metadata != null) {
            ...
            cy.A01.A5n(A0F);
            j10 = Math.max(j10, c0846Ce.A04 != -9223372036854775807L ? c0846Ce.A04 : c0849Ch.A02);
            if (c0846Ce.A03 == 2 && trackCount == -1) {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A0D(com.facebook.ads.redexgen.uinode.InterfaceC0838Bt r12) throws java.io.IOException, java.lang.InterruptedException {
        /*
    ...
    private boolean A0E(InterfaceC0838Bt interfaceC0838Bt, C0842Bz c0842Bz) throws IOException, InterruptedException {
        long j10 = this.A07 - this.A00;
        long atomEndPosition = interfaceC0838Bt.A7i() + j10;
        boolean z10 = false;
        C0980Hz c0980Hz = this.A0A;
        if (c0980Hz != null) {
            interfaceC0838Bt.readFully(c0980Hz.A00, this.A00, (int) j10);
            if (this.A01 == CJ.A0V) {
            ...
            long atomPayloadSize = interfaceC0838Bt.A7i();
            c0842Bz.A00 = atomPayloadSize + j10;
            z10 = true;
        }
        A08(atomEndPosition);
    ...
    public static boolean A0F(C0980Hz c0980Hz) {
        int A08;
        int majorBrand;
        c0980Hz.A0Y(8);
    ...
    public final C0 A7t(long j10) {
        ...
        if (i10 != -1) {
            ...
            j11 = c0849Ch.A07[A02];
            j12 = c0849Ch.A06[A02];
            if (j11 < j10 && A02 < c0849Ch.A01 - 1 && (A01 = c0849Ch.A01(j10)) != -1 && A01 != A02) {
                j13 = c0849Ch.A07[A01];
                j14 = c0849Ch.A06[A01];
            }
        } else {
        ...
        while (true) {
            ...
            if (secondSampleIndex != this.A02) {
                C0849Ch c0849Ch2 = cyArr2[secondSampleIndex].A03;
                j12 = A03(c0849Ch2, j11, j12);
                if (j13 != -9223372036854775807L) {
                    j14 = A03(c0849Ch2, j13, j14);
                }
            }
            secondSampleIndex++;
        }
        C2 c22 = new C2(j11, j12);
        if (j13 == -9223372036854775807L) {
            return new C0(c22);
        }
        return new C0(c22, new C2(j13, j14));
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0837Bs
    public final void A8o(InterfaceC0839Bu interfaceC0839Bu) {
        this.A09 = interfaceC0839Bu;
    }
    ...
    public final int AEH(InterfaceC0838Bt interfaceC0838Bt, C0842Bz c0842Bz) throws IOException, InterruptedException {
        while (true) {
            switch (this.A03) {
                case 0:
                    if (!A0D(interfaceC0838Bt)) {
                        return -1;
                    }
                    break;
                case 1:
                    if (!A0E(interfaceC0838Bt, c0842Bz)) {
                        break;
                    } else {
                        return 1;
                    }
                case 2:
                    return A01(interfaceC0838Bt, c0842Bz);
                default:
    ...
    public final boolean AGR(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        return AbstractC0845Cc.A04(interfaceC0838Bt);
    }
}
