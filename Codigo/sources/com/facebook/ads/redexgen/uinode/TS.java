...
public abstract class TS extends OL {
    ...
    public final void A13() {
        if (C0988Ih.A0y(this.A06.A05()) && this.A06.A08() != null) {
            this.A06.A08().setCTAClickListener(getCtaButton());
        }
    }

    public void setAdDetailsClickListener(AbstractC1118No abstractC1118No) {
        if (C0988Ih.A0y(this.A06.A05()) && abstractC1118No != null) {
            ViewOnClickListenerC1271Tl ctaButton = getCtaButton();
            if (A01[1].charAt(21) != 'h') {
                throw new RuntimeException();
            }
            A01[3] = "am5A0dIgunRuJRLaM18rzwVTPisxqXDR";
            abstractC1118No.setOnClickListener(OI.A03(ctaButton, A0C(0, 9, 108)));
        }
    }
