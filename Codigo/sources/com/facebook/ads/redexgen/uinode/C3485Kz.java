...
public final class C3485Kz {
    ...
    public static int A00(C4337Yn c4337Yn, int i10) {
        return AbstractC3440KE.A00(c4337Yn).getInt(A01(0, 21, 2), i10);
    }

    public static String A02(C4337Yn c4337Yn, String str) {
        int A002 = A00(c4337Yn, -1);
        if (A002 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C4337Yn c4337Yn, String str, String str2) {
        if (c4337Yn == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c4337Yn, str);
    ...
    public final RewardedVideoAd A07(C4337Yn c4337Yn, String str, String str2) {
        if (c4337Yn == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c4337Yn, str);
    ...
    public final void A08(C4337Yn c4337Yn, boolean z10) {
        int i10 = 0;
        String A01 = A01(0, 21, 2);
        if (!z10) {
            int lastNonChainedAds = AbstractC3440KE.A00(c4337Yn).getInt(A01, 0);
            i10 = lastNonChainedAds + 1;
        }
        AbstractC3440KE.A00(c4337Yn).edit().putInt(A01, i10).apply();
    }

    public final boolean A09(C4337Yn c4337Yn, String str, int i10) {
        if (i10 <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c4337Yn, i10 - 1);
