...
public final class X0 implements InterfaceC0863Cy {
    ...
    public final D4 A0A = new D4(32, RecognitionOptions.ITF);
    public final D4 A08 = new D4(33, RecognitionOptions.ITF);
    public final D4 A06 = new D4(34, RecognitionOptions.ITF);
    public final D4 A07 = new D4(39, RecognitionOptions.ITF);
    public final D4 A09 = new D4(40, RecognitionOptions.ITF);
    public final C0980Hz A0C = new C0980Hz();
    ...
    public static Format A00(String str, D4 d42, D4 d43, D4 d44) {
        ...
        if (i02.A0A() && i02.A0A()) {
            ...
            if (picWidthInLumaSamples == 255) {
                ...
                float[] fArr = AbstractC0976Hv.A04;
                String[] strArr2 = A0F;
                ...
                if (picWidthInLumaSamples < fArr.length) {
                    f10 = AbstractC0976Hv.A04[picWidthInLumaSamples];
                } else {
    ...
    private void A03(long j10, int i10, int i11, long j11) {
        ...
        if (this.A07.A04(i11)) {
            ...
            A0F[3] = "Yba7mj";
            this.A0C.A0b(this.A07.A01, AbstractC0976Hv.A02(d42.A01, this.A07.A00));
            this.A0C.A0Z(5);
            this.A0B.A02(j11, this.A0C);
        }
        if (this.A09.A04(i11)) {
            this.A0C.A0b(this.A09.A01, AbstractC0976Hv.A02(this.A09.A01, this.A09.A00));
            this.A0C.A0Z(5);
            this.A0B.A02(j11, this.A0C);
        }
    }
    ...
    public final void A4R(C0980Hz c0980Hz) {
        while (true) {
            ...
            if (A04 > 0) {
                ...
                long j10 = this.A01;
                int offset = c0980Hz.A04();
                this.A01 = j10 + offset;
                C4 c42 = this.A02;
                int offset2 = c0980Hz.A04();
                c42.AFR(c0980Hz, offset2);
                while (limit < A07) {
                    int A042 = AbstractC0976Hv.A04(bArr, limit, A07, this.A0D);
                    if (A042 == A07) {
                        A07(bArr, limit, A07);
                        return;
                    }
                    int bytesWrittenPastPosition = AbstractC0976Hv.A00(bArr, A042);
                    int i10 = A042 - limit;
                    if (i10 > 0) {
                        A07(bArr, limit, A042);
                    }
    ...
    public final void A4p(InterfaceC0839Bu interfaceC0839Bu, DC dc2) {
        dc2.A05();
        this.A04 = dc2.A04();
        C4 AGi = interfaceC0839Bu.AGi(dc2.A03(), 2);
        this.A02 = AGi;
        this.A03 = new D3(AGi);
        this.A0B.A03(interfaceC0839Bu, dc2);
    }
