...
public final class C3F extends AbstractC07106j {
    ...
    public C3F(Context context, DM dm2, long j10, InterfaceC0821Bc<FrameworkMediaCrypto> interfaceC0821Bc, boolean z10, Handler handler, InterfaceC0984Id interfaceC0984Id, int i10) {
        super(2, dm2, interfaceC0821Bc, z10);
        this.A0U = j10;
        this.A0T = i10;
        Context applicationContext = context.getApplicationContext();
        this.A0V = applicationContext;
        this.A0W = new IT(applicationContext);
        this.A0X = new C0983Ic(handler, interfaceC0984Id);
        this.A0Y = A0M();
    ...
    */
    ...
    private void A0L(Surface surface) throws C07709c {
        if (surface == null) {
            if (this.A0N != null) {
                surface = this.A0N;
            } else {
    ...
    private final boolean A0S(MediaCodec mediaCodec, int i10, long j10, long j11) throws C07709c {
        int A10 = A10(j11);
        if (A10 == 0) {
            return false;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int A1C(com.facebook.ads.redexgen.uinode.DM r10, com.facebook.ads.redexgen.uinode.InterfaceC0821Bc<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> r11, com.facebook.ads.internal.exoplayer2.thirdparty.Format r12) throws com.facebook.ads.redexgen.uinode.DP {
        /*
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC07106j
    public final void A1G() throws C07709c {
        super.A1G();
        this.A04 = 0;
    }
    ...
    */
    ...
    public final void A1N(C1377Xr c1377Xr) {
        this.A04++;
        this.A0K = Math.max(c1377Xr.A00, this.A0K);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean A1Q(long r32, long r34, android.media.MediaCodec r36, java.nio.ByteBuffer r37, int r38, int r39, long r40, boolean r42) throws com.facebook.ads.redexgen.uinode.C07709c {
        /*
