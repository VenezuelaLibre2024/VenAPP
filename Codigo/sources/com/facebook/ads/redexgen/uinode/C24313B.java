...
public final class C24313B {
    ...
    public final void A03(int i10) {
        ...
        if (A00 != null) {
            AbstractC24643j.A02(A00, this.A04, i10);
            A01(i10, null);
        }
    }
    ...
    public final boolean A07(float f10, float f11) {
        ...
        return AbstractC24643j.A06(A00, this.A04, f10, f11);
    }
    ...
    public final boolean A08(float f10, float f11, boolean z10) {
        ...
        return AbstractC24643j.A07(A00, this.A04, f10, f11, z10);
    }
    ...
    public final boolean A0B(int i10, int i11) {
        ...
        if (A06()) {
            ...
            for (ViewParent parent = this.A04.getParent(); parent != null; parent = parent.getParent()) {
                if (AbstractC24643j.A08(parent, view, this.A04, i10, i11)) {
                    A01(i11, parent);
                    AbstractC24643j.A05(parent, view, this.A04, i10, i11);
                    return true;
                }
    ...
    public final boolean A0D(int i10, int i11, int i12, int i13, int[] iArr, int startX) {
        ...
        if (i10 != 0 || i11 != 0 || i12 != 0 || i13 != 0) {
            ...
            AbstractC24643j.A03(A00, this.A04, i10, i11, i12, i13, startX);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
                iArr[0] = iArr[0] - i14;
                iArr[1] = iArr[1] - i15;
    ...
    */
    public final boolean A0F(int r17, int r18, int[] r19, int[] r20, int r21) {
        ...
        L20:
            r7 = 0
            r6 = 0
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C24313B.A05
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 9
            if (r1 == r0) goto L9a
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C24313B.A05
        ...
        L67:
            ...
            com.facebook.ads.redexgen.uinode.AbstractC24643j.A04(r10, r11, r12, r13, r14, r15)
            if (r4 == 0) goto L81
            android.view.View r0 = r3.A04
            r0.getLocationInWindow(r4)
            r0 = r4[r9]
        ...
        La6:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24313B.A0F(int, int, int[], int[], int):boolean");
    }
}
