...
public enum EnumC3658Nm {
    ...
    public static EnumC3658Nm A00(int i10) {
        for (EnumC3658Nm enumC3658Nm : valuesCustom()) {
            if (enumC3658Nm.A00 == i10) {
                return enumC3658Nm;
            }
        }
        return A05;
    ...
    public static EnumC3658Nm[] valuesCustom() {
        Object clone = values().clone();
        if (A02[4].length() == 18) {
            throw new RuntimeException();
        }
        A02[4] = "9YF3oPenjmVnddjujEMQmJq4m";
        return (EnumC3658Nm[]) clone;
    }
}
