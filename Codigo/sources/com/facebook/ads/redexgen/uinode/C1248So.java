...
public final class C1248So extends FrameLayout implements MD {
    ...
    public boolean A08;
    public boolean A09;
    public final C1500b3 A0A;
    public final C5T A0B;
    public final C07046c A0C;
    public final C1399Yn A0D;
    public final J2 A0E;
    public final JA A0F;
    public final ViewOnSystemUiVisibilityChangeListenerC1053Lb A0G;
    public final MC A0H;
    public final FullScreenAdToolbar A0I;
    public final InterfaceC1087Mj A0J;
    public final ArrayList<C1158Pc> A0K;
    ...
    */
    private com.facebook.ads.redexgen.uinode.PQ A08(boolean r26, int r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1248So.A08(boolean, int):com.facebook.ads.redexgen.X.PQ");
    }
    ...
    public C1248So(C1399Yn c1399Yn, InterfaceC1087Mj interfaceC1087Mj, J2 j22, C1500b3 c1500b3, C07046c c07046c, MC mc2) {
        super(c1399Yn);
        ...
        this.A00 = 0;
        this.A01 = 0;
        this.A0B = new C1251Sr(this);
        this.A0D = c1399Yn;
        this.A0J = interfaceC1087Mj;
        this.A0E = j22;
        this.A0A = c1500b3;
        this.A0C = c07046c;
        this.A0H = mc2;
        this.A0F = new JA(c1500b3.A0v(0).A12(), j22);
        ...
        this.A0G = viewOnSystemUiVisibilityChangeListenerC1053Lb;
        viewOnSystemUiVisibilityChangeListenerC1053Lb.A05(EnumC1052La.A03);
        this.A05 = new Q7(c1399Yn, interfaceC1087Mj, c1500b3.A0T(), mc2);
    ...
    */
    private int A00() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1248So.A00():int");
    }
    ...
    public static /* synthetic */ int A02(C1248So c1248So, int i10) {
        int i11 = c1248So.A01 + i10;
        c1248So.A01 = i11;
        return i11;
    }
    ...
    private FullScreenAdToolbar A05() {
        ...
        fullScreenAdToolbar.setToolbarListener(new C1249Sp(this));
    ...
    private void A0B() {
        ...
        if (i10 > 0 && !TextUtils.isEmpty(this.A0A.A0v(i10 - 1).A12())) {
            ...
            PQ pq = this.A04;
            C1112Ni A03 = c1112Ni.A03(pq != null ? pq.getAdViewabilityChecker() : null);
            PQ pq2 = this.A04;
    ...
    private void A0C() {
        this.A0D.A0E().A4E();
        this.A07 = true;
        this.A03 = new C1124Nu(this.A0D, this.A0A, this.A0E, this.A0H, this.A0I.getToolbarHeight(), this.A02);
        C1158Pc c1158Pc = null;
        Iterator<C1158Pc> it = this.A0K.iterator();
        while (true) {
            ...
            if (A0M[1].charAt(22) == '6') {
                ...
                C1158Pc next = it.next();
                if (next.A00 == C1158Pc.A06) {
                    c1158Pc = next;
                    break;
                }
            } else {
        ...
        PQ pq = this.A04;
        if (pq != null) {
            AbstractC1066Lo.A0J(pq);
            this.A04.A0z();
            this.A04 = null;
        }
        AbstractC1066Lo.A0J(this.A03);
        AbstractC1066Lo.A0G(1102, this.A03);
    ...
    private void A0I(ViewGroup viewGroup, C1158Pc c1158Pc) {
        if (c1158Pc.A00 == C1158Pc.A06 && c1158Pc.A03 != null) {
            OA.A00(this.A0D, viewGroup, c1158Pc.A03);
        } else {
            AbstractC1066Lo.A0M(viewGroup, c1158Pc.A01);
        }
        this.A0I.setFullscreen(c1158Pc.A05);
        this.A0I.A06(c1158Pc.A02, c1158Pc.A04);
    }

    private void A0J(AbstractC1502b5 abstractC1502b5) {
        if (A0V(abstractC1502b5)) {
            int i10 = this.A02;
            if (A0M[2].charAt(7) != '3') {
                throw new RuntimeException();
            }
            ...
            if (i10 == 2) {
                this.A0I.setOnlyPageDetails(abstractC1502b5.A10());
                return;
            }
        }
        this.A0I.setOnlyPageDetails(null);
    ...
    public static boolean A0V(AbstractC1502b5 abstractC1502b5) {
    ...
    private void setupToolbarForAd(PQ pq) {
        ...
        this.A06 = true;
        AbstractC1502b5 A0v = this.A0A.A0v(this.A00);
        this.A0I.A09(this.A0D, A0v.A0r());
        this.A0I.A08(A0v.A10(), A0v.A12(), A01(this.A00));
        C1158Pc fullScreenAdStyle = pq.getFullScreenAdStyle();
