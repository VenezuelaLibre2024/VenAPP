...
public abstract class LW {
    ...
    public static String A03(Context context, Throwable th2) {
        int A0I = C0988Ih.A0I(context);
        int maxStacktraceLines = C0988Ih.A02(context);
        return A06(th2, A0I, maxStacktraceLines, C0988Ih.A1G(context));
    }
    ...
    public static String A06(Throwable th2, int i10, int i11, boolean z10) {
        ...
        try {
            C1293Uh c1293Uh = new C1293Uh();
            LU lu = c1293Uh;
            if (i11 >= 0) {
                lu = new C1291Uf(lu, i11);
            }
            if (i10 >= 0) {
                lu = new C1290Ue(lu, i10, i10);
            }
            if (z10) {
                lu = new C1292Ug(lu);
            }
            C1294Ui c1294Ui = new C1294Ui(c1293Uh, 1, lu);
            th2.printStackTrace(new PrintWriter(new LV(c1294Ui)));
            c1294Ui.flush();
            return c1293Uh.toString();
