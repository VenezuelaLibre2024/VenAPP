...
public class HandlerThreadC3327IL extends HandlerThread implements Handler.Callback {
    public static byte[] A05;
    public Handler A00;
    public RunnableC3291Hk A01;
    ...
    public HandlerThreadC3327IL() {
        super(A00(77, 12, 64));
    }

    private void A01() {
        AbstractC3281Ha.A01(this.A01);
        this.A01.A08();
    }
    ...
    public final DummySurface A04(int i10) {
        ...
        this.A01 = new RunnableC3291Hk(this.A00);
        boolean z10 = false;
        synchronized (this) {
        ...
        if (runtimeException == null) {
            ...
            if (error == null) {
                return (DummySurface) AbstractC3281Ha.A01(this.A02);
            }
            throw error;
        }
    ...
    */
    public final boolean handleMessage(android.os.Message r7) {
        ...
        L84:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.HandlerThreadC3327IL.handleMessage(android.os.Message):boolean");
    }
}
