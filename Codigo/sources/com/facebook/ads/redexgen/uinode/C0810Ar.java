...
public final class C0810Ar {
    ...
    public long A03;
    public long A04;
    public final C0808Ap A05;

    public C0810Ar(AudioTrack audioTrack) {
        if (IF.A02 >= 19) {
            this.A05 = new C0808Ap(audioTrack);
            A05();
        } else {
            this.A05 = null;
            A00(3);
    ...
    public final boolean A08(long j10) {
        C0808Ap c0808Ap = this.A05;
        if (c0808Ap == null || j10 - this.A03 < this.A04) {
            return false;
        }
        this.A03 = j10;
        boolean A02 = c0808Ap.A02();
        switch (this.A00) {
            case 0:
                if (!A02) {
