...
public final class C3133F8 {
    ...
    public C2961C3[] A0H = new C2961C3[AdError.NETWORK_ERROR_CODE];
     ...
     */
    public final synchronized int A09(C28259p c28259p, C4279Xr c4279Xr, boolean z10, boolean z11, Format format, C3132F7 c3132f7) {
        if (!A0I()) {
            if (z11) {
                c4279Xr.A02(4);
                return -4;
        ...
        if (z10 || this.A0G[A00] != format) {
            c28259p.A00 = this.A0G[A00];
            return -5;
        }
        if (c4279Xr.A0B()) {
            return -3;
        }
        c4279Xr.A00 = this.A0F[A00];
        c4279Xr.A02(this.A0B[A00]);
        c3132f7.A00 = this.A0C[A00];
        c3132f7.A01 = this.A0E[A00];
        c3132f7.A02 = this.A0H[A00];
        this.A03++;
        return -4;
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized void A0G(long j10, int i10, long j11, int i11, C2961C3 c2961c3) {
        if (this.A0A) {
            if ((i10 & 1) == 0) {
                return;
            } else {
        ...
        if (i12 == i13) {
            ...
            C2961C3[] c2961c3Arr = new C2961C3[i14];
            ...
            System.arraycopy(this.A0H, this.A04, c2961c3Arr, 0, i16);
            ...
            System.arraycopy(this.A0H, 0, c2961c3Arr, i16, i17);
    ...
    */
    private int A01(int r6, int r7, long r8, boolean r10) {
        ...
        L21:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3133F8.A01(int, int, long, boolean):int");
    }
    ...
    */
    public final long A0C(int r6) {
        /*
            ...
            r0 = 1
        L10:
            com.facebook.ads.redexgen.uinode.AbstractC3281Ha.A03(r0)
            int r0 = r5.A02
            int r0 = r0 - r2
            r5.A02 = r0
            long r2 = r5.A06
        ...
        L2d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3133F8.A0C(int):long");
    }
    ...
    public final synchronized long A0D(long j10, boolean z10, boolean z11) {
        ...
        if (i11 != 0) {
            ...
            if (j10 >= jArr[searchLength]) {
                ...
                int A01 = A01(searchLength, i11, j10, z10);
                if (A01 == -1) {
                    return -1L;
                }
                return A02(A01);
    ...
    public final synchronized boolean A0K(Format format) {
        ...
        this.A09 = false;
        if (AbstractC3322IF.A0g(format, this.A08)) {
            return false;
        }
        this.A08 = format;
        return true;
