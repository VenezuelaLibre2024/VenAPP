...
public final class SN extends AnonymousClass56 implements MJ {
    ...
    public SN(B4 b42, SparseBooleanArray sparseBooleanArray, RE re2, int i10, int i11, int i12, int i13, C1399Yn c1399Yn, C1U c1u) {
        super(b42);
        this.A09 = c1399Yn;
        this.A0A = b42;
    ...
    private void A0A(J2 j22, C1058Lg c1058Lg, String str, C1171Pp c1171Pp) {
        ...
        this.A01 = new SP(this, str, c1171Pp, j22, c1171Pp.A04(), c1058Lg);
        RE re3 = new RE(this.A0A, 10, new WeakReference(this.A01), this.A09);
        this.A03 = re3;
        re3.A0Y(false);
        this.A03.A0W(100);
        this.A03.A0X(100);
        this.A0A.setOnAssetsLoadedListener(new SO(this, c1171Pp));
    }

    public final void A0j(C1171Pp c1171Pp, J2 j22, C07046c c07046c, C1058Lg c1058Lg, String str) {
        int A02 = c1171Pp.A02();
        ...
        String imageUrl = c1171Pp.A03().A0D().A07();
        String A08 = c1171Pp.A03().A0D().A08();
        this.A0A.setIsVideo(!TextUtils.isEmpty(A08));
        if (this.A0A.A18()) {
            this.A0A.setVideoPlaceholderUrl(imageUrl);
            this.A0A.setVideoUrl(c07046c.A0S(A08));
        } else {
            this.A0A.setImageUrl(imageUrl);
        }
        this.A0A.setLayoutParams(marginLayoutParams);
        this.A0A.setAdTitleAndDescription(c1171Pp.A03().A0E().A06(), c1171Pp.A03().A0E().A01());
        this.A0A.setCTAInfo(c1171Pp.A03().A0F(), c1171Pp.A04());
        this.A0A.A1A(c1171Pp.A04());
