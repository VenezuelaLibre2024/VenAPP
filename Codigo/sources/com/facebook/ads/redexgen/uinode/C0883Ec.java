...
public final class C0883Ec extends ZY {
    ...
    private int A00(AbstractC06654o abstractC06654o, View view, C4Y c4y) {
        int containerCenter;
        int A0F = c4y.A0F(view) + (c4y.A0D(view) / 2);
        if (abstractC06654o.A1T()) {
            int A0A = c4y.A0A();
    ...
    private View A01(AbstractC06654o abstractC06654o, C4Y c4y) {
        int childCenter;
        int A0W = abstractC06654o.A0W();
        if (A0W == 0) {
            return null;
        }
        View view = null;
        ...
        for (int absClosest = 0; absClosest < A0W; absClosest++) {
            View A0t = abstractC06654o.A0t(absClosest);
            int A0F = c4y.A0F(A0t);
    ...
    private View A02(AbstractC06654o abstractC06654o, C4Y c4y) {
        int A0W = abstractC06654o.A0W();
        if (A0W == 0) {
            return null;
        }
        View closestChild = null;
        int childStart = a.e.API_PRIORITY_OTHER;
        for (int i10 = 0; i10 < A0W; i10++) {
            View A0t = abstractC06654o.A0t(i10);
    ...
    private C4Y A03(AbstractC06654o abstractC06654o) {
        C4Y c4y = this.A00;
        if (c4y == null || c4y.A02 != abstractC06654o) {
            this.A00 = C4Y.A00(abstractC06654o);
        }
        return this.A00;
    }

    private C4Y A04(AbstractC06654o abstractC06654o) {
        C4Y c4y = this.A01;
        if (c4y == null || c4y.A02 != abstractC06654o) {
            this.A01 = C4Y.A01(abstractC06654o);
        }
        return this.A01;
    }
    ...
    */
    public final int A0C(com.facebook.ads.redexgen.uinode.AbstractC06654o r10, int r11, int r12) {
        /*
            r9 = this;
            int r8 = r10.A0Z()
            r4 = -1
        ...
        L1a:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C0883Ec.A02
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 1
            ...
            throw r0
        L36:
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C0883Ec.A02
        ...
        La5:
            ...
            goto L53
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0883Ec.A0C(com.facebook.ads.redexgen.X.4o, int, int):int");
    }

    @Override // com.facebook.ads.redexgen.uinode.ZY
    public final View A0D(AbstractC06654o abstractC06654o) {
        if (abstractC06654o.A21()) {
            return A01(abstractC06654o, A04(abstractC06654o));
        }
        if (abstractC06654o.A20()) {
            return A01(abstractC06654o, A03(abstractC06654o));
        }
        return null;
    }

    @Override // com.facebook.ads.redexgen.uinode.ZY
    public final C1424Zn A0E(AbstractC06654o abstractC06654o) {
        if (!(abstractC06654o instanceof AnonymousClass50)) {
            return null;
        }
        return new C0884Ed(this, super.A00.getContext());
    }

    @Override // com.facebook.ads.redexgen.uinode.ZY
    public final int[] A0H(AbstractC06654o abstractC06654o, View view) {
        int[] iArr = new int[2];
        if (abstractC06654o.A20()) {
            iArr[0] = A00(abstractC06654o, view, A03(abstractC06654o));
        } else {
            iArr[0] = 0;
        }
        ...
        if (A21) {
            iArr[1] = A00(abstractC06654o, view, A04(abstractC06654o));
        } else {
            iArr[1] = 0;
        }
        return iArr;
