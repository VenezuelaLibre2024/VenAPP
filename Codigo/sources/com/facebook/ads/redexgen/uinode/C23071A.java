...
public final class C23071A extends BroadcastReceiver {
    ...
    public C23071A(C2932Ba c2932Ba, Context context) {
        this.A01 = c2932Ba;
        this.A00 = context;
    }
    ...
    public final void A02() {
        ...
        C24092o.A00(this.A00).A06(this, intentFilter);
    }

    public final void A03() {
        try {
            C24092o.A00(this.A00).A05(this);
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (str3.equals(action5)) {
            ...
            if (serializableExtra instanceof C3601Mr) {
                if (this.A01.getListener() != null) {
                ...
                if (this.A02) {
                    ...
                    this.A01.A0Y(((C3601Mr) serializableExtra).A01());
                }
                this.A01.setVisibility(0);
                this.A01.A0b(EnumC3818QM.A04, 1);
                return;
            }
            if (serializableExtra instanceof C3780Pk) {
                if (this.A01.getListener() == null) {
                    return;
                }
                InterfaceC3573MP listener = this.A01.getListener();
                String[] split3 = A04;
            ...
            if (serializableExtra instanceof C3739P5) {
                if (this.A01.getListener() == null) {
                    return;
                }
            ...
            if (serializableExtra instanceof C27929H) {
                if (this.A01.getListener() != null) {
            ...
            if (serializableExtra instanceof C3680O8) {
                if (this.A01.getListener() != null) {
                    InterfaceC3573MP listener2 = this.A01.getListener();
                    String[] split4 = A04;
            ...
            if (!(serializableExtra instanceof C278398) || this.A01.getListener() == null) {
                return;
            }
