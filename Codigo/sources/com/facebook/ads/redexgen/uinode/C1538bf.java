...
public class C1538bf implements C0S {
    ...
    public final AtomicReference<EnumC05530e> A08;
    ...
    private final void A03(JSONObject jSONObject) {
        ...
        try {
            ...
            EnumC05530e enumC05530e = this.A08.get();
            if (enumC05530e != null) {
                C0Z.A0I.A04(enumC05530e).A02(jSONObject);
            }
    ...
    public C1538bf(C1536bd c1536bd) {
        this(c1536bd, UUID.randomUUID().toString());
    }

    public C1538bf(C1536bd c1536bd, String str) {
    ...
    @Override // com.facebook.ads.redexgen.uinode.C0S
    public final void AGG(EnumC05530e viewType) {
        if (KL.A02(this)) {
            return;
        }
        try {
