...
public final class C25865i implements NativeAdApi {
    ...
    public C25865i(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        C4107V2.A0L(nativeAdBaseApi).A1Y(EnumC3407Jg.A05);
    }

    public C25865i(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }

    private C4107V2 A00() {
        return C4107V2.A0L(this.A01);
    }
    ...
    public final List<NativeAd> A03() {
        ...
        for (C4107V2 internalNativeAd : A00().A1H()) {
    ...
    public final VideoAutoplayBehavior getVideoAutoplayBehavior() {
        return EnumC3397JU.A00(A00().A18());
    }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C4337Yn A11 = A00().A11();
            C4337Yn downloadContext = C25805c.A03(imageView.getContext());
            downloadContext.A0K(A11);
            C4107V2.A0j(A00().getAdIcon(), imageView, downloadContext);
        }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, MediaView mediaView2, List<View> list) {
        if (mediaView != null) {
            ((C4367ZH) mediaView.getMediaViewApi()).A0L(this.A00);
        }
        if (mediaView2 != null) {
            ((C4367ZH) mediaView2.getMediaViewApi()).A0M(this.A01, false);
        }
        if (list != null) {
