...
public final class C3574MQ extends RelativeLayout {
    public TextView A00;
    ...
    public static final int A08 = (int) (AbstractC3499LD.A02 * 60.0f);
    public static final int A07 = (int) (AbstractC3499LD.A02 * 8.0f);
    public static final int A09 = (int) (AbstractC3499LD.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC3499LD.A02 * 24.0f);
    public static final int A06 = (int) (AbstractC3499LD.A02 * 12.0f);

    public C3574MQ(C4337Yn c4337Yn, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c4337Yn);
        TextView textView = new TextView(c4337Yn);
        this.A05 = textView;
        Button button = new Button(c4337Yn);
        this.A02 = button;
        Button button2 = new Button(c4337Yn);
        this.A01 = button2;
        ImageView imageView = new ImageView(c4337Yn);
        this.A03 = imageView;
        this.A04 = new LinearLayout(c4337Yn);
        ...
        if (textView2 != null) {
            ...
            AbstractC3536Lo.A0X(this.A00, false, 18);
        }
        imageView.setImageBitmap(bitmap);
        imageView.setColorFilter(i10);
        button.setText(str3);
        AbstractC3536Lo.A0X(button, true, 18);
        button.setAllCaps(true);
        button.setTextColor(i11);
        int i12 = A06;
        button.setPadding(i12, i12, i12, i12);
        button2.setText(str4);
        AbstractC3536Lo.A0X(button2, true, 18);
        button2.setAllCaps(true);
        button2.setTextColor(i10);
        button2.setPadding(i12, i12, i12, i12);
        int A01 = AbstractC24102p.A01(i11, 20);
        int i13 = A07;
        AbstractC3536Lo.A0O(button, i10, i13);
        AbstractC3536Lo.A0O(button2, A01, i13);
        A00();
        setGravity(17);
    }
