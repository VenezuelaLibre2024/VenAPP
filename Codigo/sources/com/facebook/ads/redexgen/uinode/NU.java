...
public class NU extends WebChromeClient {
    ...
    public final WeakReference<C1399Yn> A00;
    ...
    public NU(WeakReference<C1399Yn> weakReference, WeakReference<NS> weakReference2, WeakReference<NO> weakReference3) {
    ...
    private boolean A02(ValueCallback valueCallback) {
        ...
        C1399Yn c1399Yn = this.A00.get();
        if (c1399Yn != null && c1399Yn.A0D() != null) {
            z10 = U1.A09;
            if (z10) {
                ...
                try {
                    ...
                    c1399Yn.A0D().startActivityForResult(Intent.createChooser(intent, A00(3, 12, 112)), AdError.NO_FILL_ERROR_CODE);
                    return true;
                } catch (Exception e10) {
                    c1399Yn.A07().A9b(A00(80, 8, 70), C8A.A2b, new C8B(e10));
