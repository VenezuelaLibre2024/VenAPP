...
public final class C1333Vw implements InterfaceC0950Gu {
    ...
    public boolean A03;
    public final HG<? super C1333Vw> A04;
    ...
    public C1333Vw(HG<? super C1333Vw> hg2) {
        this.A04 = hg2;
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0950Gu
    public final long ADl(C0954Gy c0954Gy) throws H1 {
        try {
            this.A01 = c0954Gy.A04;
            RandomAccessFile randomAccessFile = new RandomAccessFile(c0954Gy.A04.getPath(), A00(0, 1, 20));
            this.A02 = randomAccessFile;
            randomAccessFile.seek(c0954Gy.A03);
            long length = c0954Gy.A02 == -1 ? this.A02.length() - c0954Gy.A03 : c0954Gy.A02;
            this.A00 = length;
            if (length >= 0) {
                this.A03 = true;
                HG<? super C1333Vw> hg2 = this.A04;
                if (hg2 != null) {
