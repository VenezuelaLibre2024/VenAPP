...
public final class C3872RE {
    ...
    public int A02;
    public long A03;
    public AbstractRunnableC3455KT A04;
    public C3873RF A05;
    ...
    public final WeakReference<AbstractC3871RD> A0E;
    ...
    */
    public static int A08(java.util.Vector<android.graphics.Rect> r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3872RE.A08(java.util.Vector):int");
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 9 out of bounds for length 9
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static C3873RF A0E(View view, int i10, C4337Yn c4337Yn) {
        if (view == null) {
            A0N(null, false, A0H(353, 16, 31));
            return new C3873RF(EnumC22620Q.A08);
        }
        boolean A2H = C3348Ih.A2H(c4337Yn);
        String A0H2 = A0H(415, 37, 113);
        String A0H3 = A0H(331, 22, 99);
        if (A2H) {
            if (view.getParent() == null) {
                A0N(view, false, A0H3);
                return new C3873RF(EnumC22620Q.A0K);
            }
            if (!view.isShown()) {
                A0N(view, false, A0H2);
                return new C3873RF(EnumC22620Q.A0N);
            }
        } else {
            if (view.getParent() == null) {
                A0N(view, false, A0H3);
                return new C3873RF(EnumC22620Q.A0H);
            }
            if (!view.isShown()) {
                A0N(view, false, A0H2);
                return new C3873RF(EnumC22620Q.A0H);
        ...
        if (A0H[4].charAt(15) == 'A') {
            ...
            try {
                ...
                if (!view.getGlobalVisibleRect(rect)) {
                    return new C3873RF(EnumC22620Q.A07);
                }
                int i11 = Build.VERSION.SDK_INT;
                if (A0H[1].length() == 16) {
                    A0H[1] = "Od97VXu84qI514kY";
                    if (i11 >= 17) {
                        ((WindowManager) c4337Yn.getSystemService(A0H(594, 6, 109))).getDefaultDisplay().getRealMetrics(new DisplayMetrics());
                    } else {
                    ...
                    if (A082 < A01) {
                        ...
                        return new C3873RF(EnumC22620Q.A04, A082);
                    }
                    if (!C3553M5.A03(c4337Yn)) {
                        A0N(view, false, A0H(185, 26, 62));
                        return new C3873RF(EnumC22620Q.A0L, A082);
                    }
                    Map<String, String> A012 = C3554M6.A01(c4337Yn);
                    if (C3537Lp.A04(A012)) {
                        A0N(view, false, A0H(156, 29, 77));
                        return new C3873RF(EnumC22620Q.A0A, A082);
                    }
                    if (C3348Ih.A1d(c4337Yn) && C3537Lp.A03(A012)) {
                        A0N(view, false, A0H(31, 31, 14));
                        return new C3873RF(EnumC22620Q.A05, A082, A012);
                    }
                    A0N(view, true, A0H(396, 19, 63));
                    return new C3873RF(EnumC22620Q.A0J, A082, A012);
                }
    ...
    public final synchronized String A0R() {
        return EnumC22620Q.valuesCustom()[this.A05.A01()].toString() + String.format(Locale.US, A0H(0, 9, 96), Float.valueOf(this.A05.A00() * 100.0f));
    }

    static {
        A0M();
        A0I = C3872RE.class.getSimpleName();
    }

    public C3872RE(View view, int i10, int i11, boolean z10, WeakReference<AbstractC3871RD> weakReference, C4337Yn c4337Yn) {
        this.A0B = new Handler();
        this.A01 = 0;
        this.A02 = AdError.NETWORK_ERROR_CODE;
        this.A08 = true;
        this.A05 = new C3873RF(EnumC22620Q.A0M);
    ...
    public C3872RE(View view, int i10, WeakReference<AbstractC3871RD> weakReference, C4337Yn c4337Yn) {
        this(view, i10, 0, false, weakReference, c4337Yn);
    }

    public C3872RE(View view, int i10, boolean z10, WeakReference<AbstractC3871RD> weakReference, C4337Yn c4337Yn) {
        this(view, i10, 0, z10, weakReference, c4337Yn);
    }
    ...
    public static /* synthetic */ int A05(C3872RE c3872re) {
        int i10 = c3872re.A00;
        c3872re.A00 = i10 + 1;
        return i10;
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
            ...
            boolean z10 = true;
            boolean z11 = !(childAt instanceof C3793Px);
            if ((childAt instanceof C3996TE) && AbstractC3874RG.A00(childAt)) {
                z10 = false;
            }
            if (z11 && z10) {
    ...
    public static Vector<Rect> A0L(View view) {
        ...
        if ((view instanceof ViewGroup) && (AbstractC3874RG.A00(view) || isTransparentToolbar)) {
    ...
    public final synchronized Map<String, String> A0S() {
        ...
        hashMap.put(A0H(592, 2, 68), C3527Lf.A05(this.A03));
    ...
    public final synchronized void A0U() {
        ...
        C266577 c266577 = new C266577(this, this.A0D);
        this.A04 = c266577;
        this.A0B.postDelayed(c266577, this.A01);
        this.A08 = false;
        this.A00 = 0;
        this.A05 = new C3873RF(EnumC22620Q.A0M);
        this.A06 = new HashMap();
