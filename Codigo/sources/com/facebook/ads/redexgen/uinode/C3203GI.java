...
public final class C3203GI {
    ...
    public final C3306Hz A00 = new C3306Hz();
    ...
    public static char A00(C3306Hz c3306Hz, int i10) {
        return (char) c3306Hz.A00[i10];
    }

    public static String A02(C3306Hz c3306Hz) {
        int limit = c3306Hz.A06();
        int A07 = c3306Hz.A07();
        char c10 = 0;
        while (limit < A07 && c10 == 0) {
            int i10 = limit + 1;
            int position = c3306Hz.A00[limit];
            int limit2 = (char) position;
            c10 = limit2 == 41 ? (char) 1 : (char) 0;
            limit = i10;
        }
        int position2 = c3306Hz.A06();
        return c3306Hz.A0S((limit - 1) - position2).trim();
    }

    public static String A03(C3306Hz c3306Hz, StringBuilder sb2) {
        sb2.setLength(0);
        int A06 = c3306Hz.A06();
        int A07 = c3306Hz.A07();
        boolean z10 = false;
        while (A06 < A07 && !z10) {
            int position = c3306Hz.A00[A06];
        ...
        int position2 = c3306Hz.A06();
        c3306Hz.A0Z(A06 - position2);
        return sb2.toString();
    }

    public static String A04(C3306Hz c3306Hz, StringBuilder sb2) {
        A0A(c3306Hz);
        if (c3306Hz.A04() == 0) {
            return null;
        }
        String A032 = A03(c3306Hz, sb2);
        String A01 = A01(0, 0, 115);
        if (!A01.equals(A032)) {
            return A032;
        }
        String identifier = A01 + ((char) c3306Hz.A0E());
        return identifier;
    }

    public static String A05(C3306Hz c3306Hz, StringBuilder sb2) {
        StringBuilder sb3 = new StringBuilder();
        boolean z10 = false;
        while (!z10) {
            int A06 = c3306Hz.A06();
            String token = A04(c3306Hz, sb2);
            if (token == null) {
                return null;
            }
    ...
    public static String A06(C3306Hz c3306Hz, StringBuilder sb2) {
        A0A(c3306Hz);
        if (c3306Hz.A04() < 5) {
            return null;
        }
        String A0S = c3306Hz.A0S(5);
    ...
    private void A08(C3207GM c3207gm, String str) {
        ...
        if (indexOf != -1) {
            ...
            if (matcher.matches()) {
                c3207gm.A0K(matcher.group(1));
            }
            str = str.substring(0, indexOf);
        }
        String[] classDivision = AbstractC3322IF.A0l(str, A01(9, 2, 77));
        String str4 = classDivision[0];
        int indexOf2 = str4.indexOf(35);
        if (indexOf2 != -1) {
            c3207gm.A0J(str4.substring(0, indexOf2));
            c3207gm.A0I(str4.substring(indexOf2 + 1));
        } else {
            c3207gm.A0J(str4);
        }
        if (classDivision.length > 1) {
            c3207gm.A0L((String[]) Arrays.copyOfRange(classDivision, 1, classDivision.length));
        }
    }

    public static void A09(C3306Hz c3306Hz) {
        String line;
        do {
            line = c3306Hz.A0P();
    ...
    public static void A0A(C3306Hz c3306Hz) {
        boolean skipping = true;
        while (c3306Hz.A04() > 0 && skipping) {
            boolean skipping2 = A0D(c3306Hz);
            if (!skipping2) {
                boolean skipping3 = A0C(c3306Hz);
                if (!skipping3) {
                    skipping = false;
                }
            }
    ...
    public static void A0B(C3306Hz c3306Hz, C3207GM c3207gm, StringBuilder sb2) {
        A0A(c3306Hz);
        String A032 = A03(c3306Hz, sb2);
        String A01 = A01(0, 0, 115);
        if (A01.equals(A032)) {
        ...
        String property = A04(c3306Hz, sb2);
        if (!A012.equals(property)) {
            return;
        }
        A0A(c3306Hz);
        String token = A05(c3306Hz, sb2);
        if (token == null || A01.equals(token)) {
            return;
        }
        int A06 = c3306Hz.A06();
        String A042 = A04(c3306Hz, sb2);
        String[] strArr = A03;
        String str = strArr[4];
        ...
        if (position != str2.charAt(25)) {
            ...
            if (property6.equals(A032)) {
                c3207gm.A0C(AbstractC3286Hf.A02(token));
                return;
            }
            String property7 = A01(30, 16, 24);
            if (property7.equals(A032)) {
                c3207gm.A0B(AbstractC3286Hf.A02(token));
                return;
            }
    ...
    public static boolean A0C(C3306Hz c3306Hz) {
        int position = c3306Hz.A06();
        int limit = c3306Hz.A07();
        ...
        if (bArr[i10] == 42) {
            ...
            c3306Hz.A0Z(limit - c3306Hz.A06());
            return true;
        }
        return false;
    }

    public static boolean A0D(C3306Hz c3306Hz) {
        switch (A00(c3306Hz, c3306Hz.A06())) {
            case '\t':
            case '\n':
            case '\f':
            case '\r':
    ...
    public final C3207GM A0E(C3306Hz c3306Hz) {
        this.A01.setLength(0);
        int A06 = c3306Hz.A06();
        A09(c3306Hz);
        C3306Hz c3306Hz2 = this.A00;
        byte[] bArr = c3306Hz.A00;
        int initialInputPosition = c3306Hz.A06();
        c3306Hz2.A0b(bArr, initialInputPosition);
        this.A00.A0Y(A06);
        String A062 = A06(this.A00, this.A01);
        if (A062 != null) {
            if (A01(117, 1, 24).equals(A04(this.A00, this.A01))) {
                C3207GM style = new C3207GM();
                A08(style, A062);
                String str = null;
                boolean z10 = false;
