...
public final class BI extends AbstractC1266Tg {
    ...
    public BI(OP op) {
        ...
        C1264Te c1264Te = new C1264Te(this);
        this.A0A = c1264Te;
        this.A0B = new O1(op, getAdDataBundle(), A01, A02, getAdDetailsView(), A09, c1264Te);
        ...
        if (supported.A00) {
            ...
            if (!C0988Ih.A18(getAdContextWrapper())) {
                return;
            }
            AbstractC1115Nl.A00(A01.getVideoImplView(), C0988Ih.A19(getAdContextWrapper()), new OT(this));
        }
    }
    ...
    private SA A01(OP op) {
        ...
        int i10 = AbstractC1266Tg.A0F;
        int i11 = AbstractC1266Tg.A0F;
        int toolbarHeight = AbstractC1266Tg.A0F;
        imageView.setPadding(i10, i11, toolbarHeight, AbstractC1266Tg.A0F);
        int toolbarHeight2 = AbstractC1266Tg.A0G;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC1266Tg.A0G);
        int toolbarHeight3 = AbstractC1266Tg.A0E;
    ...
    private KP A02(OP op) {
        KP A0A = op.A0A();
        A0A.A06(-1, AbstractC1266Tg.A0B);
        A0A.setPadding(AbstractC1266Tg.A0J, AbstractC1266Tg.A0J, AbstractC1266Tg.A0J, AbstractC1266Tg.A0J);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC1266Tg.A0I);
    ...
    private void A06() {
        ...
        AbstractC1066Lo.A0H(this.A0C);
        AbstractC1066Lo.A0a(this.A0C, this.A0D, this.A0B, this.A00);
        AbstractC1066Lo.A0L(this.A04);
        Q5 q52 = this.A05;
        ViewOnClickListenerC1271Tl ctaButton = getCtaButton();
        String[] strArr = A0G;
        ...
        switch (OU.A00[((Q4) A03.first).ordinal()]) {
            case 1:
                ...
                break;
            case 2:
                AbstractC1066Lo.A0a(getAdDetailsView());
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC1266Tg.A0H, AbstractC1266Tg.A0H, AbstractC1266Tg.A0H, AbstractC1266Tg.A0H);
        ...
        if (getAdInfo().A0G().A00() >= 0) {
            ...
            L9 l92 = new L9((int) getAdInfo().A0G().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C1263Td(this));
            this.A03 = l92;
            l92.A07();
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC1266Tg, com.facebook.ads.redexgen.uinode.OL
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC1266Tg
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC1266Tg, com.facebook.ads.redexgen.uinode.OL, android.view.View
