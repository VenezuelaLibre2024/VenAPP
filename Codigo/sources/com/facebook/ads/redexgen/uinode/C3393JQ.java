...
public final class C3393JQ implements NativeAdRatingApi {
    ...
    public C3393JQ(double d10, double d11) {
        this.A01 = d10;
        this.A00 = d11;
    }

    public static C3393JQ A00(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        ...
        if (A03[1].length() == 15) {
            ...
            if (optDouble != 0.0d) {
                if (A03[5].charAt(0) == 'R') {
                    ...
                    if (mValue != 0.0d) {
                        return new C3393JQ(optDouble, mValue);
                    }
                }
            }
            return null;
