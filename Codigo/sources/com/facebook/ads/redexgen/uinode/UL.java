...
public abstract class UL extends RelativeLayout implements MD {
    ...
    public Q7 A06;
    public boolean A07;
    public final ViewOnSystemUiVisibilityChangeListenerC1053Lb A08;
    public final MC A09;
    ...
    public UL(C1399Yn c1399Yn, J2 j22, MC mc2, AbstractC1502b5 abstractC1502b5) {
        super(c1399Yn);
        this.A07 = false;
        this.A04 = false;
        this.A03 = false;
        ...
        this.A0C = j22;
        this.A09 = mc2;
        this.A08 = new ViewOnSystemUiVisibilityChangeListenerC1053Lb(this);
        this.A0A = abstractC1502b5;
        JA ja2 = new JA(abstractC1502b5.A12(), j22);
        this.A0D = ja2;
        this.A0E = new FullScreenAdToolbar(c1399Yn, getAudienceNetworkListener(), ja2, 0, abstractC1502b5.A0r());
    }
    ...
    private void A0N() {
        ...
        if (A0X() && this.A02 == null) {
            this.A04 = true;
            C1162Pg A0B = new C1160Pe(this.A0B, this.A0A.A0x().A0E(), this.A0A.A10()).A08(this.A0A.A0w().A01()).A0B();
            this.A02 = A0B;
    ...
    private void A0P(C1P c1p, boolean z10) {
        ...
        this.A0E.A06(c1p, ViewOnClickListenerC1271Tl.A08(this.A0A));
    ...
    public final void A0U(View view, boolean z10, int i10) {
        ...
        C1P A0J = A0J(i10);
        A0P(A0J, z10);
        AbstractC1066Lo.A0M(this, A0J.A07(false));
        if (this.A09 != null) {
            A0N();
            String[] strArr = A0G;
            ...
            if (z10 && Build.VERSION.SDK_INT >= 19) {
                ViewOnSystemUiVisibilityChangeListenerC1053Lb viewOnSystemUiVisibilityChangeListenerC1053Lb = this.A08;
                if (A0G[0].charAt(10) == 'o') {
                    throw new RuntimeException();
                }
                A0G[2] = "LlUUcmlOaTawHlOzciUSj9DhXPbTXBAe";
                viewOnSystemUiVisibilityChangeListenerC1053Lb.A05(EnumC1052La.A04);
            }
        }
    }
    ...
    public void setImpressionRecordingFlag(C1058Lg c1058Lg) {
        c1058Lg.A05();
