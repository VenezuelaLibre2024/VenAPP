...
public abstract class AbstractC3436K9 {
    ...
    public static String A01(C26937f c26937f) {
        return A05(c26937f) + A00(47, 19, 24);
    }

    public static String A02(C26937f c26937f) {
        String loggingEndpointPrefix = C3348Ih.A0T(c26937f);
        StringBuilder append = new StringBuilder().append(A07(c26937f, loggingEndpointPrefix));
        String loggingEndpointPrefix2 = A00(22, 14, 63);
        return append.append(loggingEndpointPrefix2).toString();
    }

    public static String A03(C26937f c26937f) {
        return A05(c26937f) + A00(1, 21, 21);
    }

    public static String A04(C26937f c26937f) {
        String syncEndpointPrefix = C3348Ih.A0U(c26937f);
        StringBuilder append = new StringBuilder().append(A07(c26937f, syncEndpointPrefix));
        String syncEndpointPrefix2 = A00(36, 11, 123);
        return append.append(syncEndpointPrefix2).toString();
    }

    public static String A05(C26937f c26937f) {
        String str = A02.get();
        if (!TextUtils.isEmpty(str)) {
            return str;
        }
        String urlOverride = A00(66, 28, 104);
        return A06(c26937f, urlOverride);
    }

    public static String A06(C26937f c26937f, String str) {
        String sb2;
    ...
    public static String A07(C26937f c26937f, String str) {
        String str2 = A03.get();
        if (!TextUtils.isEmpty(str2)) {
            return str2;
        }
        String urlOverride = A00(94, 26, 52);
        return A08(A06(c26937f, urlOverride), str);
    }
