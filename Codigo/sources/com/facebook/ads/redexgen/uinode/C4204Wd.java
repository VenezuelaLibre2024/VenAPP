...
public final class C4204Wd implements InterfaceC3039DW {
    ...
    public static final InterfaceC3050Di A04;
    public final InterfaceC3050Di A00;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static ChapterFrame A06(C3306Hz c3306Hz, int i10, int i11, boolean z10, int i12, InterfaceC3050Di interfaceC3050Di) throws UnsupportedEncodingException {
        int A06 = c3306Hz.A06();
        int A022 = A02(c3306Hz.A00, A06);
        String str = new String(c3306Hz.A00, A06, A022 - A06, A0I(169, 10, 32));
        c3306Hz.A0Y(A022 + 1);
        int A08 = c3306Hz.A08();
        int A082 = c3306Hz.A08();
        long A0M = c3306Hz.A0M();
        if (A0M == KeyboardMap.kValueMask) {
            A0M = -1;
        }
        long A0M2 = c3306Hz.A0M();
        if (A0M2 == KeyboardMap.kValueMask) {
            A0M2 = -1;
        }
        ArrayList arrayList = new ArrayList();
        int i13 = A06 + i10;
        while (c3306Hz.A06() < i13) {
            Id3Frame A0B = A0B(i11, c3306Hz, z10, i12, interfaceC3050Di);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static GeobFrame A09(C3306Hz c3306Hz, int i10) throws UnsupportedEncodingException {
        int A0E = c3306Hz.A0E();
        String A0H = A0H(A0E);
        byte[] bArr = new byte[i10 - 1];
        c3306Hz.A0c(bArr, 0, i10 - 1);
        int A022 = A02(bArr, 0);
    ...
    static {
        A0L();
        A04 = new C4205We();
        A03 = AbstractC3322IF.A08(A0I(166, 3, 12));
    }
    ...
    public C4204Wd(InterfaceC3050Di interfaceC3050Di) {
        this.A00 = interfaceC3050Di;
    }
    ...
    public static int A01(C3306Hz c3306Hz, int i10) {
        byte[] bArr = c3306Hz.A00;
        for (int A06 = c3306Hz.A06(); A06 + 1 < i10; A06++) {
            int i11 = bArr[A06];
    ...
    */
    public static int A02(byte[] r1, int r2) {
        ...
        Lb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4204Wd.A02(byte[], int):int");
    }
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L21:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4204Wd.A03(byte[], int, int):int");
    }

    public static ApicFrame A04(C3306Hz c3306Hz, int i10, int i11) throws UnsupportedEncodingException {
        int A022;
        String A0M;
        int descriptionStartIndex = c3306Hz.A0E();
        String A0H = A0H(descriptionStartIndex);
        int encoding = i10 - 1;
        byte[] bArr = new byte[encoding];
        int encoding2 = i10 - 1;
        c3306Hz.A0c(bArr, 0, encoding2);
        String A0I = A0I(458, 6, 45);
        String A0I2 = A0I(169, 10, 32);
        if (i11 == 2) {
            A022 = 2;
            A0M = A0I + AbstractC3322IF.A0M(new String(bArr, 0, 3, A0I2));
            if (A0I(474, 9, 58).equals(A0M)) {
                A0M = A0I(464, 10, 126);
            }
        } else {
            A022 = A02(bArr, 0);
            A0M = AbstractC3322IF.A0M(new String(bArr, 0, A022, A0I2));
            if (A0M.indexOf(47) == -1) {
                A0M = A0I + A0M;
            }
        }
    ...
    public static BinaryFrame A05(C3306Hz c3306Hz, int i10, String str) {
        byte[] bArr = new byte[i10];
        c3306Hz.A0c(bArr, 0, i10);
        return new BinaryFrame(str, bArr);
    }

    public static ChapterTocFrame A07(C3306Hz c3306Hz, int i10, int i11, boolean z10, int framePosition, InterfaceC3050Di interfaceC3050Di) throws UnsupportedEncodingException {
        int A06 = c3306Hz.A06();
        int A022 = A02(c3306Hz.A00, A06);
        String A0I = A0I(169, 10, 32);
        String str = new String(c3306Hz.A00, A06, A022 - A06, A0I);
        c3306Hz.A0Y(A022 + 1);
        int framePosition2 = c3306Hz.A0E();
        boolean z11 = (framePosition2 & 2) != 0;
        boolean z12 = (framePosition2 & 1) != 0;
        int A0E = c3306Hz.A0E();
        String[] strArr = new String[A0E];
        for (int i12 = 0; i12 < A0E; i12++) {
            int startIndex = c3306Hz.A06();
            int i13 = A02(c3306Hz.A00, startIndex);
            int framePosition3 = i13 - startIndex;
            strArr[i12] = new String(c3306Hz.A00, startIndex, framePosition3, A0I);
            c3306Hz.A0Y(i13 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i14 = A06 + i10;
        while (c3306Hz.A06() < i14) {
            String[] strArr2 = A02;
            ...
            Id3Frame A0B = A0B(i11, c3306Hz, z10, framePosition, interfaceC3050Di);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
    ...
    public static CommentFrame A08(C3306Hz c3306Hz, int i10) throws UnsupportedEncodingException {
        if (i10 < 4) {
            return null;
        }
        int textStartIndex = c3306Hz.A0E();
        String A0H = A0H(textStartIndex);
        byte[] bArr = new byte[3];
        c3306Hz.A0c(bArr, 0, 3);
        String description = new String(bArr, 0, 3);
        int encoding = i10 - 4;
        byte[] data = new byte[encoding];
        int encoding2 = i10 - 4;
        c3306Hz.A0c(data, 0, encoding2);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.redexgen.uinode.C3051Dj A0A(com.facebook.ads.redexgen.uinode.C3306Hz r9) {
        /*
            int r4 = r9.A04()
            r3 = 10
            r8 = 0
        ...
        L21:
            int r4 = r9.A0G()
            int r0 = com.facebook.ads.redexgen.uinode.C4204Wd.A03
            if (r4 == r0) goto L48
        ...
        Lb8:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4204Wd.A0A(com.facebook.ads.redexgen.X.Hz):com.facebook.ads.redexgen.X.Dj");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.internal.exoplayer2.thirdparty.metadata.id3.Id3Frame A0B(int r25, com.facebook.ads.redexgen.uinode.C3306Hz r26, boolean r27, int r28, com.facebook.ads.redexgen.uinode.InterfaceC3050Di r29) {
        /*
            Method dump skipped, instructions count: 746
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4204Wd.A0B(int, com.facebook.ads.redexgen.X.Hz, boolean, int, com.facebook.ads.redexgen.X.Di):com.facebook.ads.internal.exoplayer2.thirdparty.metadata.id3.Id3Frame");
    }

    public static PrivFrame A0C(C3306Hz c3306Hz, int i10) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i10];
        c3306Hz.A0c(bArr, 0, i10);
        int A022 = A02(bArr, 0);
    ...
    public static TextInformationFrame A0D(C3306Hz c3306Hz, int i10) throws UnsupportedEncodingException {
        if (i10 < 1) {
            return null;
        }
        int valueStartIndex = c3306Hz.A0E();
    ...
    public static TextInformationFrame A0E(C3306Hz c3306Hz, int i10, String str) throws UnsupportedEncodingException {
        if (i10 < 1) {
            return null;
        }
        int A0E = c3306Hz.A0E();
    ...
    public static UrlLinkFrame A0F(C3306Hz c3306Hz, int i10) throws UnsupportedEncodingException {
        if (i10 < 1) {
            return null;
        }
        int descriptionEndIndex = c3306Hz.A0E();
    ...
    public static UrlLinkFrame A0G(C3306Hz c3306Hz, int i10, String str) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i10];
        c3306Hz.A0c(bArr, 0, i10);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0M(com.facebook.ads.redexgen.uinode.C3306Hz r16, int r17, int r18, boolean r19) {
        /*
            Method dump skipped, instructions count: 262
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C4204Wd.A0M(com.facebook.ads.redexgen.X.Hz, int, int, boolean):boolean");
    }
    ...
    public final Metadata A0O(byte[] bArr, int i10) {
        ...
        C3051Dj A0A = A0A(c3306Hz);
        if (A0A == null) {
            return null;
        }
        int startPosition = c3306Hz.A06();
        i11 = A0A.A01;
        ...
        c3306Hz.A0X(startPosition + i12);
        boolean z11 = false;
        i13 = A0A.A01;
        if (!A0M(c3306Hz, i13, frameHeaderSize, false)) {
            i15 = A0A.A01;
            if (i15 == 4 && A0M(c3306Hz, 4, frameHeaderSize, true)) {
                z11 = true;
            } else {
        ...
        while (c3306Hz.A04() >= frameHeaderSize) {
            i14 = A0A.A01;
            Id3Frame A0B = A0B(i14, c3306Hz, z11, frameHeaderSize, this.A00);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
