...
public final class C1267Th extends AbstractC1118No {
    ...
    private void A04() {
        ...
        AbstractC1066Lo.A0K(this.A05);
        this.A05.setLayoutParams(AbstractC1118No.A08);
        this.A05.setTextColor(this.A0A ? this.A07.A06(true) : -1);
        AbstractC1066Lo.A0X(this.A05, true, 18);
        ...
        AbstractC1066Lo.A0X(this.A04, false, 14);
    ...
    public C1267Th(C1399Yn c1399Yn, int i10, boolean z10, C1P c1p, boolean z11, String str, J2 j22, MC mc2, RE re2, C1058Lg c1058Lg, C1U c1u) {
        super(c1399Yn, i10, c1p, z11, str, j22, mc2, re2, c1058Lg, c1u);
        this.A0B = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0G = c1399Yn;
        ...
        this.A09 = new O5(c1399Yn, A0R, 5, A0Q, -1);
        ...
        this.A07 = c1p;
        this.A0H = C0988Ih.A0y(c1399Yn);
        AbstractC1066Lo.A0R(this, c1399Yn);
        this.A0A = C0988Ih.A24(c1399Yn);
        A06();
    }
    ...
    private void A03() {
        ...
        AbstractC1066Lo.A0X(this.A03, false, 16);
        if (this.A0H) {
    ...
    private void A05() {
        ...
        AbstractC1066Lo.A0X(this.A0F, false, 12);
    ...
    private void A06() {
        removeAllViews();
        super.A02.setLayoutParams(AbstractC1118No.A08);
        A04();
        A03();
        A02();
        A05();
        A07();
        AbstractC1066Lo.A0J(super.A02);
        AbstractC1066Lo.A0J(super.A04);
    ...
    private void A07() {
        ...
        if (TextUtils.isEmpty(this.A08.A04())) {
            AbstractC1066Lo.A0H(super.A04);
        }
        if (TextUtils.isEmpty(this.A06.A04())) {
            AbstractC1066Lo.A0H(this.A0F);
        }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC1118No
    ...
    public void setInfo(C1N c1n, C1Q c1q, String str, String str2, InterfaceC1120Nq interfaceC1120Nq) {
        super.setInfo(c1n, c1q, str, str2, interfaceC1120Nq);
        this.A06 = c1n;
        this.A08 = c1q;
        A07();
    }
