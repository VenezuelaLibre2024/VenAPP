...
public class C0925Fu {
    ...
    public int A03;
    public int A04;
    public final List<C0924Ft> A06 = new ArrayList();
    ...
    public final C0918Fn A05() {
        ...
        if (A08[2].length() != 4) {
            ...
            if (A08[7].charAt(3) != 'N') {
                ...
                return new C0918Fn(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, i12, 1, i11, f10, i10, Float.MIN_VALUE);
            }
        }
        throw new RuntimeException();
    }

    public C0925Fu(int i10, int i11) {
        A09(i10);
        A0A(i11);
    }
    ...
    private final SpannableString A00() {
        ...
        for (int italicStartPosition = 0; italicStartPosition < this.A06.size(); italicStartPosition++) {
            C0924Ft c0924Ft = this.A06.get(italicStartPosition);
            boolean z11 = c0924Ft.A02;
            int i13 = c0924Ft.A01;
            if (i13 != 8) {
                z10 = i13 == 7;
                if (i13 != 7) {
    ...
    public final void A06() {
        ...
        if (length > 0) {
            ...
            for (int i10 = length3 - 1; i10 >= 0; i10--) {
                C0924Ft c0924Ft = this.A06.get(i10);
                int length4 = c0924Ft.A00;
                if (length4 == length) {
                    int length5 = c0924Ft.A00;
                    c0924Ft.A00 = length5 - 1;
                } else {
                    return;
                }
            }
    ...
    public final void A0E(int i10, boolean z10) {
        this.A06.add(new C0924Ft(i10, z10, this.A05.length()));
    }
