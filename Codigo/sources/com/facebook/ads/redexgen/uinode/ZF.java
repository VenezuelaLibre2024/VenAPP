...
public class ZF extends C3E {
    ...
    public final /* synthetic */ C06855j A01;

    public ZF(C06855j c06855j) {
        this.A01 = c06855j;
    }
    ...
    public final Object A04(ViewGroup viewGroup, int i10) {
        ...
        if (adViewProvider != null) {
            ...
            type = this.A01.A02;
            if (type != null) {
                c1399Yn2 = this.A01.A06;
                NativeAd nativeAd = this.A00.get(i10);
                type2 = this.A01.A02;
                nativeAdViewAttributes2 = this.A01.A03;
                adView = NativeAdView.render(c1399Yn2, nativeAd, type2, nativeAdViewAttributes2);
            } else {
                c1399Yn = this.A01.A06;
                NativeAd nativeAd2 = this.A00.get(i10);
                nativeAdViewAttributes = this.A01.A03;
                adView = NativeAdView.render(c1399Yn, nativeAd2, nativeAdViewAttributes);
            }
        }
