...
public final class C07337o {
    ...
    public final C1396Yk A03 = new C1396Yk(this);
    public final C1397Yl A02 = new C1397Yl(this);
    ...
    static {
        A07();
        StringBuilder append = new StringBuilder().append(A05(107, 14, 91)).append(C1396Yk.A02.A01);
        ...
        StringBuilder append4 = append3.append(A054).append(C1396Yk.A01.A01).append(A052);
        String A055 = A05(136, 6, 111);
        A06 = append4.append(A055).append(A054).append(C1397Yl.A04.A01).append(A052).append(A055).append(A054).append(C1397Yl.A05.A01).append(A052).append(A055).append(A054).append(C1397Yl.A0A.A01).append(A052).append(A055).append(A054).append(C1397Yl.A08.A01).append(A052).append(A055).append(A054).append(C1397Yl.A07.A01).append(A052).append(A055).append(A054).append(C1397Yl.A06.A01).append(A052).append(A055).append(A054).append(C1397Yl.A03.A01).append(A052).append(A055).append(A054).append(C1397Yl.A02.A01).append(A05(11, 6, 42)).append(A055).append(A05(17, 6, 65)).append(A053).append(A05(30, 4, 3)).append(A055).append(A054).append(C1397Yl.A09.A01).append(A05(0, 3, 78)).append(A053).append(A054).append(C1396Yk.A02.A01).append(A05(34, 10, 74)).append(A055).append(A054).append(C1397Yl.A08.A01).append(A05(7, 4, 98)).toString();
    ...
    public C07337o(C1398Ym c1398Ym) {
        this.A01 = c1398Ym;
    }

    private synchronized SQLiteDatabase A00() {
        if (this.A00 == null) {
            final C1398Ym c1398Ym = this.A01;
            this.A00 = new SQLiteOpenHelper(c1398Ym, this) { // from class: com.facebook.ads.redexgen.X.7p
                ...
                static {
                    A02();
                    A03 = C07347p.class.getSimpleName();
                }

                {
                    super(c1398Ym, A01(c1398Ym), (SQLiteDatabase.CursorFactory) null, 4);
                    if (this != null) {
                        this.A00 = this;
                        return;
                    }
                ...
                public static String A01(C1398Ym c1398Ym2) {
                    Locale locale = Locale.US;
                    Object[] objArr = {A00(0, 0, 95)};
                    String processName = A00(126, 8, 81);
                    String format = String.format(locale, processName, objArr);
                    if (!C0988Ih.A2C(c1398Ym2)) {
                        return format;
                    }
                    String defaultDbName = c1398Ym2.getPackageName();
                    String processName2 = ProcessUtils.getProcessName(c1398Ym2);
                ...
                public final void onCreate(SQLiteDatabase sQLiteDatabase) {
                    for (AbstractC07367s abstractC07367s : this.A00.A0M()) {
                        abstractC07367s.A07(sQLiteDatabase);
                    }
                }
                ...
                public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
                    for (AbstractC07367s abstractC07367s : this.A00.A0M()) {
                        abstractC07367s.A08(sQLiteDatabase);
                        abstractC07367s.A07(sQLiteDatabase);
                    }
                }
                ...
                public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
                    ...
                    if (i10 <= 3 && i11 >= 4) {
                        C07327m c07327m = C1397Yl.A02;
                        sQLiteDatabase.execSQL(A00(11, 30, 61) + c07327m.A01 + A00(0, 1, 125) + c07327m.A02 + A00(1, 10, 109));
                    }
                }
            };
        }
    ...
    private synchronized SQLiteDatabase A01() {
        ...
        this.A01.A07().A9a(A05(RecognitionOptions.ITF, 8, 84), C8A.A0v, new C8B(e10));
        throw e10;
        return A00();
    }
    ...
    public final int A08(int i10) {
        ...
        lock.lock();
        try {
            int delete = A0E().delete(A05(136, 6, 111), C1397Yl.A02.A01 + A05(3, 4, 28), new String[]{String.valueOf(i10 - 1)});
            lock.unlock();
            return delete;
        } catch (Throwable th2) {
            A08.unlock();
    ...
    public final <T> AsyncTask A0F(final AbstractC07357r<T> abstractC07357r, final AbstractC07628t<T> abstractC07628t) {
        Executor executor = ExecutorC1071Lt.A07;
        final C1398Ym c1398Ym = this.A01;
        return AbstractC1068Lq.A00(executor, new AsyncTask<Void, Void, T>(c1398Ym, abstractC07357r, abstractC07628t) { // from class: com.facebook.ads.redexgen.X.7n
            public static byte[] A04;
            ...
            public C7q A00;
            public final C1398Ym A01;
            public final AbstractC07357r<T> A02;
            public final AbstractC07628t<T> A03;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.8t != com.facebook.ads.internal.eventstorage.AdEventStorageCallback<T> */
            {
                this.A02 = abstractC07357r;
                this.A03 = abstractC07628t;
                this.A01 = c1398Ym;
            }
            ...
            private final T A00(Void... voidArr) {
                ...
                try {
                    try {
                        ...
                        this.A01.A07().A9a(A01(0, 8, 71), C8A.A0w, new C8B(e10));
                        this.A00 = C7q.A09;
                        return t10;
                    }
                } catch (Throwable th2) {
    ...
    public final AsyncTask A0G(String str, int i10, String str2, double d10, double d11, String str3, Map<String, String> data, AbstractC07628t<String> abstractC07628t) {
        return A0F(new EP(this, str2, str, i10, d10, d11, str3, data), abstractC07628t);
    }
    ...
    public final boolean A0L(String str) {
        ...
        try {
            ...
            sb2.append(A05(121, 7, 95)).append(A05(136, 6, 111)).append(A05(44, 5, 67)).append(C1397Yl.A02.A01).append(A05(61, 1, 83)).append(C1397Yl.A02.A01).append(A05(56, 2, 49)).append(A05(49, 7, 11)).append(C1397Yl.A04.A01).append(A05(62, 2, 26));
    ...
    public final AbstractC07367s[] A0M() {
        return new AbstractC07367s[]{this.A03, this.A02};
    }
}
