...
public class C3030DI extends Exception {
    ...
    public C3030DI(Format format, Throwable th2, boolean z10, int i10) {
    ...
    public C3030DI(Format format, Throwable th2, boolean z10, String str) {
        super(A01(2, 21, 67) + str + A01(0, 2, 104) + format, th2);
        this.A02 = format.A0O;
        this.A03 = z10;
        this.A00 = str;
        this.A01 = AbstractC3322IF.A02 >= 21 ? A02(th2) : null;
    }
