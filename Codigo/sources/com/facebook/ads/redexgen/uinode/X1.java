...
public final class X1 implements InterfaceC0863Cy {
    ...
    public final D4 A08 = new D4(7, RecognitionOptions.ITF);
    public final D4 A06 = new D4(8, RecognitionOptions.ITF);
    public final D4 A07 = new D4(6, RecognitionOptions.ITF);
        ...
        if (!this.A05 || this.A03.A07()) {
            ...
            if (!this.A05) {
                if (this.A08.A03() && this.A06.A03()) {
                    ...
                    C0975Hu spsData = AbstractC0976Hv.A06(this.A08.A01, 3, this.A08.A00);
                    C0974Ht A05 = AbstractC0976Hv.A05(this.A06.A01, 3, this.A06.A00);
                ...
                this.A03.A05(AbstractC0976Hv.A06(this.A08.A01, 3, this.A08.A00));
                this.A08.A00();
            } else if (this.A06.A03()) {
                this.A03.A04(AbstractC0976Hv.A05(this.A06.A01, 3, this.A06.A00));
                this.A06.A00();
            }
        }
        if (this.A07.A04(i11)) {
            ...
            int unescapedLength = AbstractC0976Hv.A02(d42.A01, this.A07.A00);
    ...
    public final void A4R(C0980Hz c0980Hz) {
        ...
        C4 c42 = this.A02;
        int offset3 = c0980Hz.A04();
        c42.AFR(c0980Hz, offset3);
        while (true) {
            int A04 = AbstractC0976Hv.A04(bArr, A06, A07, this.A0D);
            if (A04 == A07) {
                A04(bArr, A06, A07);
                return;
            }
            int lengthToNalUnit = AbstractC0976Hv.A01(bArr, A04);
            int i10 = A04 - A06;
            String[] strArr = A0F;
    ...
    public final void A4p(InterfaceC0839Bu interfaceC0839Bu, DC dc2) {
        ...
        this.A09.A03(interfaceC0839Bu, dc2);
    }
