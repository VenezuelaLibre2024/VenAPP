...
public final class AnonymousClass84 {
    ...
    public static int A00(String str, int i10, C07277f c07277f) {
    ...
    public static void A05(C07277f c07277f, int i10, int i11) {
        c07277f.A07().A9a(A01(435, 10, 113), C8A.A2X, new C8B(A01(338, 33, 80) + i10, A01(87, 9, 13) + i11));
    }

    @Deprecated
    public static void A06(C07277f c07277f, String str, int i10, C8B c8b) {
        if (c07277f == null) {
            A0F(new RuntimeException(A01(48, 39, 84)));
            return;
        }
        AbstractC07267e.A01(c07277f.A01());
        if (A02 && c8b.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 70) + str + A01(31, 16, 8) + i10, c8b));
        }
        try {
            if (A0J(c07277f, str, i10, Math.random(), c8b)) {
                A09(c07277f, str, i10, c8b);
            }
        } catch (Throwable t10) {
            A0F(t10);
        }
    ...
    @Deprecated
    public static void A07(C07277f c07277f, String str, int i10, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A0A(false);
            c8b.A06(1);
    ...
    @Deprecated
    public static void A08(C07277f c07277f, String str, int i10, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A08(false);
            A06(c07277f, str, i10, c8b);
    ...
    public static void A09(C07277f c07277f, String str, int i10, C8B c8b) {
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                int A012 = Ij.A01(c07277f);
                ...
                A0A(c07277f, str, i10, c8b, true);
            }
        }
    }

    public static void A0A(C07277f c07277f, String str, int i10, C8B c8b, boolean z10) {
        ...
        C1390Ye c1390Ye = new C1390Ye(c07277f, str, i10, c8b, anonymousClass83);
        if (z10) {
            A01.execute(c1390Ye);
        } else {
            c1390Ye.run();
    ...
    public static void A0C(C1398Ym c1398Ym, AnonymousClass83 anonymousClass83, AnonymousClass82 anonymousClass82, boolean z10) {
        ...
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1391Yf(c1398Ym));
            }
        }
    }
    ...
    public static boolean A0H(C07277f c07277f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        return (shouldSkipFunnelEventsForSession == null || !shouldSkipFunnelEventsForSession.booleanValue()) && Ij.A0A(c07277f) != 0;
    }

    public static boolean A0I(C07277f c07277f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        if (shouldSkipFunnelEventsForSession != null && shouldSkipFunnelEventsForSession.booleanValue()) {
            return false;
        }
        double funnelEventLogProbability = 1.0d / Ij.A0A(c07277f);
        return c07277f.A08().A00() <= funnelEventLogProbability;
    }
    ...
    */
    public static boolean A0J(com.facebook.ads.redexgen.uinode.C07277f r12, java.lang.String r13, int r14, double r15, com.facebook.ads.redexgen.uinode.C8B r17) {
        /*
    ...
    public static boolean A0K(C07277f c07277f, String str, int i10, C8B c8b) {
        if (!Ij.A0P(c07277f)) {
            return true;
        }
        int customLimit = A00.get(i10);
        int eventsLimit = Ij.A00(c07277f);
        if (c8b.A02() != -1) {
            eventsLimit = c8b.A02();
        } else {
            int currentCounter = A00(str, i10, c07277f);
