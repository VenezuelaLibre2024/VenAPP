...
public final class C2883Al extends Exception {
    ...
    */
    public C2883Al(int r5, int r6, int r7, int r8) {
        /*
            r4 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C2883Al.<init>(int, int, int, int):void");
    }
}
