...
public final class M6 {
    ...
    public static Map<String, String> A01(C1399Yn c1399Yn) {
        Window window;
        ...
        try {
            hashMap.put(A00(40, 3, 111), String.valueOf(A04(c1399Yn)));
            ...
            AnonymousClass89 A07 = c1399Yn.A07();
            int type3 = C8A.A2T;
            A07.A9a(A00(43, 5, 114), type3, new C8B(e10));
        }
        return hashMap;
    }

    public static boolean A03(C1399Yn c1399Yn) {
        return !C1067Lp.A04(A01(c1399Yn));
    }

    public static boolean A04(C1399Yn c1399Yn) {
        KeyguardManager keyguardManager = (KeyguardManager) c1399Yn.getSystemService(A00(32, 8, 4));
