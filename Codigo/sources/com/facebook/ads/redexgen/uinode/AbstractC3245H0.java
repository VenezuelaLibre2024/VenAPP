...
public abstract class AbstractC3245H0<E> implements Collection<E> {
    ...
    public final boolean containsAll(Collection<? extends Object> elements) {
        C4527bu.A07(elements, A08(60, 8, 42));
    ...
    public boolean contains(E element) {
        AbstractC3245H0<E> abstractC3245H0 = this;
        if ((abstractC3245H0 instanceof Collection) && abstractC3245H0.isEmpty()) {
            return false;
        }
        Iterator<E> it = abstractC3245H0.iterator();
        while (it.hasNext()) {
            boolean A0A = C4527bu.A0A(it.next(), element);
            String[] strArr = A01;
    ...
    public Object[] toArray() {
        return AbstractC4529bw.A02(this);
    }

    @Override // java.util.Collection
    public <T> T[] toArray(T[] array) {
        C4527bu.A07(array, A08(55, 5, 36));
        return (T[]) AbstractC4529bw.A03(this, array);
    }

    public final String toString() {
        return AbstractC22630R.A03(this, A08(0, 2, 0), A08(53, 1, 23), A08(54, 1, 115), 0, null, new C24443O(this), 24, null);
    }
}
