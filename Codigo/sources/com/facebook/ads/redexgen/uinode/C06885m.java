...
public final class C06885m implements NativeAdsManagerApi {
    ...
    public C06885m(Context context, String str, int i10) {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC1009Jg enumC1009Jg = EnumC1009Jg.A05;
        int i10 = this.A06;
        C1477ag c1477ag = this.A02;
        C1477ag c1477ag2 = new C1477ag(this.A07, this.A08, enumC1009Jg, null, i10);
        this.A02 = c1477ag2;
        if (this.A05) {
            c1477ag2.A06();
        }
