...
public final class C1262Tc extends OL implements OE {
    public static byte[] A05;
    public static final int A06;
    public final AbstractC1502b5 A00;
    public final MC A01;
    public final OG A02;
    public final C1142Om A03;
    public final C1170Po A04;
    ...
    public C1262Tc(OP op, boolean z10) {
        super(op, z10);
        int id2;
        int A01;
        this.A01 = op.A09();
        ...
        this.A00 = A04;
        C1142Om c1142Om = new C1142Om(op.A05(), op.A02());
        this.A03 = c1142Om;
        c1142Om.A01(getTitleDescContainer(), z10);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(12);
        layoutParams.setMargins(OL.A07, OL.A07, OL.A07, OL.A07);
        getCtaButton().setLayoutParams(layoutParams);
        if (op.A0C()) {
            C1170Po c1170Po = new C1170Po(op.A05());
            this.A04 = c1170Po;
            c1170Po.setPageDetails(op.A04().A10());
            AbstractC1066Lo.A0G(1007, c1170Po);
            RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
            layoutParams2.addRule(2, getCtaButton().getId());
            layoutParams2.setMargins(OL.A07, OL.A07 - (OL.A07 / 2), OL.A07, 0);
            c1170Po.setLayoutParams(layoutParams2);
            id2 = c1170Po.getId();
            A01 = op.A01() - (OL.A07 / 2);
        } else {
        ...
        frameLayout.addView(c1142Om, layoutParams4);
        addView(frameLayout);
        View view = this.A04;
        if (view != null) {
            addView(view);
        ...
        if (A02 != null && A09.A00) {
            ...
            A02.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.OV
                ...
                public final void onClick(View view2) {
                    C1262Tc.this.A13(view2);
                }
            });
        } else if (A02 != null && C0988Ih.A16(getAdContextWrapper())) {
            AbstractC1115Nl.A00(A02, C0988Ih.A17(getAdContextWrapper()), new OW(this));
        }
        if (C0988Ih.A0y(op.A05())) {
            getTitleDescContainer().setCTAClickListener(getCtaButton());
            if (op.A08() != null) {
                op.A08().setCTAClickListener(getCtaButton());
            }
        }
        if (this.A04 != null && C0988Ih.A0z(op.A05())) {
