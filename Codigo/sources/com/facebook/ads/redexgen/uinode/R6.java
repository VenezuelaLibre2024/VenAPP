...
public class R6 implements MediaController.MediaPlayerControl {
    ...
    public R6(TextureViewSurfaceTextureListenerC1023Ju textureViewSurfaceTextureListenerC1023Ju) {
    ...
    public final boolean isPlaying() {
        ...
        mediaPlayer = this.A00.A06;
        if (mediaPlayer != null) {
            TextureViewSurfaceTextureListenerC1023Ju textureViewSurfaceTextureListenerC1023Ju = this.A00;
            if (A01[3].length() == 27) {
                throw new RuntimeException();
            }
            A01[1] = "lkPRs4KbLtabABAzVL2ijXaoS745wM0q";
            mediaPlayer2 = textureViewSurfaceTextureListenerC1023Ju.A06;
