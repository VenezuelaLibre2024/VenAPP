...
public final class C3528Lg {
    ...
    static {
        A02();
        A0K = C3528Lg.class.getSimpleName();
    }

    private EnumC3504LI A00() {
        View view;
        View view2 = this.A0G;
        if (view2 == null || (view = this.A0F) == null) {
            return EnumC3504LI.A0I;
        }
        if (view2 != view) {
            return EnumC3504LI.A0G;
        }
        if (Build.VERSION.SDK_INT < 4) {
            return EnumC3504LI.A0F;
        }
        Object tag = this.A0G.getTag(EnumC3504LI.A02);
        if (tag == null) {
            return EnumC3504LI.A0H;
        }
        if (!(tag instanceof EnumC3504LI)) {
            return EnumC3504LI.A0J;
        }
        return (EnumC3504LI) tag;
    }
    ...
    public final Map<String, String> A04() {
        ...
        String radius52 = String.valueOf(j10);
    ...
    public final void A06(C4337Yn c4337Yn, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c4337Yn.A0E().AGu();
            return;
        }
        ...
        switch (motionEvent.getAction()) {
            case 0:
                this.A04 = (int) (iArr[0] / AbstractC3499LD.A02);
                this.A05 = (int) (iArr[1] / AbstractC3499LD.A02);
                this.A06 = (int) (view.getWidth() / AbstractC3499LD.A02);
                this.A03 = (int) (view.getHeight() / AbstractC3499LD.A02);
                this.A09 = 1;
                this.A0E = System.currentTimeMillis();
                this.A0A = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC3499LD.A02);
                int touchStartYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A0B = (int) (touchStartYInPx / AbstractC3499LD.A02);
            ...
            case 3:
                ...
                this.A07 = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC3499LD.A02);
                int touchEndYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A08 = (int) (touchEndYInPx / AbstractC3499LD.A02);
                this.A0F = view2;
                return;
            case 2:
                float f10 = this.A00;
