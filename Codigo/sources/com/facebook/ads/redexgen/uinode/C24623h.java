...
import com.facebook.ads.internal.androidx.support.p045v4.view.ViewPager$DecorView;
import com.facebook.ads.internal.androidx.support.p045v4.view.ViewPager$SavedState;
...
public class C24623h extends ViewGroup {
    ...
    public static final C24613g A0w;
    public static final Comparator<C24543Z> A0x;
    public int A00;
    public AbstractC24343E A01;
    public float A02;
    public float A03;
    public float A04;
    public float A05;
    ...
    public final C24543Z A0p;
    public final Runnable A0q;
    public final ArrayList<C24543Z> A0r;
    ...
    private C24543Z A03() {
        ...
        float f12 = 0.0f;
        boolean z10 = true;
        C24543Z c24543z = null;
        int i11 = 0;
        while (i11 < this.A0r.size()) {
            C24543Z c24543z2 = this.A0r.get(i11);
            if (!z10 && c24543z2.A02 != i10 + 1) {
                c24543z2 = this.A0p;
                c24543z2.A00 = f11 + f12 + f10;
                c24543z2.A02 = i10 + 1;
                c24543z2.A01 = this.A01.A00(c24543z2.A02);
                i11--;
            }
            f11 = c24543z2.A00;
            float f13 = c24543z2.A01 + f11 + f10;
            if (!z10) {
                String[] strArr = A0t;
        ...
        while (true) {
            if (i14 >= childCount) {
                ...
                for (int i15 = 0; i15 < childCount2; i15++) {
                    ...
                    if (childAt.getVisibility() != 8 && ((c24553a = (C24553a) childAt.getLayoutParams()) == null || !c24553a.A05)) {
                        float f10 = paddingLeft;
                        String[] strArr = A0t;
                        if (strArr[4].length() == strArr[5].length()) {
                            A0t[1] = "11cm9STM7FlxGR3";
                            childAt.measure(View.MeasureSpec.makeMeasureSpec((int) (f10 * c24553a.A00), 1073741824), this.A0A);
                        }
                    }
                }
                return;
            ...
            if (childAt2.getVisibility() != 8) {
                C24553a c24553a2 = (C24553a) childAt2.getLayoutParams();
                if (A0t[1].length() == 12) {
                    break;
                }
                String[] strArr2 = A0t;
                strArr2[4] = "";
                strArr2[5] = "";
                if (c24553a2 != null && c24553a2.A05) {
                    int i16 = c24553a2.A04 & 7;
                    int i17 = c24553a2.A04 & 112;
                    ...
                    if (c24553a2.width != -2) {
                        i18 = 1073741824;
                        i12 = c24553a2.width != -1 ? c24553a2.width : paddingLeft;
                    } else {
                        i12 = paddingLeft;
                    }
                    if (c24553a2.height != -2) {
                        i19 = 1073741824;
                        if (c24553a2.height != -1) {
                            i13 = c24553a2.height;
                            if (A0t[1].length() != 12) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        AbstractC24343E abstractC24343E;
        if (this.A0f) {
            return true;
        }
        if ((motionEvent.getAction() == 0 && motionEvent.getEdgeFlags() != 0) || (abstractC24343E = this.A01) == null || abstractC24343E.A01() == 0) {
            return false;
        }
        if (this.A0U == null) {
            ...
            case 2:
                if (!this.A0i) {
                    ...
                    if (findPointerIndex == -1) {
                        ...
                        float abs2 = Math.abs(y11 - this.A06);
    ...
    static {
        ...
        A0x = new Comparator<C24543Z>() { // from class: com.facebook.ads.redexgen.X.3V
            /* JADX INFO: Access modifiers changed from: private */
            @Override // java.util.Comparator
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
            public final int compare(C24543Z c24543z, C24543Z c24543z2) {
                return c24543z.A02 - c24543z2.A02;
            }
        };
        ...
        A0w = new Comparator<View>() { // from class: com.facebook.ads.redexgen.X.3g
            ...
            public final int compare(View view, View view2) {
                C24553a c24553a = (C24553a) view.getLayoutParams();
                C24553a c24553a2 = (C24553a) view2.getLayoutParams();
                if (c24553a.A05 != c24553a2.A05) {
                    return c24553a.A05 ? 1 : -1;
                }
                return c24553a.A02 - c24553a2.A02;
            }
        };
    }

    public C24623h(Context context) {
        super(context);
        this.A0r = new ArrayList<>();
        this.A0p = new C24543Z();
        this.A0o = new Rect();
        this.A0O = -1;
        this.A0T = null;
        this.A0a = null;
    ...
    private int A01(int i10, float f10, int i11, int i12) {
        ...
        if (targetPage2 > 0) {
            C24543Z lastItem = this.A0r.get(0);
            ArrayList<C24543Z> arrayList = this.A0r;
            int targetPage3 = arrayList.size();
            C24543Z c24543z = arrayList.get(targetPage3 - 1);
            int i13 = lastItem.A02;
            int targetPage4 = c24543z.A02;
    ...
    */
    private final com.facebook.ads.redexgen.uinode.C24543Z A04(int r4) {
        /*
            r3 = this;
            r2 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.3Z r1 = (com.facebook.ads.redexgen.uinode.C24543Z) r1
            int r0 = r1.A02
            if (r0 != r4) goto L16
            return r1
        L16:
        ...
        L19:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.A04(int):com.facebook.ads.redexgen.X.3Z");
    }

    private final C24543Z A05(int i10, int i11) {
        C24543Z c24543z = new C24543Z();
        c24543z.A02 = i10;
        c24543z.A03 = this.A01.A04(this, i10);
        c24543z.A01 = this.A01.A00(i10);
        if (i11 < 0 || i11 >= this.A0r.size()) {
            this.A0r.add(c24543z);
        } else {
            this.A0r.add(i11, c24543z);
        }
        return c24543z;
    }

    private final C24543Z A06(View view) {
        while (true) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.facebook.ads.redexgen.uinode.C24543Z A07(android.view.View r5) {
        /*
            r4 = this;
            r3 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.3Z r2 = (com.facebook.ads.redexgen.uinode.C24543Z) r2
        ...
        L1f:
            r3 = 0
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C24623h.A0t
            r0 = 4
            r1 = r2[r0]
            r0 = 5
            r0 = r2[r0]
        ...
        L38:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.A07(android.view.View):com.facebook.ads.redexgen.X.3Z");
    }
    ...
    */
    private void A0A() {
        ...
        L1:
            ...
            com.facebook.ads.redexgen.X.3a r0 = (com.facebook.ads.redexgen.uinode.C24553a) r0
            boolean r0 = r0.A05
            if (r0 != 0) goto L1a
            r2.removeViewAt(r1)
            int r1 = r1 + (-1)
        ...
        L1d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.A0A():void");
    }
    ...
    private final void A0D() {
        ...
        AbstractC24493T.A0B(this, new C4409Zz(this));
        if (AbstractC24493T.A00(this) == 0) {
            AbstractC24493T.A09(this, 1);
        }
        AbstractC24493T.A0C(this, new C4410a0(this));
    }

    private void A0E(int i10) {
        List<InterfaceC24573c> list = this.A0d;
        if (list != null) {
            int i11 = list.size();
        ...
        if (startPos == this.A0G) {
            ...
            if (A0t[2].length() != 14) {
                ...
                while (true) {
                    ...
                    C24543Z c24543z4 = this.A0r.get(pageLimit);
                    int i13 = c24543z4.A02;
                    int curIndex2 = this.A00;
                    if (i13 >= curIndex2) {
                        int i14 = c24543z4.A02;
                ...
                if (c24543z3 == null && startPos > 0) {
                    int N = this.A00;
                    if (A0t[1].length() != 12) {
                        A0t[2] = "0";
                        c24543z3 = A05(N, pageLimit);
                    } else {
                        String[] strArr = A0t;
                        strArr[4] = "";
                        strArr[5] = "";
                ...
                if (c24543z3 != null) {
                    ...
                    int i15 = pageLimit - 1;
                    if (i15 >= 0) {
                        C24543Z c24543z5 = this.A0r.get(i15);
                        String[] strArr2 = A0t;
                    ...
                    for (int itemIndex = curIndex6 - 1; itemIndex >= 0; itemIndex--) {
                        if (f11 >= f10 && itemIndex < pos) {
                            ...
                            int curIndex7 = c24543z2.A02;
                            if (itemIndex == curIndex7 && !c24543z2.A04) {
                                this.A0r.remove(i15);
                                this.A01.A07(this, itemIndex, c24543z2.A03);
                                i15--;
                                pageLimit--;
                                c24543z2 = i15 >= 0 ? this.A0r.get(i15) : null;
                            }
                        } else if (c24543z2 != null && itemIndex == c24543z2.A02) {
                            f11 += c24543z2.A01;
                            String[] strArr3 = A0t;
                    ...
                    if (f13 < 2.0f) {
                        ...
                        for (int i17 = curIndex11 + 1; i17 < startPos; i17++) {
                            if (f13 >= leftWidthNeeded && i17 > endPos) {
                                ...
                                C24543Z A05 = A05(i17, i16);
                                i16++;
                                f13 += A05.A01;
                                int curIndex16 = this.A0r.size();
                                if (i16 < curIndex16) {
                                    C24543Z ii5 = this.A0r.get(i16);
                                    ii2 = ii5;
                                } else {
                                    ii2 = null;
                                }
                    ...
                    A0Q(c24543z3, pageLimit, curItem);
                }
                int N2 = getChildCount();
                for (int i18 = 0; i18 < N2; i18++) {
                    View childAt = getChildAt(i18);
                    C24553a c24553a = (C24553a) childAt.getLayoutParams();
                    c24553a.A01 = i18;
                    if (!c24553a.A05 && c24553a.A00 == 0.0f) {
                        C24543Z A07 = A07(childAt);
                        String[] strArr7 = A0t;
                ...
                if (hasFocus()) {
                    ...
                    if (currentFocused != null) {
                        c24543z = A06(currentFocused);
                    } else {
                        c24543z = null;
                    }
                    if (c24543z == null || c24543z.A02 != this.A00) {
                        for (int i19 = 0; i19 < getChildCount(); i19++) {
                            View childAt2 = getChildAt(i19);
                            C24543Z A072 = A07(childAt2);
    ...
    private final void A0I(int childLeft, float f10, int i10) {
        ...
        if (0 != 0) {
            ...
            for (int i12 = 0; i12 < childCount2; i12++) {
                ...
                if (!((C24553a) childAt2.getLayoutParams()).A05) {
                    childAt2.getLeft();
                    getClientWidth();
    ...
    */
    private final void A0O(int r7, boolean r8, boolean r9, int r10) {
        ...
        L68:
            ...
            com.facebook.ads.redexgen.X.3Z r0 = (com.facebook.ads.redexgen.uinode.C24543Z) r0
            r0.A04 = r4
            int r1 = r1 + 1
            goto L68
        L7d:
        ...
        L91:
            ...
            goto L90
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.A0O(int, boolean, boolean, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0Q(com.facebook.ads.redexgen.uinode.C24543Z r13, int r14, com.facebook.ads.redexgen.uinode.C24543Z r15) {
        /*
            Method dump skipped, instructions count: 421
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.A0Q(com.facebook.ads.redexgen.X.3Z, int, com.facebook.ads.redexgen.X.3Z):void");
    }
    ...
    private void A0R(boolean z10) {
        ...
        for (int i10 = 0; i10 < this.A0r.size(); i10++) {
            C24543Z c24543z = this.A0r.get(i10);
            boolean needPopulate2 = c24543z.A04;
            if (needPopulate2) {
                z11 = true;
                c24543z.A04 = false;
            }
        ...
        if (z11) {
            if (z10) {
                AbstractC24493T.A0D(this, this.A0q);
            } else {
                this.A0q.run();
            }
        }
    ...
    private final boolean A0W() {
        AbstractC24343E abstractC24343E = this.A01;
        if (abstractC24343E != null && this.A00 < abstractC24343E.A01() - 1) {
            A0L(this.A00 + 1, true);
            return true;
        }
        if (A0t[2].length() == 14) {
    ...
    private boolean A0X(float f10) {
        ...
        C24543Z c24543z = this.A0r.get(0);
        C24543Z c24543z2 = this.A0r.get(r1.size() - 1);
        if (c24543z.A02 != 0) {
            rightAbsolute = false;
            float f13 = c24543z.A00;
            if (A0t[1].length() == 12) {
                throw new RuntimeException();
            }
            A0t[1] = "a";
        ...
        if (c24543z2.A02 != this.A01.A01() - 1) {
            leftAbsolute = false;
            float deltaX3 = c24543z2.A00;
    ...
    */
    public final void A0e() {
        ...
        L24:
            ...
            com.facebook.ads.redexgen.X.3Z r8 = (com.facebook.ads.redexgen.uinode.C24543Z) r8
        ...
        L7d:
            ...
            java.util.Comparator<com.facebook.ads.redexgen.X.3Z> r0 = com.facebook.ads.redexgen.uinode.C24623h.A0x
        ...
        L8b:
            ...
            com.facebook.ads.redexgen.X.3a r1 = (com.facebook.ads.redexgen.uinode.C24553a) r1
            boolean r0 = r1.A05
            if (r0 != 0) goto L9e
            r0 = 0
            r1.A00 = r0
        ...
        La1:
            r11.A0N(r6, r4, r5)
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C24623h.A0t
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 14
        ...
        Lbc:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.A0e():void");
    }
    ...
    */
    public final void addFocusables(java.util.ArrayList<android.view.View> r7, int r8, int r9) {
        ...
        L57:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.addFocusables(java.util.ArrayList, int, int):void");
    }
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        C24553a c24553a = (C24553a) layoutParams;
        c24553a.A05 |= A0c(view);
        if (this.A0h) {
            if (c24553a == null || !c24553a.A05) {
                c24553a.A03 = true;
                if (A0t[2].length() == 14) {
                    throw new RuntimeException();
                }
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C24553a) && super.checkLayoutParams(layoutParams);
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.draw(android.graphics.Canvas):void");
    }
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new C24553a(getContext(), attributeSet);
    }
    ...
    public AbstractC24343E getAdapter() {
        return this.A01;
    }
    ...
    public final int getChildDrawingOrder(int i10, int i11) {
        ...
        int index = ((C24553a) this.A0b.get(result).getLayoutParams()).A01;
        return index;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            ...
            int i10 = 0;
            C24543Z c24543z = this.A0r.get(0);
            float f12 = c24543z.A00;
            int size = this.A0r.size();
            int i11 = this.A0r.get(size - 1).A02;
            loop0: for (int itemIndex = c24543z.A02; itemIndex < i11; itemIndex++) {
                while (itemIndex > c24543z.A02 && i10 < size) {
                    i10++;
                    C24543Z c24543z2 = this.A0r.get(i10);
                    String[] strArr = A0t;
                    String str = strArr[7];
                    String str2 = strArr[0];
                ...
                if (itemIndex == c24543z.A02) {
                    f10 = (c24543z.A00 + c24543z.A01) * firstPos;
                    f12 = c24543z.A00 + c24543z.A01 + f11;
                } else {
        ...
        switch (action) {
            ...
            case 2:
                ...
                if (i10 != -1) {
                    ...
                    if (f11 != 0.0f && !A0Y(this.A05, f11) && A0d(this, false, (int) f11, (int) x11, (int) y11)) {
                        this.A05 = x11;
                        this.A06 = y11;
                        this.A0k = true;
                        return false;
            ...
            if (count2 == str2.length()) {
                ...
                if (i15 < paddingLeft) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        C24553a c24553a = (C24553a) childAt.getLayoutParams();
                        if (c24553a.A05) {
                            int count3 = c24553a.A04 & 7;
                            int childTop = c24553a.A04 & 112;
                            switch (count3) {
                                case 1:
                    ...
                    while (i19 < paddingLeft) {
                        ...
                        if (childAt2.getVisibility() != i16) {
                            C24553a c24553a2 = (C24553a) childAt2.getLayoutParams();
                            if (!c24553a2.A05 && (A07 = A07(childAt2)) != null) {
                                int childWidth = scrollX + ((int) (paddingRight2 * A07.A00));
                                if (c24553a2.A03) {
                                    c24553a2.A03 = false;
                                    int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (paddingRight2 * c24553a2.A00), 1073741824);
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        ss.A00 = this.A00;
        AbstractC24343E abstractC24343E = this.A01;
        if (abstractC24343E != null) {
            Parcelable superState2 = abstractC24343E.A03();
            ss.A01 = superState2;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setAdapter(com.facebook.ads.redexgen.uinode.AbstractC24343E r7) {
        /*
            r6 = this;
            com.facebook.ads.redexgen.X.3E r0 = r6.A01
            r3 = 0
        ...
        L9c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C24623h.setAdapter(com.facebook.ads.redexgen.X.3E):void");
    }
    ...
    @Deprecated
    public void setOnPageChangeListener(InterfaceC24573c interfaceC24573c) {
        this.A0Y = interfaceC24573c;
    }
    ...
    public void setPageMarginDrawable(int i10) {
        setPageMarginDrawable(AbstractC24052k.A00(getContext(), i10));
    }
