...
public final class B3 extends FrameLayout implements MD, TD {
    ...
    public boolean A04;
    public boolean A05;
    public final AbstractC1502b5 A06;
    public final C1399Yn A07;
    public final J2 A08;
    public final JA A09;
    public final ViewOnSystemUiVisibilityChangeListenerC1053Lb A0A;
    public final C1058Lg A0B;
    public final MC A0C;
    public final InterfaceC1087Mj A0D;
    public final P3 A0E;
    public final PB A0F;
    public final RD A0G;
    public final RE A0H;
    ...
    public B3(C1399Yn c1399Yn, J2 j22, MC mc2, AbstractC1502b5 abstractC1502b5, InterfaceC1087Mj interfaceC1087Mj, int i10) {
        super(c1399Yn);
        int i11;
        ...
        this.A08 = j22;
        this.A0C = mc2;
        this.A06 = abstractC1502b5;
        this.A0D = interfaceC1087Mj;
        PB A02 = PC.A02(abstractC1502b5.A0S());
        if (A02 == null) {
            this.A0F = new PB(c1399Yn, abstractC1502b5, j22, i10);
            this.A04 = false;
        } else {
            this.A0F = A02;
            this.A04 = true;
        ...
        AbstractC1066Lo.A0G(1003, this.A0F.A0O());
        if (abstractC1502b5.A0g()) {
            i11 = 0;
            P3 p32 = new P3(c1399Yn, j22, abstractC1502b5, new C07046c(c1399Yn), A0K, mc2, interfaceC1087Mj, new TN(this));
            this.A0E = p32;
            p32.A0N();
            this.A0F.A0O().setOnTouchListener(new ViewOnTouchListenerC1155Oz(this));
        ...
        RE re2 = new RE(mediaView, 1, new WeakReference(tp), c1399Yn);
        this.A0H = re2;
        ...
        this.A0A = viewOnSystemUiVisibilityChangeListenerC1053Lb;
        viewOnSystemUiVisibilityChangeListenerC1053Lb.A05(EnumC1052La.A03);
        setBackgroundColor(i11);
        if (C0988Ih.A1W(c1399Yn)) {
            c1399Yn.A0A().AGx(mediaView, abstractC1502b5.A12(), false, false, true);
        }
        try {
            JSONObject jSONObject = new JSONObject();
            boolean A18 = abstractC1502b5.A18();
            ...
            if (A18) {
                ...
                jSONObject.put(A0B, abstractC1502b5.A0I());
            } else if (C1051Kz.A05(abstractC1502b5.A0O())) {
                jSONObject.put(A0B4, true);
                jSONObject.put(A0B3, 2);
    ...
    private void A0C() {
        C1162Pg A0B = new C1160Pe(this.A07, this.A06.A0x().A0E(), this.A06.A10()).A08(this.A06.A0w().A01()).A0B();
    ...
    private void A0F(String str) {
        ...
        C1121Nr c1121Nr = new C1121Nr(this.A07, this.A0D.A6R(), this.A0H, this.A0B, this.A08, this.A06.A0y(), this.A0C);
        HashMap hashMap = new HashMap();
        hashMap.put(A0B(86, 12, 26), A0B(98, 9, 123));
        c1121Nr.A07(this.A06.A12(), str, hashMap);
    }
    ...
    public final void ADr(String str) {
        ...
        C1047Kv.A0M(new C1047Kv(), this.A07, AbstractC1050Ky.A00(urlString), this.A06.A12());
    }
    ...
    public final void onDestroy() {
        ...
        this.A0A.A03();
        this.A08.A9X(this.A06.A12(), new C1112Ni().A02(this.A0B).A03(this.A0H).A05());
        this.A00 = null;
        this.A02 = null;
        this.A01 = null;
        PC.A04(this.A06.A0S());
