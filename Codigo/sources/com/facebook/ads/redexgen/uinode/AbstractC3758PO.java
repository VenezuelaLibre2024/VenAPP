...
public abstract class AbstractC3758PO {
     ...
     */
    public static C3757PN A00(C4337Yn c4337Yn, JSONObject jSONObject, C26416c c26416c, C3377JA c3377ja, C3732Oy c3732Oy, boolean z10) {
        boolean z11;
        String str;
        boolean z12 = z10;
        ...
        c3377ja.A04(EnumC3376J9.A0P, null);
        try {
            ...
            if (optJSONObject != null && optJSONObject.optString(A012) != null) {
                ...
                if (z11) {
                    optJSONObject.put(A012, c26416c.A0Q(optJSONObject.optString(A012)));
                }
            }
            ...
            if (optJSONArray != null) {
                for (int i10 = 0; i10 < optJSONArray.length(); i10++) {
                    ...
                    if (z11) {
                        optJSONArray.put(i10, c26416c.A0Q(optString2));
                    }
                }
            }
            ...
            if (optJSONArray2 != null) {
                for (int i11 = 0; i11 < optJSONArray2.length(); i11++) {
                    A03(arrayList, arrayList2, optJSONArray2.optJSONObject(i11), c26416c, z11);
                }
            } else {
                A03(arrayList, arrayList2, jSONObject, c26416c, z11);
            }
        } catch (JSONException unused) {
            c3732Oy.A04(AbstractC27248A.A15, A01(0, 43, 79));
        }
        return new C3757PN(jSONObject, str, arrayList, arrayList2, arrayList3, z12);
    }
    ...
    public static void A03(ArrayList<String> videoUrls, ArrayList<String> arrayList, JSONObject jSONObject, C26416c c26416c, boolean z10) throws JSONException {
        ...
        if (optJSONObject != null) {
            ...
            if (optJSONObject.optString(A012) != null) {
                ...
                if (z10) {
                    optJSONObject.put(A012, c26416c.A0Q(optString));
                }
            }
        }
        ...
        if (!TextUtils.isEmpty(jSONObject.optString(A013))) {
            ...
            arrayList.add(optString2);
            if (z10) {
                jSONObject.put(A013, c26416c.A0R(optString2));
            }
        }
    }
}
