...
public final class C4281Xt implements InterfaceC2873Ab {
    ...
    public C4281Xt() {
        ByteBuffer byteBuffer = InterfaceC2873Ab.A00;
        this.A09 = byteBuffer;
        this.A0B = byteBuffer.asShortBuffer();
        this.A0A = InterfaceC2873Ab.A00;
        this.A04 = -1;
    }

    public final float A00(float f10) {
        float A00 = AbstractC3322IF.A00(f10, 0.1f, 8.0f);
        if (this.A00 != A00) {
            this.A00 = A00;
            this.A08 = null;
        }
    ...
    public final long A02(long j10) {
        ...
        if (j11 >= 1024) {
            ...
            if (i10 == i11) {
                return AbstractC3322IF.A0F(j10, this.A06, j11);
            }
            return AbstractC3322IF.A0F(j10, this.A06 * i10, j11 * i11);
        }
    ...
    public final boolean A91() {
        C2904B6 c2904b6;
        return this.A0C && ((c2904b6 = this.A08) == null || c2904b6.A0H() == 0);
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC2873Ab
    public final void AEE() {
        AbstractC3281Ha.A04(this.A08 != null);
        this.A08.A0J();
        this.A0C = true;
    }
    ...
    public final void flush() {
        if (A8w()) {
            C2904B6 c2904b6 = this.A08;
            if (c2904b6 == null) {
                this.A08 = new C2904B6(this.A05, this.A02, this.A01, this.A00, this.A03);
            } else {
                c2904b6.A0I();
            }
        }
