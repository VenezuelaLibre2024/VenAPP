...
public abstract class AbstractC3555M7 {
    ...
    public static void A02(Activity activity, int i10, C4337Yn c4337Yn) {
        try {
            activity.setRequestedOrientation(i10);
        } catch (IllegalStateException e10) {
            c4337Yn.A07().AA2(A00(0, 7, 79), AbstractC27248A.A0H, new C27258B(e10));
        }
    }
}
