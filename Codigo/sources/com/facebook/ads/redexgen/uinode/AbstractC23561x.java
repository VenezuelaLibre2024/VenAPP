...
public abstract class AbstractC23561x {
    ...
    public static AdSettings.IntegrationErrorMode A00(C4337Yn c4337Yn) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c4337Yn)) {
    ...
    public static boolean A03(C4337Yn c4337Yn) {
        return (c4337Yn.getApplicationInfo().flags & 2) != 0;
    }
}
