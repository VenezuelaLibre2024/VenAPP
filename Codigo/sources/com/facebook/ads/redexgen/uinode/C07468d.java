...
public final class C07468d {
    ...
    public static synchronized Map<String, String> A01(C07277f c07277f) {
        synchronized (C07468d.class) {
            if (A00 != null) {
                return new HashMap(A00);
            }
            HashMap<String, String> hashMap = new HashMap<>();
            A00 = hashMap;
            hashMap.put(A00(22, 6, 41), c07277f.getPackageName());
            A03(c07277f, A00, null);
            return new HashMap(A00);
        }
    }

    public static synchronized void A03(C07277f c07277f, Map<String, String> map, String str) {
        synchronized (C07468d.class) {
            map.put(A00(41, 3, 83), A00(65, 7, 55));
            map.put(A00(44, 11, 68), c07277f.A04().A8I());
            map.put(A00(33, 2, 37), c07277f.A04().A8H());
            ...
            map.put(A00(55, 10, 72), c07277f.A08().A02());
        }
    }
}
