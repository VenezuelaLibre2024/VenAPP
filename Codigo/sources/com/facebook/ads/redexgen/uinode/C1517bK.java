...
public class C1517bK implements InterfaceC05590k, InterfaceC05630p {
    ...
    private void A06(Map<String, String> map, Map<String, String> map2) {
        try {
            new Handler().postDelayed(new C1518bL(this, map2, A03(map)), this.A01.A07() * AdError.NETWORK_ERROR_CODE);
    ...
    */
    public final void A0M(java.util.Map<java.lang.String, java.lang.String> r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1517bK.A0M(java.util.Map):void");
    }

    static {
        A04();
        A0E = C1517bK.class.getSimpleName();
    }

    public C1517bK(C1399Yn c1399Yn) {
        this(c1399Yn, new AnonymousClass14());
    }

    public C1517bK(C1399Yn c1399Yn, AnonymousClass14 anonymousClass14) {
        ...
        if (!this.A06) {
            ...
            if (A0f != null && A0f.size() > 0) {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    C1517bK adapter = new C1517bK(this.A0A);
    ...
    public final void A0L(C1399Yn c1399Yn, AnonymousClass15 anonymousClass15, J2 j22, C05951v c05951v, JO jo) {
        int i10;
        this.A02 = anonymousClass15;
        this.A04 = jo;
        JSONObject A03 = c05951v.A03();
        C8T A01 = c05951v.A01();
        if (A01 != null) {
            i10 = A01.A06();
        } else {
        ...
        this.A00 = i10;
        A05(AnonymousClass17.A00(c1399Yn, A03, LJ.A02(A03, A02(94, 2, 85))));
        if (AbstractC05600l.A06(c1399Yn, this, j22)) {
            c1399Yn.A0E().A4K();
            anonymousClass15.ACQ(this, C1005Jb.A00(AdErrorType.NO_FILL));
            return;
        }
        if (anonymousClass15 != null) {
            anonymousClass15.ACN(this);
        }
        AnonymousClass16 anonymousClass16 = new AnonymousClass16(c1399Yn, this.A0B, this, anonymousClass15);
