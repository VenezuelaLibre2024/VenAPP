...
public final class C1440a5<K, V> extends AnonymousClass31<K, V> implements Map<K, V> {
    public AbstractC06242y<K, V> A00;
    ...
    private AbstractC06242y<K, V> A00() {
        if (this.A00 == null) {
            this.A00 = new C1441a6(this);
        }
        return this.A00;
    }
