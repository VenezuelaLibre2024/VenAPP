...
public final class BQ extends C1235Sb {
    ...
    public BQ(C06433r c06433r, int i10, List<C1171Pp> list, RE re2, Bundle bundle) {
        super(c06433r, i10, list, re2, bundle);
        c06433r.A1f(this);
    ...
    @Override // com.facebook.ads.redexgen.uinode.C1235Sb, com.facebook.ads.redexgen.uinode.AbstractC06704t
    ...
    @Override // com.facebook.ads.redexgen.uinode.C1235Sb
    ...
    public final void A0d(List<C1171Pp> list) {
        this.A05 = list;
    }
}
