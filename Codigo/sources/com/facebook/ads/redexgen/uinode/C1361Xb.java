...
public final class C1361Xb extends C6 {
    ...
    public final void A0B(C0980Hz c0980Hz, long j10) throws C07889v {
        int A0E = c0980Hz.A0E();
        long A09 = j10 + (c0980Hz.A09() * 1000);
        if (A0E == 0 && !this.A02) {
            C0980Hz c0980Hz2 = new C0980Hz(new byte[c0980Hz.A04()]);
            c0980Hz.A0c(c0980Hz2.A00, 0, c0980Hz.A04());
            IH A00 = IH.A00(c0980Hz2);
            this.A01 = A00.A02;
        ...
        if (A0E == 1 && this.A02) {
            ...
            int i11 = 0;
            while (c0980Hz.A04() > 0) {
                c0980Hz.A0c(this.A03.A00, i10, this.A01);
                this.A03.A0Y(0);
                int A0H = this.A03.A0H();
                this.A04.A0Y(0);
                super.A00.AFR(this.A04, 4);
                super.A00.AFR(c0980Hz, A0H);
                i11 = i11 + 4 + A0H;
            }
    ...
    public C1361Xb(C4 c42) {
        super(c42);
        this.A04 = new C0980Hz(AbstractC0976Hv.A03);
        this.A03 = new C0980Hz(4);
    }

    @Override // com.facebook.ads.redexgen.uinode.C6
    public final boolean A0C(C0980Hz c0980Hz) throws C1362Xc {
        int frameType = c0980Hz.A0E();
        ...
        throw new C1362Xc(A00(0, 28, 46) + i11);
    }
}
