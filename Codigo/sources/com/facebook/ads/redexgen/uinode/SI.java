...
public final class SI extends LinearLayout implements QB {
    ...
    public SI(C1399Yn c1399Yn, NativeBannerAd nativeBannerAd, JR jr, JS js, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1399Yn);
        ...
        Q8 q82 = new Q8(c1399Yn, nativeBannerAd, js, jr, adOptionsView);
        int i10 = A06;
