...
public class C3649Nd extends WebViewClient {
    ...
    public final WeakReference<C4036Ts> A03;
    public final WeakReference<InterfaceC3647Nb> A04;
    public final WeakReference<AtomicBoolean> A05;
    public final WeakReference<C3528Lg> A06;
    public final WeakReference<C3872RE> A07;
    ...
    public C3649Nd(C4337Yn c4337Yn, WeakReference<InterfaceC3647Nb> weakReference, WeakReference<C3872RE> weakReference2, WeakReference<C3528Lg> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C4036Ts> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z10) {
        this.A02 = c4337Yn;
    ...
    private void A03(int i10, CharSequence charSequence, long j10) {
        ...
        this.A02.A07().A9a(A01(306, 8, 32), AbstractC27248A.A2d, new C27258B(AdErrorType.WEB_VIEW_FAILED_TO_LOAD.getDefaultErrorMessage(), A01(55, 12, 72) + jSONObject.toString()));
    }
    ...
    private final void A05(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        this.A02.A0E().AHA(webResourceResponse.getStatusCode(), AbstractC3503LH.A01(webResourceResponse.getStatusCode(), A01(67, 10, 55), A01(0, 0, 49) + webResourceRequest.getUrl()));
    }
    ...
    private void A07(String str, String str2) {
        ...
        if (c4337Yn != null) {
            c4337Yn.A07().A9a(A01(306, 8, 32), AbstractC27248A.A2a, new C27258B(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 72) + jSONObject.toString()));
        }
    }
        ...
        if (path != null && scheme != null) {
            ...
            if (path2.length() != 8) {
                ...
                if (scheme.equals(A01)) {
                    ...
                    List<String> A09 = C26416c.A09(this.A02);
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0E().AH8();
        this.A00 = new Date();
        new Handler().postDelayed(new C4037Tt(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean A0u = C3348Ih.A0u(this.A02);
        ...
        if (A0u || webResourceRequest.isForMainFrame()) {
            ...
            this.A02.A0E().AH9(AbstractC3503LH.A01(webResourceError.getErrorCode(), A01 + ((Object) webResourceError.getDescription()), A01 + webResourceRequest.getUrl()));
        }
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        AbstractC3644NY.A02(AbstractC27248A.A2Z);
        InterfaceC3647Nb adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().AB4(str, new C3654Ni().A03(this.A07.get()).A02(this.A06.get()).A05());
            return true;
        }
        return true;
    }
