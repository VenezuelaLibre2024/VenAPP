...
public final class C3259HE implements InterfaceC4560cc {
    ...
    public final InterfaceC4562ce A02;
    ...
    private final void A02(List<Rect> list) {
        ...
        list2.add(rect);
        Iterator<InterfaceC3911Rr> it = this.A02.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public C3259HE(View view, InterfaceC4562ce interfaceC4562ce) {
        this.A03 = new WeakReference<>(view);
        this.A02 = interfaceC4562ce;
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC4560cc
