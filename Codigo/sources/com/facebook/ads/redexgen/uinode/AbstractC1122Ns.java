...
public abstract class AbstractC1122Ns {
    /* JADX WARN: Type inference failed for: r0v0, types: [com.facebook.ads.redexgen.X.3n] */
    public static C06393n A00(final OP op, final V2 v22, final String str, final BQ bq) {
        ...
        return new BK(op, v22, z10, str, bq) { // from class: com.facebook.ads.redexgen.X.3n
            ...
            public void setupNativeCtaExtension(C1171Pp c1171Pp) {
                C1U A0y;
                this.A01 = c1171Pp;
                int A0M = C0988Ih.A0M(this.A0I.A05());
                C1P A01 = this.A03.A0z().A0w().A01();
                C1399Yn A05 = this.A0I.A05();
                String A0L = this.A03.A0z().A0L();
                J2 j22 = this.A02;
                MC dummyListener = NW.getDummyListener();
                RE A0b = this.A04.A0b();
                C1058Lg A19 = this.A03.A19();
                if (this.A03.A0z() == null) {
                    A0y = null;
                } else {
                    A0y = this.A03.A0z().A0y();
                }
                ViewOnClickListenerC1271Tl viewOnClickListenerC1271Tl = new ViewOnClickListenerC1271Tl(A05, A0L, A01, j22, dummyListener, A0b, A19, A0y);
                this.A00 = viewOnClickListenerC1271Tl;
                viewOnClickListenerC1271Tl.setCta(c1171Pp.A03().A0F(), this.A05, new HashMap());
                this.A03.A1K(this.A00);
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
                if (A0M == 1) {
                    layoutParams.addRule(12);
                    AbstractC1066Lo.A0P(this.A00, A06, 5, A01.A09(false));
