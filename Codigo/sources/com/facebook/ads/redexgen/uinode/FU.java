...
public final class FU extends AbstractC1502b5 implements Serializable {
    ...
    public static FU A02(JSONObject jSONObject, C1399Yn c1399Yn) {
        FU fu = new FU(AbstractC1502b5.A08(jSONObject, c1399Yn, new C1499b2()));
        fu.A16(jSONObject);
        fu.A0b(A03(0, 12, 67));
        return fu;
    }
