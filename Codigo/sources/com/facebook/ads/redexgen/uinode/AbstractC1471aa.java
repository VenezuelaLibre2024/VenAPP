...
public abstract class AbstractC1471aa implements C2K {
    ...
    public AbstractC1471aa(C1399Yn c1399Yn, String str, C2E c2e) {
        this.A02 = c1399Yn;
        this.A04 = str;
        DynamicLoaderFactory.makeLoader(c1399Yn).getInitApi().onAdLoadInvoked(c1399Yn);
        C1474ad c1474ad = new C1474ad(c1399Yn, this);
        this.A00 = c1474ad;
        AnonymousClass29 anonymousClass29 = new AnonymousClass29(c1399Yn, this);
        this.A01 = anonymousClass29;
        this.A03 = new Handler(Looper.getMainLooper());
        this.A05 = c2e.A4g(c1474ad, this, anonymousClass29);
    }
    ...
    public final void A05() {
        if (this.A01.A01) {
            ...
            this.A02.A0E().AEh();
            this.A01.A02 = true;
            this.A01.A0E(AbstractC0990Ik.A01.get());
        }
    }
    ...
    public final void A07() {
        if (!C0988Ih.A0p(this.A02)) {
            return;
        }
        ExecutorC1060Li.A00(new C1472ab(this));
    }
    ...
    public final void ACJ(int i10, String str, Bundle bundle) {
        ...
        Runnable callbackApiRunnable = new C1473ac(this, obtain);
