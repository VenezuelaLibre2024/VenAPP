...
public final class C1353Wt implements DD {
    ...
    public boolean A03;
    public final D6 A04;
    public final C0980Hz A05 = new C0980Hz(32);

    public C1353Wt(D6 d62) {
        this.A04 = d62;
    }

    @Override // com.facebook.ads.redexgen.uinode.DD
    public final void A4S(C0980Hz c0980Hz, boolean z10) {
        int i10 = -1;
        if (z10) {
            int A0E = c0980Hz.A0E();
        ...
        while (c0980Hz.A04() > 0) {
            ...
            if (payloadStartPosition < 3) {
                if (payloadStartPosition == 0) {
                    ...
                    c0980Hz.A0Y(c0980Hz.A06() - 1);
                    if (tableId == 255) {
                        this.A03 = true;
                        return;
                    }
                }
                int tableId2 = c0980Hz.A04();
                int min = Math.min(tableId2, 3 - this.A00);
                c0980Hz.A0c(this.A05.A00, this.A00, min);
                ...
                if (payloadStartPosition2 == 3) {
                    ...
                    if (headerBytesToRead2 < this.A01) {
                        ...
                        C0980Hz c0980Hz2 = this.A05;
                        int headerBytesToRead3 = this.A01;
                        c0980Hz2.A0W(Math.min(4098, Math.max(headerBytesToRead3, bArr.length * 2)));
                ...
                c0980Hz.A0c(this.A05.A00, this.A00, min2);
    ...
    public final void A8q(IB ib2, InterfaceC0839Bu interfaceC0839Bu, DC dc2) {
        this.A04.A8q(ib2, interfaceC0839Bu, dc2);
        this.A03 = true;
    }
