...
public final class C5P implements AdViewApi {
    ...
    public C5P(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        ...
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            ...
            EnumC1007Je A04 = L3.A04(adSize);
            this.A0B = A04;
            this.A0C = str;
            this.A09 = adViewParentApi;
            this.A08 = adView;
            EQ A08 = C06785c.A08(context);
            this.A0A = A08;
            A08.A0E().A2s(AdPlacementType.BANNER.toString(), str);
            C05941u c05941u = new C05941u(str, L3.A05(A04), AdPlacementType.BANNER, L3.A04(adSize), 1, new C1470aZ());
            c05941u.A06(this.A05);
            c05941u.A07(this.A06);
            FR fr = new FR(A08, c05941u);
            this.A03 = fr;
            fr.A0P(new ZQ(this));
            return;
        }
    ...
    public C5P(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws C1006Jc {
        this(context, str, A00(str2), adViewParentApi, adView);
        this.A0A.A0E().A3n();
    }

    public static AdSize A00(String str) throws C1006Jc {
        EnumC1009Jg template = C1014Jl.A00(str);
        if (template != null) {
            C1014Jl.A03(template);
            return L3.A01(template);
        }
        throw new C1006Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A01(67, 41, 7), str));
    }
    ...
    public final void A0B(RelativeLayout relativeLayout, View view) {
        ...
        String str = this.A06;
        if (str != null && (A01 = AbstractC1178Pw.A01(this.A0A, str)) != null) {
    ...
    public final void A0D(C1110Ng c1110Ng) {
        this.A04 = c1110Ng;
    }
    ...
    public final void destroy() {
        AbstractC1018Jp.A05(A01(114, 7, 72), A01(24, 19, 109), A01(0, 8, 65));
        this.A0A.A0E().A2t();
        FR fr = this.A03;
        if (fr != null) {
            fr.A0V(true);
        ...
        if (Build.VERSION.SDK_INT >= 18 && this.A04 != null && C0988Ih.A11(this.A08.getContext())) {
            C1110Ng c1110Ng = this.A04;
            String[] strArr = A0E;
            if (strArr[3].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
    ...
    public final void loadAd() {
        AbstractC1018Jp.A05(A01(121, 6, 44), A01(43, 24, 112), A01(16, 8, 127));
        A03(null);
    }

    @Override // com.facebook.ads.internal.api.AdViewApi
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        AbstractC1018Jp.A05(A01(121, 6, 44), A01(43, 24, 112), A01(8, 8, 5));
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        View view = this.A01;
        if (view != null) {
            AbstractC1011Ji.A01(this.A07, view, this.A0B);
        }
    }
    ...
    public final void setExtraHints(ExtraHints extraHints) {
        ...
        if (C0988Ih.A0g(this.A0A) && (fr = this.A03) != null) {
            fr.A07.A06(this.A05);
