...
public final class C1338Wd implements DW {
    ...
    public static final InterfaceC0870Di A04;
    public final InterfaceC0870Di A00;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static ChapterFrame A06(C0980Hz c0980Hz, int i10, int i11, boolean z10, int i12, InterfaceC0870Di interfaceC0870Di) throws UnsupportedEncodingException {
        int A06 = c0980Hz.A06();
        int A022 = A02(c0980Hz.A00, A06);
        String str = new String(c0980Hz.A00, A06, A022 - A06, A0I(169, 10, 32));
        c0980Hz.A0Y(A022 + 1);
        int A08 = c0980Hz.A08();
        ...
        int i13 = A06 + i10;
        while (c0980Hz.A06() < i13) {
            Id3Frame A0B = A0B(i11, c0980Hz, z10, i12, interfaceC0870Di);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static GeobFrame A09(C0980Hz c0980Hz, int i10) throws UnsupportedEncodingException {
        int A0E = c0980Hz.A0E();
        String A0H = A0H(A0E);
        byte[] bArr = new byte[i10 - 1];
        c0980Hz.A0c(bArr, 0, i10 - 1);
        int A022 = A02(bArr, 0);
    ...
    public C1338Wd(InterfaceC0870Di interfaceC0870Di) {
        this.A00 = interfaceC0870Di;
    }
    ...
    public static int A01(C0980Hz c0980Hz, int i10) {
        byte[] bArr = c0980Hz.A00;
        for (int A06 = c0980Hz.A06(); A06 + 1 < i10; A06++) {
            int i11 = bArr[A06];
    ...
    */
    public static int A02(byte[] r1, int r2) {
        ...
        Lb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1338Wd.A02(byte[], int):int");
    }
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L21:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1338Wd.A03(byte[], int, int):int");
    }

    public static ApicFrame A04(C0980Hz c0980Hz, int i10, int i11) throws UnsupportedEncodingException {
        int A022;
        String A0M;
        int descriptionStartIndex = c0980Hz.A0E();
        String A0H = A0H(descriptionStartIndex);
        int encoding = i10 - 1;
        byte[] bArr = new byte[encoding];
        int encoding2 = i10 - 1;
        c0980Hz.A0c(bArr, 0, encoding2);
    ...
    public static BinaryFrame A05(C0980Hz c0980Hz, int i10, String str) {
        byte[] bArr = new byte[i10];
        c0980Hz.A0c(bArr, 0, i10);
        return new BinaryFrame(str, bArr);
    }

    public static ChapterTocFrame A07(C0980Hz c0980Hz, int i10, int i11, boolean z10, int framePosition, InterfaceC0870Di interfaceC0870Di) throws UnsupportedEncodingException {
        int A06 = c0980Hz.A06();
        int A022 = A02(c0980Hz.A00, A06);
        String A0I = A0I(169, 10, 32);
        String str = new String(c0980Hz.A00, A06, A022 - A06, A0I);
        c0980Hz.A0Y(A022 + 1);
        int framePosition2 = c0980Hz.A0E();
        boolean z11 = (framePosition2 & 2) != 0;
        boolean z12 = (framePosition2 & 1) != 0;
        int A0E = c0980Hz.A0E();
        String[] strArr = new String[A0E];
        for (int i12 = 0; i12 < A0E; i12++) {
            int startIndex = c0980Hz.A06();
            int i13 = A02(c0980Hz.A00, startIndex);
            int framePosition3 = i13 - startIndex;
            strArr[i12] = new String(c0980Hz.A00, startIndex, framePosition3, A0I);
            c0980Hz.A0Y(i13 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i14 = A06 + i10;
        while (c0980Hz.A06() < i14) {
            String[] strArr2 = A02;
            ...
            Id3Frame A0B = A0B(i11, c0980Hz, z10, framePosition, interfaceC0870Di);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
    ...
    public static CommentFrame A08(C0980Hz c0980Hz, int i10) throws UnsupportedEncodingException {
        if (i10 < 4) {
            return null;
        }
        int textStartIndex = c0980Hz.A0E();
        String A0H = A0H(textStartIndex);
        byte[] bArr = new byte[3];
        c0980Hz.A0c(bArr, 0, 3);
        String description = new String(bArr, 0, 3);
        int encoding = i10 - 4;
        byte[] data = new byte[encoding];
        int encoding2 = i10 - 4;
        c0980Hz.A0c(data, 0, encoding2);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.redexgen.uinode.Dj A0A(com.facebook.ads.redexgen.uinode.C0980Hz r9) {
        /*
            int r4 = r9.A04()
            r3 = 10
            r8 = 0
        ...
        L21:
            int r4 = r9.A0G()
            int r0 = com.facebook.ads.redexgen.uinode.C1338Wd.A03
            if (r4 == r0) goto L48
        ...
        Lb8:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1338Wd.A0A(com.facebook.ads.redexgen.X.Hz):com.facebook.ads.redexgen.X.Dj");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.internal.exoplayer2.thirdparty.metadata.id3.Id3Frame A0B(int r25, com.facebook.ads.redexgen.uinode.C0980Hz r26, boolean r27, int r28, com.facebook.ads.redexgen.uinode.InterfaceC0870Di r29) {
        /*
            Method dump skipped, instructions count: 746
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1338Wd.A0B(int, com.facebook.ads.redexgen.X.Hz, boolean, int, com.facebook.ads.redexgen.X.Di):com.facebook.ads.internal.exoplayer2.thirdparty.metadata.id3.Id3Frame");
    }

    public static PrivFrame A0C(C0980Hz c0980Hz, int i10) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i10];
        c0980Hz.A0c(bArr, 0, i10);
        int A022 = A02(bArr, 0);
    ...
    public static TextInformationFrame A0D(C0980Hz c0980Hz, int i10) throws UnsupportedEncodingException {
        if (i10 < 1) {
            return null;
        }
        int valueStartIndex = c0980Hz.A0E();
    ...
    public static TextInformationFrame A0E(C0980Hz c0980Hz, int i10, String str) throws UnsupportedEncodingException {
        if (i10 < 1) {
            return null;
        }
        int A0E = c0980Hz.A0E();
    ...
    public static UrlLinkFrame A0F(C0980Hz c0980Hz, int i10) throws UnsupportedEncodingException {
        if (i10 < 1) {
            return null;
        }
        int descriptionEndIndex = c0980Hz.A0E();
    ...
    public static UrlLinkFrame A0G(C0980Hz c0980Hz, int i10, String str) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i10];
        c0980Hz.A0c(bArr, 0, i10);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0M(com.facebook.ads.redexgen.uinode.C0980Hz r16, int r17, int r18, boolean r19) {
        /*
            Method dump skipped, instructions count: 262
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1338Wd.A0M(com.facebook.ads.redexgen.X.Hz, int, int, boolean):boolean");
    }
    ...
    public final Metadata A0O(byte[] bArr, int i10) {
        ...
        int i17;
        ArrayList arrayList = new ArrayList();
        C0980Hz c0980Hz = new C0980Hz(bArr, i10);
        Dj A0A = A0A(c0980Hz);
        if (A0A == null) {
            return null;
        }
        int startPosition = c0980Hz.A06();
        i11 = A0A.A01;
        ...
        c0980Hz.A0X(startPosition + i12);
        boolean z11 = false;
        i13 = A0A.A01;
        if (!A0M(c0980Hz, i13, frameHeaderSize, false)) {
            i15 = A0A.A01;
            if (i15 == 4 && A0M(c0980Hz, 4, frameHeaderSize, true)) {
                z11 = true;
            } else {
        ...
        while (c0980Hz.A04() >= frameHeaderSize) {
            i14 = A0A.A01;
            Id3Frame A0B = A0B(i14, c0980Hz, z11, frameHeaderSize, this.A00);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
