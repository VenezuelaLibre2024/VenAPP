...
public final class C2996Cg {
    ...
    public final void A02(int i10) {
        C3306Hz c3306Hz = this.A09;
        if (c3306Hz == null || c3306Hz.A07() < i10) {
            this.A09 = new C3306Hz(i10);
        }
        this.A01 = i10;
        this.A0A = true;
        this.A0B = true;
    ...
    public final void A04(InterfaceC2951Bt interfaceC2951Bt) throws IOException, InterruptedException {
        interfaceC2951Bt.readFully(this.A09.A00, 0, this.A01);
        this.A09.A0Y(0);
        this.A0B = false;
    }

    public final void A05(C3306Hz c3306Hz) {
        c3306Hz.A0c(this.A09.A00, 0, this.A01);
        this.A09.A0Y(0);
        this.A0B = false;
    }
}
