...
public abstract class NY extends WebView {
    ...
    public NY(Activity activity, C1399Yn c1399Yn) {
        super(activity);
        A03(c1399Yn);
    }

    public NY(C1399Yn c1399Yn) {
        super(c1399Yn);
        A03(c1399Yn);
    }

    public static void A02(int i10) {
        C1398Ym context = AbstractC07267e.A00();
        if (context != null) {
            context.A07().A9a(A00(56, 8, 76), i10, new C8B(A00(35, 10, 98)));
        }
    }

    private void A03(C07277f c07277f) {
        setWebChromeClient(A0D());
        setWebViewClient(A0E());
        AbstractC1108Ne.A04(this);
        ...
        if (c07277f.A04().A8z() && Build.VERSION.SDK_INT >= 19) {
