...
public abstract class AbstractC05600l {
    ...
    public static EnumC05580j A00(JSONObject jSONObject) {
        return EnumC05580j.A00(jSONObject.optString(A02(52, 21, 114)));
    }

    public static C1533ba A01(C1399Yn c1399Yn, JSONObject jSONObject, String str) {
        return new C1533ba(jSONObject, c1399Yn, str);
    }

    public static Collection<String> A03(C1399Yn c1399Yn, JSONObject jSONObject) {
        ...
        try {
            ...
            c1399Yn.A07().A9a(A02(73, 7, 42), C8A.A2C, new C8B(e10));
        }
    ...
    public static boolean A06(C1399Yn c1399Yn, InterfaceC05590k interfaceC05590k, J2 j22) {
        EnumC05580j A7E = interfaceC05590k.A7E();
        if (A7E != null) {
            EnumC05580j invalidationBehavior = EnumC05580j.A03;
            if (A7E != invalidationBehavior) {
                boolean packageInstalled = false;
                Collection<String> A6n = interfaceC05590k.A6n();
                ...
                while (true) {
                    ...
                    if (LM.A04(c1399Yn, it.next())) {
                        packageInstalled = true;
                        break;
                    }
                }
                EnumC05580j invalidationBehavior2 = EnumC05580j.A02;
                if (packageInstalled != (A7E == invalidationBehavior2)) {
                    return false;
                }
                String A6T = interfaceC05590k.A6T();
                ...
                c1399Yn.A07().A9a(A02(32, 3, 83), C8A.A0Z, new C8B(A02(0, 32, 28)));
                return true;
            }
        }
        return false;
