...
public final class X3 implements InterfaceC0863Cy {
    ...
    private boolean A02(C0980Hz c0980Hz, int i10) {
        if (c0980Hz.A04() == 0) {
            return false;
        }
        if (c0980Hz.A0E() != i10) {
    ...
    public final void A4R(C0980Hz c0980Hz) {
        if (this.A03) {
            if (this.A00 == 2 && !A02(c0980Hz, 32)) {
                return;
            }
            if (this.A00 == 1 && !A02(c0980Hz, 0)) {
                return;
            }
            ...
            int bytesAvailable = c0980Hz.A04();
            for (C4 c42 : this.A05) {
                c0980Hz.A0Y(A062);
                c42.AFR(c0980Hz, bytesAvailable);
            }
    ...
    */
    public final void A4p(com.facebook.ads.redexgen.uinode.InterfaceC0839Bu r15, com.facebook.ads.redexgen.uinode.DC r16) {
        /*
            r14 = this;
            r2 = 0
        L1:
