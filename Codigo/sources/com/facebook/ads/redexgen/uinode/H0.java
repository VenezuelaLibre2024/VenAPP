...
public abstract class H0<E> implements Collection<E> {
    ...
    public final boolean containsAll(Collection<? extends Object> elements) {
        C1553bu.A07(elements, A08(60, 8, 42));
    ...
    public boolean contains(E element) {
        ...
        while (it.hasNext()) {
            boolean A0A = C1553bu.A0A(it.next(), element);
            String[] strArr = A01;
    ...
    public Object[] toArray() {
        return AbstractC1555bw.A02(this);
    }

    @Override // java.util.Collection
    public <T> T[] toArray(T[] array) {
        C1553bu.A07(array, A08(55, 5, 36));
        return (T[]) AbstractC1555bw.A03(this, array);
    }
