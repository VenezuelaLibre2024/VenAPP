...
public final class C07417y {
    ...
    public C07417y(String str, Map<String, String> mStaticEnvironmentData) {
        this(str, mStaticEnvironmentData, false);
    }

    public C07417y(String str, Map<String, String> map, boolean z10) {
        this.A01 = str;
        this.A02 = map;
