...
public final class TT extends OL {
    ...
    public TextView A0F;
    public AbstractC1502b5 A0G;
    public NJ A0H;
    public NK A0I;
    public U1 A0J;
    public ViewOnClickListenerC1271Tl A0K;
    public OP A0L;
    public C1144Oo A0M;
    public boolean A0N;
    public boolean A0O;
    ...
    public final AbstractC05560h A0c;
    public final JA A0d;
    public final O0 A0e;
    public final O1 A0f;
    public final KP A0g;
    ...
    public TT(OP op) {
        ...
        this.A08 = 0;
        this.A01 = 0;
        this.A0i = new RunnableC1136Og(this);
        this.A0P = false;
        ...
        this.A0g = A0A;
        if (A0A != null) {
            AbstractC1066Lo.A0K(A0A);
        }
        View A03 = this.A0L.A03();
        this.A0b = A03;
        this.A0c = C05570i.A01(op.A05(), op.A06(), op.A04().A12(), AbstractC1050Ky.A00(op.A04().A0x().A0F().A05()), new HashMap(), false, true, this.A0G.A0y());
        ...
        if (sa2 != null && C0988Ih.A18(getAdContextWrapper())) {
            AbstractC1115Nl.A00(sa2.getVideoImplView(), C0988Ih.A19(getAdContextWrapper()), new ViewOnClickListenerC1137Oh(this));
        } else if (sa2 == null && this.A0A != null && C0988Ih.A16(getAdContextWrapper())) {
            AbstractC1115Nl.A00(this.A0A, C0988Ih.A17(getAdContextWrapper()), new ViewOnClickListenerC1138Oi(this));
        }
        this.A0E = null;
        this.A0K = null;
    }
    ...
    private void A0K() {
        AbstractC1066Lo.A0J(this.A0D);
        LinearLayout linearLayout = new LinearLayout(this.A0L.A05());
        this.A0D = linearLayout;
        AbstractC1066Lo.A0R(linearLayout, getAdContextWrapper());
    ...
    public void A16() {
        A0d(((C0912Ff) this.A0c).A0G().toString());
        A0g(true);
    }

    private void A0M() {
        ExecutorC1060Li.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.Oa
            @Override // java.lang.Runnable
            public final void run() {
                TT.this.A15();
            }
    ...
    private void A0P() {
        AbstractC1066Lo.A0J(this.A0C);
        LinearLayout linearLayout = new LinearLayout(this.A0L.A05());
        this.A0C = linearLayout;
        linearLayout.setOrientation(1);
        AbstractC1066Lo.A0K(this.A0C);
        A0U();
    ...
    private void A0T() {
        ...
        if (this.A0G.A0l()) {
            this.A0A.setOnClickListener(new ViewOnClickListenerC1139Oj(this));
        }
        ...
        AbstractC1066Lo.A0K(this.A0F);
        C1144Oo c1144Oo = new C1144Oo(this.A0L.A05(), this.A0L.A04(), this.A0L.A06(), this.A0L.A09(), this.A0L.A0B(), this.A0L.A07(), getColors(), new TU(this));
        this.A0M = c1144Oo;
        c1144Oo.setAutoClickTime(this.A0L.A04(), this.A0L.A08());
        AbstractC1066Lo.A0G(AdError.NO_FILL_ERROR_CODE, this.A0M);
        addView(this.A0M);
        A0V();
        A0K();
        if (C0988Ih.A0y(this.A0L.A05())) {
            this.A0D.setOnClickListener(new ViewOnClickListenerC1140Ok(this));
            if (this.A0L.A08() != null) {
                this.A0L.A08().setCTAClickListener(new ViewOnClickListenerC1141Ol(this));
            }
        }
    }
    ...
    public void A0d(String str) {
        ...
        if (this.A0Y) {
            ...
            AbstractC1066Lo.A0J(this.A0K);
        }
        AbstractC1066Lo.A0J(this.A0J);
        TY ty = new TY(this);
        if (this.A0L.A05().A0D() == null) {
            this.A0L.A05().A0E().A8e();
        }
        if (!AbstractC0989Ii.A02(this.A0L.A05()) && this.A0L.A05().A0D() != null) {
        ...
        this.A0J.setOnTouchListener(new ViewOnTouchListenerC1133Od(this));
        setUpBrowserControls(this.A0J);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -1);
        layoutParams.weight = 0.9f;
        if (this.A0Y || this.A0G.A0n()) {
            C1399Yn A05 = this.A0L.A05();
            ...
            ViewOnClickListenerC1271Tl viewOnClickListenerC1271Tl = new ViewOnClickListenerC1271Tl(A05, A0L, A00, this.A0L.A04().A0x().A0F().A06(), this.A0L.A06(), this.A0L.A09(), this.A0L.A0B(), this.A0L.A07(), this.A0L.A04().A0y());
            this.A0K = viewOnClickListenerC1271Tl;
            viewOnClickListenerC1271Tl.setCta(this.A0L.A04().A0x().A0F(), this.A0L.A04().A12(), new HashMap());
        }
        if (!this.A0Y || this.A0K == null) {
            ...
            if (this.A0N) {
                ViewOnClickListenerC1271Tl viewOnClickListenerC1271Tl2 = this.A0K;
                int i10 = A0n;
                viewOnClickListenerC1271Tl2.setPadding(i10, 0, i10, 0);
            }
    ...
    public void A0g(boolean z10) {
        ...
        if (z10) {
            C1144Oo c1144Oo = this.A0M;
            objectAnimator = ObjectAnimator.ofFloat(c1144Oo, A0J, c1144Oo.getY(), this.A05 / 5);
        }
        ...
        duration.addUpdateListener(new C1134Oe(this));
        ...
        animatorSet.addListener(new C1135Of(this, z10));
        animatorSet.start();
    }
    ...
    */
    private void A0h(boolean r8) {
        /*
            ...
            com.facebook.ads.redexgen.uinode.AbstractC1066Lo.A0J(r0)
            android.view.View r0 = r7.A0A
            if (r0 != 0) goto L17
            com.facebook.ads.redexgen.X.OP r0 = r7.A0L
            android.view.View r0 = r0.A02()
            r7.A0A = r0
            com.facebook.ads.redexgen.uinode.AbstractC1066Lo.A0K(r0)
        L17:
            boolean r4 = r7.A0O
        ...
        L60:
            ...
            boolean r0 = com.facebook.ads.redexgen.uinode.C0988Ih.A16(r0)
            if (r0 == 0) goto La2
    ...
    */
    public final void A10(com.facebook.ads.redexgen.uinode.C1G r6, java.lang.String r7, double r8, android.os.Bundle r10) {
        ...
        L17:
            ...
            r0 = 8
            com.facebook.ads.redexgen.uinode.AbstractC1066Lo.A0N(r1, r0)
            com.facebook.ads.redexgen.X.OP r0 = r5.A0L
            com.facebook.ads.redexgen.X.Yn r0 = r0.A05()
            boolean r0 = com.facebook.ads.redexgen.uinode.C0988Ih.A0y(r0)
            if (r0 == 0) goto L30
            android.widget.LinearLayout r1 = r5.A0D
            r0 = 0
            r1.setClickable(r0)
    ...
    public final /* synthetic */ void A18(View view) {
        ExecutorC1060Li.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.OX
            @Override // java.lang.Runnable
            public final void run() {
                TT.this.A14();
            }
    ...
    private void setUpBrowserControls(U1 u12) {
        AbstractC1066Lo.A0J(this.A0H);
        NJ nj2 = new NJ(this.A0L.A05(), u12, true);
        this.A0H = nj2;
        u12.setBrowserNavigationListener(nj2.getBrowserNavigationListener());
        AbstractC1066Lo.A0K(this.A0H);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        layoutParams.weight = 0.1f;
        this.A0H.setListener(new TZ(this));
        this.A0H.setOnTouchListener(new ViewOnTouchListenerC1132Oc(this));
        this.A0C.addView(this.A0H, layoutParams);
        AbstractC1066Lo.A0J(this.A0I);
