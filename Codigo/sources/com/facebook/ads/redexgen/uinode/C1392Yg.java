...
public final class C1392Yg implements InterfaceC07397w {
    ...
    public C1392Yg(Context context, C7v c7v) {
        this.A00 = context;
        this.A02 = c7v;
    }

    private C07377t A00() {
        return C07377t.A00(KE.A00(this.A00).getString(A01(0, 16, 81), null));
    }

    private void A02() {
        this.A02.AAQ(new C1393Yh(this));
    }

    public final void A04(String[] strArr, Integer num, Integer num2) {
        C07377t c07377t = new C07377t(strArr, num, num2);
        C07377t newSettings = this.A01;
        if (c07377t.equals(newSettings)) {
            return;
        }
        this.A01 = c07377t;
        this.A03.set(true);
        ...
        C07377t newSettings2 = this.A01;
        edit.putString(A01(0, 16, 81), newSettings2.A07()).apply();
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC07397w
    public final C07377t A6i() {
        A02();
        return this.A01;
    }
    ...
    public final boolean A9F() {
        ...
        Set<String> A0W = C0988Ih.A0W(this.A00);
