...
public abstract class AnonymousClass17 {
     ...
     */
    public static AnonymousClass14 A01(C1399Yn c1399Yn, JSONObject jSONObject, String str, boolean z10, int i10, int i11) {
        if (jSONObject == null) {
            return new AnonymousClass14();
        }
        L4.A02(c1399Yn, A02(0, 23, 77));
        ...
        Uri A002 = TextUtils.isEmpty(A02) ? null : AbstractC1050Ky.A00(A02);
        String A022 = LJ.A02(jSONObject, A02(RecognitionOptions.ITF, 4, 27));
        ...
        FT A0215 = FT.A02(jSONObject, c1399Yn);
        ...
        EnumC05580j A007 = AbstractC05600l.A00(jSONObject);
        Collection<String> A03 = AbstractC05600l.A03(c1399Yn, jSONObject);
        ...
        try {
            ...
            if (optJSONArray != null && optJSONArray.length() > 0) {
                ...
                for (int i12 = 0; i12 < length; i12++) {
                    try {
                        arrayList2.add(A01(c1399Yn, optJSONArray.getJSONObject(i12), str, true, i12, length));
                        ...
                        c1399Yn.A07().A9a(A02(311, 7, 91), C8A.A2A, new C8B(e));
                        Log.e(C1517bK.A0E, A02(23, 30, 50), e);
    ...
    public static AnonymousClass14 A00(C1399Yn c1399Yn, JSONObject jSONObject, String str) {
        return A01(c1399Yn, jSONObject, str, false, -1, 0);
    }
}
