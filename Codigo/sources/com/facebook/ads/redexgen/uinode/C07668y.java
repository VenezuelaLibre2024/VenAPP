...
public final class C07668y implements Closeable {
    ...
    public C07668y(File file) throws IOException {
        ...
        this.A00 = new C07678z(readInt, fileIdx);
    }
    ...
    public final C07678z A03() throws IOException {
        if (!this.A01) {
            return this.A00;
        }
    ...
    public final void A04(C07678z c07678z) throws IOException {
        if (!this.A01) {
            if (c07678z.A02() >= 0 && c07678z.A03() >= 0) {
                this.A00 = c07678z;
                A01();
                return;
            }
            throw new IOException(String.format(Locale.US, A00(28, 25, 96), Integer.valueOf(c07678z.A02()), Integer.valueOf(c07678z.A03())));
        }
        throw new IOException(A00(0, 28, 58));
    }
