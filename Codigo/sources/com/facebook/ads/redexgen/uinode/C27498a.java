...
public final class C27498a {
    ...
    static {
        A06();
        A02 = C27498a.class.getSimpleName();
    ...
    public static long A01(C26937f c26937f, String str) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                c26937f.A07().A9a(A02(144, 7, 117), AbstractC27248A.A1E, new C27258B(e10));
            }
            return -1L;
        }
    }
    ...
    public static String A05(C26937f c26937f, String str) {
        JSONObject jSONObject = new JSONObject();
        A07(c26937f, jSONObject, A02(174, 6, 127), String.valueOf(A08()));
        A07(c26937f, jSONObject, A02(97, 8, 52), String.valueOf(A01(c26937f, str)));
        A07(c26937f, jSONObject, A02(180, 15, 73), String.valueOf(A00()));
        A07(c26937f, jSONObject, A02(105, 18, 113), String.valueOf(AbstractC3466Ke.A01(c26937f)));
        A07(c26937f, jSONObject, A02(161, 13, 111), String.valueOf(A09(c26937f)));
        A07(c26937f, jSONObject, A02(133, 11, 61), A04(c26937f));
        A07(c26937f, jSONObject, A02(123, 10, 96), A03(c26937f));
        return jSONObject.toString();
    }

    public static void A07(C26937f c26937f, JSONObject jSONObject, String str, String str2) {
        try {
