...
public abstract class AbstractC23341b {
    ...
    public static C23301X A00(JSONObject jSONObject) {
        return new C23291W().A06(A08(jSONObject)).A07(A07(jSONObject)).A05(A09(jSONObject)).A04(A06(jSONObject)).A08();
    }

    public static C23391g A01(JSONObject jSONObject) {
        return new C23381f().A06(A0A(jSONObject)).A07(A0B(jSONObject)).A05(A05(jSONObject)).A04(A04(jSONObject)).A08();
    }
