...
public class C4394Zj implements InterfaceC24924B {
    ...
    public C4394Zj(C3100Eb c3100Eb) {
        this.A00 = c3100Eb;
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC24924B
    ...
    public final void A57(int i10) {
        AbstractC254856 A0F;
        View view = A6M(i10);
        if (view != null && (A0F = C3100Eb.A0F(view)) != null) {
            if (!A0F.A0c() || A0F.A0f()) {
                A0F.A0T(RecognitionOptions.QR_CODE);
            } else {
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC24924B
    public final AbstractC254856 A6Q(View view) {
        return C3100Eb.A0F(view);
    }
