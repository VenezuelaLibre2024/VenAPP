...
public abstract class AbstractC4530by {
    ...
    public static final <E extends Enum<E>> InterfaceC3220Ga<E> A01(E[] eArr) {
        C4527bu.A07(eArr, A00(0, 7, 70));
        return new C24403K(eArr);
    }
}
