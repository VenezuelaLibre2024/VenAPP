...
public class C1479ai implements AnonymousClass15 {
    ...
    public C1479ai(FO fo, Runnable runnable, long j10, C8Q c8q) {
        this.A04 = fo;
        this.A06 = runnable;
        this.A03 = j10;
        this.A05 = c8q;
    ...
    public final void ACM(C1517bK c1517bK) {
        if (!this.A00) {
            this.A00 = true;
    ...
    @Override // com.facebook.ads.redexgen.uinode.AnonymousClass15
    public final void ACN(C1517bK c1517bK) {
        Map A01;
        if (c1517bK != this.A04.A00) {
            return;
        }
        this.A04.A0F().removeCallbacks(this.A06);
        this.A04.A01 = c1517bK;
        this.A04.A06.A0F(c1517bK);
        if (!this.A02) {
            this.A02 = true;
    ...
    @Override // com.facebook.ads.redexgen.uinode.AnonymousClass15
    public final void ACO(C1517bK c1517bK) {
        if (!this.A01) {
            this.A01 = true;
            FO fo = this.A04;
            C8Q c8q = this.A05;
    ...
    @Override // com.facebook.ads.redexgen.uinode.AnonymousClass15
    public final void ACQ(C1517bK c1517bK, C1005Jb c1005Jb) {
        Map A01;
        if (c1517bK != this.A04.A00) {
            return;
        }
        this.A04.A0F().removeCallbacks(this.A06);
        this.A04.A0N(c1517bK);
        if (!this.A02) {
            this.A02 = true;
            A01 = this.A04.A01(this.A03);
            A01.put(A00(0, 5, 58), String.valueOf(c1005Jb.A03().getErrorCode()));
            A01.put(A00(5, 3, 72), String.valueOf(c1005Jb.A04()));
            this.A04.A05(this.A05.A03(C8U.A05), A01);
        }
        this.A04.ABR(c1005Jb);
    }
}
