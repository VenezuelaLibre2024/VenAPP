...
public final class Y7 implements AC {
    ...
    public final InterfaceC0821Bc<FrameworkMediaCrypto> A03;
    ...
    @Deprecated
    public Y7(Context context, InterfaceC0821Bc<FrameworkMediaCrypto> interfaceC0821Bc, int i10, long j10) {
        this.A02 = context;
        this.A00 = i10;
        this.A01 = j10;
        this.A03 = interfaceC0821Bc;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bc != com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> */
    private final void A02(Context context, InterfaceC0821Bc<FrameworkMediaCrypto> interfaceC0821Bc, long j10, Handler handler, InterfaceC0984Id interfaceC0984Id, int extensionRendererIndex, ArrayList<Y5> arrayList) {
        arrayList.add(new C3F(context, DM.A00, j10, interfaceC0821Bc, false, handler, interfaceC0984Id, 50));
        ...
        try {
            try {
                ...
                try {
                    arrayList.add(size, (Y5) cls.getConstructor(clazz, clazz2, Handler.class, InterfaceC0984Id.class, clazz3).newInstance(true, Long.valueOf(j10), handler, interfaceC0984Id, 50));
    ...
    */
    private final void A03(android.content.Context r15, com.facebook.ads.redexgen.uinode.InterfaceC0821Bc<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> r16, com.facebook.ads.redexgen.uinode.InterfaceC0794Ab[] r17, android.os.Handler r18, com.facebook.ads.redexgen.uinode.InterfaceC0802Aj r19, int r20, java.util.ArrayList<com.facebook.ads.redexgen.uinode.Y5> r21) {
        /*
    ...
    private final void A05(Context context, InterfaceC0922Fr interfaceC0922Fr, Looper looper, int i10, ArrayList<Y5> arrayList) {
        arrayList.add(new AnonymousClass63(interfaceC0922Fr, looper));
    }

    private final InterfaceC0794Ab[] A06() {
        return new InterfaceC0794Ab[0];
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bc != com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> */
    @Override // com.facebook.ads.redexgen.uinode.AC
    public final Y5[] A4l(Handler handler, InterfaceC0984Id interfaceC0984Id, InterfaceC0802Aj interfaceC0802Aj, InterfaceC0922Fr interfaceC0922Fr, DZ dz, InterfaceC0821Bc<FrameworkMediaCrypto> interfaceC0821Bc) {
        InterfaceC0821Bc<FrameworkMediaCrypto> interfaceC0821Bc2 = interfaceC0821Bc;
        if (interfaceC0821Bc2 == null) {
            interfaceC0821Bc2 = null;
        }
        ArrayList<Y5> arrayList = new ArrayList<>();
        A02(this.A02, interfaceC0821Bc2, this.A01, handler, interfaceC0984Id, this.A00, arrayList);
        A03(this.A02, interfaceC0821Bc2, A06(), handler, interfaceC0802Aj, this.A00, arrayList);
        A05(this.A02, interfaceC0922Fr, handler.getLooper(), this.A00, arrayList);
