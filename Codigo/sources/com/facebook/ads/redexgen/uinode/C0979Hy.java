...
public final class C0979Hy {
    ...
    public C0979Hy(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C0979Hy(byte[] bArr, int i10) {
        this.A00 = bArr;
        this.A02 = i10;
    }
    ...
    private void A00() {
        int i10;
        int i11 = this.A03;
        AbstractC0955Ha.A04(i11 >= 0 && (i11 < (i10 = this.A02) || (i11 == i10 && this.A01 == 0)));
    }
    ...
    public final void A0A(int firstByteInputBits, int i10) {
        ...
        int firstByteReadSize3 = b10 | ((firstByteInputBits >>> (i10 - min)) << firstByteRightPaddingSize);
    ...
    public final boolean A0F() {
        boolean returnValue = (this.A00[this.A03] & (RecognitionOptions.ITF >> this.A01)) != 0;
        A06();
        return returnValue;
    }
}
