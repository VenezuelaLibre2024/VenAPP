...
public final class C1278Ts extends NY {
    ...
    public final WeakReference<InterfaceC1105Nb> A0A;
    ...
    static {
        A06();
        A0H = C1278Ts.class.getSimpleName();
    }

    public C1278Ts(C1399Yn c1399Yn, WeakReference<InterfaceC1105Nb> weakReference, int i10, String str) {
        this(c1399Yn, weakReference, i10, false);
        if (C0988Ih.A1W(c1399Yn)) {
            c1399Yn.A01().A0A().AGw(this, str == null ? A04(0, 0, 74) : str, false, true);
            this.A06 = true;
        }
    }

    public C1278Ts(C1399Yn c1399Yn, WeakReference<InterfaceC1105Nb> weakReference, int i10, boolean z10) {
        super(c1399Yn);
        ...
        this.A01 = new C1058Lg();
        this.A05 = true;
        this.A06 = false;
        this.A09 = c1399Yn;
        this.A04 = z10;
        this.A0A = weakReference;
        this.A02 = new C1282Tw(this);
        this.A03 = new RE(this, i10, new WeakReference(this.A02), c1399Yn);
        setWebChromeClient(A0D());
        setWebViewClient(A0E());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        if (Build.VERSION.SDK_INT > 16) {
            addJavascriptInterface(new C1104Na(this, weakReference.get(), this.A03, atomicBoolean, atomicBoolean2, c1399Yn), A04(0, 9, 97));
        }
    }
    ...
    public final WebViewClient A0E() {
        return new C1107Nd(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }

    public final void A0F() {
        this.A09.A0E().AGy();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C1280Tu(this.A03));
    }
