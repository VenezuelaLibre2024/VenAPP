...
public final class C3K<T extends Enum<T>> extends AbstractC07176u<T> implements InterfaceC0931Ga<T>, Serializable {
    ...
    public C3K(T[] tArr) {
        C1553bu.A07(tArr, A03(7, 7, 60));
        this.A00 = tArr;
    }

    private final int A00(T t10) {
        C1553bu.A07(t10, A03(0, 7, 113));
        int ordinal = t10.ordinal();
        if (((Enum) C3M.A01(this.A00, ordinal)) == t10) {
            return ordinal;
        }
        return -1;
    }
    ...
    public final T get(int i10) {
        AbstractC07176u.A02.A03(i10, this.A00.length);
        return this.A00[i10];
    }
