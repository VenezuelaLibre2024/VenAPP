...
public abstract class AbstractC1555bw {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C1553bu.A07(collection, A00(0, 10, 112));
        ...
        while (true) {
            ...
            if (i11 >= length) {
                ...
                C1553bu.A06(objArr, A002);
                i10 = i11;
            } else {
                if (!it.hasNext()) {
                    Object[] copyOf = Arrays.copyOf(objArr, i11);
                    C1553bu.A06(copyOf, A002);
                    return copyOf;
                }
                i10 = i11;
            }
            ...
            if (size == 0) {
                ...
                if (!hasNext) {
                    ...
                    if (size <= $i$f$toArrayImpl2) {
                        ...
                        C1553bu.A05(newInstance, A00(21, 62, 53));
