...
public final class C2892Au {
    ...
    public boolean A0L;
    public boolean A0M;
    public final InterfaceC2890As A0N;
    ...
    public C2892Au(InterfaceC2890As interfaceC2890As) {
        this.A0N = (InterfaceC2890As) AbstractC3281Ha.A01(interfaceC2890As);
    ...
    */
    private long A00() {
        ...
        L33:
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C2892Au.A0Q
            r0 = 7
            r1 = r2[r0]
            r0 = 3
            r2 = r2[r0]
        ...
        L6d:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C2892Au.A0Q
            r0 = 1
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 9
        ...
        Lbe:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C2892Au.A00():long");
    }
    ...
    private void A08(long j10, long audioTimestampSystemTimeUs) {
        ...
        if (Math.abs(A02 - j10) > 5000000) {
            this.A0N.ADH(A01, A02, j10, audioTimestampSystemTimeUs);
            this.A0I.A04();
        } else if (Math.abs(A02(A01) - audioTimestampSystemTimeUs) > 5000000) {
            this.A0N.ACi(A01, A02, j10, audioTimestampSystemTimeUs);
            this.A0I.A04();
        } else {
            this.A0I.A03();
        }
    ...
    public final void A0G(AudioTrack audioTrack, int i10, int i11, int i12) {
        ...
        this.A02 = i11;
        this.A00 = i12;
        this.A0I = new C2889Ar(audioTrack);
        this.A03 = audioTrack.getSampleRate();
        this.A0M = A0A(i10);
        boolean A0c = AbstractC3322IF.A0c(i10);
        this.A0L = A0c;
    ...
    public final boolean A0L(long j10) {
        InterfaceC2890As interfaceC2890As;
        ...
        boolean A0J = A0J(j10);
        this.A0K = A0J;
        if (hadData && !A0J && playState != 1 && (interfaceC2890As = this.A0N) != null) {
            interfaceC2890As.ADQ(this.A00, AbstractC28079W.A01(this.A05));
        }
        return true;
    }
}
