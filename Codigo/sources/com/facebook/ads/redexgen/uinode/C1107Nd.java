...
public class C1107Nd extends WebViewClient {
    ...
    public C1107Nd(C1399Yn c1399Yn, WeakReference<InterfaceC1105Nb> weakReference, WeakReference<RE> weakReference2, WeakReference<C1058Lg> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C1278Ts> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z10) {
        this.A02 = c1399Yn;
    ...
    private void A07(String str, String str2) {
        ...
        if (c1399Yn != null) {
            c1399Yn.A07().A9a(A01(306, 8, 32), C8A.A2a, new C8B(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 72) + jSONObject.toString()));
        }
    }
        ...
        if (path != null && scheme != null) {
            ...
            if (path2.length() != 8) {
                ...
                if (scheme.equals(A01)) {
                    ...
                    List<String> A09 = C07046c.A09(this.A02);
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0E().AH8();
        this.A00 = new Date();
        new Handler().postDelayed(new C1279Tt(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean A0u = C0988Ih.A0u(this.A02);
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        NY.A02(C8A.A2Z);
        InterfaceC1105Nb adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().AB4(str, new C1112Ni().A03(this.A07.get()).A02(this.A06.get()).A05());
            return true;
        }
        return true;
    }
