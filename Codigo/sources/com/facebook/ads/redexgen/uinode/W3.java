...
public final class W3 implements InterfaceC0950Gu {
    ...
    public final long ADl(C0954Gy c0954Gy) throws IOException {
        ...
        if (A00(102, 4, 80).equals(scheme)) {
            ...
            throw new C07889v(scheme3);
        }
        String scheme4 = A00(82, 20, 87) + scheme;
        throw new C07889v(scheme4);
    }
