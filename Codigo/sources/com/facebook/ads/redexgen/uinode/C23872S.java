...
public final class C23872S {
    ...
    public final InterfaceC23932Y A00;
    ...
    public C23872S(InterfaceC23932Y interfaceC23932Y) {
        this.A00 = interfaceC23932Y;
    }
    ...
    public static List<C23912W> A04(String str) throws JSONException {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            ...
            C23912W c23912w = new C23912W(jSONObject.getInt(A02(601, 12, 123)), jSONObject.getString(A02(590, 11, 33)), jSONObject.optString(A02(366, 16, 17)));
            Iterator<C23912W> it = A04(jSONObject.optString(A02(382, 16, 100))).iterator();
            while (it.hasNext()) {
                c23912w.A06(it.next());
            }
            children.add(c23912w);
            if (A02[0].charAt(8) == 'D') {
    ...
    public static Map<String, String> A05(String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(AbstractC27248A.A28, new C27258B(A02(239, 20, 101)));
                return null;
            }
            if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(AbstractC27248A.A25, new C27258B(A02(221, 18, 10)));
                return null;
            }
            return hashMap;
        } catch (JSONException e10) {
            A08(AbstractC27248A.A27, new C27258B(e10));
            return null;
        }
    }

    private final void A07() {
        C4422aD A5S = this.A00.A5S();
        A5S.A00(A02(518, 22, 120), 0L);
        A5S.A02();
    }

    public static void A08(int i10, C27258B c27258b) {
        C4336Ym sdkContext = AbstractC26927e.A00();
        if (sdkContext != null) {
            sdkContext.A07().A9a(A02(687, 9, 5), i10, c27258b);
        }
    }
    ...
    public final C23912W A0A() {
        C23912W c23912w = new C23912W(A00());
        try {
            for (C23912W hideAdParent : A04(A03(A02(503, 15, 30), A02(0, 0, 94)))) {
                c23912w.A06(hideAdParent);
            }
        } catch (JSONException e10) {
            A07();
            A08(AbstractC27248A.A26, new C27258B(e10));
        }
        return c23912w;
    }

    public final C23912W A0B() {
        C23912W c23912w = new C23912W(A01());
        try {
            for (C23912W reportAdParent : A04(A03(A02(670, 17, 53), A02(0, 0, 94)))) {
                c23912w.A06(reportAdParent);
            }
        } catch (JSONException e10) {
            A07();
            A08(AbstractC27248A.A29, new C27258B(e10));
        }
        return c23912w;
    }
    ...
    public final boolean A0O(Context context, boolean z10) {
        return (z10 || C3348Ih.A29(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
