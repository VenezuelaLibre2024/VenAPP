...
public final class TextureViewSurfaceTextureListenerC1024Jv extends TextureView implements TextureView.SurfaceTextureListener, InterfaceC1201Qt, R9, InterfaceC1203Qv {
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (C0988Ih.A1X(this.A0A) && this.A0D != RB.A08) {
            if (!this.A0L) {
                this.A0L = true;
                this.A0A.A0E().AFY();
            }
    ...
    static {
        A07();
        A0Q = TextureViewSurfaceTextureListenerC1024Jv.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC1024Jv(C1399Yn c1399Yn) {
        super(c1399Yn);
        this.A0D = RB.A04;
        this.A0E = RB.A04;
        this.A0M = false;
    ...
    public TextureViewSurfaceTextureListenerC1024Jv(C1399Yn c1399Yn, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC1024Jv(C1399Yn c1399Yn, AttributeSet attributeSet, int i10) {
    ...
    */
    private void A04() {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC1024Jv.A0P
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            ...
            throw r0
        L38:
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC1024Jv.A0P
        ...
        Lbc:
            ...
            goto L65
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC1024Jv.A04():void");
    }

    private void A05() {
        C1204Qw c1204Qw = this.A0C;
        if (c1204Qw == null) {
            return;
        }
        C1202Qu A08 = c1204Qw.A08();
        String[] strArr = A0P;
    ...
    public final boolean A8b() {
        C1204Qw c1204Qw = this.A0C;
        return c1204Qw != null && c1204Qw.A0K();
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC1201Qt
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC1203Qv
    ...
    public final void onAttachedToWindow() {
        ...
        if (C0988Ih.A2D(getContext()) && !isHardwareAccelerated()) {
            setVideoState(RB.A03);
            AGZ(8);
        }
    }
    ...
    public final void onWindowFocusChanged(boolean z10) {
        ...
        if (!z10) {
            if (this.A0D != RB.A05) {
                if ((this.A0A.A0F().A01() || C0988Ih.A1c(this.A0A)) && Build.VERSION.SDK_INT >= 24) {
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.facebook.ads.redexgen.X.R1
                        ...
                        public final void run() {
                            TextureViewSurfaceTextureListenerC1024Jv.this.A0A();
                        }
                    }, 1000L);
                    return;
                } else {
