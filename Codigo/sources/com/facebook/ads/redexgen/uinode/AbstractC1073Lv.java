...
public abstract class AbstractC1073Lv {
    public static Bitmap A00(C1399Yn c1399Yn, Bitmap bitmap, int i10) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation output = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(c1399Yn);
    ...
    public static Bitmap A01(C1399Yn c1399Yn, Bitmap bitmap, int i10, int i11) {
        ...
        try {
            Bitmap A00 = A00(c1399Yn, createBitmap, i10);
            if (i11 != 1) {
            ...
            return new C1286Ua().A02(createBitmap, i10);
        }
    }
}
