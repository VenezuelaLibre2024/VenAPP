...
public abstract class C2A {
    ...
    public static void A02(C1398Ym c1398Ym, Message message) {
        Bundle bundle = message.getData().getBundle(A00(0, 17, 52));
        if (bundle != null) {
            AbstractC07448b.A05(c1398Ym, bundle.getString(A00(35, 23, 34)), bundle.getString(A00(17, 18, 102)));
        }
    }
    ...
    public static boolean A04(C1398Ym c1398Ym, boolean z10, ServiceConnection serviceConnection) {
        boolean validationPassed = (c1398Ym.A04().A8z() && z10) || A03(c1398Ym, AbstractC0990Ik.A04(z10));
        if (!validationPassed) {
            return false;
        }
        boolean validationPassed2 = c1398Ym.bindService(new Intent().setComponent(new ComponentName(AbstractC0990Ik.A04(z10), A00(58, 58, 15))), serviceConnection, 1);
