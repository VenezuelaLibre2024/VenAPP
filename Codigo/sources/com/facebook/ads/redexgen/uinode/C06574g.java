...
public final class C06574g extends C8 {
    ...
    public C06574g(List<byte[]> list) {
        super(A02(182, 10, 38));
        if (list != null && !list.isEmpty()) {
            this.A04 = true;
            String A0Q = IF.A0Q(list.get(0));
            String formatLine = A02(47, 8, 49);
            AbstractC0955Ha.A03(A0Q.startsWith(formatLine));
            A06(A0Q);
            A04(new C0980Hz(list.get(1)));
            return;
        }
        this.A04 = false;
    }
    ...
    public final WF A0b(byte[] bArr, int i10, boolean z10) {
        ...
        C0970Hp c0970Hp = new C0970Hp();
        C0980Hz c0980Hz = new C0980Hz(bArr, i10);
        if (!this.A04) {
            A04(c0980Hz);
        }
        A05(c0980Hz, arrayList, c0970Hp);
        C0918Fn[] c0918FnArr = new C0918Fn[arrayList.size()];
        arrayList.toArray(c0918FnArr);
        return new WF(c0918FnArr, c0970Hp.A05());
    }

    private void A04(C0980Hz c0980Hz) {
        String A0P;
        do {
            A0P = c0980Hz.A0P();
            if (A0P == null) {
    ...
    private void A05(C0980Hz c0980Hz, List<C0918Fn> list, C0970Hp c0970Hp) {
        while (true) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x005d, code lost:
        ...
        if (r6.equals(A02(216, 5, 33)) != false) goto L44;
     */
    /*
    ...
    */
    private void A06(java.lang.String r9) {
        ...
        L90:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C06574g.A06(java.lang.String):void");
    }

    private void A07(String str, List<C0918Fn> list, C0970Hp c0970Hp) {
        int i10 = this.A01;
        ...
        list.add(new C0918Fn(endTimeString.replaceAll(A023, A024).replaceAll(A02(203, 3, 50), A024)));
        c0970Hp.A04(startTimeUs);
        if (j10 != -9223372036854775807L) {
            list.add(null);
            String[] strArr = A06;
