...
public abstract class AbstractC27638o {
    ...
    public static String A01(C26937f c26937f) {
        return WebSettings.getDefaultUserAgent(c26937f);
    }

    public static String A02(final C26937f c26937f) {
        FutureTask futureTask = new FutureTask(new Callable<String>() { // from class: com.facebook.ads.redexgen.X.8n
            ...
            public final String call() {
                ...
                if (userAgentString != null) {
                    atomicReference2 = AbstractC27638o.A04;
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ExecutorC3530Li.A00(futureTask);
            try {
    ...
    public static String A03(C26937f c26937f, C27348K c27348k) {
        String A07 = c27348k.A07();
        if (TextUtils.isEmpty(A07)) {
            ...
            if (!andSet) {
                ...
                int i10 = AbstractC27248A.A1Z;
                String bundle = A00(73, 7, 29);
                C27258B c27258b = new C27258B(bundle);
                String bundle2 = A00(116, 7, 65);
                A072.A9a(bundle2, i10, c27258b);
            }
        }
        return A07;
    }

    public static String A04(C26937f c26937f, boolean z10) {
        if (c26937f == null) {
            return A00;
        }
        if (z10) {
        ...
        long A012 = AbstractC3347Ig.A01(c26937f);
        String A002 = A00(143, 23, 90);
        String A003 = A00(133, 10, 64);
        String userAgentString = A00(88, 28, 104);
        if (A012 > 0) {
            SharedPreferences sharedPreferences = c26937f.getSharedPreferences(ProcessUtils.getProcessSpecificName(userAgentString, c26937f), 0);
        ...
        if (A012 > 0) {
            SharedPreferences sharedPreferences2 = c26937f.getSharedPreferences(ProcessUtils.getProcessSpecificName(userAgentString, c26937f), 0);
    ...
    public static String A05(C27348K c27348k, C26937f c26937f) {
        if (AbstractC3347Ig.A04(c26937f)) {
            return A00(63, 5, 117) + A03(c26937f, c27348k) + A00(39, 6, 127) + c27348k.A06() + A00(45, 6, 121) + c27348k.A04() + A00(38, 1, 111);
        }
        return A00(0, 0, 40);
    }

    public static String A06(C27348K c27348k, C26937f c26937f, boolean z10) {
        return A04(c26937f, z10) + A00(0, 38, 127) + c26937f.A04().A8H() + A00(57, 6, 54) + C27348K.A04 + A00(38, 1, 111) + A05(c27348k, c26937f) + A00(68, 5, 69) + c26937f.A04().A8I() + A00(51, 6, 77) + Locale.getDefault().toString() + A00(87, 1, 79);
    }

    public static void A09(C26937f c26937f, Throwable th2) {
        c26937f.A07().A9a(A00(166, 8, 84), AbstractC27248A.A2g, new C27258B(th2));
    }
}
