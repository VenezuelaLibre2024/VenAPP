...
public class C1426Zp implements InterfaceC06634m {
    ...
    public final void A04(C0882Eb c0882Eb, boolean z10) {
        this.A00 = 0;
        int[] iArr = this.A03;
        if (iArr != null) {
            Arrays.fill(iArr, -1);
        }
        AbstractC06654o abstractC06654o = c0882Eb.A06;
        if (c0882Eb.A04 != null && abstractC06654o != null && abstractC06654o.A1U()) {
            if (z10) {
                boolean A0B = c0882Eb.A00.A0B();
                String[] strArr = A05;
                if (strArr[0].charAt(30) != strArr[5].charAt(30)) {
                    A05[7] = "b5aEeD0";
                    if (!A0B) {
                        abstractC06654o.A1r(c0882Eb.A04.A0E(), this);
                    }
                }
                throw new RuntimeException();
            }
            if (!c0882Eb.A1p()) {
                abstractC06654o.A1q(this.A01, this.A02, c0882Eb.A0s, this);
            }
            int i10 = this.A00;
            int i11 = abstractC06654o.A00;
            String[] strArr2 = A05;
            if (strArr2[3].length() != strArr2[6].length()) {
                A05[7] = "TjVTm35";
                if (i10 > i11) {
                    abstractC06654o.A00 = this.A00;
                    abstractC06654o.A08 = z10;
                    c0882Eb.A0r.A0O();
                    return;
                }
                return;
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC06634m
