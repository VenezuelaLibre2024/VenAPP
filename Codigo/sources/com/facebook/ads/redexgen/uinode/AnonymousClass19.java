...
public final class AnonymousClass19 extends BroadcastReceiver {
    ...
    public AbstractC1506b9 A00;
    public AnonymousClass18 A01;
    public String A02;

    public AnonymousClass19(String str, AbstractC1506b9 abstractC1506b9, AnonymousClass18 anonymousClass18) {
        this.A00 = abstractC1506b9;
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (qp.A03(action2).equals(action)) {
            ...
            AbstractC1506b9 abstractC1506b9 = this.A00;
            String action3 = A03[1];
            if (action3.length() != 11) {
                A03[0] = "z37hhVYNur1y5njE4t22VYTMbB";
                anonymousClass18.AD0(abstractC1506b9);
                return;
            }
        } else {
            QP qp2 = QP.A09;
                ...
                if (strArr[3].charAt(16) != strArr[4].charAt(16)) {
                    ...
                    if (A1V) {
                        ...
                        if (strArr2[3].charAt(16) != strArr2[4].charAt(16)) {
                            ...
                            anonymousClass182.AD1(abstractC1506b92, adError);
                            return;
                        }
                        String[] strArr4 = A03;
