...
public abstract class AbstractC0862Cv {
     ...
     */
    public static C0861Cu A04(C0980Hz c0980Hz) throws C07889v {
        A0A(1, c0980Hz, false);
        long A0K = c0980Hz.A0K();
        int A0E = c0980Hz.A0E();
        long A0K2 = c0980Hz.A0K();
        int A0A = c0980Hz.A0A();
        int A0A2 = c0980Hz.A0A();
        int A0A3 = c0980Hz.A0A();
        int A0E2 = c0980Hz.A0E();
        return new C0861Cu(A0K, A0E, A0K2, A0A, A0A2, A0A3, (int) Math.pow(2.0d, A0E2 & 15), (int) Math.pow(2.0d, (A0E2 & 240) >> 4), (c0980Hz.A0E() & 1) > 0, Arrays.copyOf(c0980Hz.A00, c0980Hz.A07()));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00ea, code lost:
        ...
        return new com.facebook.ads.redexgen.uinode.C0859Cr(r9, r10, r11, r12, r13);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x0116, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C07889v(A05(228, 42, 126) + r12);
     */
    ...
    */
    public static com.facebook.ads.redexgen.uinode.C0859Cr A02(com.facebook.ads.redexgen.uinode.C0857Cp r14) throws com.facebook.ads.redexgen.uinode.C07889v {
        /*
            Method dump skipped, instructions count: 316
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.AbstractC0862Cv.A02(com.facebook.ads.redexgen.X.Cp):com.facebook.ads.redexgen.X.Cr");
    }

    public static C0860Cs A03(C0980Hz c0980Hz) throws C07889v {
        A0A(3, c0980Hz, false);
        int length = (int) c0980Hz.A0K();
        String A0S = c0980Hz.A0S(length);
        ...
        while (true) {
            ...
            A01[5] = "ziwCMa4";
            if (j10 < A0K) {
                int len = (int) c0980Hz.A0K();
                strArr[i12] = c0980Hz.A0S(len);
                int length4 = strArr[i12].length();
                i11 = i11 + 4 + length4;
                i12++;
            } else {
                int length5 = c0980Hz.A0E();
                if ((length5 & 1) != 0) {
                    return new C0860Cs(A0S, strArr, i11 + 1);
                }
                String vendor2 = A05(198, 30, 84);
                throw new C07889v(vendor2);
            }
        }
    }

    public static void A07(int i10, C0857Cp c0857Cp) throws C07889v {
        int j10;
        int A02 = c0857Cp.A02(6) + 1;
        for (int i11 = 0; i11 < A02; i11++) {
            int A022 = c0857Cp.A02(16);
            switch (A022) {
                case 0:
                    if (c0857Cp.A04()) {
                        j10 = c0857Cp.A02(4) + 1;
                    ...
                    if (c0857Cp.A04()) {
                        int i12 = c0857Cp.A02(8);
                        int i13 = i12 + 1;
                        for (int i14 = 0; i14 < i13; i14++) {
                            int mappingsCount = i10 - 1;
                            c0857Cp.A03(A00(mappingsCount));
                            int mappingsCount2 = i10 - 1;
                            c0857Cp.A03(A00(mappingsCount2));
                        }
                    }
                    int mappingsCount3 = c0857Cp.A02(2);
                    if (mappingsCount3 == 0) {
                        if (j10 > 1) {
                        ...
                        throw new C07889v(A05(406, 58, 29));
                    }
                default:
    ...
    public static void A08(C0857Cp c0857Cp) throws C07889v {
        int A02 = c0857Cp.A02(6) + 1;
            ...
            switch (A022) {
                ...
                case 1:
                    ...
                    for (int partitions = 0; partitions < iArr.length; partitions++) {
                        iArr[partitions] = c0857Cp.A02(3) + 1;
                        int A023 = c0857Cp.A02(2);
                        if (A023 > 0) {
                            c0857Cp.A03(8);
                        }
                    ...
                    c0857Cp.A03(2);
                    int partitions2 = c0857Cp.A02(4);
                    int i12 = 0;
                    int floorCount5 = 0;
                    for (int i13 = 0; i13 < j11; i13++) {
                        i12 += iArr[partitionClassList[i13]];
                        while (floorCount5 < i12) {
                            c0857Cp.A03(partitions2);
                            floorCount5++;
                        }
                    }
                    break;
                default:
                    throw new C07889v(A05(114, 41, 34) + A022);
            }
        }
    }

    public static void A09(C0857Cp c0857Cp) throws C07889v {
        int A02 = c0857Cp.A02(6) + 1;
        for (int i10 = 0; i10 < A02; i10++) {
            int residueCount = c0857Cp.A02(16);
            if (residueCount <= 2) {
                c0857Cp.A03(24);
                c0857Cp.A03(24);
                c0857Cp.A03(24);
                int A022 = c0857Cp.A02(6) + 1;
                c0857Cp.A03(8);
                int[] iArr = new int[A022];
                for (int i11 = 0; i11 < A022; i11++) {
                    int i12 = 0;
                    int residueCount2 = c0857Cp.A02(3);
                    if (c0857Cp.A04()) {
                        i12 = c0857Cp.A02(5);
                    }
                ...
                throw new C07889v(A05(363, 43, 2));
            }
        }
    }

    public static boolean A0A(int i10, C0980Hz c0980Hz, boolean z10) throws C07889v {
        if (c0980Hz.A04() < 7) {
            if (z10) {
                return false;
            }
            throw new C07889v(A05(464, 18, 36) + c0980Hz.A04());
        }
        if (c0980Hz.A0E() != i10) {
            if (z10) {
                return false;
            }
            throw new C07889v(A05(93, 21, 41) + Integer.toHexString(i10));
        }
        if (c0980Hz.A0E() != 118 || c0980Hz.A0E() != 111 || c0980Hz.A0E() != 114 || c0980Hz.A0E() != 98 || c0980Hz.A0E() != 105 || c0980Hz.A0E() != 115) {
            if (z10) {
                return false;
            }
            throw new C07889v(A05(10, 28, 123));
        }
        return true;
    }

    public static Ct[] A0B(C0857Cp c0857Cp) {
        int A02 = c0857Cp.A02(6) + 1;
        Ct[] ctArr = new Ct[A02];
        for (int windowType = 0; windowType < A02; windowType++) {
            boolean A04 = c0857Cp.A04();
            int A022 = c0857Cp.A02(16);
            int i10 = c0857Cp.A02(16);
            ctArr[windowType] = new Ct(A04, A022, i10, c0857Cp.A02(8));
        }
        return ctArr;
    }

    public static Ct[] A0C(C0980Hz c0980Hz, int i10) throws C07889v {
        A0A(5, c0980Hz, false);
        int A0E = c0980Hz.A0E() + 1;
        C0857Cp c0857Cp = new C0857Cp(c0980Hz.A00);
        int numberOfBooks = c0980Hz.A06();
        c0857Cp.A03(numberOfBooks * 8);
        for (int numberOfBooks2 = 0; numberOfBooks2 < A0E; numberOfBooks2++) {
            A02(c0857Cp);
        }
        int numberOfBooks3 = c0857Cp.A02(6);
        int timeCount = numberOfBooks3 + 1;
        for (int i11 = 0; i11 < timeCount; i11++) {
            int numberOfBooks4 = c0857Cp.A02(16);
            if (numberOfBooks4 != 0) {
                throw new C07889v(A05(311, 52, 47));
            }
        }
        A08(c0857Cp);
        A09(c0857Cp);
        ...
        throw new C07889v(A05(155, 43, 85));
    }
}
