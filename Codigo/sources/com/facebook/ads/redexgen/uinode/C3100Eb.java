...
import com.facebook.ads.internal.androidx.support.p046v7.widget.RecyclerView$SavedState;
...
public class C3100Eb extends ViewGroup implements InterfaceC24303A {
    ...
    public C24934C A01;
    public C4400Zp A02;
    public RunnableC25064P A03;
    public AbstractC25184c A04;
    public AbstractC25264k A05;
    public AbstractC25304o A06;
    public InterfaceC25394x A07;
    public RunnableC254755 A08;
    public C4387Zb A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    ...
    public C24313B A0d;
    public InterfaceC25214f A0e;
    public InterfaceC25244i A0f;
    public AbstractC25334r A0g;
    public InterfaceC25344s A0h;
    public AbstractC25354t A0i;
    public RecyclerView$SavedState A0j;
    public Runnable A0k;
    public List<RecyclerView.OnChildAttachStateChangeListener> A0l;
    public List<AbstractC25354t> A0m;
    public boolean A0n;
    public boolean A0o;
    public final Rect A0p;
    public final RectF A0q;
    public final C25384w A0r;
    public final C254553 A0s;
    public final C25565E A0t;
    public final Runnable A0u;
    public final ArrayList<RecyclerView.ItemDecoration> A0v;
    public final List<AbstractC254856> A0w;
    public final int A0x;
    public final int A0y;
    public final Rect A0z;
    public final AccessibilityManager A10;
    public final C4389Ze A11;
    public final InterfaceC25555D A12;
    public final ArrayList<InterfaceC25344s> A13;
    ...
    private void A0N() {
        ...
        if (this.A0s.A0C) {
            for (int A05 = this.A01.A05() - 1; A05 >= 0; A05--) {
                AbstractC254856 A0F = A0F(this.A01.A09(A05));
                if (!A0F.A0f()) {
                    long A0C = A0C(A0F);
                    C25254j A08 = this.A05.A08(this.A0s, A0F);
                    AbstractC254856 A052 = this.A0t.A05(A0C);
                    if (A052 == null || A052.A0f()) {
                        this.A0t.A0E(A0F, A08);
                    } else {
                        boolean A0H = this.A0t.A0H(A052);
                        C25565E c25565e = this.A0t;
                        if (A19[5].charAt(2) != 'Y') {
                            break;
                        }
                        A19[1] = "oIS3LUWJBkP0D1bim3OID749wsN9UxnV";
                        boolean A0H2 = c25565e.A0H(A0F);
                        if (A0H && A052 == A0F) {
                            this.A0t.A0E(A0F, A08);
                        } else {
                            C25254j A04 = this.A0t.A04(A052);
                            this.A0t.A0E(A0F, A08);
                            C25254j A03 = this.A0t.A03(A0F);
                            if (A04 == null) {
                                A0m(A0C, A0F, A052);
                            } else {
        ...
        C254553 c254553 = this.A0s;
        c254553.A05 = c254553.A03;
        this.A0C = false;
        this.A0s.A0C = false;
        this.A0s.A0B = false;
        this.A06.A09 = false;
        if (this.A0r.A02 != null) {
            ArrayList<AbstractC254856> arrayList = this.A0r.A02;
            String[] strArr = A19;
    ...
    public C3100Eb(Context context) {
        this(context, null);
    }

    public C3100Eb(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C3100Eb(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        this.A11 = new C4389Ze(this);
        this.A0r = new C25384w(this);
        this.A0t = new C25565E();
        this.A0u = new Runnable() { // from class: com.facebook.ads.redexgen.X.4Z
            @Override // java.lang.Runnable
            public final void run() {
                if (!C3100Eb.this.A0D || C3100Eb.this.isLayoutRequested()) {
                    return;
                }
                if (!C3100Eb.this.A0F) {
                    C3100Eb.this.requestLayout();
                } else if (C3100Eb.this.A0I) {
                    C3100Eb.this.A0J = true;
                } else {
                    C3100Eb.this.A1I();
                }
            }
        ...
        this.A0U = 0;
        this.A0N = 0;
        this.A05 = new C3103Ee();
        this.A0W = 0;
        this.A0V = -1;
        this.A0L = Float.MIN_VALUE;
        this.A0M = Float.MIN_VALUE;
        this.A0o = true;
        this.A08 = new RunnableC254755(this);
        this.A02 = A1E ? new C4400Zp() : null;
        this.A0s = new C254553();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new C4392Zh(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        this.A0k = new Runnable() { // from class: com.facebook.ads.redexgen.X.4a
            @Override // java.lang.Runnable
            public final void run() {
                if (C3100Eb.this.A05 != null) {
                    C3100Eb.this.A05.A0J();
                }
                C3100Eb.this.A0K = false;
            }
        };
        this.A12 = new C4395Zk(this);
        ...
        this.A0L = AbstractC24503U.A00(viewConfiguration, context);
        this.A0M = AbstractC24503U.A01(viewConfiguration, context);
        ...
        A0e();
        A0O();
        if (AbstractC24493T.A00(this) == 0) {
            AbstractC24493T.A09(this, 1);
        }
        this.A10 = (AccessibilityManager) getContext().getSystemService(A0I(1831, 13, 81));
        setAccessibilityDelegateCompat(new C4387Zb(this));
    ...
    private final long A0C(AbstractC254856 abstractC254856) {
        return this.A04.A0A() ? abstractC254856.A0K() : abstractC254856.A03;
    }

    private View A0D() {
        AbstractC254856 A1F2;
        int i10 = this.A0s.A01 != -1 ? this.A0s.A01 : 0;
        int A03 = this.A0s.A03();
        for (int i11 = i10; i11 < A03; i11++) {
            AbstractC254856 A1F3 = A1F(i11);
            if (A1F3 == null) {
                break;
            }
    ...
    private final AbstractC254856 A0E(long j10) {
        AbstractC25184c abstractC25184c = this.A04;
        if (abstractC25184c == null || !abstractC25184c.A0A()) {
            return null;
        }
        int A06 = this.A01.A06();
        AbstractC254856 abstractC254856 = null;
        for (int i10 = 0; i10 < A06; i10++) {
            AbstractC254856 holder = A0F(this.A01.A0A(i10));
            if (holder != null && !holder.A0a()) {
                ...
                if (A0K != j10) {
                    ...
                    abstractC254856 = holder;
                } else {
                    return holder;
                }
            }
        }
        return abstractC254856;
    }

    public static AbstractC254856 A0F(View view) {
        if (view == null) {
            return null;
        }
        ...
        return ((C25314p) layoutParams).A00;
    }

    private final AbstractC254856 A0G(View view) {
    ...
    public static C3100Eb A0H(View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        boolean z10 = view instanceof C3100Eb;
        if (A19[5].charAt(2) != 'Y') {
            throw new RuntimeException();
        }
        ...
        for (int i10 = 0; i10 < count; i10++) {
            C3100Eb A0H = A0H(viewGroup.getChildAt(i10));
            if (A0H != null) {
                return A0H;
            }
        }
    ...
    */
    private void A0L() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.A0L():void");
    }
    ...
    */
    private void A0M() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C3100Eb.A19
            r0 = 3
            r1 = r2[r0]
            r0 = 0
            r0 = r2[r0]
        ...
        L5d:
            r4.A0C = r0
            com.facebook.ads.redexgen.X.53 r4 = r6.A0s
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C3100Eb.A19
            r0 = 1
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 32
        ...
        L8b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.A0M():void");
    }

    private void A0O() {
        this.A01 = new C24934C(new C4394Zj(this));
    }
    ...
    */
    private void A0P() {
        ...
        La1:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.A0P():void");
    }
    ...
    private void A0Q() {
        ...
        if (this.A0o && this.A04 != null && hasFocus() && getDescendantFocusability() != 393216) {
            ...
            if (this.A0s.A08 != -1 && this.A04.A0A()) {
                abstractC254856 = A0E(this.A0s.A08);
            }
            View view = null;
            if (abstractC254856 == null || this.A01.A0K(abstractC254856.A0H) || !abstractC254856.A0H.hasFocusable()) {
                if (this.A01.A05() > 0) {
                    view = A0D();
                }
            } else {
                view = abstractC254856.A0H;
            }
            if (view != null) {
    ...
    private void A0U() {
        ...
        AbstractC254856 A0G2 = view == null ? null : A0G(view);
        if (A0G2 == null) {
            A0S();
            return;
        }
        ...
        c254553.A01 = A0G;
        C254553 c2545532 = this.A0s;
        View child = A0G2.A0H;
        c2545532.A02 = A0B(child);
    }

    private void A0V() {
        this.A08.A08();
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null) {
            abstractC25304o.A0x();
        }
    }
    ...
    private final void A0X() {
        ...
        for (int i10 = 0; i10 < A06; i10++) {
            ...
            AbstractC254856 A0F = A0F(c24934c.A0A(i10));
            if (!A0F.A0f()) {
                A0F.A0M();
            }
        }
    ...
    private final void A0Z() {
        ...
        for (int size = this.A0w.size() - 1; size >= 0; size--) {
            AbstractC254856 abstractC254856 = this.A0w.get(size);
            if (abstractC254856.A0H.getParent() == this && !abstractC254856.A0f() && (state = abstractC254856.A02) != -1) {
                AbstractC24493T.A09(abstractC254856.A0H, state);
                abstractC254856.A02 = -1;
            }
        }
        this.A0w.clear();
    }
    ...
    private final void A0e() {
        this.A00 = new C4401Zq(new C4393Zi(this));
    }
    ...
    private final void A0g() {
        int A06 = this.A01.A06();
        for (int i10 = 0; i10 < A06; i10++) {
            ((C25314p) this.A01.A0A(i10).getLayoutParams()).A01 = true;
        }
        this.A0r.A0M();
    }
    ...
    private final void A0h() {
        int A06 = this.A01.A06();
        for (int i10 = 0; i10 < A06; i10++) {
            AbstractC254856 A0F = A0F(this.A01.A0A(i10));
            if (A0F != null && !A0F.A0f()) {
                A0F.A0T(6);
            }
        }
    ...
    private void A0j(float f10, float f11, float f12, float f13) {
        ...
        if (f11 < 0.0f) {
            A0b();
            AbstractC248443.A00(this.A0a, (-f11) / getWidth(), 1.0f - (f12 / getHeight()));
            z10 = true;
        } else if (f11 > 0.0f) {
            A0c();
            AbstractC248443.A00(this.A0b, f11 / getWidth(), f12 / getHeight());
            z10 = true;
        }
        if (f13 < 0.0f) {
            A0d();
            AbstractC248443.A00(this.A0c, (-f13) / getHeight(), f10 / getWidth());
            z10 = true;
        } else if (f13 > 0.0f) {
            A0a();
            AbstractC248443.A00(this.A0Z, f13 / getHeight(), 1.0f - (f10 / getWidth()));
            z10 = true;
        }
    ...
    private final void A0k(int i10) {
        AbstractC25304o abstractC25304o = this.A06;
        AbstractC25354t abstractC25354t = this.A0i;
        if (abstractC25354t != null) {
            abstractC25354t.A0L(this, i10);
        }
        List<AbstractC25354t> list = this.A0m;
        String[] strArr = A19;
        if (strArr[2].length() == strArr[7].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0m(long j10, AbstractC254856 abstractC254856, AbstractC254856 abstractC2548562) {
        int A05 = this.A01.A05();
        for (int i10 = 0; i10 < A05; i10++) {
            AbstractC254856 A0F = A0F(this.A01.A09(i10));
            if (A0F != abstractC254856 && A0C(A0F) == j10) {
                AbstractC25184c abstractC25184c = this.A04;
                String A0I = A0I(1, 17, 65);
                if (abstractC25184c != null && abstractC25184c.A0A()) {
                    throw new IllegalStateException(A0I(1696, 130, 77) + A0F + A0I + abstractC254856 + A1H());
                }
                throw new IllegalStateException(A0I(1508, 188, 116) + A0F + A0I + abstractC254856 + A1H());
            }
        }
        Log.e(A0I(1370, 12, 79), A0I(1202, 111, 90) + abstractC2548562 + A0I(18, 41, 39) + abstractC254856 + A1H());
    }
    ...
    public static void A0o(View view, Rect rect) {
        ...
        Rect rect2 = c25314p.A03;
        rect.set((view.getLeft() - rect2.left) - c25314p.leftMargin, (view.getTop() - rect2.top) - c25314p.topMargin, view.getRight() + rect2.right + c25314p.rightMargin, view.getBottom() + rect2.bottom + c25314p.bottomMargin);
    }
    ...
    private void A0p(View view, View view2) {
        ...
        if (focusedLayoutParams instanceof C25314p) {
            C25314p c25314p = (C25314p) focusedLayoutParams;
            if (!c25314p.A01) {
                Rect insets = c25314p.A03;
    ...
    private void A0q(AbstractC25184c abstractC25184c, boolean z10, boolean z11) {
        AbstractC25184c abstractC25184c2 = this.A04;
        if (abstractC25184c2 != null) {
            C4389Ze c4389Ze = this.A11;
            String[] strArr = A19;
            if (strArr[2].length() == strArr[7].length()) {
                throw new RuntimeException();
            }
            ...
            abstractC25184c2.A08(c4389Ze);
        }
        if (!z10 || z11) {
            A1N();
        }
        this.A00.A09();
        AbstractC25184c abstractC25184c3 = this.A04;
        this.A04 = abstractC25184c;
        if (abstractC25184c != null) {
            abstractC25184c.A07(this.A11);
        }
        AbstractC25304o abstractC25304o = this.A06;
        C25384w c25384w = this.A0r;
        AbstractC25184c oldAdapter = this.A04;
        c25384w.A0U(abstractC25184c3, oldAdapter, z10);
        this.A0s.A0D = true;
        A1P();
    }

    private void A0r(AbstractC254856 abstractC254856) {
        View view = abstractC254856.A0H;
        boolean z10 = view.getParent() == this;
        this.A0r.A0Y(A1G(view));
        if (abstractC254856.A0c()) {
            C24934C c24934c = this.A01;
            String[] strArr = A19;
            if (strArr[3].length() == strArr[0].length()) {
                throw new RuntimeException();
            ...
            c24934c.A0H(view, -1, view.getLayoutParams(), true);
            return;
        }
        if (!z10) {
    ...
    public static void A0s(AbstractC254856 abstractC254856) {
        if (abstractC254856.A09 != null) {
            WeakReference<C3100Eb> weakReference = abstractC254856.A09;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            C3100Eb c3100Eb = weakReference.get();
            while (c3100Eb != null) {
                View item = abstractC254856.A0H;
                if (c3100Eb == item) {
                    return;
                }
                Object parent = c3100Eb.getParent();
            ...
            abstractC254856.A09 = null;
        }
    }

    private void A0t(AbstractC254856 abstractC254856, AbstractC254856 abstractC2548562, C25254j c25254j, C25254j c25254j2, boolean z10, boolean z11) {
        ...
        if (abstractC254856 != abstractC2548562) {
            if (z11) {
                A0r(abstractC2548562);
            }
            abstractC254856.A06 = abstractC2548562;
            A0r(abstractC254856);
            this.A0r.A0Y(abstractC254856);
            abstractC2548562.A0X(false);
            abstractC2548562.A07 = abstractC254856;
        }
        if (this.A05.A0H(abstractC254856, abstractC2548562, c25254j, c25254j2)) {
            A1M();
        }
    }
    ...
    private void A0x(int[] iArr) {
        ...
        int maxPositionPreLayout = C5101a.e.API_PRIORITY_OTHER;
    ...
    private final boolean A12(int i10, int i11) {
        ...
        boolean A20 = abstractC25304o.A20();
        ...
        if (!canScrollHorizontal) {
            ...
            AbstractC25334r abstractC25334r = this.A0g;
            if (abstractC25334r != null) {
                boolean canScrollHorizontal2 = abstractC25334r.A0B(i10, i11);
    ...
    private final boolean A13(int i10, int i11, MotionEvent motionEvent) {
        ...
        if (this.A04 != null) {
            A1J();
            A1K();
            AbstractC24112q.A01(A0I(1361, 9, 75));
            A1h(this.A0s);
            if (i10 != 0) {
        ...
        if (A1t(i12, unconsumedX, unconsumedY, consumedX, this.A17, 0)) {
            ...
            if (motionEvent != null && !AbstractC242939.A00(motionEvent, 8194)) {
    ...
    private final boolean A18(AccessibilityEvent accessibilityEvent) {
        if (A1q()) {
            ...
            if (accessibilityEvent != null) {
                i10 = AbstractC24673m.A00(accessibilityEvent);
            }
            if (i10 == 0) {
                i10 = 0;
            }
    ...
    public final int A1B(View view) {
        AbstractC254856 holder = A0F(view);
        if (holder != null) {
            return holder.A0I();
        }
        return -1;
    ...
    public final int A1C(AbstractC254856 abstractC254856) {
        if (!abstractC254856.A0i(524) && abstractC254856.A0Y()) {
            return this.A00.A05(abstractC254856.A03);
        }
        if (A19[5].charAt(2) != 'Y') {
            throw new RuntimeException();
        }
    ...
    */
    public final android.graphics.Rect A1D(android.view.View r6) {
        /*
            ...
            com.facebook.ads.redexgen.X.4p r4 = (com.facebook.ads.redexgen.uinode.C25314p) r4
            boolean r0 = r4.A01
            if (r0 != 0) goto Ld
        ...
        L6d:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.A1D(android.view.View):android.graphics.Rect");
    }
    ...
    */
    public final android.view.View A1E(android.view.View r3) {
        ...
        L17:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.A1E(android.view.View):android.view.View");
    }

    public final AbstractC254856 A1F(int i10) {
        if (this.A0C) {
            return null;
        }
        int A06 = this.A01.A06();
        AbstractC254856 hidden = null;
        for (int i11 = 0; i11 < A06; i11++) {
            AbstractC254856 A0F = A0F(this.A01.A0A(i11));
            if (A0F != null && !A0F.A0a()) {
    ...
    public final AbstractC254856 A1G(View view) {
    ...
    public final void A1I() {
        ...
        if (this.A00.A0D(4)) {
            ...
            if (!A0D) {
                AbstractC24112q.A01(A0I(1341, 20, 82));
                A1J();
                A1K();
                this.A00.A08();
                if (!this.A0J) {
    ...
    public final void A1M() {
        if (!this.A0K && this.A0F) {
            AbstractC24493T.A0D(this, this.A0k);
            this.A0K = true;
        }
    }

    public final void A1N() {
        AbstractC25264k abstractC25264k = this.A05;
        if (abstractC25264k != null) {
            abstractC25264k.A0I();
        }
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null) {
            abstractC25304o.A1I(this.A0r);
            this.A06.A1G(this.A0r);
        }
        this.A0r.A0P();
    }
    ...
    public final void A1W(int i10) {
        ...
        if (abstractC25304o != null) {
            abstractC25304o.A1x(this, this.A0s, i10);
            return;
        }
        String[] strArr3 = A19;
    ...
    public final void A1a(int i10, int i11) {
        int A00 = AbstractC25304o.A00(i10, getPaddingLeft() + getPaddingRight(), AbstractC24493T.A03(this));
        int paddingTop = getPaddingTop();
        int width = getPaddingBottom();
        int i12 = paddingTop + width;
        int width2 = AbstractC24493T.A02(this);
        setMeasuredDimension(A00, AbstractC25304o.A00(i11, i12, width2));
    }
    ...
    public final void A1b(int i10, int i11) {
        ...
        AbstractC25354t abstractC25354t = this.A0i;
        if (abstractC25354t != null) {
            abstractC25354t.A0M(this, i10, i11);
        }
        List<AbstractC25354t> list = this.A0m;
        if (list != null) {
    ...
    public final void A1f(AbstractC25354t abstractC25354t) {
        if (this.A0m == null) {
            this.A0m = new ArrayList();
        }
        this.A0m.add(abstractC25354t);
    }

    public final void A1g(AbstractC25354t abstractC25354t) {
        List<AbstractC25354t> list = this.A0m;
        if (list != null) {
            list.remove(abstractC25354t);
        }
    }

    public final void A1h(C254553 c254553) {
        if (getScrollState() == 2) {
            OverScroller overScroller = this.A08.A01;
            c254553.A06 = overScroller.getFinalX() - overScroller.getCurrX();
            c254553.A07 = overScroller.getFinalY() - overScroller.getCurrY();
        } else {
            c254553.A06 = 0;
            c254553.A07 = 0;
        }
    ...
    public final void A1i(AbstractC254856 abstractC254856, C25254j c25254j) {
        abstractC254856.A0U(0, 8192);
        if (this.A0s.A0E && abstractC254856.A0d() && !abstractC254856.A0a() && !abstractC254856.A0f()) {
            this.A0t.A08(A0C(abstractC254856), abstractC254856);
        }
        this.A0t.A0F(abstractC254856, c25254j);
    }

    public final void A1j(AbstractC254856 abstractC254856, C25254j c25254j, C25254j c25254j2) {
        abstractC254856.A0X(false);
        if (this.A05.A0E(abstractC254856, c25254j, c25254j2)) {
            A1M();
        }
    }

    public final void A1k(AbstractC254856 abstractC254856, C25254j c25254j, C25254j c25254j2) {
        A0r(abstractC254856);
        abstractC254856.A0X(false);
        if (this.A05.A0F(abstractC254856, c25254j, c25254j2)) {
            A1M();
        }
    }
    ...
    public final boolean A1v(View view) {
        ...
        if (A0L) {
            AbstractC254856 viewHolder = A0F(view);
    ...
    public final boolean A1w(AbstractC254856 abstractC254856) {
        AbstractC25264k abstractC25264k = this.A05;
        return abstractC25264k == null || abstractC25264k.A0M(abstractC254856, abstractC254856.A0L());
    }

    public final boolean A1x(AbstractC254856 abstractC254856, int i10) {
        if (A1q()) {
            abstractC254856.A02 = i10;
            this.A0w.add(abstractC254856);
            return false;
        }
        AbstractC24493T.A09(abstractC254856.A0H, i10);
        return true;
    }
    ...
    public final void addFocusables(ArrayList<View> arrayList, int i10, int i11) {
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null) {
            boolean A1c = abstractC25304o.A1c(this, arrayList, i10, i11);
            if (A19[5].charAt(2) != 'Y') {
                throw new RuntimeException();
            }
            String[] strArr = A19;
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C25314p) && this.A06.A1Y((C25314p) layoutParams);
    }

    @Override // android.view.View
    public final int computeHorizontalScrollExtent() {
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null && abstractC25304o.A20()) {
    ...
    public final int computeVerticalScrollExtent() {
        ...
        if (strArr[3].length() != strArr[0].length()) {
            ...
            AbstractC25304o abstractC25304o2 = this.A06;
            String[] strArr3 = A19;
            if (strArr3[3].length() != strArr3[0].length()) {
                A19[5] = "sfYwg45p3roym5legx720iFNlg07mmUN";
                return abstractC25304o2.A1i(this.A0s);
            }
        }
        throw new RuntimeException();
    }
    ...
    public final int computeVerticalScrollOffset() {
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null && abstractC25304o.A21()) {
    ...
    public final int computeVerticalScrollRange() {
        ...
        return abstractC25304o2.A1k(this.A0s);
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.draw(android.graphics.Canvas):void");
    }
    ...
    */
    public final android.view.View focusSearch(android.view.View r9, int r10) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null) {
            return abstractC25304o.A0v(getContext(), attributeSet);
        }
        throw new IllegalStateException(A0I(1475, 33, 17) + A1H());
    }
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null) {
            C25314p A0w = abstractC25304o.A0w(layoutParams);
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
    ...
    public AbstractC25184c getAdapter() {
        return this.A04;
    }
    ...
    public C4387Zb getCompatAccessibilityDelegate() {
        return this.A09;
    }

    public AbstractC25264k getItemAnimator() {
        return this.A05;
    }

    public AbstractC25304o getLayoutManager() {
        return this.A06;
    }
    ...
    public AbstractC25334r getOnFlingListener() {
        return this.A0g;
    }
    ...
    public C25374v getRecycledViewPool() {
        return this.A0r.A0H();
    }
    ...
    private C24313B getScrollingChildHelper() {
        if (this.A0d == null) {
            this.A0d = new C24313B(this);
        }
        return this.A0d;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null) {
            abstractC25304o.A1N(this);
        }
        this.A0K = false;
        if (A1E) {
            RunnableC25064P runnableC25064P = RunnableC25064P.A07.get();
            this.A03 = runnableC25064P;
            if (runnableC25064P == null) {
                this.A03 = new RunnableC25064P();
                Display A04 = AbstractC24493T.A04(this);
                float f10 = 60.0f;
                ...
                RunnableC25064P.A07.set(this.A03);
            }
            this.A03.A09(this);
        }
    }
    ...
    public final void onDetachedFromWindow() {
        RunnableC25064P runnableC25064P;
        ...
        AbstractC25304o abstractC25304o = this.A06;
        if (abstractC25304o != null) {
            abstractC25304o.A1Q(this, this.A0r);
        }
        this.A0w.clear();
        removeCallbacks(this.A0k);
        this.A0t.A07();
        if (A1E && (runnableC25064P = this.A03) != null) {
            runnableC25064P.A0A(this);
            this.A03 = null;
        }
    }
    ...
    */
    public final boolean onGenericMotionEvent(android.view.MotionEvent r7) {
        ...
        Lb0:
            ...
            goto L57
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.onGenericMotionEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    public final boolean onInterceptTouchEvent(android.view.MotionEvent r11) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        AbstractC24112q.A01(A0I(1330, 11, 86));
        A0Y();
        AbstractC24112q.A00();
        this.A0D = true;
    }
    ...
    */
    public void onMeasure(int r7, int r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.onMeasure(int, int):void");
    }
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        if (state != null) {
            ...
            AbstractC25304o abstractC25304o = this.A06;
            if (abstractC25304o != null) {
                recyclerView$SavedState.A00 = abstractC25304o.A1l();
            } else {
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r21) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C3100Eb.onTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.ViewGroup
    public final void removeDetachedView(View view, boolean z10) {
        AbstractC254856 A0F = A0F(view);
        if (A0F != null) {
            if (A0F.A0c()) {
                A0F.A0P();
            } else if (!A0F.A0f()) {
    ...
    public void setAccessibilityDelegateCompat(C4387Zb c4387Zb) {
        this.A09 = c4387Zb;
        AbstractC24493T.A0B(this, c4387Zb);
    }

    public void setAdapter(AbstractC25184c abstractC25184c) {
        setLayoutFrozen(false);
        A0q(abstractC25184c, false, true);
        requestLayout();
    }

    public void setChildDrawingOrderCallback(InterfaceC25214f interfaceC25214f) {
        if (interfaceC25214f == null) {
            return;
        }
        this.A0e = interfaceC25214f;
        setChildrenDrawingOrderEnabled(interfaceC25214f != null);
    }
    ...
    public void setItemAnimator(AbstractC25264k abstractC25264k) {
        AbstractC25264k abstractC25264k2 = this.A05;
        if (abstractC25264k2 != null) {
            abstractC25264k2.A0I();
            this.A05.A0B(null);
        }
        this.A05 = abstractC25264k;
        if (abstractC25264k != null) {
            InterfaceC25244i interfaceC25244i = this.A0f;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            strArr[0] = "AtGY6u7EZb";
            abstractC25264k.A0B(interfaceC25244i);
        }
    }
    ...
    public void setLayoutManager(AbstractC25304o abstractC25304o) {
        ...
        this.A01.A0B();
        this.A06 = abstractC25304o;
        if (abstractC25304o != null) {
            C3100Eb c3100Eb = abstractC25304o.A03;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            if (c3100Eb == null) {
                ...
                throw new IllegalArgumentException(A0I(1109, 14, 88) + abstractC25304o + A0I(59, 39, 9) + abstractC25304o.A03.A1H());
            }
        }
        this.A0r.A0O();
        requestLayout();
    ...
    public void setOnFlingListener(AbstractC25334r abstractC25334r) {
        this.A0g = abstractC25334r;
    }

    @Deprecated
    public void setOnScrollListener(AbstractC25354t abstractC25354t) {
        this.A0i = abstractC25354t;
    }
    ...
    public void setRecycledViewPool(C25374v c25374v) {
        this.A0r.A0V(c25374v);
    }

    public void setRecyclerListener(InterfaceC25394x interfaceC25394x) {
        this.A07 = interfaceC25394x;
    }
    ...
    public void setViewCacheExtension(AbstractC254654 abstractC254654) {
        this.A0r.A0W(abstractC254654);
    }
    ...
    @Override // android.view.View, com.facebook.ads.redexgen.uinode.InterfaceC24303A
