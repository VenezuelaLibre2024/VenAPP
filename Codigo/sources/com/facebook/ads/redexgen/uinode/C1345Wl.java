...
public final class C1345Wl implements C1 {
    public long A00;
    public long A01;
    ...
    public C1345Wl(int i10, int i11, int i12, int i13, int i14, int i15) {
        this.A06 = i10;
        this.A07 = i11;
        this.A02 = i12;
        this.A04 = i13;
    ...
    public final C0 A7t(long j10) {
        ...
        long A0E = IF.A0E(j11 * positionOffset2, 0L, this.A00 - i10);
        long j12 = this.A01 + A0E;
        long A05 = A05(j12);
        C2 seekPoint = new C2(A05, j12);
        if (A05 < j10) {
            long j13 = this.A00;
            int i11 = this.A04;
            if (A0E != j13 - i11) {
