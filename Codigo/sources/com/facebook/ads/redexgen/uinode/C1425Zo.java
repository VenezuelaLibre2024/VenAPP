...
public class C1425Zo extends AbstractC06654o implements AnonymousClass50 {
    ...
    public C1425Zo(Context context) {
        this(context, 1, false);
    }

    public C1425Zo(Context context, int i10, boolean z10) {
        this.A0A = false;
        this.A05 = false;
        this.A0C = false;
        this.A0B = true;
    ...
    private final int A04(int i10, C06724w c06724w, AnonymousClass53 anonymousClass53) {
        if (A0W() == 0 || i10 == 0) {
            return 0;
        }
        this.A07.A0B = true;
        ...
        int layoutDirection = A08(c06724w, this.A07, anonymousClass53, false);
    ...
    private int A05(int i10, C06724w c06724w, AnonymousClass53 anonymousClass53, boolean z10) {
        int gap = this.A04.A07() - i10;
        if (gap > 0) {
            int i11 = -A04(-gap, c06724w, anonymousClass53);
            int i12 = i10 + i11;
            if (z10) {
    ...
    private int A06(int i10, C06724w c06724w, AnonymousClass53 anonymousClass53, boolean z10) {
        int A0A;
    ...
    */
    private final int A08(com.facebook.ads.redexgen.uinode.C06724w r10, com.facebook.ads.redexgen.uinode.C4T r11, com.facebook.ads.redexgen.uinode.AnonymousClass53 r12, boolean r13) {
        /*
            r9 = this;
            int r6 = r11.A00
            int r0 = r11.A07
        ...
        L5b:
            ...
            int r8 = r11.A07
            int r7 = r11.A00
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C1425Zo.A0G
            r0 = 0
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 7
            if (r1 == r0) goto La1
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C1425Zo.A0G
        ...
        La1:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1425Zo.A08(com.facebook.ads.redexgen.X.4w, com.facebook.ads.redexgen.X.4T, com.facebook.ads.redexgen.X.53, boolean):int");
    }
    ...
    private View A0K(C06724w c06724w, AnonymousClass53 anonymousClass53) {
        return A28(c06724w, anonymousClass53, 0, A0W(), anonymousClass53.A03());
    }

    private View A0L(C06724w c06724w, AnonymousClass53 anonymousClass53) {
        return A28(c06724w, anonymousClass53, A0W() - 1, -1, anonymousClass53.A03());
    }

    private View A0M(C06724w c06724w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0D() : A0E();
    }

    private View A0N(C06724w c06724w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0E() : A0D();
    }

    private View A0O(C06724w c06724w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0K(c06724w, anonymousClass53) : A0L(c06724w, anonymousClass53);
    }

    private View A0P(C06724w c06724w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0L(c06724w, anonymousClass53) : A0K(c06724w, anonymousClass53);
    }
    ...
    private void A0b(C06724w c06724w, int i10) {
        int A0W = A0W();
        if (i10 < 0) {
            return;
        }
        ...
        for (int i12 = A0W - 1; i12 >= 0; i12--) {
            ...
            A0d(c06724w, childCount5, i12);
            return;
        }
    }

    private void A0c(C06724w c06724w, int i10) {
        if (i10 < 0) {
            return;
        }
        String[] strArr = A0G;
    ...
    private void A0d(C06724w c06724w, int i10, int i11) {
        if (i10 == i11) {
            return;
        }
        if (i11 > i10) {
    ...
    private void A0e(C06724w c06724w, C4T c4t) {
        if (!c4t.A0B || c4t.A09) {
            return;
        }
        int i10 = c4t.A05;
    ...
    private void A0f(C06724w c06724w, AnonymousClass53 anonymousClass53, int scrapExtraEnd, int scrapExtraEnd2) {
        if (!anonymousClass53.A08() || A0W() == 0 || anonymousClass53.A07() || !A22()) {
            return;
        }
        int i10 = 0;
        int scrapExtraStart = 0;
        List<AnonymousClass56> A0J = c06724w.A0J();
        int i11 = A0J.size();
        int A0p = A0p(A0t(0));
        ...
        if (i10 > 0) {
            ...
            this.A07.A00 = 0;
            this.A07.A04();
            A08(c06724w, this.A07, anonymousClass53, false);
        }
    ...
    private void A0g(C06724w c06724w, AnonymousClass53 anonymousClass53, C4R c4r) {
        if (A0k(anonymousClass53, c4r)) {
            return;
        }
        boolean A0j = A0j(c06724w, anonymousClass53, c4r);
        String[] strArr = A0G;
        if (strArr[2].charAt(4) == strArr[4].charAt(4)) {
            throw new RuntimeException();
        }
    ...
    private boolean A0j(C06724w c06724w, AnonymousClass53 anonymousClass53, C4R c4r) {
        View A0P;
        int A0A;
        if (A0W() == 0) {
            return false;
        ...
        if (c4r.A02) {
            A0P = A0O(c06724w, anonymousClass53);
        } else {
            A0P = A0P(c06724w, anonymousClass53);
        }
        if (A0P == null) {
            return false;
        }
    ...
    public int A1d(int i10, C06724w c06724w, AnonymousClass53 anonymousClass53) {
        if (this.A00 == 1) {
            return 0;
        }
        return A04(i10, c06724w, anonymousClass53);
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC06654o
    public int A1e(int i10, C06724w c06724w, AnonymousClass53 anonymousClass53) {
        if (this.A00 == 0) {
            return 0;
        }
        int A04 = A04(i10, c06724w, anonymousClass53);
        String[] strArr = A0G;
        if (strArr[6].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC06654o
    public View A1n(View view, int i10, C06724w c06724w, AnonymousClass53 anonymousClass53) {
        int A27;
        View A0M;
        View nextCandidate;
        A0U();
        ...
        this.A07.A07 = Integer.MIN_VALUE;
        this.A07.A0B = false;
        A08(c06724w, this.A07, anonymousClass53, true);
        if (A27 == -1) {
            A0M = A0N(c06724w, anonymousClass53);
        } else {
            A0M = A0M(c06724w, anonymousClass53);
        }
        if (A27 == -1) {
            nextCandidate = A0G();
        } else {
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC06654o
    public final void A1q(int i10, int i11, AnonymousClass53 anonymousClass53, InterfaceC06634m interfaceC06634m) {
        if (this.A00 != 0) {
            i10 = i11;
        }
        int delta = A0W();
        ...
        A2E(anonymousClass53, this.A07, interfaceC06634m);
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC06654o
    public final void A1r(int i10, InterfaceC06634m interfaceC06634m) {
        boolean z10;
        int direction;
        LinearLayoutManager$SavedState linearLayoutManager$SavedState = this.A03;
        if (linearLayoutManager$SavedState != null && linearLayoutManager$SavedState.A01()) {
        ...
        for (int i13 = 0; i13 < this.A06 && direction >= 0 && direction < i10; i13++) {
            interfaceC06634m.A3S(direction, 0);
            direction += i12;
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00ac, code lost:
        ...
        if (r9.A02 == Integer.MIN_VALUE) goto L138;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x00b6, code lost:
        ...
        if (r9.A05 == false) goto L175;
     */
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00b8, code lost:
    
        r3 = r9.A04.A07() - r9.A04.A0C(r1);
        r2 = com.facebook.ads.redexgen.uinode.C1425Zo.A0G;
     */
    /* JADX WARN: Code restructure failed: missing block: B:33:0x00d6, code lost:
    
        if (r2[2].charAt(4) == r2[4].charAt(4)) goto L174;
     */
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00d8, code lost:
    
        com.facebook.ads.redexgen.uinode.C1425Zo.A0G[5] = "r3FnQil1r32czyLALUutLd0XCkxYZ4G";
        r3 = r3 - r9.A02;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void A1u(com.facebook.ads.redexgen.uinode.C06724w r10, com.facebook.ads.redexgen.uinode.AnonymousClass53 r11) {
        /*
            Method dump skipped, instructions count: 621
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1425Zo.A1u(com.facebook.ads.redexgen.X.4w, com.facebook.ads.redexgen.X.53):void");
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC06654o
    public final void A1w(C0882Eb c0882Eb, C06724w c06724w) {
        super.A1w(c0882Eb, c06724w);
        if (this.A09) {
            A1I(c06724w);
            c06724w.A0P();
        }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC06654o
    public void A1x(C0882Eb c0882Eb, AnonymousClass53 anonymousClass53, int i10) {
        C1424Zn linearSmoothScroller = new C1424Zn(c0882Eb.getContext());
    ...
    */
    public final int A27(int r8) {
        ...
        L75:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1425Zo.A27(int):int");
    }

    public View A28(C06724w c06724w, AnonymousClass53 anonymousClass53, int i10, int i11, int i12) {
        A29();
        View view = null;
        View view2 = null;
        ...
        while (i10 != i11) {
            ...
            if (A0p >= 0 && A0p < i12) {
                if (((C06664p) outOfBoundsMatch.getLayoutParams()).A02()) {
                    if (view == null) {
    ...
    public void A2C(C06724w c06724w, AnonymousClass53 anonymousClass53, C4R c4r, int i10) {
    }

    public void A2D(C06724w c06724w, AnonymousClass53 anonymousClass53, C4T c4t, C4S c4s) {
        int A0g;
        int right;
        int i10;
        int i11;
        View A03 = c4t.A03(c06724w);
        if (A03 == null) {
            c4s.A01 = true;
            return;
        }
        C06664p c06664p = (C06664p) A03.getLayoutParams();
        if (c4t.A08 == null) {
        ...
        if (c06664p.A02() || c06664p.A01()) {
            c4s.A03 = true;
        }
        c4s.A02 = A03.hasFocusable();
    }

    public void A2E(AnonymousClass53 anonymousClass53, C4T c4t, InterfaceC06634m interfaceC06634m) {
        int i10 = c4t.A01;
        if (i10 >= 0) {
            int pos = anonymousClass53.A03();
            if (i10 < pos) {
                int pos2 = c4t.A07;
                interfaceC06634m.A3S(i10, Math.max(0, pos2));
            }
        }
    }
