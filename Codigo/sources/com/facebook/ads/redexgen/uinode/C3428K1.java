...
public final class C3428K1 {
    ...
    public C3428K1(C26937f c26937f, String str, C3512LQ c3512lq, EnumC3407Jg enumC3407Jg, int i10, C3412Jl c3412Jl, String str2, String str3, String str4, InterfaceC27488Z interfaceC27488Z) {
        this.A01 = c26937f;
        this.A06 = str;
        this.A03 = c3512lq;
        this.A02 = enumC3407Jg;
        this.A00 = i10;
        this.A0B = c3412Jl;
        this.A0A = enumC3407Jg.A04();
        this.A07 = str2;
        this.A05 = str3;
        this.A04 = str4;
    ...
    private long A00() {
        SharedPreferences A00 = AbstractC3440KE.A00(this.A01);
        ...
        if (string.equals(locale)) {
            return AbstractC23882T.A00(this.A01.A01()).A09();
        }
    ...
    public final InterfaceC27488Z A05() {
        return this.A09;
    }

    public final EnumC3407Jg A06() {
        return this.A02;
    }

    public final C3512LQ A07() {
        return this.A03;
    }
    ...
    public final Map<String, String> A09(Map<String, String> map) {
        ...
        A03(hashMap, A01(125, 4, 91), AbstractC26186E.A00().A03());
        ...
        C3512LQ c3512lq = this.A03;
        if (c3512lq != null) {
            A03(hashMap, A01(276, 5, 52), String.valueOf(c3512lq.A01()));
            A03(hashMap, A01(119, 6, 81), String.valueOf(this.A03.A00()));
        }
        EnumC3407Jg enumC3407Jg = this.A02;
        if (enumC3407Jg != null) {
            A03(hashMap, A01(RecognitionOptions.QR_CODE, 11, 36), String.valueOf(enumC3407Jg.A03()));
        }
        InterfaceC27488Z interfaceC27488Z = this.A09;
        ...
        if (idfaFlag2.charAt(22) == strArr[3].charAt(22)) {
            ...
            if (interfaceC27488Z.isTestMode(c26937f)) {
            ...
            A03(hashMap, A01(160, 13, 80), String.valueOf(C3537Lp.A02(this.A01)));
            A03(hashMap, A01(233, 12, 126), C3527Lf.A05(System.currentTimeMillis()));
            ...
            A03(hashMap, A01(20, 36, 122), C3527Lf.A06(A00()));
