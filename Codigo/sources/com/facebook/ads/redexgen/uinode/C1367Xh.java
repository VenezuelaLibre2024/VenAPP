...
public final class C1367Xh implements InterfaceC0837Bs {
    ...
    public static final InterfaceC0840Bv A09;
    ...
    private int A00(int i10) throws C07889v {
        String A03;
        if (!A07(i10)) {
            ...
            throw new C07889v(append.append(A03).append(A03(0, 12, 31)).append(i10).toString());
        }
        if (this.A05) {
            return A0E[i10];
        }
    ...
    private int A01(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        interfaceC0838Bt.AFM();
        interfaceC0838Bt.ADv(this.A06, 0, 1);
        byte b10 = this.A06[0];
        if ((b10 & 131) <= 0) {
            return A00((b10 >> 3) & 15);
        }
        throw new C07889v(A03(65, 38, 115) + ((int) b10));
    }

    private int A02(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        if (this.A00 == 0) {
            try {
                int A01 = A01(interfaceC0838Bt);
                this.A01 = A01;
                this.A00 = A01;
        ...
        int AFQ = this.A03.AFQ(interfaceC0838Bt, this.A00, true);
        if (AFQ == -1) {
            return -1;
        }
    ...
    private boolean A09(InterfaceC0838Bt interfaceC0838Bt) throws IOException, InterruptedException {
        byte[] bArr = A0B;
        if (A0A(interfaceC0838Bt, bArr)) {
            this.A05 = false;
            interfaceC0838Bt.AGP(bArr.length);
            return true;
        }
        byte[] bArr2 = A0C;
        if (!A0A(interfaceC0838Bt, bArr2)) {
            return false;
        }
        this.A05 = true;
        interfaceC0838Bt.AGP(bArr2.length);
        return true;
    }

    private boolean A0A(InterfaceC0838Bt interfaceC0838Bt, byte[] bArr) throws IOException, InterruptedException {
        interfaceC0838Bt.AFM();
        byte[] bArr2 = new byte[bArr.length];
        interfaceC0838Bt.ADv(bArr2, 0, bArr.length);
    ...
    public final int AEH(InterfaceC0838Bt interfaceC0838Bt, C0842Bz c0842Bz) throws IOException, InterruptedException {
        if (interfaceC0838Bt.A7i() != 0 || A09(interfaceC0838Bt)) {
            A04();
            return A02(interfaceC0838Bt);
        }
        throw new C07889v(A03(27, 26, 99));
    }
