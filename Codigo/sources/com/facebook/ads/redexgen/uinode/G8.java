...
public final class G8 {
    ...
    public int A05;
    public boolean A06;
    public final C0980Hz A07 = new C0980Hz();
    public final int[] A08 = new int[RecognitionOptions.QR_CODE];

    /* JADX INFO: Access modifiers changed from: private */
    public void A03(C0980Hz c0980Hz, int i10) {
        int totalLength;
        if (i10 < 4) {
            return;
        }
        c0980Hz.A0Z(3);
        int i11 = i10 - 4;
        if (((c0980Hz.A0E() & RecognitionOptions.ITF) != 0 ? 1 : 0) != 0) {
            String[] strArr = A09;
            if (strArr[4].charAt(22) == strArr[7].charAt(22)) {
                String[] strArr2 = A09;
                strArr2[2] = "m4TsyqBzkyxUuct48";
                strArr2[5] = "zfIYrv7wq9TBAE9Jz";
                if (i11 < 7 || (totalLength = c0980Hz.A0G()) < 4) {
                    return;
                }
                this.A01 = c0980Hz.A0I();
                this.A00 = c0980Hz.A0I();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A04(C0980Hz c0980Hz, int i10) {
        if (i10 < 19) {
            return;
        }
        this.A05 = c0980Hz.A0I();
        this.A04 = c0980Hz.A0I();
        c0980Hz.A0Z(11);
        this.A02 = c0980Hz.A0I();
        this.A03 = c0980Hz.A0I();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A05(C0980Hz c0980Hz, int i10) {
        if (i10 % 5 != 2) {
            return;
        }
        c0980Hz.A0Z(2);
        ...
        for (int index = 0; index < i11; index++) {
            ...
            int entryCount2 = c0980Hz.A0E() << 24;
            this.A08[A0E] = entryCount2 | (IF.A06(i12, 0, 255) << 16) | (IF.A06(g10, 0, 255) << 8) | IF.A06((int) (a10 + ((A0E3 - 128) * 1.772d)), 0, 255);
        }
        this.A06 = true;
    }

    public final C0918Fn A06() {
        int A0E;
        ...
        float f12 = this.A03;
        int i10 = this.A04;
        return new C0918Fn(createBitmap, f11, 0, f12 / i10, 0, this.A01 / argbBitmapDataIndex3, this.A00 / i10);
    }
