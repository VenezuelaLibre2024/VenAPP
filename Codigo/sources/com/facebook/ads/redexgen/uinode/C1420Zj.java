...
public class C1420Zj implements C4B {
    ...
    public C1420Zj(C0882Eb c0882Eb) {
        this.A00 = c0882Eb;
    }
    ...
    public final void A57(int i10) {
        ...
        View view = A6M(i10);
        if (view != null && (A0F = C0882Eb.A0F(view)) != null) {
            if (!A0F.A0c() || A0F.A0f()) {
