...
public abstract class AbstractViewOnTouchListenerC24453P extends C3100Eb implements View.OnTouchListener {
    ...
    public AbstractViewOnTouchListenerC24453P(C4337Yn c4337Yn) {
        super(c4337Yn);
        this.A05 = 0;
        this.A00 = 0;
        this.A03 = true;
    ...
    public AbstractViewOnTouchListenerC24453P(C4337Yn c4337Yn, AttributeSet attributeSet) {
    ...
    public AbstractViewOnTouchListenerC24453P(C4337Yn c4337Yn, AttributeSet attributeSet, int i10) {
    ...
    public void setLayoutManager(AbstractC25304o abstractC25304o) {
        if (abstractC25304o instanceof C4399Zo) {
            super.setLayoutManager(abstractC25304o);
            this.A01 = (C4399Zo) abstractC25304o;
            return;
        }
        throw new IllegalArgumentException(A09(0, 50, 58));
    }

    public void setSnapDelegate(InterfaceC3782Pm interfaceC3782Pm) {
        this.A02 = interfaceC3782Pm;
    }
}
