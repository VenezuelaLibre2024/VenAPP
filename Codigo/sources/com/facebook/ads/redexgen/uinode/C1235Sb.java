...
public class C1235Sb extends AbstractC06704t {
    ...
    public InterfaceC1145Op A02;
    public RE A04;
    public List<C1171Pp> A05;
    public boolean A09;
    public final int A0A;
    public final Context A0B;
    public final C1425Zo A0C;
    ...
    public final InterfaceC1149Ot A0F = new C1238Se(this);
    public InterfaceC1147Or A03 = new C1237Sd(this);
    public final InterfaceC1148Os A0E = new C1236Sc(this);
    ...
    public C1235Sb(C06433r c06433r, int i10, List<C1171Pp> list, RE re2, Bundle bundle) {
        this.A0C = c06433r.getLayoutManager();
        this.A0A = i10;
        this.A05 = list;
        this.A04 = re2;
        this.A0D = new C1424Zn(c06433r.getContext());
        this.A0B = c06433r.getContext();
        c06433r.A1f(this);
        A0D(bundle);
    }
    ...
    public static boolean A0I(OL ol2, int i10) {
        int allowedAreaMaxX;
        int furthestX;
        if (i10 != 2) {
        ...
        return ((int) (x10 + ((float) allowedAreaMinX2))) <= allowedAreaMaxX && ol2.getX() >= ((float) furthestX);
    }
    ...
    public void A0L(C0882Eb c0882Eb, int i10) {
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC06704t
    public void A0M(C0882Eb c0882Eb, int i10, int i11) {
        super.A0M(c0882Eb, i10, i11);
        this.A09 = false;
        if (this.A06) {
            this.A09 = true;
            A06();
    ...
    public final InterfaceC1147Or A0N() {
        return this.A03;
    }

    public final InterfaceC1148Os A0O() {
        return this.A0E;
    }

    public final InterfaceC1149Ot A0P() {
        return this.A0F;
    }
    ...
    public final void A0Y(InterfaceC1145Op interfaceC1145Op) {
        this.A02 = interfaceC1145Op;
    }
