...
public final class C3000Ck {
    ...
    public final C3306Hz A0A = new C3306Hz(255);
    ...
    static {
        A01();
        A0C = AbstractC3322IF.A08(A00(0, 4, 33));
    }
    ...
    public final boolean A03(InterfaceC2951Bt interfaceC2951Bt, boolean z10) throws IOException, InterruptedException {
        this.A0A.A0V();
        A02();
        boolean hasEnoughBytes = interfaceC2951Bt.A7I() == -1 || interfaceC2951Bt.A7I() - interfaceC2951Bt.A7d() >= 27;
        if (hasEnoughBytes) {
            boolean hasEnoughBytes2 = interfaceC2951Bt.ADw(this.A0A.A00, 0, 27, true);
            if (hasEnoughBytes2) {
                if (this.A0A.A0M() != A0C) {
                    if (z10) {
                        return false;
                    }
                    throw new C28319v(A00(4, 46, 60));
                }
                ...
                if (A0E != 0) {
                    ...
                    throw new C28319v(A00(50, 31, 66));
                }
                ...
                this.A01 = A0E2 + 27;
                this.A0A.A0V();
                interfaceC2951Bt.ADv(this.A0A.A00, 0, this.A02);
