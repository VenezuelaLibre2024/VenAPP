...
import com.facebook.ads.redexgen.uinode.C22850o;
...
public final class C22850o {
    ...
    public C22850o(InterfaceC3369J2 interfaceC3369J2, final Activity activity, int i10) {
    ...
    public static C22850o A00(InterfaceC3369J2 interfaceC3369J2, Activity activity) {
        return A01(interfaceC3369J2, activity, Build.VERSION.SDK_INT);
    }

    public static C22850o A01(InterfaceC3369J2 interfaceC3369J2, Activity activity, int i10) {
        if (activity != null && i10 >= 14) {
            return new C22850o(interfaceC3369J2, activity, i10);
        }
        return null;
    }

    private void A04(String str, long j10, long j11, EnumC22780g enumC22780g) {
        HashMap hashMap = new HashMap();
        hashMap.put(A02(9, 10, 8), Long.toString(j10));
        hashMap.put(A02(0, 9, 34), Long.toString(j11));
        if (enumC22780g != null) {
            hashMap.put(A02(19, 7, 9), enumC22780g.name());
        }
    ...
    public final void A06(EnumC22780g enumC22780g) {
        this.A02 = enumC22780g;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC22780g enumC22780g = EnumC22780g.A04;
        if (A07[2].charAt(6) == '9') {
