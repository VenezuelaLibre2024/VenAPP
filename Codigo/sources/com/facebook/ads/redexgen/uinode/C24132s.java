...
public final class C24132s<E> implements Cloneable {
    ...
    private final E A02(long j10, E e10) {
        E e11;
        int A03 = AbstractC24122r.A03(this.A02, this.A00, j10);
    ...
    public final void A0B(long j10, E e10) {
        ...
        if (this.A01 && i11 >= this.A02.length) {
            A04();
            i10 = AbstractC24122r.A03(this.A02, this.A00, j10) ^ (-1);
        }
        int i12 = this.A00;
        if (i12 >= this.A02.length) {
            int A00 = AbstractC24122r.A00(i12 + 1);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2s != com.facebook.ads.internal.androidx.support.v4.util.LongSparseArray<E> */
    public C24132s(int i10) {
        this.A01 = false;
        if (i10 == 0) {
            this.A02 = AbstractC24122r.A01;
            this.A03 = AbstractC24122r.A02;
        } else {
            int A00 = AbstractC24122r.A00(i10);
    ...
    public final C24132s<E> clone() {
        C24132s<E> c24132s = null;
        try {
            c24132s = (C24132s) super.clone();
            c24132s.A02 = (long[]) this.A02.clone();
            c24132s.A03 = (Object[]) this.A03.clone();
            return c24132s;
