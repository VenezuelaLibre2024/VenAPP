...
public final class C5V implements AudienceNetworkActivityApi, Repairable {
    ...
    public C5V(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        C1399Yn A02 = C06785c.A02(audienceNetworkActivity);
        this.A0N = A02;
        A02.A0L(this);
    }
    ...
    private void A08() {
        String str = this.A0E;
        if (str != null) {
            C1179Px A01 = AbstractC1178Pw.A01(this.A0N, str);
            this.A0B = A01;
            if (A01 != null) {
    ...
    private void A0A() {
        boolean z10 = !this.A0J || C0988Ih.A1a(this.A0N);
    ...
    private void A0C(Intent intent) {
        if (C0988Ih.A11(this.A0L)) {
            ...
            if (kb2 != kb3 && Build.VERSION.SDK_INT >= 18) {
                ...
                AbstractC1066Lo.A0M(textView, Color.argb(160, 0, 0, 0));
    ...
    private void A0D(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            Bundle A02 = C1037Kj.A02(bundle, DynamicLoaderImpl.class.getClassLoader());
    ...
    */
    ...
    public void A0H(String str, C05741a c05741a) {
        if (this.A08 == null) {
            return;
        }
        if (this.A09 == null) {
            C1399Yn c1399Yn = this.A0N;
            this.A09 = AbstractC1093Mp.A02(c1399Yn, c1399Yn.A09(), str, c05741a, this.A08, new ZW(this, null));
            this.A09.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        }
        AbstractC1066Lo.A0J(this.A09);
        AbstractC1066Lo.A0T(this.A06);
    ...
    public final void A0P(String str, C07598q c07598q) {
        Intent intent = new Intent(str + A06(0, 1, 84) + this.A0C);
        if (c07598q != null) {
            intent.putExtra(A06(402, 5, 105), c07598q);
        }
        C06142o.A00(this.A0L).A07(intent);
    }
    ...
    public final void finish(int i10) {
        ...
        if (C0988Ih.A1U(this.A0N) && !this.A0H && !this.A0G) {
            this.A0N.A0E().AAX();
            A0L();
        }
        if (A0I() && !this.A0F) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        Intent intent = C1037Kj.A01(this.A0L.getIntent(), DynamicLoaderImpl.class.getClassLoader());
        this.A05 = intent;
        C1399Yn A03 = C1037Kj.A03(intent);
        if (A03 != null) {
            C1399Yn startAdContext = this.A0N;
            startAdContext.A0J(A03.A0E());
            C1399Yn startAdContext2 = this.A0N;
            startAdContext2.A0C(A03.A0B());
            C1399Yn startAdContext3 = this.A0N;
        ...
        if (C0988Ih.A2N(this.A0N) && this.A07 == KB.A03 && z10) {
        ...
        AbstractC1066Lo.A0M(relativeLayout, 0);
        ...
        if (C0988Ih.A1x(this.A0L) && this.A0L.getWindow() != null) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x006c, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.C0988Ih.A11(r4.A0L) == false) goto L49;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0080, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.C5V.A0Q[2].length() == 25) goto L55;
     */
    ...
    */
    public final void onDestroy() {
        ...
        L66:
            ...
            boolean r0 = com.facebook.ads.redexgen.uinode.C0988Ih.A11(r0)
            if (r0 == 0) goto L73
