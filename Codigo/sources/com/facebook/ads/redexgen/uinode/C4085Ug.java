...
public class C4085Ug implements InterfaceC3516LU {
    ...
    public C4085Ug(InterfaceC3516LU interfaceC3516LU) {
        this.A02 = interfaceC3516LU;
    }
    ...
    public final void AE8(String str) {
        boolean A0A;
        String A042;
        A0A = AbstractC3518LW.A0A(str);
        if (!A0A) {
            A042 = AbstractC3518LW.A04(str);
