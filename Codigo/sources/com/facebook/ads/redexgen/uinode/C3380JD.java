...
public final class C3380JD {
     ...
     */
    public static void A06(C26937f c26937f, InterfaceC3878RK interfaceC3878RK, Map<String, ?> map) throws JSONException {
        ...
        A09(c26937f, hashMap2);
        C27518c A08 = c26937f.A08();
        JSONObject A05 = C27268C.A05(new C27288E(A08.A01(), A08.A02(), hashMap2));
        ...
        c3892ry.put(A01(171, 7, 16), jSONObject2.toString());
        interfaceC3878RK.AE0(c26937f.A04().A73(), c3892ry.A08(), new C4128VN(c26937f));
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 2 out of bounds for length 2
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static void A09(C26937f c26937f, Map<String, String> map) {
        map.putAll(c26937f.A03().A4n());
    }

    static {
        A04();
        A02 = C3380JD.class.getSimpleName();
    ...
    public static void A05(C26937f c26937f) {
        if (A0B(c26937f)) {
            return;
        }
        synchronized (C3380JD.class) {
            ...
            atomicInteger.set(1);
            ExecutorC3541Lt.A06.execute(new C4129VO(c26937f));
        }
    }

    public static void A08(C26937f c26937f, String str) {
        int i10;
        int i11;
        if (A0B(c26937f)) {
            return;
        ...
        synchronized (C3380JD.class) {
            if (A04.get() != 2) {
                ...
                SharedPreferences sharedPreferences = c26937f.getApplicationContext().getSharedPreferences(ProcessUtils.getProcessSpecificName(A01(116, 31, 104), c26937f), 0);
    ...
    public static boolean A0B(C26937f c26937f) {
        ...
        if (!AbstractC3350Ij.A0U(c26937f)) {
            return true;
        }
        return A0A(c26937f.A08().A00(), AbstractC3350Ij.A0C(c26937f));
    }
}
