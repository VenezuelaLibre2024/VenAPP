...
public final class HE implements InterfaceC1584cc {
    ...
    public final InterfaceC1586ce A02;
    ...
    private final void A02(List<Rect> list) {
        ...
        list2.add(rect);
        Iterator<InterfaceC1225Rr> it = this.A02.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public HE(View view, InterfaceC1586ce interfaceC1586ce) {
        this.A03 = new WeakReference<>(view);
        this.A02 = interfaceC1586ce;
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC1584cc
