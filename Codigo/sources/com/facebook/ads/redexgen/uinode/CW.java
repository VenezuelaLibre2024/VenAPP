...
public abstract class CW {
    ...
    public static ApicFrame A01(C0980Hz c0980Hz) {
        String A092;
        int A082 = c0980Hz.A08();
    ...
    public static CommentFrame A02(int i10, C0980Hz c0980Hz) {
        int A082 = c0980Hz.A08();
        ...
        if (atomType == atomSize) {
            c0980Hz.A0Z(8);
            int atomSize2 = A082 - 16;
            String A0R2 = c0980Hz.A0R(atomSize2);
    ...
    public static Id3Frame A03(int i10, String str, C0980Hz c0980Hz, boolean z10, boolean z11) {
        int A002 = A00(c0980Hz);
        if (z11) {
    ...
    public static Id3Frame A04(C0980Hz c0980Hz) {
        int position = c0980Hz.A06();
        int shortType = c0980Hz.A08() + position;
        int typeTopByte = c0980Hz.A08();
        ...
        try {
            if (endPosition == 169 || endPosition == 65533) {
                ...
                if (endPosition2 != position3) {
                    ...
                    int position4 = A04;
                    if (i10 == position4) {
                        return A02(typeTopByte, c0980Hz);
                    }
                    int position5 = A0A;
                    if (i10 != position5) {
                        int position6 = A0B;
                        if (i10 != position6) {
                            ...
                            if (i10 != position7) {
                                ...
                                if (i10 != position8) {
                                    int position9 = A0C;
                                    if (i10 == position9) {
                                        return A07(typeTopByte, A09(1445, 4, 124), c0980Hz);
                                    }
                                    int position10 = A03;
                                    if (i10 == position10) {
                                        return A07(typeTopByte, A09(1457, 4, 98), c0980Hz);
                                    }
                                    int position11 = A07;
                                    if (i10 == position11) {
                                        return A07(typeTopByte, A09(1493, 4, 22), c0980Hz);
                                    }
                                    int position12 = A02;
                                    if (i10 == position12) {
                                        return A07(typeTopByte, A09(1425, 4, 11), c0980Hz);
                                    }
                                    int position13 = A09;
                                    if (i10 == position13) {
                                        return A07(typeTopByte, A09(1592, 4, 49), c0980Hz);
                                    }
                                    int position14 = A08;
                                    if (i10 == position14) {
                                        return A07(typeTopByte, A09(1441, 4, 86), c0980Hz);
                                    }
                                    int position15 = A0J;
                                    if (i10 == position15) {
                                        return A07(typeTopByte, A09(1449, 4, 88), c0980Hz);
                                    }
                                    String str3 = A09(1287, 32, 18) + CJ.A02(typeTopByte);
                                    c0980Hz.A0Y(shortType);
                                    return null;
                                }
                            }
                            return A07(typeTopByte, A09(1437, 4, 16), c0980Hz);
                        }
                    }
                    return A07(typeTopByte, A09(1453, 4, 108), c0980Hz);
                }
                throw new RuntimeException();
            }
            int position16 = A0I;
            ...
            if (typeTopByte == position17) {
                return A06(typeTopByte, A09(1465, 4, 62), c0980Hz);
            }
            int position18 = A0S;
            if (typeTopByte == position18) {
                return A06(typeTopByte, A09(1469, 4, 18), c0980Hz);
            }
            int position19 = A0R;
            if (typeTopByte == position19) {
                return A03(typeTopByte, A09(1429, 4, 122), c0980Hz, true, false);
            }
            int position20 = A0E;
            if (typeTopByte == position20) {
                return A03(typeTopByte, A09(1433, 4, 36), c0980Hz, true, true);
            }
            int position21 = A0F;
            ...
            if (typeTopByte == position22) {
                TextInformationFrame A072 = A07(typeTopByte, A09(1461, 4, 112), c0980Hz);
                c0980Hz.A0Y(shortType);
                String[] strArr3 = A01;
            ...
            if (typeTopByte == position24) {
                return A07(typeTopByte, A09(1489, 4, 114), c0980Hz);
            }
            int position25 = A0M;
            if (typeTopByte == position25) {
                return A07(typeTopByte, A09(1473, 4, 68), c0980Hz);
            }
            int position26 = A0O;
            if (typeTopByte == position26) {
                TextInformationFrame A073 = A07(typeTopByte, A09(1477, 4, 78), c0980Hz);
                c0980Hz.A0Y(shortType);
                String[] strArr5 = A01;
            ...
            if (typeTopByte == position28) {
                return A07(typeTopByte, A09(1485, 4, 77), c0980Hz);
            }
            int position29 = A0P;
            if (typeTopByte == position29) {
                return A07(typeTopByte, A09(1481, 4, 80), c0980Hz);
            }
            int position30 = A0L;
            if (typeTopByte == position30) {
                Id3Frame A032 = A03(typeTopByte, A09(843, 14, 105), c0980Hz, false, false);
                c0980Hz.A0Y(shortType);
                String[] strArr6 = A01;
                ...
                if (typeTopByte == position32) {
                    return A03(typeTopByte, A09(857, 13, 31), c0980Hz, false, true);
                }
                int position33 = A0U;
                if (typeTopByte == position33) {
                    return A07(typeTopByte, A09(1503, 10, 125), c0980Hz);
                }
                int position34 = A0T;
                if (typeTopByte == position34) {
                    return A07(typeTopByte, A09(1497, 6, 33), c0980Hz);
                }
                int position35 = A0K;
                if (typeTopByte == position35) {
                    InternalFrame A052 = A05(c0980Hz, shortType);
                    c0980Hz.A0Y(shortType);
                    String[] strArr8 = A01;
    ...
    public static InternalFrame A05(C0980Hz c0980Hz, int i10) {
        String value = null;
        String str = null;
        int atomSize = -1;
        int i11 = -1;
        while (c0980Hz.A06() < i10) {
            int dataAtomPosition = c0980Hz.A06();
            int atomType = c0980Hz.A08();
            int A082 = c0980Hz.A08();
            c0980Hz.A0Z(4);
            if (A082 == CJ.A0f) {
                value = c0980Hz.A0R(atomType - 12);
            } else if (A082 == CJ.A0p) {
                str = c0980Hz.A0R(atomType - 12);
            } else {
                if (A082 == CJ.A0G) {
                ...
                c0980Hz.A0Z(atomType - 12);
            }
        }
        if (value == null || str == null || atomSize == -1) {
            return null;
        }
        c0980Hz.A0Y(atomSize);
        c0980Hz.A0Z(16);
        String name2 = c0980Hz.A0R(i11 - 16);
        return new InternalFrame(value, str, name2);
    }

    public static TextInformationFrame A06(int i10, String str, C0980Hz c0980Hz) {
        int A082 = c0980Hz.A08();
        int atomType = c0980Hz.A08();
        int atomSize = CJ.A0G;
    ...
    public static TextInformationFrame A07(int i10, String str, C0980Hz c0980Hz) {
        int A082 = c0980Hz.A08();
        int atomType = c0980Hz.A08();
        int atomSize = CJ.A0G;
        if (atomType == atomSize) {
            c0980Hz.A0Z(8);
            int atomSize2 = A082 - 16;
            return new TextInformationFrame(str, null, c0980Hz.A0R(atomSize2));
        }
    ...
    */
    public static com.facebook.ads.internal.exoplayer2.thirdparty.metadata.id3.TextInformationFrame A08(com.facebook.ads.redexgen.uinode.C0980Hz r5) {
        /*
            int r5 = A00(r5)
            r3 = 0
            if (r5 <= 0) goto L3c
