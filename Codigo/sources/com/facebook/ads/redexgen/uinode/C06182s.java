...
public final class C06182s<E> implements Cloneable {
    ...
    private final E A02(long j10, E e10) {
        E e11;
        int A03 = AbstractC06172r.A03(this.A02, this.A00, j10);
        return (A03 < 0 || (e11 = (E) this.A03[A03]) == A05) ? e10 : e11;
    }
    ...
    public final void A0B(long j10, E e10) {
        ...
        if (this.A01 && i11 >= this.A02.length) {
            A04();
            i10 = AbstractC06172r.A03(this.A02, this.A00, j10) ^ (-1);
        }
        int i12 = this.A00;
        if (i12 >= this.A02.length) {
            int A00 = AbstractC06172r.A00(i12 + 1);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2s != com.facebook.ads.internal.androidx.support.v4.util.LongSparseArray<E> */
    public C06182s(int i10) {
        this.A01 = false;
        if (i10 == 0) {
            this.A02 = AbstractC06172r.A01;
            this.A03 = AbstractC06172r.A02;
        } else {
            int A00 = AbstractC06172r.A00(i10);
    ...
    public final C06182s<E> clone() {
        C06182s<E> c06182s = null;
        try {
            c06182s = (C06182s) super.clone();
            c06182s.A02 = (long[]) this.A02.clone();
            c06182s.A03 = (Object[]) this.A03.clone();
            return c06182s;
