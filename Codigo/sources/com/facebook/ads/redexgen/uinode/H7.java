...
public final class H7<T extends H8> extends Handler implements Runnable {
    ...
    public final /* synthetic */ C1327Vq A09;
    ...
    public H7(C1327Vq c1327Vq, Looper looper, T loadable, H6<T> h62, int i10, long j10) {
        super(looper);
        this.A09 = c1327Vq;
        this.A05 = loadable;
        this.A01 = h62;
        ...
        try {
            try {
                try {
                    ...
                    if (!this.A08) {
                        obtainMessage(3, new HC(e12)).sendToTarget();
                    }
                }
