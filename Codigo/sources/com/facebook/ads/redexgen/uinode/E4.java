...
public final class E4 implements XV {
     ...
     */
    public static E4 A01(long j10, long j11, By by, C0980Hz c0980Hz) {
        int A0H;
        int i10 = by.A04;
        int i11 = by.A03;
        int A08 = c0980Hz.A08();
        if ((A08 & 1) != 1 || (A0H = c0980Hz.A0H()) == 0) {
            return null;
        }
        long A0F = IF.A0F(A0H, i10 * 1000000, i11);
        if ((A08 & 6) != 6) {
            return new E4(j11, by.A02, A0F);
        }
        long A0H2 = c0980Hz.A0H();
        long[] jArr = new long[100];
        for (int i12 = 0; i12 < 100; i12++) {
            jArr[i12] = c0980Hz.A0E();
        }
        if (j10 != -1 && j10 != j11 + A0H2) {
            Log.w(A02(27, 10, 25), A02(2, 25, 119) + j10 + A02(0, 2, 77) + (j11 + A0H2));
        }
        return new E4(j11, by.A02, A0F, A0H2, jArr);
    }
    ...
    public final C0 A7t(long j10) {
        ...
        long A0E = IF.A0E(j10, 0L, this.A03);
