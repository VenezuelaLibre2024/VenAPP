...
public final class C1273Tn implements L8 {
    ...
    public C1273Tn(int i10, int i11, int i12, String str, String str2, MB mb2, ViewOnClickListenerC1271Tl viewOnClickListenerC1271Tl) {
        this.A01 = i10;
        this.A00 = i11;
        this.A02 = i12;
        this.A05 = str;
        this.A04 = str2;
        this.A03 = mb2;
        this.A06 = viewOnClickListenerC1271Tl;
    }
        ...
        if (!this.A09 && (mb2 = this.A03) != null) {
            if (this.A01 == 1) {
                if (!this.A0A) {
                    ...
                    this.A03.setProgressClickListener(new ViewOnClickListenerC1119Np(this));
                    this.A03.A05();
                    this.A03.setToolbarListener(new C1274To(this));
                    this.A0A = true;
                    Integer num = this.A07;
                ...
                if (f10 <= this.A02) {
                    if (!this.A08) {
                        ...
                        if (num2 == null || num2.intValue() == 4) {
                            ...
                            this.A03.setProgressImage(EnumC1074Lw.CROSS);
                            this.A03.setToolbarActionMode(6);
                        }
                    }
