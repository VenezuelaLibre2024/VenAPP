...
public abstract class AbstractC1093Mp {
    ...
    public static AbstractC1092Mo A01(C1399Yn c1399Yn, J2 j22, String str, NativeAdLayout nativeAdLayout) {
        if (nativeAdLayout == null) {
            return null;
        }
        ...
        int i10 = A01;
        if (h10 >= i10 && w10 >= i10) {
            return new U4(c1399Yn, j22, str);
        }
        if (h10 < A03 || w10 < A02) {
            return null;
        }
        return new U5(c1399Yn, j22, str);
    }

    public static U6 A02(C1399Yn c1399Yn, J2 j22, String str, C05741a c05741a, MD md2, MC mc2) {
        return new U6(c1399Yn, j22, str, c05741a, md2, mc2);
    }
