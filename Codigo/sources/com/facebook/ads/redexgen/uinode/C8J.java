...
public final class C8J {
    ...
    public static void A0A(C07277f c07277f) {
        try {
            c07277f = AbstractC1049Kx.A00(c07277f, null, new IntentFilter(A01(24, 37, 122)));
            if (c07277f == 0) {
                return;
            }
            int intExtra = c07277f.getIntExtra(A01(109, 5, 89), -1);
            int scale = c07277f.getIntExtra(A01(123, 5, 3), -1);
            int level = c07277f.getIntExtra(A01(134, 6, 71), -1);
            ...
            c07277f.A07().A9a(A01(102, 7, 57), C8A.A1T, new C8B(e10));
        }
    }

    public static synchronized void A0B(C07277f c07277f) {
        synchronized (C8J.class) {
            A09(c07277f);
            A0A(c07277f);
            if (A04 == null) {
                SensorManager sensorManager = (SensorManager) c07277f.getSystemService(A01(RecognitionOptions.ITF, 6, 67));
                A04 = sensorManager;
                if (sensorManager == null) {
                    return;
                }
