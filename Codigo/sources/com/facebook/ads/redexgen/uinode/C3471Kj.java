...
public final class C3471Kj {
    ...
    public static final Set<C4337Yn> A06;
    public static final AtomicReference<InterfaceC3478Ks> A07;
    public static final AtomicReference<InterfaceC3480Ku> A08;
    ...
    static {
        A07();
        Package r42 = C3471Kj.class.getPackage();
        A02 = r42;
    ...
    public static C4337Yn A03(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C4337Yn c4337Yn : A06) {
                String adId = c4337Yn.A0E().getId();
    ...
    public static AdActivityIntent A04(C4337Yn c4337Yn) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c4337Yn.getApplicationContext(), A05());
        adActivityIntent.putExtra(A03, c4337Yn.A0E().getId());
        A06.add(c4337Yn);
    ...
    public static void A08(Activity activity, Intent intent) throws C3469Kh {
        try {
            activity.startActivityForResult(intent, 0);
        } catch (ActivityNotFoundException e10) {
            throw new C3469Kh(e10);
        }
    }
    ...
    public static void A0A(C4337Yn c4337Yn, AdActivityIntent adActivityIntent) throws C3469Kh {
        Context launchContext;
        Context applicationContext = c4337Yn.getApplicationContext();
        if (C3348Ih.A25(c4337Yn) && (launchContext = c4337Yn.A0D()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0J(c4337Yn, adActivityIntent)) {
                    c4337Yn.A0E().AF0();
                    return;
                }
                return;
    ...
    public static boolean A0C(C4337Yn c4337Yn, Intent intent) throws C3469Kh {
        A07.get();
        return A0G(c4337Yn, intent, null);
    }

    public static boolean A0D(C4337Yn c4337Yn, Intent intent) throws C3469Kh {
        A07.get();
        if (0 == 0 || c4337Yn.A0D() == null) {
            return false;
        }
        c4337Yn.A0B();
        try {
            ...
            c4337Yn.A07().A9a(A06(90, 8, 122), AbstractC27248A.A07, new C27258B(e11));
            return false;
        }
    }

    public static boolean A0E(C4337Yn c4337Yn, Intent intent) throws C3469Kh {
        return A0F(c4337Yn, A00(intent), -1);
    }

    public static boolean A0F(C4337Yn c4337Yn, Intent intent, int i10) throws C3469Kh {
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c4337Yn.A0D();
            }
            if (currentActivity != null) {
                if (i10 >= 0) {
    ...
    public static boolean A0G(C4337Yn c4337Yn, Intent intent, InterfaceC3478Ks interfaceC3478Ks) throws C3469Kh {
        if (A0B(intent, C3348Ih.A0V(c4337Yn))) {
            return false;
        }
        Context context = c4337Yn;
        String[] strArr = A01;
        if (strArr[6].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
        A01[1] = "W";
        Context startContext = c4337Yn.A0D();
        if (startContext != null) {
            context = startContext;
        } else {
            intent.addFlags(268435456);
        }
        if (interfaceC3478Ks != null && !A0B(intent, C3348Ih.A0X(c4337Yn))) {
            c4337Yn.A0B();
            try {
                ...
                c4337Yn.A07().A9a(A06(90, 8, 122), AbstractC27248A.A08, new C27258B(e11));
                return false;
            }
        }
        try {
            ...
            throw new C3469Kh(e12);
        }
    }

    public static boolean A0H(C4337Yn c4337Yn, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0I(c4337Yn, uri, str, null);
    }

    public static boolean A0I(C4337Yn c4337Yn, Uri uri, String str, InterfaceC3480Ku interfaceC3480Ku) throws ActivityNotFoundException {
        if (interfaceC3480Ku == null || c4337Yn.A0D() == null) {
            return false;
        }
    ...
    public static boolean A0J(C4337Yn c4337Yn, AdActivityIntent adActivityIntent) throws C3469Kh {
        return A0F(c4337Yn, A00(adActivityIntent), 0);
    }
}
