...
public abstract class C6E {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x000a, code lost:
        ...
        if (android.text.TextUtils.isEmpty(r6.A03()) != false) goto L17;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.redexgen.uinode.C6C A01(com.facebook.ads.redexgen.uinode.C07277f r5, com.facebook.ads.redexgen.uinode.C6C r6) {
        /*
            if (r6 == 0) goto Lc
    ...
    public static C6C A02(C07277f c07277f, C6C c6c, C6D c6d) {
        C6F c6f = null;
        try {
            if (AbstractC0987Ig.A06(c07277f) && (c6c == null || TextUtils.isEmpty(c6c.A03()))) {
                c6f = C6G.A00(c07277f.getContentResolver());
            }
        } catch (Throwable th2) {
            c07277f.A07().A9a(A04(12, 7, 6), C8A.A1S, new C8B(th2));
        }
    ...
    public static void A07(C07277f c07277f) {
        long j10;
        C6C A022;
        try {
            C6D c6d = new C6D(c07277f);
            A06(c6d);
            if (A08()) {
                return;
            }
            ...
            if (j10 > 0) {
                ...
                if (cacheTS - j10 < AbstractC0987Ig.A00(c07277f)) {
                    return;
                }
            }
            if (AbstractC0987Ig.A07(c07277f)) {
                A022 = A01(c07277f, A02(c07277f, null, c6d));
            } else {
                A022 = A02(c07277f, A01(c07277f, null), c6d);
            }
            ...
            c07277f.A07().A9a(A04(12, 7, 6), C8A.A1R, new C8B(t10));
        }
    }
