...
public final class C24403K<T extends Enum<T>> extends AbstractC26556u<T> implements InterfaceC3220Ga<T>, Serializable {
    ...
    public C24403K(T[] tArr) {
        C4527bu.A07(tArr, A03(7, 7, 60));
        this.A00 = tArr;
    }

    private final int A00(T t10) {
        C4527bu.A07(t10, A03(0, 7, 113));
        int ordinal = t10.ordinal();
        if (((Enum) AbstractC24423M.A01(this.A00, ordinal)) == t10) {
            return ordinal;
        }
        return -1;
    }
    ...
    public final T get(int i10) {
        AbstractC26556u.A02.A03(i10, this.A00.length);
        return this.A00[i10];
    }

    private final boolean A05(T t10) {
        C4527bu.A07(t10, A03(0, 7, 113));
        Enum target = (Enum) AbstractC24423M.A01(this.A00, t10.ordinal());
        return target == t10;
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC3245H0, java.util.Collection, java.util.List
