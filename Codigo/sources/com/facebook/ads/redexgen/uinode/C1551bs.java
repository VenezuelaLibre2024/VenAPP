...
public final class C1551bs {
    ...
    public final String A02(GL gl2) {
        String obj = gl2.getClass().getGenericInterfaces()[0].toString();
        String A002 = A00(0, 21, 47);
        return obj.startsWith(A002) ? obj.substring(A002.length()) : obj;
    }

    public final String A03(AbstractC07146o abstractC07146o) {
        return A02(abstractC07146o);
    }
}
