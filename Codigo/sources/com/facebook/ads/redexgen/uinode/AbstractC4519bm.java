...
public abstract class AbstractC4519bm implements InterfaceC22470B {
    ...
    static {
        A04();
        A03 = AbstractC4519bm.class.getSimpleName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A06(File file) throws IOException {
        C22500E.A03(file);
        List<File> files = C22500E.A01(file.getParentFile());
        A07(files);
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC22470B
    public void AGh(final File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.0F
            ...
            public final Void call() throws Exception {
                AbstractC4519bm.this.A06(this.A00);
                return null;
            }
        });
    }
