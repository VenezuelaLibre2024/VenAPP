...
public final class C2975CH {
    ...
    public final long A05(InterfaceC2951Bt interfaceC2951Bt, boolean z10, boolean z11, int i10) throws IOException, InterruptedException {
        if (this.A01 == 0) {
            if (!interfaceC2951Bt.AEM(this.A02, 0, 1, z10)) {
                return -1L;
            }
        ...
        if (i11 != 1) {
            interfaceC2951Bt.readFully(this.A02, 1, i11 - 1);
        }
        this.A01 = 0;
