...
public final class JD {
     ...
     */
    public static void A06(C07277f c07277f, RK rk2, Map<String, ?> map) throws JSONException {
        ...
        A09(c07277f, hashMap2);
        C07458c A08 = c07277f.A08();
        ...
        rk2.AE0(c07277f.A04().A73(), ry.A08(), new VN(c07277f));
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 2 out of bounds for length 2
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static void A09(C07277f c07277f, Map<String, String> map) {
        map.putAll(c07277f.A03().A4n());
    }
    ...
    public static void A05(C07277f c07277f) {
        if (A0B(c07277f)) {
            return;
        }
        synchronized (JD.class) {
            ...
            atomicInteger.set(1);
            ExecutorC1071Lt.A06.execute(new VO(c07277f));
        }
    }

    public static void A08(C07277f c07277f, String str) {
        int i10;
        int i11;
        if (A0B(c07277f)) {
            return;
        ...
        synchronized (JD.class) {
            if (A04.get() != 2) {
                ...
                SharedPreferences sharedPreferences = c07277f.getApplicationContext().getSharedPreferences(ProcessUtils.getProcessSpecificName(A01(116, 31, 104), c07277f), 0);
    ...
    public static boolean A0B(C07277f c07277f) {
        ...
        return A0A(c07277f.A08().A00(), Ij.A0C(c07277f));
    }
}
