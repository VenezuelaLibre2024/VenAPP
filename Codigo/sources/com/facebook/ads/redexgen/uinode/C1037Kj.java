...
public final class C1037Kj {
    ...
    public static final Set<C1399Yn> A06;
    public static final AtomicReference<InterfaceC1044Ks> A07;
    public static final AtomicReference<InterfaceC1046Ku> A08;
    ...
    static {
        A07();
        Package r42 = C1037Kj.class.getPackage();
        A02 = r42;
    ...
    public static C1399Yn A03(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C1399Yn c1399Yn : A06) {
                String adId = c1399Yn.A0E().getId();
    ...
    public static AdActivityIntent A04(C1399Yn c1399Yn) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c1399Yn.getApplicationContext(), A05());
        adActivityIntent.putExtra(A03, c1399Yn.A0E().getId());
        A06.add(c1399Yn);
    ...
    public static void A08(Activity activity, Intent intent) throws C1035Kh {
        try {
            activity.startActivityForResult(intent, 0);
        } catch (ActivityNotFoundException e10) {
            throw new C1035Kh(e10);
        }
    }
    ...
    public static void A0A(C1399Yn c1399Yn, AdActivityIntent adActivityIntent) throws C1035Kh {
        Context launchContext;
        Context applicationContext = c1399Yn.getApplicationContext();
        if (C0988Ih.A25(c1399Yn) && (launchContext = c1399Yn.A0D()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0J(c1399Yn, adActivityIntent)) {
                    c1399Yn.A0E().AF0();
                    return;
                }
                return;
    ...
    public static boolean A0C(C1399Yn c1399Yn, Intent intent) throws C1035Kh {
        A07.get();
        return A0G(c1399Yn, intent, null);
    }

    public static boolean A0D(C1399Yn c1399Yn, Intent intent) throws C1035Kh {
        A07.get();
        if (0 == 0 || c1399Yn.A0D() == null) {
            return false;
        }
        c1399Yn.A0B();
        try {
            ...
            c1399Yn.A07().A9a(A06(90, 8, 122), C8A.A07, new C8B(e11));
            return false;
        }
    }

    public static boolean A0E(C1399Yn c1399Yn, Intent intent) throws C1035Kh {
        return A0F(c1399Yn, A00(intent), -1);
    }

    public static boolean A0F(C1399Yn c1399Yn, Intent intent, int i10) throws C1035Kh {
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c1399Yn.A0D();
            }
            if (currentActivity != null) {
                if (i10 >= 0) {
    ...
    public static boolean A0G(C1399Yn c1399Yn, Intent intent, InterfaceC1044Ks interfaceC1044Ks) throws C1035Kh {
        if (A0B(intent, C0988Ih.A0V(c1399Yn))) {
            return false;
        }
        Context context = c1399Yn;
        String[] strArr = A01;
        if (strArr[6].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
        A01[1] = "W";
        Context startContext = c1399Yn.A0D();
        if (startContext != null) {
            context = startContext;
        } else {
            intent.addFlags(268435456);
        }
        if (interfaceC1044Ks != null && !A0B(intent, C0988Ih.A0X(c1399Yn))) {
            c1399Yn.A0B();
            try {
                ...
                c1399Yn.A07().A9a(A06(90, 8, 122), C8A.A08, new C8B(e11));
                return false;
            }
        }
        try {
            ...
            throw new C1035Kh(e12);
        }
    }

    public static boolean A0H(C1399Yn c1399Yn, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0I(c1399Yn, uri, str, null);
    }

    public static boolean A0I(C1399Yn c1399Yn, Uri uri, String str, InterfaceC1046Ku interfaceC1046Ku) throws ActivityNotFoundException {
        if (interfaceC1046Ku == null || c1399Yn.A0D() == null) {
            return false;
        }
    ...
    public static boolean A0J(C1399Yn c1399Yn, AdActivityIntent adActivityIntent) throws C1035Kh {
        return A0F(c1399Yn, A00(adActivityIntent), 0);
    }
}
