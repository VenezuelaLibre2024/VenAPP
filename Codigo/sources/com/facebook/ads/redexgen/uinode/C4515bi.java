...
public final class C4515bi implements InterfaceC22560K {
    ...
    static {
        A04();
        A07 = C4515bi.class.getSimpleName();
    }

    public C4515bi(String str) {
        this(str, C22540I.A01(str));
    }

    public C4515bi(String str, int i10) {
        this(str);
        this.A00 = i10;
    }

    public C4515bi(String str, String str2) {
        this.A05 = Integer.MIN_VALUE;
        this.A00 = -1;
        this.A03 = (String) AbstractC22550J.A00(str);
        this.A06 = str2;
    }
    ...
    private HttpURLConnection A02(int i10, int i11) throws IOException, C4517bk {
        ...
        do {
            ...
            if (i12 > 5) {
                ...
                throw new C4517bk(url2);
            }
        } while (code != 0);
        return httpURLConnection;
    }

    private void A03() throws C4517bk {
        String[] strArr;
    ...
    private final void A05(int i10, int i11) throws C4517bk {
        try {
            ...
            throw new C4517bk(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i10, e10);
        }
    }
    ...
    public final void close() throws C4517bk {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C4517bk(A01(92, 37, 93), e10);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC22560K
    public final synchronized int length() throws C4517bk {
    ...
    public final int read(byte[] bArr) throws C4517bk {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new C3200GF(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e10);
            } catch (IOException e11) {
                throw new C4517bk(A01 + this.A03, e11);
            }
        }
        throw new C4517bk(A01 + this.A03 + A01(51, 23, 21));
    }
