...
public final class NJ extends LinearLayout {
    ...
    static {
        ...
        A0I = AbstractC1050Ky.A00(A06(90, 23, 31));
        A0J = new ND();
        A0H = Color.argb(34, 0, 0, 0);
    }

    public NJ(C1399Yn c1399Yn, WebView webView) {
        this(c1399Yn, webView, false);
    }

    public NJ(C1399Yn c1399Yn, WebView webView, boolean z10) {
        super(c1399Yn);
        this.A09 = getResources().getDisplayMetrics().density;
        this.A0C = new U3(this);
        this.A0A = webView;
        this.A0B = c1399Yn;
        this.A08 = AbstractC0989Ii.A06(c1399Yn);
        this.A0D = z10;
        A08();
    }
    ...
    private void A08() {
        ...
        this.A01.setImageBitmap(AbstractC1075Lx.A01(EnumC1074Lw.BROWSER_CLOSE));
        ImageView imageView2 = this.A01;
        View.OnTouchListener onTouchListener = A0J;
        imageView2.setOnTouchListener(onTouchListener);
        this.A01.setOnClickListener(new NE(this));
        addView(this.A01, layoutParams);
        if (this.A08 && !C0988Ih.A2N(this.A0B)) {
        ...
        if (C0988Ih.A2N(this.A0B) && !this.A0D) {
            ...
            imageView4.setImageBitmap(AbstractC1075Lx.A01(EnumC1074Lw.HANDLER));
            float f11 = this.A09;
        ...
        if (this.A08 && !C0988Ih.A2N(this.A0B)) {
            ...
            this.A02.setImageBitmap(AbstractC1075Lx.A02(EnumC1074Lw.BACK_ARROW));
            ...
            if (queryIntentActivities.isEmpty()) {
                ...
                if (queryIntentActivities.size() == 1 && queryIntentActivities.get(0).activityInfo != null) {
                    if (A06(72, 18, 95).equals(queryIntentActivities.get(0).activityInfo.packageName)) {
                        bitmap = AbstractC1075Lx.A01(EnumC1074Lw.BROWSER_LAUNCH_CHROME);
                    }
                }
                bitmap = AbstractC1075Lx.A01(EnumC1074Lw.BROWSER_LAUNCH_NATIVE);
            }
        }
        if (C0988Ih.A2N(this.A0B)) {
