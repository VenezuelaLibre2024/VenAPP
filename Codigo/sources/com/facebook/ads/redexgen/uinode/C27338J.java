...
public final class C27338J {
    ...
    public static void A0A(C26937f c26937f) {
        try {
            c26937f = AbstractC3483Kx.A00(c26937f, null, new IntentFilter(A01(24, 37, 122)));
            if (c26937f == 0) {
                return;
            }
            int intExtra = c26937f.getIntExtra(A01(109, 5, 89), -1);
            int scale = c26937f.getIntExtra(A01(123, 5, 3), -1);
            int level = c26937f.getIntExtra(A01(134, 6, 71), -1);
            ...
            c26937f.A07().A9a(A01(102, 7, 57), AbstractC27248A.A1T, new C27258B(e10));
        }
    }

    public static synchronized void A0B(C26937f c26937f) {
        synchronized (C27338J.class) {
            A09(c26937f);
            A0A(c26937f);
            if (A04 == null) {
                SensorManager sensorManager = (SensorManager) c26937f.getSystemService(A01(RecognitionOptions.ITF, 6, 67));
                A04 = sensorManager;
                if (sensorManager == null) {
                    return;
                }
            ...
            if (A02 == null) {
                C27318H c27318h = new C27318H();
                A02 = c27318h;
                Sensor sensor = A00;
                if (sensor != null) {
                    A04.registerListener(c27318h, sensor, 3);
                }
            }
            if (A03 == null) {
                C27328I c27328i = new C27328I();
                A03 = c27328i;
                Sensor sensor2 = A01;
                if (sensor2 != null) {
                    A04.registerListener(c27328i, sensor2, 3);
                }
            }
        }
    }
