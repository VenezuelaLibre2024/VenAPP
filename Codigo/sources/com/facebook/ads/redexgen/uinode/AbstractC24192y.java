...
public abstract class AbstractC24192y<K, V> {
        ...
        if (this.A00 == null) {
            this.A00 = new Set<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.2u
                ...
                public final boolean addAll(Collection<? extends Map.Entry<K, V>> collection) {
                    int A04 = AbstractC24192y.this.A04();
                    for (Map.Entry<K, V> entry : collection) {
                        AbstractC24192y.this.A0F(entry.getKey(), entry.getValue());
                    }
                    return A04 != AbstractC24192y.this.A04();
                }
                ...
                public final boolean contains(Object obj) {
                    ...
                    int index = AbstractC24192y.this.A05(entry.getKey());
                    if (index < 0) {
                        return false;
                    }
                    Object foundVal = AbstractC24192y.this.A0B(index, 1);
                    return AbstractC24122r.A04(foundVal, entry.getValue());
                }
                ...
                public final boolean equals(Object obj) {
                    return AbstractC24192y.A03(this, obj);
                }
                ...
                public final int hashCode() {
                    int i10 = 0;
                    for (int A04 = AbstractC24192y.this.A04() - 1; A04 >= 0; A04--) {
                        int i11 = 0;
                        Object A0B = AbstractC24192y.this.A0B(A04, 0);
                        Object A0B2 = AbstractC24192y.this.A0B(A04, 1);
                ...
                public final boolean isEmpty() {
                    return AbstractC24192y.this.A04() == 0;
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2u != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$EntrySet */
                @Override // java.util.Set, java.util.Collection, java.lang.Iterable
                public final Iterator<Map.Entry<K, V>> iterator() {
                    return new C24172w(AbstractC24192y.this);
                }
                ...
                public final int size() {
                    return AbstractC24192y.this.A04();
                }
    ...
    public final Set<K> A09() {
        if (this.A01 == null) {
            this.A01 = new Set<K>() { // from class: com.facebook.ads.redexgen.X.2v
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean contains(Object obj) {
                    return AbstractC24192y.this.A05(obj) >= 0;
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2v != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean containsAll(Collection<?> collection) {
                    return AbstractC24192y.A00(AbstractC24192y.this.A07(), collection);
                }
                ...
                public final int hashCode() {
                    int i10 = 0;
                    int result = AbstractC24192y.this.A04();
                    for (int i11 = result - 1; i11 >= 0; i11--) {
                        int i12 = 0;
                        Object A0B = AbstractC24192y.this.A0B(i11, 0);
                        if (A0B != null) {
                            i12 = A0B.hashCode();
                        }
                        i10 += i12;
                ...
                public final Iterator<K> iterator() {
                    return new C24142t(AbstractC24192y.this, 0);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2v != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean remove(Object obj) {
                    int A05 = AbstractC24192y.this.A05(obj);
                    if (A05 >= 0) {
                        AbstractC24192y.this.A0E(A05);
                        return true;
                    }
                    return false;
                }
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean removeAll(Collection<?> collection) {
                    return AbstractC24192y.A01(AbstractC24192y.this.A07(), collection);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2v != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean retainAll(Collection<?> collection) {
                    return AbstractC24192y.A02(AbstractC24192y.this.A07(), collection);
                }
                ...
                @Override // java.util.Set, java.util.Collection
                public final Object[] toArray() {
                    return AbstractC24192y.this.A0G(0);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2v != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final <T> T[] toArray(T[] tArr) {
                    return (T[]) AbstractC24192y.this.A0H(tArr, 0);
                }
            };
        }
        return this.A01;
        ...
        if (this.A02 == null) {
            this.A02 = new Collection<V>() { // from class: com.facebook.ads.redexgen.X.2x
                ...
                public final boolean removeAll(Collection<?> collection) {
                    ...
                    int i10 = 0;
                    while (i10 < A04) {
                        if (collection.contains(AbstractC24192y.this.A0B(i10, 1))) {
                            AbstractC24192y.this.A0E(i10);
                            i10--;
                            A04--;
                            z10 = true;
                        }
                ...
                @Override // java.util.Collection
                public final boolean contains(Object obj) {
                    return AbstractC24192y.this.A06(obj) >= 0;
                }
                ...
                public final Iterator<V> iterator() {
                    return new C24142t(AbstractC24192y.this, 1);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2x != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final boolean remove(Object obj) {
                    int A06 = AbstractC24192y.this.A06(obj);
                    if (A06 >= 0) {
                        AbstractC24192y.this.A0E(A06);
                        return true;
                    }
                    if (A01[6].charAt(4) == 'M') {
                ...
                @Override // java.util.Collection
                public final Object[] toArray() {
                    return AbstractC24192y.this.A0G(1);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2x != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final <T> T[] toArray(T[] tArr) {
                    return (T[]) AbstractC24192y.this.A0H(tArr, 1);
                }
            };
        }
        return this.A02;
