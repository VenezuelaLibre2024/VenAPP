...
public final class C0913Fg extends AbstractC1532bZ {
    ...
    private final List<Intent> A06() {
        List<C05610m> A052 = A05();
        ArrayList arrayList = new ArrayList();
        if (A052 != null) {
            Iterator<C05610m> it = A052.iterator();
            while (it.hasNext()) {
    ...
    static {
        A07();
        A06 = C0913Fg.class.getSimpleName();
    }

    public C0913Fg(C1399Yn c1399Yn, J2 j22, String str, Uri uri, Map<String, String> extraData, C05620o c05620o, boolean z10, C1U c1u) {
    ...
    */
    private android.content.Intent A00(com.facebook.ads.redexgen.uinode.C05610m r10) {
        /*
            Method dump skipped, instructions count: 286
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0913Fg.A00(com.facebook.ads.redexgen.X.0m):android.content.Intent");
    }

    private Intent A01(C05610m c05610m) {
        Intent intent = new Intent(A04(88, 26, 38));
        intent.addFlags(268435456);
        if (!TextUtils.isEmpty(c05610m.A05()) && !TextUtils.isEmpty(c05610m.A04())) {
            intent.setComponent(new ComponentName(c05610m.A05(), c05610m.A04()));
        }
        if (!TextUtils.isEmpty(c05610m.A03())) {
            intent.setData(AbstractC1050Ky.A00(c05610m.A03()));
        }
        return intent;
    }
    ...
    private final Uri A02() {
        ...
        return AbstractC1050Ky.A00(String.format(locale, storeUrl2, objArr));
    }

    private EnumC05550g A03() throws C1035Kh {
        C1047Kv c1047Kv = new C1047Kv();
        try {
            return C1047Kv.A05(c1047Kv, ((AbstractC05560h) this).A00, A02(), ((AbstractC05560h) this).A02, this.A03);
            ...
            if (queryParameter != null && queryParameter.length() > 0) {
                C1047Kv.A0D(c1047Kv, ((AbstractC05560h) this).A00, AbstractC1050Ky.A00(queryParameter), ((AbstractC05560h) this).A02);
            }
            return EnumC05550g.A08;
        }
    }

    private List<C05610m> A05() {
        ...
        try {
            ...
            if (optJSONArray != null) {
                for (int i10 = 0; i10 < optJSONArray.length(); i10++) {
                    C05610m A00 = C05610m.A00(optJSONArray.optJSONObject(i10));
                    if (A00 != null) {
                        arrayList.add(A00);
                    }
                }
            ...
            AnonymousClass89 A07 = ((AbstractC05560h) this).A00.A07();
            int i11 = C8A.A24;
            C8B c8b = new C8B(e10);
    ...
    private boolean A08() {
        ...
        while (it.hasNext()) {
            if (C1037Kj.A0C(((AbstractC05560h) this).A00, it.next())) {
                return true;
            }
        }
        return false;
    ...
    public static boolean A09(C1399Yn c1399Yn, String str) {
        if (Build.VERSION.SDK_INT >= 30 && str != null) {
            boolean A1g = C0988Ih.A1g(c1399Yn);
            if (A05[3].length() == 13) {
                throw new RuntimeException();
            }
            String[] strArr = A05;
    ...
    public final EnumC05550g A0D() {
        ...
        if (!AbstractC1066Lo.A0e(((AbstractC05560h) this).A00, enumC05550g, this.A03)) {
            A0E(this.A03, enumC05550g);
            C1U.A06(this.A02, ((AbstractC05560h) this).A00);
        } else {
            EnumC05550g enumC05550g2 = EnumC05550g.A07;
            ...
            strArr[7] = "cFM2nXNzq";
            strArr[1] = "5qRqyCpR9";
            if (enumC05550g != enumC05550g2 && (og2 = this.A00) != null) {
                og2.A0B(A04(264, 25, 51), this.A02, ((AbstractC05560h) this).A02);
            }
        }
        return enumC05550g;
    }
    ...
    public final EnumC05550g A0G() {
        ...
        if (!A0F) {
            try {
                enumC05550g = A03();
                if (enumC05550g != EnumC05550g.A08) {
                    A042 = A04(188, 16, 80);
                } else {
                    A042 = A04(163, 25, 10);
                }
            } catch (Exception unused) {
                enumC05550g = EnumC05550g.A03;
            }
        }
