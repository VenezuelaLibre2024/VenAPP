...
public final class V2 implements Ad, NativeAdBaseApi, Repairable, JX {
    ...
    private void A0f(View view, View view2, List<View> list, boolean z10) {
        ...
        if (A0C == null) {
            ...
            Log.e(A0n, A0W3);
            C1005Jb c1005Jb = new C1005Jb(AdErrorType.NATIVE_AD_IS_NOT_LOADED, A0W3);
            A11().A0E().A2m(C1057Lf.A01(this.A00), c1005Jb.A03().getErrorCode(), c1005Jb.A04());
            if (!C0988Ih.A2F(this.A0c) || (v12 = this.A0G) == null) {
                return;
            }
            v12.ABR(c1005Jb);
            return;
        ...
        if (zx != null && A0C.A08() == 1) {
            zx.A03(EnumC1074Lw.AN_INFO_ICON);
        }
        if (view2 == null) {
            if (this.A0J == EnumC1009Jg.A05) {
                AdErrorType adErrorType = AdErrorType.NO_MEDIAVIEW_IN_NATIVEAD;
                String A0W4 = A0W(243, 21, 68);
                C1005Jb c1005Jb2 = new C1005Jb(adErrorType, A0W4);
                A11().A0E().A2m(C1057Lf.A01(this.A00), c1005Jb2.A03().getErrorCode(), c1005Jb2.A04());
                V1 v13 = this.A0G;
                if (v13 != null) {
                    v13.ABR(c1005Jb2);
                }
            ...
            C1005Jb c1005Jb3 = new C1005Jb(adErrorType2, A0W5);
            A11().A0E().A2m(C1057Lf.A01(this.A00), c1005Jb3.A03().getErrorCode(), c1005Jb3.A04());
            V1 v14 = this.A0G;
            if (v14 != null) {
                v14.ABR(c1005Jb3);
            }
        ...
        if (!z12 && !z13) {
            if (this.A0G != null) {
                C1005Jb c1005Jb4 = new C1005Jb(AdErrorType.UNSUPPORTED_AD_ASSET_NATIVEAD, A0W(519, 31, 15));
                A11().A0E().A2m(C1057Lf.A01(this.A00), c1005Jb4.A03().getErrorCode(), c1005Jb4.A04());
                this.A0G.ABR(c1005Jb4);
                return;
            }
            return;
        }
        ...
        if (view instanceof ViewGroup) {
            C1086Mi c1086Mi = new C1086Mi(this.A0c, new V8(this));
            this.A0K = c1086Mi;
            ((ViewGroup) view).addView(c1086Mi);
        }
        if (A0C.A0S()) {
        ...
        C1507bA c1507bA = new C1507bA(this.A0c, new V3(this, null), this.A0R, this.A0a);
        this.A09 = c1507bA;
        c1507bA.A0D(arrayList);
        A0o.put(view, new WeakReference<>(this));
        if (Build.VERSION.SDK_INT < 18 || !C0988Ih.A11(this.A0c)) {
            return;
        }
        C1110Ng c1110Ng = new C1110Ng();
        this.A0L = c1110Ng;
        c1110Ng.A0C(this.A0g);
        this.A0L.A0B(this.A0c.getPackageName());
        this.A0L.A0A(this.A0R);
        C1517bK c1517bK = this.A0a;
        if (c1517bK != null && c1517bK.A0E().A03() > 0) {
    ...
    public V2(Context context, String str, JO jo, boolean z10) {
        ...
        this.A0J = EnumC1009Jg.A05;
        this.A0E = JL.A04;
        this.A08 = AnonymousClass12.A03;
        this.A0U = new WeakReference<>(null);
        this.A0i = new ArrayList();
        this.A0f = new C1058Lg();
        this.A0Z = false;
        this.A0Y = false;
        this.A00 = -1L;
        if (context instanceof C1399Yn) {
            this.A0c = (C1399Yn) context;
        } else if (!z10) {
            this.A0c = C06785c.A04(context);
        } else {
            this.A0c = C06785c.A03(context);
        }
        this.A0c.A0L(this);
        this.A0g = str;
        this.A0d = jo;
    ...
    public V2(C1399Yn c1399Yn, C1517bK c1517bK, C8T c8t, JO jo) {
        this((Context) c1399Yn, (String) null, jo, true);
        this.A0a = c1517bK;
        this.A0D = c8t;
        this.A0j = true;
        this.A05 = new View(c1399Yn);
    }

    public V2(C1399Yn c1399Yn, C1517bK c1517bK, C8T c8t, JO jo, C1477ag c1477ag) {
        this(c1399Yn, c1517bK, c8t, jo);
        this.A0B = c1477ag;
    }
    ...
    public static Drawable A05(C1399Yn c1399Yn, Bitmap bitmap, boolean z10, String str) {
        BitmapDrawable A00;
        BitmapDrawable bitmapDrawable = new BitmapDrawable(c1399Yn.getResources(), bitmap);
        if (z10 && (A00 = AbstractC1178Pw.A00(c1399Yn, str)) != null) {
    ...
    public static NativeAdBase A0A(Context context, String str, String str2) throws C1006Jc {
        EnumC1009Jg A00 = C1014Jl.A00(str2);
        if (A00 != null) {
            EnumC1009Jg enumC1009Jg = EnumC1009Jg.A04;
            String[] strArr = A0m;
            if (strArr[7].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            ...
            EnumC1009Jg template = EnumC1009Jg.A05;
            if (A00 == template) {
                return new NativeAd(context, str);
            }
            throw new C1006Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A0W(42, 34, 84), A00));
        }
        throw new C1006Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A0W(114, 50, 50), str2));
    }

    private final C1517bK A0C() {
        C1517bK c1517bK = this.A0a;
        if (c1517bK != null && c1517bK.A0R()) {
            return c1517bK;
        }
        return null;
    }
    ...
    private void A0a() {
        if (!TextUtils.isEmpty(getAdChoicesLinkUrl())) {
            C1047Kv.A0M(new C1047Kv(), this.A0c, AbstractC1050Ky.A00(getAdChoicesLinkUrl()), A1B());
        }
    }
    ...
    private void A0g(FrameLayout frameLayout, String str) {
        ...
        C1179Px A01 = AbstractC1178Pw.A01(C06785c.A03(this.A0c), str);
        this.A0N = A01;
        if (A01 != null) {
    ...
    private void A0h(C1517bK c1517bK, boolean z10) {
        if (c1517bK == null) {
            return;
        }
        ...
        if (equals) {
            AnonymousClass14 A0E = c1517bK.A0E();
            String clientToken = c1517bK.A6T();
            if (!TextUtils.isEmpty(clientToken)) {
                this.A0b.A0d(new JA(clientToken, this.A0c.A09()));
            }
            if (A0E.A0G() != null) {
                C07026a c07026a = new C07026a(A0E.A0G().getUrl(), A0E.A0G().getHeight(), A0E.A0G().getWidth(), c1517bK.A0G(), A0W(596, 6, 89));
                c07026a.A00 = this.A0C;
                this.A0b.A0V();
                this.A0b.A0b(c07026a);
            }
            if (!this.A0J.equals(EnumC1009Jg.A04)) {
                if (A0E.A0F() != null) {
                    this.A0b.A0b(new C07026a(A0E.A0F().getUrl(), A0E.A0F().getHeight(), A0E.A0F().getWidth(), c1517bK.A0G(), A0W(596, 6, 89)));
                }
                List<V2> A0H = c1517bK.A0H();
                String[] strArr = A0m;
                if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                    throw new RuntimeException();
                }
                ...
                if (A0H != null) {
                    for (V2 v22 : c1517bK.A0H()) {
                        if (v22.getAdCoverImage() != null) {
                            this.A0b.A0b(new C07026a(v22.getAdCoverImage().getUrl(), v22.getAdCoverImage().getHeight(), v22.getAdCoverImage().getWidth(), c1517bK.A0G(), A0W(596, 6, 89)));
                        }
                    }
                }
                String A0d = A0E.A0d();
                if (!TextUtils.isEmpty(A0d)) {
                    this.A0b.A0a(new C6Y(A0d, c1517bK.A0G(), A0W(596, 6, 89), A0E.A0A()));
                }
            }
            AbstractC1502b5 A0D = A0E.A0D();
            if (A0D != null && A0D.A0m()) {
        ...
        this.A0b.A0W(new V9(this, c1517bK, z10), new C6V(c1517bK.A0G(), A0W));
    }
    ...
    private void A0i(AnonymousClass15 anonymousClass15) {
        ...
        c1517bK.A0K(anonymousClass15);
    }

    public static void A0j(NativeAdImageApi nativeAdImageApi, ImageView imageView, C1399Yn c1399Yn) {
        if (nativeAdImageApi != null && imageView != null) {
            new AsyncTaskC1276Tq(imageView, c1399Yn).A05(nativeAdImageApi.getHeight(), nativeAdImageApi.getWidth()).A07(nativeAdImageApi.getUrl());
        }
    }
    ...
    public final C1517bK A0y() {
        return this.A0a;
    }

    public final AbstractC1502b5 A0z() {
        return A0F().A0D();
    }

    public final C07046c A10() {
        return this.A0b;
    }

    public final C1399Yn A11() {
        return this.A0c;
    }
    ...
    public final String A1G() {
        C1517bK c1517bK = this.A0a;
        if (c1517bK == null || TextUtils.isEmpty(c1517bK.A0E().A0d())) {
            return null;
        }
    ...
    public final void A1I() {
        ...
        C1399Yn c1399Yn = this.A0c;
        AbstractC1092Mo A01 = AbstractC1093Mp.A01(c1399Yn, c1399Yn.A09(), A1B(), this.A07);
        if (A01 == null) {
            A0a();
        } else {
    ...
    public final void A1K(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            boolean A11 = C0988Ih.A11(view.getContext());
            String[] strArr = A0m;
            if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                throw new RuntimeException();
            }
    ...
    public final void A1R(NativeAdBase nativeAdBase, NativeAdListener nativeAdListener) {
        ...
        A0m(new C0828Bj(nativeAdListener, nativeAdBase));
    }
    ...
    public final void A1T(C1517bK c1517bK) {
        A0h(c1517bK, true);
        if (this.A0G != null) {
            List<V2> A0H = c1517bK.A0H();
            String[] strArr = A0m;
            ...
            if (A0H != null) {
                VB vb2 = new VB(this);
                Iterator<V2> it = c1517bK.A0H().iterator();
                while (it.hasNext()) {
                    it.next().A0i(vb2);
                }
            }
    ...
    public final void A1V(JL jl2, String str, C6i c6i) {
        if (str == null) {
            this.A0c.A0E().A2p();
        } else {
            this.A0c.A0E().A2o();
        ...
        if (this.A0j) {
            AdSettings.IntegrationErrorMode A00 = AbstractC05971x.A00(this.A0c);
            ...
            if (!integrationErrorMode.equals(A00)) {
                C1005Jb c1005Jb = new C1005Jb(AdErrorType.LOAD_AD_CALLED_MORE_THAN_ONCE, A0W(566, 30, 115));
                A11().A0E().A2m(C1057Lf.A01(this.A00), c1005Jb.A03().getErrorCode(), c1005Jb.A04());
                V1 v12 = this.A0G;
                if (v12 != null) {
                    v12.ABR(c1005Jb);
        ...
        this.A0j = true;
        this.A0E = jl2;
        if (jl2.equals(JL.A05)) {
            this.A08 = AnonymousClass12.A05;
        }
        this.A0C = c6i;
        C05941u c05941u = new C05941u(this.A0g, this.A0J, A0R(), null, 1, new C1470aZ());
        c05941u.A05(jl2);
        c05941u.A06(this.A0S);
        c05941u.A07(this.A0T);
        FO fo = new FO(this.A0c, c05941u);
        this.A0A = fo;
        fo.A0P(new VC(this));
        this.A0A.A0T(str);
    }
    ...
    public final void A1Y(EnumC1009Jg enumC1009Jg) {
        if (!A0q()) {
            if (EnumC1009Jg.A04.equals(enumC1009Jg)) {
                C1399Yn c1399Yn = this.A0c;
                String[] strArr = A0m;
                if (strArr[7].length() != strArr[5].length()) {
                    throw new RuntimeException();
                ...
                c1399Yn.A0E().A2s(AdPlacementType.NATIVE_BANNER.toString(), this.A0g);
            } else {
                this.A0c.A0E().A2s(AdPlacementType.NATIVE.toString(), this.A0g);
            }
        }
        this.A0J = enumC1009Jg;
    }
    ...
    */
    ...
    public final void destroy() {
        AbstractC1018Jp.A05(A0W(553, 7, 7), A0W(363, 19, 23), A0W(5, 8, 76));
        if (C0988Ih.A1W(this.A0c)) {
    ...
    public final boolean hasCallToAction() {
        C1517bK c1517bK = this.A0a;
        return c1517bK != null && c1517bK.A0Q();
    }
    ...
    public final boolean isAdLoaded() {
        C1517bK c1517bK = this.A0a;
        return c1517bK != null && c1517bK.A0R();
    }

    @Override // com.facebook.ads.Ad
    public final void loadAd() {
        AbstractC1018Jp.A05(A0W(560, 6, 14), A0W(382, 24, 98), A0W(13, 8, 89));
    ...
    public final void loadAd(NativeAdBase.NativeLoadAdConfig nativeLoadAdConfig) {
        AbstractC1018Jp.A05(A0W(560, 6, 14), A0W(382, 24, 98), A0W(21, 8, 126));
    ...
    public final void repair(Throwable th2) {
        ...
        A11().A0E().A2m(C1057Lf.A01(this.A00), AdError.INTERNAL_ERROR_CODE, str);
        V1 v12 = this.A0G;
        if (v12 != null) {
            v12.ABR(new C1005Jb(AdError.INTERNAL_ERROR_CODE, str));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0070, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.C0988Ih.A1W(r4) != false) goto L81;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0087, code lost:
        ...
        if (r4.containsKey(r7.A04) == false) goto L113;
     */
    /* JADX WARN: Code restructure failed: missing block: B:27:0x0095, code lost:
    
        if (r4.get(r7.A04).get() != r7) goto L113;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:29:0x00ab, code lost:
        ...
        if (r2[4].length() == r2[6].length()) goto L108;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:39:0x00d1, code lost:
        ...
        if (android.os.Build.VERSION.SDK_INT < 18) goto L103;
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00d5, code lost:
    
        if (r7.A0L == null) goto L103;
     */
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00dd, code lost:
    
        if (com.facebook.ads.redexgen.uinode.C0988Ih.A11(r7.A0c) == false) goto L103;
     */
