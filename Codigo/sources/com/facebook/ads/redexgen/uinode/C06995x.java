...
public final class C06995x implements RewardedVideoAdApi, Repairable {
    ...
    public C06995x(Context context, String str, Ad ad2) {
        this.A00 = ad2;
        String uuid = UUID.randomUUID().toString();
        C1399Yn A07 = C06785c.A07(context, uuid);
        this.A03 = A07;
        C0S A0E = A07.A0E();
        String adId = AdPlacementType.REWARDED_VIDEO.toString();
        A0E.A2s(adId, str);
        C2F c2f = new C2F(A07, str, ad2, new C1470aZ());
        this.A01 = c2f;
        A07.A0L(this);
    ...
    public final C07005y buildLoadAdConfig() {
        return new C07005y(this);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi, com.facebook.ads.FullScreenAd
    /* renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final C07015z buildShowAdConfig() {
        return new C07015z();
    }

    public final void A04() {
        if (C0988Ih.A1s(this.A03)) {
            return;
        }
        this.A02.A08();
        this.A03.A0E().A2t();
    ...
    public final void destroy() {
        AbstractC1018Jp.A05(A00(136, 7, 66), A00(48, 27, 119), A00(16, 8, 74));
        A04();
    }
    ...
    public final void loadAd() {
        AbstractC1018Jp.A05(A00(143, 6, 60), A00(75, 32, 89), A00(24, 8, 17));
        A07(null, null, true);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final void loadAd(RewardedVideoAd.RewardedVideoLoadAdConfig rewardedVideoLoadAdConfig) {
        ((C07005y) rewardedVideoLoadAdConfig).A00();
    }

    @Override // com.facebook.ads.internal.context.Repairable
    public final void repair(Throwable th2) {
        if (this.A01.A04 != null) {
            this.A01.A04.onError(this.A00, new AdError(AdError.INTERNAL_ERROR_CODE, A00(32, 16, 5) + LW.A03(this.A01.A0B, th2)));
        }
    }
    ...
    public final boolean show() {
        AbstractC1018Jp.A05(A00(149, 4, 94), A00(107, 29, 107), A00(0, 8, 62));
        return A08(new C07015z().withAppOrientation(-1).build());
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final boolean show(RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        AbstractC1018Jp.A05(A00(149, 4, 94), A00(107, 29, 107), A00(8, 8, 108));
