...
public class C4324Ya extends AbstractRunnableC3455KT {
    public static byte[] A02;
    public final /* synthetic */ AudienceNetworkAds.InitListener A00;
    public final /* synthetic */ C4336Ym A01;
    ...
    public C4324Ya(C4336Ym c4336Ym, AudienceNetworkAds.InitListener initListener) {
        this.A01 = c4336Ym;
    ...
    public final void A06() {
        try {
            C4309YL.A02().A0C(this.A01);
        } catch (Throwable th2) {
            this.A01.A07().A3c(th2);
        }
        C27478Y.A0C(this.A01);
        AudienceNetworkAds.InitListener initListener = this.A00;
        if (initListener != null) {
            C27478Y.A04(initListener, new C27468X(true, A00(0, 29, 0)));
        }
    }
}
