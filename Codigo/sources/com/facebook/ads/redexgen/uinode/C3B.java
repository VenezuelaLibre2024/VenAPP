...
public final class C3B {
    ...
    public final void A03(int i10) {
        ...
        if (A00 != null) {
            AbstractC06353j.A02(A00, this.A04, i10);
            A01(i10, null);
        }
    }
    ...
    public final boolean A07(float f10, float f11) {
        ...
        return AbstractC06353j.A06(A00, this.A04, f10, f11);
    }
    ...
    public final boolean A08(float f10, float f11, boolean z10) {
        ...
        return AbstractC06353j.A07(A00, this.A04, f10, f11, z10);
    }
    ...
    public final boolean A0B(int i10, int i11) {
        ...
        if (A06()) {
            ...
            for (ViewParent parent = this.A04.getParent(); parent != null; parent = parent.getParent()) {
                if (AbstractC06353j.A08(parent, view, this.A04, i10, i11)) {
                    A01(i11, parent);
                    AbstractC06353j.A05(parent, view, this.A04, i10, i11);
                    return true;
                }
    ...
    public final boolean A0D(int i10, int i11, int i12, int i13, int[] iArr, int startX) {
        ...
        if (i10 != 0 || i11 != 0 || i12 != 0 || i13 != 0) {
            ...
            AbstractC06353j.A03(A00, this.A04, i10, i11, i12, i13, startX);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
                iArr[0] = iArr[0] - i14;
                iArr[1] = iArr[1] - i15;
    ...
    */
    public final boolean A0F(int r17, int r18, int[] r19, int[] r20, int r21) {
        ...
        L67:
            ...
            com.facebook.ads.redexgen.uinode.AbstractC06353j.A04(r10, r11, r12, r13, r14, r15)
            if (r4 == 0) goto L81
            android.view.View r0 = r3.A04
            r0.getLocationInWindow(r4)
            r0 = r4[r9]
