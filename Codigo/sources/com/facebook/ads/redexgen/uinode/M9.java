...
public final class M9 extends LinearLayout {
    ...
    public M9(C1399Yn c1399Yn, int i10) {
        super(c1399Yn);
        this.A03 = c1399Yn;
        this.A02 = C2T.A00(c1399Yn.A01());
        setOrientation(0);
        this.A00 = new ImageView(c1399Yn);
        this.A01 = new ImageView(c1399Yn);
        A04(i10);
    }

    private void A04(int i10) {
        EnumC1074Lw enumC1074Lw;
        A05(this.A00, EnumC1074Lw.AD_CHOICES_ICON);
        if (i10 == 2) {
            int i11 = A05;
            ...
            AbstractC1066Lo.A0X(textView, true, 13);
        ...
        if (i10 == 1) {
            enumC1074Lw = EnumC1074Lw.AN_INFO_ICON;
        } else {
            enumC1074Lw = EnumC1074Lw.DEFAULT_INFO_ICON;
        }
        A05(this.A01, enumC1074Lw);
        int i14 = A06;
    ...
    public static void A05(ImageView imageView, EnumC1074Lw enumC1074Lw) {
        imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        imageView.setImageBitmap(AbstractC1075Lx.A01(enumC1074Lw));
        imageView.setColorFilter(-1);
    }

    public void setAdDetails(C05741a c05741a, String str, JA ja2, MC mc2) {
        setOnClickListener(new M8(this, ja2, mc2, str, c05741a));
    }
