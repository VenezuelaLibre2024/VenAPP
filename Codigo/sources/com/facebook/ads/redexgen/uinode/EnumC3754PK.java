...
public enum EnumC3754PK {
    ...
    EnumC3754PK(String str) {
        this.A00 = str;
    }

    public static EnumC3754PK A00(String str) {
        for (EnumC3754PK enumC3754PK : values()) {
            if (enumC3754PK.A00.equalsIgnoreCase(str)) {
                return enumC3754PK;
            }
        }
        return A0O;
