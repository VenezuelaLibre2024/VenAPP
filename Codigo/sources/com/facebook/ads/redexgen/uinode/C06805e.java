...
public final class C06805e implements InterstitialAdApi, Repairable {
    ...
    public C06805e(Context context, String str, InterstitialAd interstitialAd) {
        this.A00 = interstitialAd;
        String uuid = UUID.randomUUID().toString();
        C1399Yn A06 = C06785c.A06(context, uuid);
        this.A03 = A06;
        C0S A0E = A06.A0E();
    ...
    public final void A05(EnumSet<CacheFlag> enumSet, String str) {
        AbstractC1018Jp.A05(A00(129, 8, 2), A00(65, 30, 1), A00(16, 8, 113));
        if (str == null) {
            this.A03.A0E().A2p();
        } else {
            this.A03.A0E().A2o();
    ...
    public final void destroy() {
        AbstractC1018Jp.A05(A00(122, 7, 20), A00(40, 25, 28), A00(0, 8, 49));
    ...
    public final void loadAd(InterstitialAd.InterstitialLoadAdConfig interstitialLoadAdConfig) {
        ((C06815f) interstitialLoadAdConfig).A00();
    }

    @Override // com.facebook.ads.internal.context.Repairable
    public final void repair(Throwable th2) {
        if (this.A01.A02() != null) {
            this.A01.A02().onError(this.A00, new AdError(AdError.INTERNAL_ERROR_CODE, A00(24, 16, 8) + LW.A03(this.A03, th2)));
        }
    }
    ...
    public final boolean show() {
        AbstractC1018Jp.A05(A00(137, 4, 64), A00(95, 27, 39), A00(8, 8, 7));
        this.A03.A0E().A2y();
        boolean A0H = this.A02.A0H(this.A00, new C06825g());
