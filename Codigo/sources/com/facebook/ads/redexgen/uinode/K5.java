...
public final class K5 {
     ...
     */
    private C1301Up A01(C1399Yn c1399Yn, JSONObject jSONObject, long j10) throws JSONException {
        ...
        if (jSONObject2.has(A042)) {
            ...
            while (true) {
                ...
                if (strArr[5].charAt(22) == strArr[0].charAt(22)) {
                    ...
                    JC.A06(c1399Yn, jSONObject3, j10, null);
                    ...
                    if (optJSONObject != null) {
                        ...
                        c1399Yn.A0E().A4t(AdErrorType.UNKNOWN_ERROR.getErrorCode(), A04(67, 18, 82));
                    }
                    i10++;
                } else {
        ...
        return new C1301Up(c8s, jSONObject.optString(A04(29, 18, 1)));
    }
    ...
    private C1300Uo A02(JSONObject jSONObject) {
        return new C1300Uo(jSONObject.optString(A04(144, 7, 21), A04(0, 0, 87)), jSONObject.optInt(A04(59, 4, 3), 0), null);
    }

    private C1300Uo A03(JSONObject jSONObject) {
        try {
            ...
            return new C1300Uo(jSONObject.optString(A04(144, 7, 21), A04(0, 0, 87)), jSONObject.optInt(A04(59, 4, 3), 0), new C8S(A002, adReportingConfig, definition.optString(A04(0, 19, 98)), null));
    ...
    public final K7 A06(C1399Yn c1399Yn, String str, long j10) throws JSONException {
        char c10;
        if (!TextUtils.isEmpty(str)) {
            ...
            switch (c10) {
                case 0:
                    return A01(c1399Yn, jSONObject, j10);
                case 1:
