...
import com.facebook.ads.redexgen.uinode.AbstractC06654o;
...
public class RecyclerView$SavedState extends AbsSavedState {
    ...
    public RecyclerView$SavedState(Parcel parcel, ClassLoader classLoader) {
        ...
        this.A00 = parcel.readParcelable(classLoader == null ? AbstractC06654o.class.getClassLoader() : classLoader);
    }
