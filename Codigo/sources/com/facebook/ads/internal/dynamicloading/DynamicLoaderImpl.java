...
import com.facebook.ads.redexgen.uinode.C06775b;
import com.facebook.ads.redexgen.uinode.C06785c;
import com.facebook.ads.redexgen.uinode.C06805e;
import com.facebook.ads.redexgen.uinode.C06835h;
import com.facebook.ads.redexgen.uinode.C06845i;
import com.facebook.ads.redexgen.uinode.C06855j;
import com.facebook.ads.redexgen.uinode.C06885m;
import com.facebook.ads.redexgen.uinode.C06955t;
import com.facebook.ads.redexgen.uinode.C06995x;
import com.facebook.ads.redexgen.uinode.C1000Iv;
import com.facebook.ads.redexgen.uinode.C1001Iw;
import com.facebook.ads.redexgen.uinode.C1006Jc;
...
import com.facebook.ads.redexgen.uinode.EnumC1007Je;
...
public class DynamicLoaderImpl implements DynamicLoader, RemoteRenderingApi {
    ...
    public static final InitApi A06 = new InitApi() { // from class: com.facebook.ads.redexgen.X.5d
        ...
        public final void initialize(Context context, MultithreadedBundleWrapper multithreadedBundleWrapper, AudienceNetworkAds.InitListener initListener, int i10) {
            C8Y.A0G(C06785c.A09(context), multithreadedBundleWrapper, initListener, i10);
        }
    ...
    public AdSizeApi createAdSizeApi(int i10) {
        final EnumC1007Je A022 = L3.A02(i10);
    ...
    public AudienceNetworkActivityApi createAudienceNetworkActivity(final AudienceNetworkActivity audienceNetworkActivity, final AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        return new AudienceNetworkActivityApi(audienceNetworkActivity, audienceNetworkActivityApi, c5v) { // from class: com.facebook.ads.redexgen.X.5W
            ...
            private void A02(Throwable th2) {
                ...
                this.A02.A0L();
                finish(8);
                C07277f logContext = this.A02.A0K();
                if (logContext != null) {
    ...
    public InterstitialAdApi createInterstitialAd(Context context, String str, InterstitialAd interstitialAd) {
        return (InterstitialAdApi) C5M.A00(new C06805e(context, str, interstitialAd), InterstitialAdApi.class);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C06845i createNativeAdApi(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        return new C06845i(nativeAd, nativeAdBaseApi);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C06845i createNativeAdApi(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        return new C06845i(nativeAdBase, nativeAd, nativeAdBaseApi);
    }
    ...
    public NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i10, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i11) {
        return new C06855j(nativeAdScrollView, context, nativeAdsManager, adViewProvider, i10, type, nativeAdViewAttributes, i11);
    }
    ...
    public NativeAdViewApi createNativeAdViewApi() {
        if (A02 == null) {
            A02 = new NativeAdViewApi() { // from class: com.facebook.ads.redexgen.X.5k
                ...
                public static View A00(C1399Yn c1399Yn, NativeAd nativeAd, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    ...
                    ER er = new ER();
                    NativeAdLayout mediumRectTemplateLayout = new NativeAdLayout(c1399Yn, er);
                    er.A04(mediumRectTemplateLayout, c1399Yn, nativeAd, jr);
                ...
                public static View A01(C1399Yn c1399Yn, NativeAd nativeAd, NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    ...
                    A0L.A1W(jr);
                    ER er = new ER();
                    NativeAdLayout nativeAdLayout = new NativeAdLayout(c1399Yn, er);
                    er.A04(nativeAdLayout, c1399Yn, nativeAd, jr);
                ...
                public final View render(Context context, NativeAd nativeAd, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    try {
                        return A00(C06785c.A03(context), nativeAd, type, nativeAdViewAttributes);
                    } catch (Throwable th2) {
                        C1399Yn A032 = C06785c.A03(context);
                        if (A00[1].length() == 17) {
                ...
                public final View render(Context context, NativeAd nativeAd, NativeAdViewAttributes nativeAdViewAttributes) {
                    C1399Yn contextWrapper;
                    try {
                        if (context instanceof C1399Yn) {
                            contextWrapper = (C1399Yn) context;
                        } else {
                            contextWrapper = C06785c.A03(context);
                        }
                        return A01(contextWrapper, nativeAd, nativeAdViewAttributes);
                    } catch (Throwable th2) {
                        return MR.A00(C06785c.A03(context), th2);
                    }
                }
            };
        }
    ...
    public NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i10) {
        return (NativeAdsManagerApi) C5M.A00(new C06885m(context, str, i10), NativeAdsManagerApi.class);
    }
        ...
        return new NativeBannerAdApi(nativeAdBaseApi) { // from class: com.facebook.ads.redexgen.X.5q
            ...
            private void A02(ImageView imageView, NativeAdBaseApi nativeAdBaseApi2) {
                ...
                if (adIcon != null) {
                    ...
                    C1399Yn A032 = C06785c.A03(imageView.getContext());
                    if (preloadedBitmap != null) {
                        ...
                        Z9 z93 = null;
                        new AsyncTaskC06895n(A032, z92, A0L.A1d(), z93).execute(new C06915p(adIcon.getUrl(), A0L.A1C(), z93));
                        return;
                    }
                }
                V1 A15 = A0L.A15();
                ...
                if (A15 != null) {
                    A15.ABR(C1005Jb.A00(adErrorType));
                }
    ...
    public NativeBannerAdViewApi createNativeBannerAdViewApi() {
        if (A03 == null) {
            A03 = new NativeBannerAdViewApi() { // from class: com.facebook.ads.redexgen.X.5r
                public static View A00(C1399Yn c1399Yn, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    V2.A0L(nativeBannerAd.getInternalNativeAd()).A1X(JS.A00(type.getEnumCode()));
                    EZ bannerTemplateLayoutApi = new EZ();
                    NativeAdLayout nativeAdLayout = new NativeAdLayout(c1399Yn, bannerTemplateLayoutApi);
                    bannerTemplateLayoutApi.A04(c1399Yn, nativeBannerAd, (JR) nativeAdViewAttributes.getInternalAttributes(), nativeAdLayout);
                ...
                public final View render(Context context, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    try {
                        return A00(C06785c.A03(context), nativeBannerAd, type, nativeAdViewAttributes);
                    } catch (Throwable th2) {
                        return MR.A00(C06785c.A03(context), th2);
                    }
                }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) C5M.A00(new C06955t(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) C5M.A00(new C06995x(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }

    public static C06775b getBidderTokenProviderApi() {
        if (A04 == null) {
            A04 = new C06775b();
        }
        C06775b c06775b = A04;
