...
final class m {
    ...
    private final List<int[]> f26924a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    private final List<String> f26925b = new ArrayList();

    private void a(int[] iArr, String str) {
        this.f26924a.add(iArr);
    ...
    public String c(String str) {
        ...
        int size = this.f26924a.size();
        for (int i11 = 0; i11 < size && parseInt >= (i10 = (iArr = this.f26924a.get(i11))[0]); i11++) {
            if (iArr.length != 1) {
                i10 = iArr[1];
            }
            if (parseInt <= i10) {
                return this.f26925b.get(i11);
            }
        }
        return null;
    }
