...
public class AccessibilityViewEmbedder {
    ...
    public static class ViewAndId {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f18504id == viewAndId.f18504id && this.view.equals(viewAndId.view);
        }

        public int hashCode() {
            return ((this.view.hashCode() + 31) * 31) + this.f18504id;
        }
    }
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i10) {
        ...
        if (viewAndId == null || !this.embeddedViewToDisplayBounds.containsKey(viewAndId.view) || viewAndId.view.getAccessibilityNodeProvider() == null || (createAccessibilityNodeInfo = viewAndId.view.getAccessibilityNodeProvider().createAccessibilityNodeInfo(viewAndId.f18504id)) == null) {
            return null;
        }
    ...
    public boolean performAction(int i10, int i11, Bundle bundle) {
        ...
        return accessibilityNodeProvider.performAction(viewAndId.f18504id, i11, bundle);
    }
