...
public class AccessibilityBridge extends AccessibilityNodeProvider {
    ...
    public AccessibilityBridge(View view, AccessibilityChannel accessibilityChannel, AccessibilityManager accessibilityManager, ContentResolver contentResolver, AccessibilityViewEmbedder accessibilityViewEmbedder, PlatformViewsAccessibilityDelegate platformViewsAccessibilityDelegate) {
        ...
        this.accessibilityStateChangeListener = anonymousClass2;
        ...
        this.animationScaleObserver = anonymousClass3;
        ...
        AnonymousClass4 anonymousClass4 = new AccessibilityManager.TouchExplorationStateChangeListener() { // from class: io.flutter.view.AccessibilityBridge.4
            ...
            AnonymousClass4(AccessibilityManager accessibilityManager2) {
        ...
        this.touchExplorationStateChangeListener = anonymousClass4;
        ...
        anonymousClass3.onChange(false);
    ...
    static /* synthetic */ int access$1272(AccessibilityBridge accessibilityBridge, int i10) {
        int i11 = i10 & accessibilityBridge.accessibilityFeatureFlags;
        accessibilityBridge.accessibilityFeatureFlags = i11;
        return i11;
    }

    static /* synthetic */ int access$1276(AccessibilityBridge accessibilityBridge, int i10) {
        int i11 = i10 | accessibilityBridge.accessibilityFeatureFlags;
        accessibilityBridge.accessibilityFeatureFlags = i11;
        return i11;
    }
    ...
    public CustomAccessibilityAction getOrCreateAccessibilityAction(int i10) {
        ...
        customAccessibilityAction2.f18502id = i10;
    ...
    private void handleTouchExploration(float f10, float f11, boolean z10) {
        ...
        if (hitTest != null) {
            sendAccessibilityEvent(hitTest.f18503id, RecognitionOptions.ITF);
        }
        SemanticsNode semanticsNode = this.hoveredObject;
        if (semanticsNode != null) {
            sendAccessibilityEvent(semanticsNode.f18503id, RecognitionOptions.QR_CODE);
        }
    ...
    private void onWindowNameChange(SemanticsNode semanticsNode) {
        ...
        AccessibilityEvent obtainAccessibilityEvent = obtainAccessibilityEvent(semanticsNode.f18503id, 32);
    ...
    private boolean performCursorMoveAction(SemanticsNode semanticsNode, int i10, Bundle bundle, boolean z10) {
        ...
        if (i12 != semanticsNode.textSelectionBase || i13 != semanticsNode.textSelectionExtent) {
            ...
            AccessibilityEvent obtainAccessibilityEvent = obtainAccessibilityEvent(semanticsNode.f18503id, 8192);
            obtainAccessibilityEvent.getText().add(str);
    ...
    */
    ...
    private void sendWindowContentChangeEvent(int i10) {
        AccessibilityEvent obtainAccessibilityEvent = obtainAccessibilityEvent(i10, RecognitionOptions.PDF417);
    ...
    private void willRemoveSemanticsNode(SemanticsNode semanticsNode) {
        ...
        if (semanticsNode2 == semanticsNode) {
            sendAccessibilityEvent(semanticsNode2.f18503id, MIN_ENGINE_GENERATED_NODE_ID);
    ...
    */
    ...
    public int getHoveredObjectId() {
        return this.hoveredObject.f18503id;
    }
    ...
    public boolean onAccessibilityHoverEvent(MotionEvent motionEvent, boolean z10) {
        ...
        if (hitTest != null && hitTest.platformViewId != -1) {
            ...
            return this.accessibilityViewEmbedder.onAccessibilityHoverEvent(hitTest.f18503id, motionEvent);
        }
    ...
    public boolean performAction(int i10, int i11, Bundle bundle) {
        ...
        switch (i11) {
            ...
            case 64:
                ...
                sendAccessibilityEvent(i10, RecognitionOptions.TEZ_CODE);
            ...
            case RecognitionOptions.ITF /* 128 */:
                SemanticsNode semanticsNode2 = this.accessibilityFocusedSemanticsNode;
                if (semanticsNode2 != null && semanticsNode2.f18503id == i10) {
                    this.accessibilityFocusedSemanticsNode = null;
                }
            ...
            default:
                ...
                this.accessibilityChannel.dispatchSemanticsAction(i10, Action.CUSTOM_ACTION, Integer.valueOf(customAccessibilityAction.f18502id));
                return true;
        }
    }
    ...
    public void reset() {
        ...
        if (semanticsNode != null) {
            sendAccessibilityEvent(semanticsNode.f18503id, MIN_ENGINE_GENERATED_NODE_ID);
        }
        this.accessibilityFocusedSemanticsNode = null;
        this.hoveredObject = null;
    ...
    void updateSemantics(ByteBuffer byteBuffer, String[] strArr, ByteBuffer[] byteBufferArr) {
        ...
        for (SemanticsNode semanticsNode4 : arrayList2) {
            if (!this.flutterNavigationStack.contains(Integer.valueOf(semanticsNode4.f18503id))) {
        ...
        if (semanticsNode3 != null && (semanticsNode3.f18503id != this.previousRouteId || arrayList2.size() != this.flutterNavigationStack.size())) {
            this.previousRouteId = semanticsNode3.f18503id;
            onWindowNameChange(semanticsNode3);
        }
        this.flutterNavigationStack.clear();
        Iterator it = arrayList2.iterator();
        while (it.hasNext()) {
            this.flutterNavigationStack.add(Integer.valueOf(((SemanticsNode) it.next()).f18503id));
        }
        ...
        while (it3.hasNext()) {
            ...
            if (semanticsNode5.didScroll()) {
                AccessibilityEvent obtainAccessibilityEvent = obtainAccessibilityEvent(semanticsNode5.f18503id, RecognitionOptions.AZTEC);
            ...
            if (semanticsNode5.hasFlag(Flag.IS_LIVE_REGION) && semanticsNode5.didChangeLabel()) {
                sendWindowContentChangeEvent(semanticsNode5.f18503id);
            }
            SemanticsNode semanticsNode6 = this.accessibilityFocusedSemanticsNode;
            if (semanticsNode6 != null && semanticsNode6.f18503id == semanticsNode5.f18503id) {
                Flag flag = Flag.IS_SELECTED;
                if (!semanticsNode5.hadFlag(flag) && semanticsNode5.hasFlag(flag)) {
                    AccessibilityEvent obtainAccessibilityEvent2 = obtainAccessibilityEvent(semanticsNode5.f18503id, 4);
            ...
            if (semanticsNode7 != null && semanticsNode7.f18503id == semanticsNode5.f18503id && ((semanticsNode2 = this.lastInputFocusedSemanticsNode) == null || semanticsNode2.f18503id != this.inputFocusedSemanticsNode.f18503id)) {
                this.lastInputFocusedSemanticsNode = this.inputFocusedSemanticsNode;
                sendAccessibilityEvent(obtainAccessibilityEvent(semanticsNode5.f18503id, 8));
            ...
            if (semanticsNode8 != null && semanticsNode8.f18503id == semanticsNode5.f18503id) {
                Flag flag2 = Flag.IS_TEXT_FIELD;
                if (semanticsNode5.hadFlag(flag2) && semanticsNode5.hasFlag(flag2) && ((semanticsNode = this.accessibilityFocusedSemanticsNode) == null || semanticsNode.f18503id == this.inputFocusedSemanticsNode.f18503id)) {
                    ...
                    AccessibilityEvent createTextChangedEvent = createTextChangedEvent(semanticsNode5.f18503id, str, str2);
                    ...
                    if (semanticsNode5.previousTextSelectionBase != semanticsNode5.textSelectionBase || semanticsNode5.previousTextSelectionExtent != semanticsNode5.textSelectionExtent) {
                        AccessibilityEvent obtainAccessibilityEvent3 = obtainAccessibilityEvent(semanticsNode5.f18503id, 8192);
