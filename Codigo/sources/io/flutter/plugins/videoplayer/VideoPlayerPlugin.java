...
public class VideoPlayerPlugin implements FlutterPlugin, Messages.AndroidVideoPlayerApi {
    ...
    private VideoPlayerPlugin(final PluginRegistry.Registrar registrar) {
        FlutterState flutterState = new FlutterState(registrar.context(), registrar.messenger(), new KeyForAssetFn() { // from class: io.flutter.plugins.videoplayer.o
        ...
        }, new KeyForAssetAndPackageName() { // from class: io.flutter.plugins.videoplayer.p
    ...
    public static void registerWith(PluginRegistry.Registrar registrar) {
        ...
        registrar.addViewDestroyListener(new PluginRegistry.ViewDestroyListener() { // from class: io.flutter.plugins.videoplayer.n
