...
public class DartExecutor implements BinaryMessenger {
    ...
    /* loaded from: classes3.dex */
    public class AnonymousClass1 implements BinaryMessenger.BinaryMessageHandler {
        AnonymousClass1() {
        }
    ...
    public DartExecutor(FlutterJNI flutterJNI, AssetManager assetManager) {
        ...
        AnonymousClass1 anonymousClass1 = new BinaryMessenger.BinaryMessageHandler() { // from class: io.flutter.embedding.engine.dart.DartExecutor.1
            AnonymousClass1() {
            }
        ...
        this.isolateChannelMessageHandler = anonymousClass1;
        this.flutterJNI = flutterJNI;
        this.assetManager = assetManager;
        DartMessenger dartMessenger = new DartMessenger(flutterJNI);
        this.dartMessenger = dartMessenger;
        dartMessenger.setMessageHandler("flutter/isolate", anonymousClass1);
