...
public final class d {
    ...
    private static final String[] f25726a = new String[0];
    ...
    public static String[] a(EditorInfo editorInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            return strArr != null ? strArr : f25726a;
        }
        ...
        return stringArray != null ? stringArray : f25726a;
    }
    ...
    public static void e(EditorInfo editorInfo, CharSequence charSequence, int i10) {
        androidx.core.util.h.k(charSequence);
