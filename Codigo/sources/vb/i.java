...
public final class i extends com.google.crypto.tink.shaded.protobuf.y<i, b> implements s0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f28753a[y.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f28753a[y.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f28753a[y.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f28753a[y.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f28753a[y.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f28753a[y.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends y.a<i, b> implements s0 {
        ...
        public b A(com.google.crypto.tink.shaded.protobuf.h hVar) {
            r();
            ((i) this.f11562b).e0(hVar);
            return this;
        }

        public b B(k kVar) {
            r();
            ((i) this.f11562b).f0(kVar);
            return this;
        }

        public b C(int i10) {
            r();
            ((i) this.f11562b).g0(i10);
            return this;
        }
    ...
    static {
        ...
        com.google.crypto.tink.shaded.protobuf.y.S(i.class, iVar);
    }
    ...
    public static i d0(com.google.crypto.tink.shaded.protobuf.h hVar, com.google.crypto.tink.shaded.protobuf.p pVar) {
        return (i) com.google.crypto.tink.shaded.protobuf.y.M(DEFAULT_INSTANCE, hVar, pVar);
    }
