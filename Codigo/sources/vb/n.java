...
public final class n extends com.google.crypto.tink.shaded.protobuf.y<n, b> implements s0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f28761a[y.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f28761a[y.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f28761a[y.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f28761a[y.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f28761a[y.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f28761a[y.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends y.a<n, b> implements s0 {
        ...
        public b A(com.google.crypto.tink.shaded.protobuf.h hVar) {
            r();
            ((n) this.f11562b).c0(hVar);
            return this;
        }

        public b B(int i10) {
            r();
            ((n) this.f11562b).d0(i10);
            return this;
        }
    ...
    static {
        ...
        com.google.crypto.tink.shaded.protobuf.y.S(n.class, nVar);
    }
    ...
    public static n b0(com.google.crypto.tink.shaded.protobuf.h hVar, com.google.crypto.tink.shaded.protobuf.p pVar) {
        return (n) com.google.crypto.tink.shaded.protobuf.y.M(DEFAULT_INSTANCE, hVar, pVar);
    }
