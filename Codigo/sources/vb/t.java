...
public final class t extends com.google.crypto.tink.shaded.protobuf.y<t, b> implements s0 {
    private static final t DEFAULT_INSTANCE;
    public static final int ENCRYPTED_KEYSET_FIELD_NUMBER = 2;
    public static final int KEYSET_INFO_FIELD_NUMBER = 3;
    private static volatile z0<t> PARSER;
    private com.google.crypto.tink.shaded.protobuf.h encryptedKeyset_ = com.google.crypto.tink.shaded.protobuf.h.f11376b;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f28767a[y.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f28767a[y.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f28767a[y.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f28767a[y.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f28767a[y.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f28767a[y.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends y.a<t, b> implements s0 {
        ...
        public b A(com.google.crypto.tink.shaded.protobuf.h hVar) {
            r();
            ((t) this.f11562b).b0(hVar);
            return this;
        }

        public b B(d0 d0Var) {
            r();
            ((t) this.f11562b).c0(d0Var);
            return this;
        }
    ...
    static {
        ...
        com.google.crypto.tink.shaded.protobuf.y.S(t.class, tVar);
    }
    ...
    public static t a0(InputStream inputStream, com.google.crypto.tink.shaded.protobuf.p pVar) {
        return (t) com.google.crypto.tink.shaded.protobuf.y.N(DEFAULT_INSTANCE, inputStream, pVar);
    }
