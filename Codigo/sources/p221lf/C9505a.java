...
public class C9505a {
    ...
    /* renamed from: a */
    private static final TimeZone f23067a = TimeZone.getTimeZone("UTC");

    /* renamed from: a */
    private static boolean m28267a(String str, int i10, char c10) {
        return i10 < str.length() && str.charAt(i10) == c10;
    }

    /* renamed from: b */
    private static int m28268b(String str, int i10) {
    ...
    */
    public static java.util.Date m28269c(java.lang.String r17, java.text.ParsePosition r18) {
        /*
            Method dump skipped, instructions count: 553
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: p221lf.C9505a.m28269c(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: d */
    private static int m28270d(String str, int i10, int i11) {
        int i12;
        int i13;
