...
public final class C9881q {
    /* renamed from: a */
    public static Status m29583a(String str) {
        String str2;
        ...
        return asList.size() > 1 ? m29584b((String) asList.get(0), (String) asList.get(1)) : m29584b((String) asList.get(0), null);
    }

    /* renamed from: b */
    private static Status m29584b(String str, String str2) {
        int i10;
        str.hashCode();
        char c10 = 65535;
        switch (str.hashCode()) {
