...
public class C10755q implements InterfaceC0665s1 {
    ...
    private static C0608c2 m32723c() {
        ...
        c0608c2.m3013a(AbstractC0612d2.m3026a(bVar2, aVar));
        c0608c2.m3013a(AbstractC0612d2.m3026a(AbstractC0612d2.b.RAW, aVar));
        return c0608c2;
    }

    /* renamed from: e */
    private List<C0608c2> m32724e(int i10) {
        ArrayList arrayList = new ArrayList();
        if (i10 == 0) {
            arrayList.add(f27179a);
            arrayList.add(f27180b);
        }
        return arrayList;
    }

    /* renamed from: f */
    private List<C0608c2> m32725f(String str) {
        ArrayList arrayList = new ArrayList();
        if (str.equals("1")) {
            arrayList.add(f27179a);
        }
    ...
    /* renamed from: g */
    private static boolean m32726g() {
    ...
    /* renamed from: h */
    public static boolean m32727h() {
        return m32726g() || m32728i() || m32729j();
    }

    /* renamed from: i */
    private static boolean m32728i() {
        if (!"samsung".equalsIgnoreCase(Build.BRAND)) {
            return false;
        }
        return f27182d.contains(Build.MODEL.toUpperCase(Locale.US));
    }

    /* renamed from: j */
    private static boolean m32729j() {
        if (!"google".equalsIgnoreCase(Build.BRAND)) {
            return false;
        }
        return f27183e.contains(Build.MODEL.toUpperCase(Locale.US));
    }

    /* renamed from: d */
    public List<C0608c2> m32730d(String str, int i10) {
        return m32726g() ? m32725f(str) : m32728i() ? m32724e(i10) : m32729j() ? Collections.singletonList(f27181c) : Collections.emptyList();
    }
}
