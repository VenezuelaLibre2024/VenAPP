...
final class C10911a {
    ...
    public byte[] m33313a() {
        ...
        int m27606j = this.f27742a.m27606j();
        int m27609m = this.f27742a.m27609m();
        for (int i10 = 0; i10 < m27606j; i10++) {
            int[] iArr = f27741b[i10];
            for (int i11 = 0; i11 < m27609m; i11++) {
                int i12 = iArr[i11];
                if (i12 >= 0 && this.f27742a.m27603g(i11, i10)) {
                    int i13 = i12 / 6;
