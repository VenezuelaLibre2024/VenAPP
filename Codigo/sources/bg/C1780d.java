...
public class C1780d {
    ...
    /* renamed from: a */
    private static final C5249j f7414a = new C5249j("MLKitImageUtils", "");

    /* renamed from: b */
    private static final C1780d f7415b = new C1780d();

    private C1780d() {
    }

    /* renamed from: b */
    public static C1780d m9501b() {
        return f7415b;
    }

    /* renamed from: a */
    public InterfaceC5312b m9502a(C0113a c0113a) {
        Object obj;
        ...
        if (m538f != -1) {
            if (m538f != 17) {
                if (m538f == 35) {
                    obj = c0113a.m540h();
                } else if (m538f != 842094169) {
                    throw new C10475a("Unsupported image format: " + c0113a.m538f(), 3);
                }
            }
            obj = (ByteBuffer) C5276s.m13324j(c0113a.m536d());
        } else {
            obj = (Bitmap) C5276s.m13324j(c0113a.m535c());
        }
        return BinderC5314d.m13412h2(obj);
    }

    /* renamed from: c */
    public int m9503c(C0113a c0113a) {
        if (c0113a.m538f() == -1) {
            return ((Bitmap) C5276s.m13324j(c0113a.m535c())).getAllocationByteCount();
        }
        if (c0113a.m538f() == 17 || c0113a.m538f() == 842094169) {
            return ((ByteBuffer) C5276s.m13324j(c0113a.m536d())).limit();
        }
        if (c0113a.m538f() != 35) {
            return 0;
        }
        return (((Image.Plane[]) C5276s.m13324j(c0113a.m541i()))[0].getBuffer().limit() * 3) / 2;
    }

    /* renamed from: d */
    public Matrix m9504d(int i10, int i11, int i12) {
        if (i12 == 0) {
            return null;
        }
    ...
    */
    public final android.graphics.Bitmap m9505e(android.content.ContentResolver r11, android.net.Uri r12) {
        /*
            r10 = this;
        ...
        L53:
            ...
            r5 = r3
        L55:
            com.google.android.gms.common.internal.j r0 = bg.C1780d.f7414a     // Catch: java.io.FileNotFoundException -> Lc4
            ...
            r0.m13287d(r1, r6, r11)     // Catch: java.io.FileNotFoundException -> Lc4
        L64:
            if (r5 != 0) goto L67
            goto L6d
        L67:
            java.lang.String r11 = "Orientation"
            int r4 = r5.m6783h(r11, r2)     // Catch: java.io.FileNotFoundException -> Lc4
        L6d:
        ...
        Lc4:
            r11 = move-exception
            com.google.android.gms.common.internal.j r0 = bg.C1780d.f7414a
            java.lang.String r12 = java.lang.String.valueOf(r12)
            java.lang.String r2 = "Could not open file: "
            java.lang.String r12 = r2.concat(r12)
            r0.m13287d(r1, r12, r11)
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: bg.C1780d.m9505e(android.content.ContentResolver, android.net.Uri):android.graphics.Bitmap");
    }
}
