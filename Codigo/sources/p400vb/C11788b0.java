...
public final class C11788b0 extends AbstractC6018y<C11788b0, b> implements InterfaceC6004s0 {
    public static final int CATALOGUE_NAME_FIELD_NUMBER = 5;
    private static final C11788b0 DEFAULT_INSTANCE;
    public static final int KEY_MANAGER_VERSION_FIELD_NUMBER = 3;
    public static final int NEW_KEY_ALLOWED_FIELD_NUMBER = 4;
    private static volatile InterfaceC6021z0<C11788b0> PARSER = null;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f31174a[AbstractC6018y.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f31174a[AbstractC6018y.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f31174a[AbstractC6018y.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f31174a[AbstractC6018y.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f31174a[AbstractC6018y.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f31174a[AbstractC6018y.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* loaded from: classes2.dex */
    public static final class b extends AbstractC6018y.a<C11788b0, b> implements InterfaceC6004s0 {
        private b() {
            super(C11788b0.DEFAULT_INSTANCE);
        }
    ...
    static {
        C11788b0 c11788b0 = new C11788b0();
        DEFAULT_INSTANCE = c11788b0;
        AbstractC6018y.m16229S(C11788b0.class, c11788b0);
    }
    ...
    protected final Object mo16251x(AbstractC6018y.f fVar, Object obj, Object obj2) {
        a aVar = null;
        switch (a.f31174a[fVar.ordinal()]) {
            case 1:
                return new C11788b0();
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC6018y.m16222K(DEFAULT_INSTANCE, "\u0000\u0005\u0000\u0000\u0001\u0005\u0005\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ\u0003\u000b\u0004\u0007\u0005Ȉ", new Object[]{"primitiveName_", "typeUrl_", "keyManagerVersion_", "newKeyAllowed_", "catalogueName_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                InterfaceC6021z0<C11788b0> interfaceC6021z0 = PARSER;
                if (interfaceC6021z0 == null) {
                    synchronized (C11788b0.class) {
