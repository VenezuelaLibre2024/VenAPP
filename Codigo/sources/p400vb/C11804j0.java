...
public final class C11804j0 extends AbstractC6018y<C11804j0, b> implements InterfaceC6004s0 {
    public static final int CONFIG_NAME_FIELD_NUMBER = 1;
    private static final C11804j0 DEFAULT_INSTANCE;
    public static final int ENTRY_FIELD_NUMBER = 2;
    private static volatile InterfaceC6021z0<C11804j0> PARSER;
    private String configName_ = "";
    private C5950a0.i<C11788b0> entry_ = AbstractC6018y.m16232y();
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f31189a[AbstractC6018y.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f31189a[AbstractC6018y.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f31189a[AbstractC6018y.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f31189a[AbstractC6018y.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f31189a[AbstractC6018y.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f31189a[AbstractC6018y.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* loaded from: classes2.dex */
    public static final class b extends AbstractC6018y.a<C11804j0, b> implements InterfaceC6004s0 {
        private b() {
            super(C11804j0.DEFAULT_INSTANCE);
        }
    ...
    static {
        C11804j0 c11804j0 = new C11804j0();
        DEFAULT_INSTANCE = c11804j0;
        AbstractC6018y.m16229S(C11804j0.class, c11804j0);
    }
    ...
    /* renamed from: W */
    public static C11804j0 m37506W() {
    ...
    protected final Object mo16251x(AbstractC6018y.f fVar, Object obj, Object obj2) {
        a aVar = null;
        switch (a.f31189a[fVar.ordinal()]) {
            case 1:
                return new C11804j0();
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC6018y.m16222K(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0001\u0000\u0001Ȉ\u0002\u001b", new Object[]{"configName_", "entry_", C11788b0.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                InterfaceC6021z0<C11804j0> interfaceC6021z0 = PARSER;
                if (interfaceC6021z0 == null) {
                    synchronized (C11804j0.class) {
