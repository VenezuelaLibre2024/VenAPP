...
public final class C11812p extends AbstractC6018y<C11812p, b> implements InterfaceC6004s0 {
    private static final C11812p DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 2;
    private static volatile InterfaceC6021z0<C11812p> PARSER = null;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f31197a[AbstractC6018y.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f31197a[AbstractC6018y.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f31197a[AbstractC6018y.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f31197a[AbstractC6018y.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f31197a[AbstractC6018y.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f31197a[AbstractC6018y.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: vb.p$b */
    /* loaded from: classes2.dex */
    public static final class b extends AbstractC6018y.a<C11812p, b> implements InterfaceC6004s0 {
        private b() {
            super(C11812p.DEFAULT_INSTANCE);
        }
        ...
        /* renamed from: A */
        public b m37573A(AbstractC5970h abstractC5970h) {
            m16257r();
            ((C11812p) this.f12777b).m37569c0(abstractC5970h);
            return this;
        }

        /* renamed from: B */
        public b m37574B(int i10) {
            m16257r();
            ((C11812p) this.f12777b).m37570d0(i10);
            return this;
        }
    ...
    static {
        C11812p c11812p = new C11812p();
        DEFAULT_INSTANCE = c11812p;
        AbstractC6018y.m16229S(C11812p.class, c11812p);
    }
    ...
    /* renamed from: a0 */
    public static b m37567a0() {
        return DEFAULT_INSTANCE.m16248u();
    }

    /* renamed from: b0 */
    public static C11812p m37568b0(AbstractC5970h abstractC5970h, C5994p c5994p) {
        return (C11812p) AbstractC6018y.m16223M(DEFAULT_INSTANCE, abstractC5970h, c5994p);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: c0 */
    public void m37569c0(AbstractC5970h abstractC5970h) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: d0 */
    public void m37570d0(int i10) {
        this.version_ = i10;
    }

    /* renamed from: Y */
    public AbstractC5970h m37571Y() {
    ...
    protected final Object mo16251x(AbstractC6018y.f fVar, Object obj, Object obj2) {
        ...
        switch (a.f31197a[fVar.ordinal()]) {
            ...
            case 5:
                InterfaceC6021z0<C11812p> interfaceC6021z0 = PARSER;
                if (interfaceC6021z0 == null) {
                    synchronized (C11812p.class) {
