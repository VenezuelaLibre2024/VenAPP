...
public final class C10484i {
    ...
    /* renamed from: a */
    private static String m31466a(CharSequence charSequence, int i10) {
        int i11;
        int i12;
        int i13 = 0;
        while (true) {
    ...
    /* renamed from: b */
    public static String m31467b(String str, C10487l c10487l) {
        if (str.length() != c10487l.m31537a()) {
            throw new IllegalArgumentException("The number of codewords does not match the selected symbol");
        }
        StringBuilder sb2 = new StringBuilder(c10487l.m31537a() + c10487l.m31538c());
        sb2.append(str);
        int mo31432f = c10487l.mo31432f();
        if (mo31432f == 1) {
            sb2.append(m31466a(str, c10487l.m31538c()));
        } else {
            sb2.setLength(sb2.capacity());
            int[] iArr = new int[mo31432f];
            int[] iArr2 = new int[mo31432f];
            int i10 = 0;
            while (i10 < mo31432f) {
                int i11 = i10 + 1;
                iArr[i10] = c10487l.mo31431b(i11);
                iArr2[i10] = c10487l.m31539d(i11);
                i10 = i11;
            }
            for (int i12 = 0; i12 < mo31432f; i12++) {
                StringBuilder sb3 = new StringBuilder(iArr[i12]);
                for (int i13 = i12; i13 < c10487l.m31537a(); i13 += mo31432f) {
                    sb3.append(str.charAt(i13));
                }
                String m31466a = m31466a(sb3.toString(), iArr2[i12]);
                int i14 = 0;
                int i15 = i12;
                while (i15 < iArr2[i12] * mo31432f) {
                    sb2.setCharAt(c10487l.m31537a() + i15, m31466a.charAt(i14));
                    i15 += mo31432f;
                    i14++;
                }
            }
