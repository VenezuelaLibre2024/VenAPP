...
public class C12793y {
    /* renamed from: a */
    private static boolean m42424a(Location location) {
        boolean isMock;
    ...
    /* renamed from: b */
    public static Map<String, Object> m42425b(Location location) {
        ...
        hashMap.put("is_mocked", Boolean.valueOf(m42424a(location)));
